...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CFECDAF953
	for <lists+linux-kernel@lfdr.de>; Wed, 11 Sep 2019 11:45:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727515AbfIKJph (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 11 Sep 2019 05:45:37 -0400
Received: from mx0b-0014ca01.pphosted.com ([208.86.201.193]:45282 "EHLO
        mx0a-0014ca01.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726657AbfIKJpg (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 11 Sep 2019 05:45:36 -0400
Received: from pps.filterd (m0042333.ppops.net [127.0.0.1])
        by mx0b-0014ca01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id x8B9cIIk031920;
        Wed, 11 Sep 2019 02:44:17 -0700
...
Received: from DM5PR07CA0045.namprd07.prod.outlook.com (2603:10b6:3:16::31) by
 BN8PR07MB6003.namprd07.prod.outlook.com (2603:10b6:408:9f::16) with Microsoft
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 11 Sep 2019 09:44:11.0945
 (UTC)
...
>> +}
>
>Would you mind moving this helper to the bottom, where it is used
>(closer to the remove/cleanup functions).
>
ok. 
...
>Cache?
>
If  feature is enabled then The NAND Flash Controller will sequence 
the multi-page read commands as cache read or cache program sequence. 
Not used by Linux driver because driver has possibility to 
program/read only a single page.
...
>> +}
>
>Not sure this function is relevant, see below.
>
>> +
...
4096.
In case ECC is enabled. 4096 offset is somewhere in sector 4. 
Start of spare are is 4096 + 3 * ecc_size. So BBM is taken from bad
place.
<page                                   ><spare                 >
...
1. During build BBT the BBM is read by functions which are expected 
    to use ECC. 
2. Controller interleaves the data with ECC.
...
>
>If the line is not readable enough you can use intermediate variables.
>Also the priority of the '*' operator could be enforced with
>parenthesis. Really this is just a nit pick :)
>
Ok I will change it.
...
>
>I think this will be refused by robots, you have to squash the two
>lines into
>
...
>
>Maybe you could turn this property into an optional one, with a default
>value?
>
Hmmm, maybe you are right. It will be simpler to use. I will change it.
...
>> +
>
>Would you mind adding yourself in MAINTAINERS for this driver (+
>bindings)?
Ok. I will do that.
