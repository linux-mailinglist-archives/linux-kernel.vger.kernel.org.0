...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0B5D64C424
	for <lists+linux-kernel@lfdr.de>; Thu, 20 Jun 2019 01:39:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730504AbfFSXjB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 19 Jun 2019 19:39:01 -0400
Received: from mga05.intel.com ([192.55.52.43]:53330 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726251AbfFSXjB (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 19 Jun 2019 19:39:01 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga105.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 19 Jun 2019 16:38:58 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.63,394,1557212400"; 
   d="gz'50?scan'50,208,50";a="335331021"
Received: from lkp-server01.sh.intel.com (HELO lkp-server01) ([10.239.97.150])
  by orsmga005.jf.intel.com with ESMTP; 19 Jun 2019 16:38:56 -0700
Received: from kbuild by lkp-server01 with local (Exim 4.89)
        (envelope-from <lkp@intel.com>)
        id 1hdkAJ-000C7M-TR; Thu, 20 Jun 2019 07:38:55 +0800
Date:   Thu, 20 Jun 2019 07:38:07 +0800
From:   kbuild test robot <lkp@intel.com>
To:     Kan Liang <kan.liang@linux.intel.com>
Cc:     kbuild-all@01.org, linux-kernel@vger.kernel.org,
        tipbuild@zytor.com, Ingo Molnar <mingo@kernel.org>,
        "Peter Zijlstra (Intel)" <peterz@infradead.org>
Subject: [tip:perf/core 23/33] arch/x86/events/intel/rapl.c:781:23: error:
 'INTEL_FAM6_ICELAKE_DESKTOP' undeclared here (not in a function); did you
 mean 'INTEL_FAM6_SKYLAKE_DESKTOP'?
Message-ID: <201906200702.n7RdDWBw%lkp@intel.com>
MIME-Version: 1.0
...
>> arch/x86/events/intel/rapl.c:781:23: error: 'INTEL_FAM6_ICELAKE_DESKTOP' undeclared here (not in a function); did you mean 'INTEL_FAM6_SKYLAKE_DESKTOP'?
     X86_RAPL_MODEL_MATCH(INTEL_FAM6_ICELAKE_DESKTOP, skl_rapl_init),
                          ^
   arch/x86/events/intel/rapl.c:702:25: note: in definition of macro 'X86_RAPL_MODEL_MATCH'
     { X86_VENDOR_INTEL, 6, model, X86_FEATURE_ANY, (unsigned long)&init }
                            ^~~~~
--
>> arch/x86/events/intel/uncore.c:1406:25: error: 'INTEL_FAM6_ICELAKE_DESKTOP' undeclared here (not in a function); did you mean 'INTEL_FAM6_SKYLAKE_DESKTOP'?
     X86_UNCORE_MODEL_MATCH(INTEL_FAM6_ICELAKE_DESKTOP, icl_uncore_init),
                            ^
   arch/x86/events/intel/uncore.c:1303:25: note: in definition of macro 'X86_UNCORE_MODEL_MATCH'
     { X86_VENDOR_INTEL, 6, model, X86_FEATURE_ANY, (unsigned long)&init }
                            ^~~~~
--
>> arch/x86/events/intel/cstate.c:583:20: error: 'INTEL_FAM6_ICELAKE_DESKTOP' undeclared here (not in a function); did you mean 'INTEL_FAM6_SKYLAKE_DESKTOP'?
     X86_CSTATES_MODEL(INTEL_FAM6_ICELAKE_DESKTOP, snb_cstates),
                       ^
   arch/x86/events/intel/cstate.c:533:25: note: in definition of macro 'X86_CSTATES_MODEL'
     { X86_VENDOR_INTEL, 6, model, X86_FEATURE_ANY, (unsigned long) &(states) }
                            ^~~~~

vim +781 arch/x86/events/intel/rapl.c
 ...
 > 781		X86_RAPL_MODEL_MATCH(INTEL_FAM6_ICELAKE_DESKTOP, skl_rapl_init),
   782		{},
   783	};
   784	
...
H4sICBLGCl0AAy5jb25maWcAlDzbctw2su/5iinnJaktJ7rYis85pQeQBEl4SIIBwJHGLyxF
