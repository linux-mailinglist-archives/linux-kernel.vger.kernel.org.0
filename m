...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CA6CC7B2F3
	for <lists+linux-kernel@lfdr.de>; Tue, 30 Jul 2019 21:09:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388144AbfG3TJG (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 30 Jul 2019 15:09:06 -0400
Received: from mail-qk1-f193.google.com ([209.85.222.193]:40062 "EHLO
        mail-qk1-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388000AbfG3TJF (ORCPT
        <rfc822;Linux-kernel@vger.kernel.org>);
        Tue, 30 Jul 2019 15:09:05 -0400
Received: by mail-qk1-f193.google.com with SMTP id s145so47393910qke.7
        for <Linux-kernel@vger.kernel.org>; Tue, 30 Jul 2019 12:08:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:date:to:cc:subject:message-id:references:mime-version
         :content-disposition:content-transfer-encoding:in-reply-to
         :user-agent;
        bh=ZnozebAcHItY4RAqLay5iIX5SX0L4YIRO+VMEXJfAFg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ZnozebAcHItY4RAqLay5iIX5SX0L4YIRO+VMEXJfAFg=;
        b=
X-Gm-Message-State: APjAAAW/Q2zezI4I3zGLvViRbQ4rvEQjq1bgV+GuaM8KyFgzdDycuYJk
        8n2DKrn45BNRTPuheBpDXtw=
X-Google-Smtp-Source: APXvYqzm+7HRb1Z4fZaPwRWe1gYjqP8r8v9aoVvZp2HKXxaJ76525bR36Rsf36y1PDYOCY4oPDUWbg==
X-Received: by 2002:a37:749:: with SMTP id 70mr77440018qkh.399.1564513735156;
        Tue, 30 Jul 2019 12:08:55 -0700 (PDT)
Received: from quaco.ghostprotocols.net ([179.97.35.50])
        by smtp.gmail.com with ESMTPSA id k38sm36902781qtk.10.2019.07.30.12.08.51
        (version=TLS1_3 cipher=AEAD-AES256-GCM-SHA384 bits=256/256);
        Tue, 30 Jul 2019 12:08:52 -0700 (PDT)
From:   Arnaldo Carvalho de Melo <arnaldo.melo@gmail.com>
X-Google-Original-From: Arnaldo Carvalho de Melo <acme@kernel.org>
Received: by quaco.ghostprotocols.net (Postfix, from userid 1000)
        id 9AF4640340; Tue, 30 Jul 2019 16:08:48 -0300 (-03)
Date:   Tue, 30 Jul 2019 16:08:48 -0300
...
Message-ID: <20190730190848.GA13361@kernel.org>
...
Em Wed, Jul 24, 2019 at 02:32:27PM +0800, Haiyan Song escreveu:
> Hi,
>=20
...
>=20
>=20
> On 7/24/19 10:27 AM, Haiyan Song wrote:
...
> >   create mode 100644 tools/perf/pmu-events/arch/x86/icelake/floating-po=
int.json
> >   create mode 100644 tools/perf/pmu-events/arch/x86/icelake/frontend.js=
on
...
> >   create mode 100644 tools/perf/pmu-events/arch/x86/icelake/pipeline.js=
on
> >   create mode 100644 tools/perf/pmu-events/arch/x86/icelake/virtual-mem=
ory.json
> >=20
> > diff --git a/tools/perf/pmu-events/arch/x86/icelake/cache.json b/tools/=
perf/pmu-events/arch/x86/icelake/cache.json
...
> > +        "PublicDescription": "Counts the number of offcore outstanding=
 demand rfo Reads transactions in the super queue every cycle. The 'Offcore=
 outstanding' state of the transaction lasts from the L2 miss until the sen=
ding transaction completion to requestor (SQ deallocation). See the corresp=
onding Umask under OFFCORE_REQUESTS.",
> > +        "EventCode": "0x60",
> > +        "Counter": "0,1,2,3",
> > +        "UMask": "0x4",
> > +        "PEBScounters": "0,1,2,3",
...
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of offcore outstanding=
 cacheable Core Data Read transactions in the super queue every cycle. A tr=
ansaction is considered to be in the Offcore outstanding state between L2 m=
iss and transaction completion sent to requestor (SQ de-allocation). See co=
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts cycles when offcore outstanding c=
acheable Core Data Read transactions are present in the super queue. A tran=
...
> > +        "BriefDescription": "Cycles when offcore outstanding cacheable=
 Core Data Read transactions are present in SuperQueue (SQ), queue to uncor=
e.",
> > +        "CounterMask": "1"
> > +    },
> > +    {
...
uper queue including requests initiated by the core, all L3 prefetches, pag=
e walks, etc..",
> > +        "EventCode": "0xB0",
> > +        "Counter": "0,1,2,3",
> > +        "UMask": "0x80",
...
> > +        "SampleAfterValue": "100003",
> > +        "BriefDescription": "Cycles the thread is active and superQ ca=
nnot take any more entries."
> > +    }
> > +]
> > \ No newline at end of file
> > diff --git a/tools/perf/pmu-events/arch/x86/icelake/floating-point.json=
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts number of SSE/AVX computational s=
calar double precision floating-point instructions retired; some instructio=
ns will count twice as noted below.  Each count represents 1 computational =
operation. Applies to SSE* and AVX* scalar double precision floating-point =
instructions: ADD SUB MUL DIV MIN MAX SQRT FM(N)ADD/SUB.  FM(N)ADD/SUB inst=
ructions count twice as they perform 2 calculations per element.",
> > +        "EventCode": "0xc7",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x1",
> > +        "PEBScounters": "0,1,2,3,4,5,6,7",
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of SSE/AVX computational scalar do=
uble precision floating-point instructions retired; some instructions will =
count twice as noted below.  Each count represents 1 computation. Applies t=
o SSE* and AVX* scalar double precision floating-point instructions: ADD SU=
B MUL DIV MIN MAX RCP14 RSQRT14 RANGE SQRT DPP FM(N)ADD/SUB.  DPP and FM(N)=
ADD/SUB instructions count twice as they perform 2 calculations per element=
=2E"
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts number of SSE/AVX computational s=
calar single precision floating-point instructions retired; some instructio=
ns will count twice as noted below.  Each count represents 1 computational =
operation. Applies to SSE* and AVX* scalar single precision floating-point =
instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT RCP FM(N)ADD/SUB.  FM(N)AD=
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of SSE/AVX computational scalar si=
ngle precision floating-point instructions retired; some instructions will =
count twice as noted below.  Each count represents 1 computation. Applies t=
o SSE* and AVX* scalar single precision floating-point instructions: ADD SU=
B MUL DIV MIN MAX RCP14 RSQRT14 RANGE SQRT DPP FM(N)ADD/SUB.  DPP and FM(N)=
ADD/SUB instructions count twice as they perform 2 calculations per element=
=2E"
> > +    },
...
28-bit packed double precision floating-point instructions retired; some in=
structions will count twice as noted below.  Each count represents 2 comput=
ation operations, one for each element.  Applies to SSE* and AVX* packed do=
uble precision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DI=
V MIN MAX SQRT DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count t=
wice as they perform 2 calculations per element.",
> > +        "EventCode": "0xc7",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x4",
> > +        "PEBScounters": "0,1,2,3,4,5,6,7",
...
acked double precision floating-point instructions retired; some instructio=
ns will count twice as noted below.  Each count represents 2 computation op=
erations, one for each element.  Applies to SSE* and AVX* packed double pre=
cision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DIV MIN MA=
X SQRT RSQRT14 RCP14 RANGE DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instruct=
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts number of SSE/AVX computational 2=
56-bit packed double precision floating-point instructions retired; some in=
structions will count twice as noted below.  Each count represents 4 comput=
ation operations, one for each element.  Applies to SSE* and AVX* packed do=
uble precision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DI=
V MIN MAX SQRT FM(N)ADD/SUB.  FM(N)ADD/SUB instructions count twice as they=
...
ns will count twice as noted below.  Each count represents 4 computation op=
erations, one for each element.  Applies to SSE* and AVX* packed double pre=
cision floating-point instructions: ADD SUB MUL DIV MIN MAX RCP14 RSQRT14 R=
ANGE SQRT DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count twice =
as they perform 2 calculations per element."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts number of SSE/AVX computational 2=
56-bit packed single precision floating-point instructions retired; some in=
structions will count twice as noted below.  Each count represents 8 comput=
ation operations, one for each element.  Applies to SSE* and AVX* packed si=
ngle precision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DI=
V MIN MAX SQRT RSQRT RCP DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructio=
ns count twice as they perform 2 calculations per element.",
...
> > +        "BriefDescription": "Number of SSE/AVX computational 256-bit p=
acked single precision floating-point instructions retired; some instructio=
ns will count twice as noted below.  Each count represents 8 computation op=
erations, one for each element.  Applies to SSE* and AVX* packed single pre=
cision floating-point instructions: ADD SUB MUL DIV MIN MAX RCP14 RSQRT14 R=
ANGE SQRT DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count twice =
as they perform 2 calculations per element."
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts number of SSE/AVX computational 5=
12-bit packed double precision floating-point instructions retired; some in=
structions will count twice as noted below.  Each count represents 8 comput=
ation operations, one for each element.  Applies to SSE* and AVX* packed do=
uble precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RS=
QRT14 RCP14 RANGE FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as th=
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of SSE/AVX computational 512-bit p=
acked double precision floating-point instructions retired; some instructio=
ns will count twice as noted below.  Each count represents 16 computation o=
perations, one for each element.  Applies to SSE* and AVX* packed double pr=
ecision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT14 R=
CP14 RANGE FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perf=
...
> > +        "PublicDescription": "Counts number of SSE/AVX computational 5=
12-bit packed double precision floating-point instructions retired; some in=
structions will count twice as noted below.  Each count represents 16 compu=
tation operations, one for each element.  Applies to SSE* and AVX* packed d=
ouble precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT R=
SQRT14 RCP14 RANGE FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as t=
...
ns will count twice as noted below.  Each count represents 8 computation op=
erations, one for each element.  Applies to SSE* and AVX* packed double pre=
cision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT14 RC=
P14 RANGE FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perfo=
rm 2 calculations per element."
> > +    }
> > +]
> > \ No newline at end of file
> > diff --git a/tools/perf/pmu-events/arch/x86/icelake/frontend.json b/too=
ls/perf/pmu-events/arch/x86/icelake/frontend.json
> > new file mode 100644
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts cycles during which uops are bein=
g delivered to Instruction Decode Queue (IDQ) while the Microcode Sequencer=
...
er an interval where the front-end delivered no uops for a period of 2 cycl=
...
> > +]
> > \ No newline at end of file
> > diff --git a/tools/perf/pmu-events/arch/x86/icelake/memory.json b/tools=
/perf/pmu-events/arch/x86/icelake/memory.json
> > new file mode 100644
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Speculatively counts the number Transact=
ional Synchronization Extensions (TSX) Aborts due to a data capacity limita=
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Speculatively counts the number TSX Abort=
s due to a data capacity limitation for transactional writes."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times a TSX Abort w=
as triggered due to a non-release/commit store to lock.",
> > +        "EventCode": "0x54",
> > +        "Counter": "0,1,2,3",
> > +        "UMask": "0x4",
> > +        "PEBScounters": "0,1,2,3",
...
> > +        "SampleAfterValue": "100003",
> > +        "BriefDescription": "Number of times a HLE transactional regio=
n aborted due to a non XRELEASE prefixed instruction writing to an elided l=
ock in the elision buffer"
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times a TSX Abort w=
as triggered due to commit but Lock Buffer not empty.",
> > +        "EventCode": "0x54",
> > +        "Counter": "0,1,2,3",
> > +        "UMask": "0x8",
> > +        "PEBScounters": "0,1,2,3",
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of times an HLE transactional exec=
ution aborted due to NoAllocatedElisionBuffer being non-zero."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times a TSX Abort w=
as triggered due to release/commit but data and address mismatch.",
> > +        "EventCode": "0x54",
> > +        "Counter": "0,1,2,3",
> > +        "UMask": "0x10",
> > +        "PEBScounters": "0,1,2,3",
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of times an HLE transactional exec=
ution aborted due to XRELEASE lock not satisfying the address and value req=
uirements in the elision buffer"
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times a TSX Abort w=
as triggered due to attempting an unsupported alignment from Lock Buffer.",
> > +        "EventCode": "0x54",
> > +        "Counter": "0,1,2,3",
> > +        "UMask": "0x20",
> > +        "PEBScounters": "0,1,2,3",
> > +        "EventName": "TX_MEM.ABORT_HLE_ELISION_BUFFER_UNSUPPORTED_ALIG=
NMENT",
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of times an HLE transactional exec=
ution aborted due to an unsupported read alignment from the elision buffer."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times we could not =
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of times HLE lock could not be eli=
ded due to ElisionBufferAvailable being zero."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Cycles while L3 cache miss demand load is=
 outstanding.",
> > +        "CounterMask": "2"
> > +    },
> > +    {
...
> > +        "PublicDescription": "Counts the number of times we entered an=
 HLE region. Does not count nested transactions.",
> > +        "EventCode": "0xC8",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x1",
> > +        "PEBScounters": "0,1,2,3,4,5,6,7",
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times HLE commit su=
cceeded.",
> > +        "EventCode": "0xC8",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x2",
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of times an HLE execution successf=
ully committed",
> > +        "Data_LA": "1"
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times HLE abort was=
 triggered.",
> > +        "EventCode": "0xc8",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x4",
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of times an HLE execution aborted =
due to any reasons (multiple categories may count as one)."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times an HLE execut=
ion aborted due to various memory events (e.g., read/write capacity and con=
flicts).",
> > +        "EventCode": "0xC8",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x8",
...
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times an HLE execut=
ion aborted due to HLE-unfriendly instructions and certain unfriendly event=
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Number of times an HLE execution aborted =
due to HLE-unfriendly instructions and certain unfriendly events (such as A=
D assists etc.)."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times an HLE execut=
ion aborted due to unfriendly events (such as interrupts).",
> > +        "EventCode": "0xC8",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x80",
> > +        "PEBScounters": "0,1,2,3,4,5,6,7",
...
> > +]
> > \ No newline at end of file
> > diff --git a/tools/perf/pmu-events/arch/x86/icelake/other.json b/tools/=
perf/pmu-events/arch/x86/icelake/other.json
> > new file mode 100644
...
threads) who share the same physical core. Software can use this event as t=
he denominator for the top-level metrics of the Top-down Microarchitecture =
Analysis method. This event is counted on a designated fixed counter (Fixed=
 Counter 3) and is an architectural event.",
> > +        "Counter": "35",
> > +        "UMask": "0x4",
> > +        "PEBScounters": "35",
> > +        "EventName": "TOPDOWN.SLOTS",
> > +        "SampleAfterValue": "10000003",
> > +        "BriefDescription": "Counts the number of available slots for =
...
> > +        "SampleAfterValue": "10000003",
> > +        "BriefDescription": "Issue slots where no uops were being issu=
ed due to lack of back end resources."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
...
> > +]
> > \ No newline at end of file
> > diff --git a/tools/perf/pmu-events/arch/x86/icelake/pipeline.json b/too=
ls/perf/pmu-events/arch/x86/icelake/pipeline.json
> > new file mode 100644
...
tired - an Architectural PerfMon event. Counting continues during hardware =
interrupts, traps, and inside interrupt handlers. Notes: INST_RETIRED.ANY i=
s counted by a designated fixed counter freeing up programmable counters to=
 count other events. INST_RETIRED.ANY_P is counted by a programmable counte=
r.",
> > +        "Counter": "32",
> > +        "UMask": "0x1",
> > +        "PEBScounters": "32",
...
eaving the four (eight when Hyperthreading is disabled) programmable counte=
rs available for other events.",
> > +        "Counter": "33",
> > +        "UMask": "0x2",
> > +        "PEBScounters": "33",
...
is counted on a dedicated fixed counter, leaving the four (eight when Hyper=
threading is disabled) programmable counters available for other events. No=
te: On all current platforms this event stops counting during 'throttling (=
TM)' states duty off periods the processor is 'halted'.  The counter update=
 is done at a lower clock rate then the core clock the overflow status bit =
for this counter may appear 'sticky'.  After the counter has overflowed and=
 software clears the overflow status bit and resets the counter to less tha=
n MAX. The reset value to the counter is not clocked immediately so the ove=
rflow status bit will flip 'high (1)' and generate another PMI (if enabled)=
 after which the reset value gets clocked into the counter. Therefore, soft=
ware will get the interrupt, read the overflow status bit '1 for bit 34 whi=
le the counter value is less than MAX. Software should ignore this case.",
> > +        "Counter": "34",
> > +        "UMask": "0x3",
> > +        "PEBScounters": "34",
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of times the load oper=
ation got the true Block-on-Store blocking code preventing store forwarding=
=2E This includes cases when: a. preceding store conflicts with the load (i=
ncomplete overlap),b. store forwarding is impossible due to u-arch limitati=
ons, c. preceding lock RMW operations are not forwarded, d. store has the n=
o-forward bit set (uncacheable/page-split/masked stores), e. all-blocking s=
tores are used (mostly, fences and port I/O), and others. The most common c=
ase is a load blocked due to its address range overlapping with a preceding=
 smaller uncompleted store. Note: This event does not take into account cas=
es of out-of-SW-control (for example, SbTailHit), unknown physical STA, and=
 cases of blocking loads on store due to being non-WB memory type or a lock=
=2E These cases are covered by other events. See the table of not supported=
...
> > +        "SampleAfterValue": "100003",
> > +        "BriefDescription": "Loads blocked by overlapping with store b=
uffer that cannot be forwarded."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
...
executed on all ports and Reservation Station (RS) was not empty.",
> > +        "EventCode": "0xa6",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x80",
> > +        "PEBScounters": "0,1,2,3,4,5,6,7",
...
> > +        "SampleAfterValue": "2000003",
> > +        "BriefDescription": "Cycles where no uops were executed, the R=
eservation Station was not empty, the Store Buffer was full and there was n=
o outstanding load."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
...
> > +        "PublicDescription": "Increments when an entry is added to the=
 Last Branch Record (LBR) array (or removed from the array in case of RETUR=
Ns in call stack mode). The event requires LBR enable via IA32_DEBUGCTL MSR=
 and branch type selection via MSR_LBR_SELECT.",
> > +        "EventCode": "0xcc",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x20",
> > +        "PEBScounters": "0,1,2,3,4,5,6,7",
...
ons (that do not end up with a VMExit to the VMM; TSX aborted Instructions =
may be counted).",
> > +        "EventCode": "0xcc",
> > +        "Counter": "0,1,2,3,4,5,6,7",
> > +        "UMask": "0x40",
...
> > +]
> > \ No newline at end of file
> > diff --git a/tools/perf/pmu-events/arch/x86/icelake/virtual-memory.json=
...
d data loads whose address translations missed in the TLB and were mapped t=
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts demand data loads that caused a c=
ompleted page walk of any page size (4K/2M/4M/1G). This implies it missed i=
...
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts page walks completed due to deman=
d data stores whose address translations missed in the TLB and were mapped =
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts demand data stores that caused a =
completed page walk of any page size (4K/2M/4M/1G). This implies it missed =
...
e) caused by a code fetch. This implies it missed in the ITLB and further l=
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts code misses in all ITLB (Instruct=
ion TLB) levels that caused a completed page walk (2M and 4M page sizes). T=
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts completed page walks (2M and 4M p=
age sizes) caused by a code fetch. This implies it missed in the ITLB (Inst=
ruction TLB) and further levels of TLB. The page walk can end with or witho=
ut a fault.",
> > +        "EventCode": "0x85",
> > +        "Counter": "0,1,2,3",
> > +        "UMask": "0xe",
...
> > +    {
> > +        "CollectPEBSRecord": "2",
> > +        "PublicDescription": "Counts the number of flushes of the big =
or small ITLB pages. Counting include both TLB Flush (covering all sets) an=
...
> > +        "SampleAfterValue": "100007",
> > +        "BriefDescription": "Flushing of the Instruction TLB (ITLB) pa=
ges, includes 4k/2M/4M pages."
> > +    },
> > +    {
> > +        "CollectPEBSRecord": "2",
...
> From e87c547be14f42434b2a8c8f7f207a6036f033db Mon Sep 17 00:00:00 2001
