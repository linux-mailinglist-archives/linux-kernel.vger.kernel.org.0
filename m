...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A0B7359885
	for <lists+linux-kernel@lfdr.de>; Fri, 28 Jun 2019 12:38:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726708AbfF1Kis (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 28 Jun 2019 06:38:48 -0400
Received: from ozlabs.org ([203.11.71.1]:58837 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726484AbfF1Kis (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 28 Jun 2019 06:38:48 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45ZtXf2hWwz9s3Z;
        Fri, 28 Jun 2019 20:38:42 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1561718322;
        bh=iqR+zg5SxFegNnID5PTpysHV4KFkSvL11N965bDJzSc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 28 Jun 2019 20:38:40 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 28
Message-ID: <20190628203840.1f74e739@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/ZyW8+81/XViuGwnt/vNkE7F"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/ZyW8+81/XViuGwnt/vNkE7F
...
Merging net/master (89ed5b519004 af_packet: Block execution of tasks waitin=
g for transmit to complete in AF_PACKET)
...
Merging cifs/for-next (1c9f7be2e462 smb3: Send netname context during negot=
iate protocol)
...
Merging jc_docs/docs-next (772626ecd2cd Add the RCU docs to the core-api ma=
nual)
...
efile
Merging net-next/master (a653f2f538f9 net: dsa: qca8k: introduce reset via =
gpio feature)
...
Merging wireless-drivers-next/master (b741422218ef rtw88: refine flow to ge=
t tx power index)
...
ling mistakes)
Merging drm-intel/for-linux-next (7218524d3ea0 drm/i915: Make i945gm_vblank=
_work_func static)
...
Merging block/for-next (f6d5c5d273a7 Merge branch 'for-5.3/block' into for-=
next)
...
Merging battery/for-next (b070df701f67 power: supply: cros: allow to set in=
...
Merging devicetree/for-next (2476ed730967 dt-bindings: net: dwmac: Deprecat=
e the PHY reset properties)
...
rflow
Merging akpm/master (8d59bc7adad2 drivers/media/platform/sti/delta/delta-ip=
...

=h3km
-----END PGP SIGNATURE-----
