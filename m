...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 430165F7B3
	for <lists+linux-kernel@lfdr.de>; Thu,  4 Jul 2019 14:09:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727673AbfGDMJ4 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 4 Jul 2019 08:09:56 -0400
Received: from ozlabs.org ([203.11.71.1]:52927 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727615AbfGDMJz (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 4 Jul 2019 08:09:55 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45fcH01pVkz9sPB;
        Thu,  4 Jul 2019 22:09:48 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1562242188;
        bh=3cc537FCI70YVujXpj68Ml/K9cLmBBWAaVYOpE/2/a8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 4 Jul 2019 22:09:45 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 4
Message-ID: <20190704220945.27728dd9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/riW5XJXjO2Tv.UA2cAcRPDx"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/riW5XJXjO2Tv.UA2cAcRPDx
...
The device-mapper tree gained a conflict against the jc_docs tree.

The usb and usb-gadget trees gained a build failure so I used the versions
from next-20190703.

The slave-dma tree gained a build failure for which I reverted a commit.

The pidfd tree gained a conflict against Linus' tree.

The hmm tree gained a conflict against the tip tree.

The akpm-current tree gained conflicts agains the hmm tree.

Non-merge commits (relative to Linus' tree): 11216
 10584 files changed, 838675 insertions(+), 310913 deletions(-)
...
Merging origin/master (eca94432934f Bluetooth: Fix faulty expression for mi=
nimum encryption key size check)
...
PPROTO_IGMP)
Merging ipsec/master (52e63a4eabcf xfrm: remove a duplicated assignment)
...
o-sized buffer)
Merging sound-asoc-fixes/for-linus (5aff6e2e4da9 Merge branch 'asoc-5.2' in=
to asoc-linus)
Merging regmap-fixes/for-linus (2217d05161cb Merge branch 'regmap-5.2' into=
 regmap-linus)
Merging regulator-fixes/for-linus (d5823800b8da Merge branch 'regulator-5.2=
' into regulator-linus)
Merging spi-fixes/for-linus (592ab4d00bfd Merge branch 'spi-5.2' into spi-l=
inus)
...
Merging drm-fixes/drm-fixes (c84c9029d782 drm/i915/ringbuffer: EMIT_INVALID=
ATE *before* switch context)
...
Merging dma-mapping/for-next (f80b90f8caba MIPS: only select ARCH_HAS_UNCAC=
...
Merging arm-soc/for-next (a5380ddda51e Merge branch 'arm/fixes' into for-ne=
xt)
...
or32)
Merging parisc-hd/for-next (5f3f94ad7710 parisc: Fix kernel panic due inval=
id values of IAOQ0 or IAOQ1)
...
Merging uml/linux-next (c4683cd5fb24 um: Fix kcov crash during startup)
...
Merging nfsd/nfsd-next (855c9e766a35 nfs: fix out-of-date connectathon talk=
 URL)
...
_init)
Merging xfs/for-next (677717fbd4b0 xfs: refactor INUMBERS to use iwalk func=
tions)
...
Merging pm/linux-next (267eacd79cad Merge branch 'pm-sleep' into linux-next)
...
$ git rm -f drivers/infiniband/hw/nes/Kconfig drivers/infiniband/hw/nes/Mak=
efile
[master 0c94a876924f] next-20190628/rdma
Merging net-next/master (a51df9f8da43 gve: fix -ENOMEM null check on a page=
 allocation)
...
Merging bpf-next/master (e5a3e259ef23 Merge branch 'bpf-tcp-rtt-hook')
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
re/en_main.c
...
om xfrm_type)
Merging mlx5-next/mlx5-next (e4075c442876 net/mlx5: Expose device definitio=
ns for object events)
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
...
fault on navi)
Merging drm-intel/for-linux-next (2c291417c164 drm/i915: Add N & CTS values=
...
Merging sound-asoc/for-next (71f8cc6cc2d7 Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (a9d9c0f92aa8 Merge remote-tracking branch 'regu=
...
Merging spi/for-next (072f3c19d56f Merge remote-tracking branch 'spi/topic/=
...
Merging percpu/for-next (f264ec1244d1 Merge branch 'for-5.4' into for-next)
...
convert to ReST)
Merging driver-core/driver-core-next (62a6bc3a1e4f driver: core: Allow subs=
ystems to continue deferring probe)
CONFLICT (content): Merge conflict in drivers/acpi/sleep.c
Merging usb/usb-next (a387fd90d468 usb :fsl: Change string format for errat=
a property)
CONFLICT (content): Merge conflict in Documentation/index.rst
$ git reset --hard HEAD^
Merging next-20190703 version of usb
CONFLICT (content): Merge conflict in Documentation/index.rst
[master 8737fb523d38] next-20190703/usb
Merging usb-gadget/next (b2357839c56a usb: renesas_usbhs: add a workaround =
for a race condition of workqueue)
$ git reset --hard HEAD^
Merging next-20190703 version of usb-gadget
...
e() polling delay)
Merging tty/tty-next (011bd05d1f5d serial: imx: set_termios(): preserve RTS=
 state)
Merging char-misc/char-misc-next (60e8523e2ea1 ocxl: Allow contexts to be a=
ttached with a NULL mm)
...
Merging staging/staging-next (5b2736ce3619 staging: rtl8723bs: hal: remove =
redundant assignment to packetType)
...
Merging gpio/for-next (08fc54c5c8ec Merge branch 'devel' into for-next)
...
Applying: PM / QOS: fix typos
Merging akpm-current/current (119c9e315933 mm/gup.c: mark undo_dev_pagemap =
as __maybe_unused)
...
rflow
Merging akpm/master (f83c44000306 drivers/media/platform/sti/delta/delta-ip=
...

=j4Jr
-----END PGP SIGNATURE-----
