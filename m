...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id BB8BBDEA1
	for <lists+linux-kernel@lfdr.de>; Mon, 29 Apr 2019 11:04:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727658AbfD2JEB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 29 Apr 2019 05:04:01 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:41583 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727200AbfD2JEA (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 29 Apr 2019 05:04:00 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 44szGz2bhdz9s47;
        Mon, 29 Apr 2019 19:03:55 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1556528635;
        bh=Z/K2UGF7oIsAH7oLqaOhC8jwDgXUrG1KCyapg1RUgXc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 29 Apr 2019 19:03:54 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 29
Message-ID: <20190429190354.0d5e2e93@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/1iLZLpQdCmYPPbbl8Enyyea"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/1iLZLpQdCmYPPbbl8Enyyea
...
Merging origin/master (9520b5324b0e Merge tag 'for-linus' of git://git.arml=
...
Merging net/master (21f1b8a6636c udp: fix GRO reception in case of length m=
ismatch)
...
Merging wireless-drivers/master (5c403533fb5f Merge tag 'iwlwifi-for-kalle-=
2019-04-28' of git://git.kernel.org/pub/scm/linux/kernel/git/iwlwifi/iwlwif=
i-fixes)
...
inus)
Merging pci-current/for-linus (d5bc73f34cc9 PCI: Fix issue with "pci=3Ddisa=
ble_acs_redir" parameter being ignored)
...
Merging slave-dma-fixes/fixes (5bb5c3a3ac10 dmaengine: mediatek-cqdma: fix =
wrong register usage in mtk_cqdma_start)
...
ext-fixes)
Merging vfs-fixes/fixes (f51dcd0f621c apparmorfs: fix use-after-free on sym=
link traversal)
...
Merging drm-fixes/drm-fixes (6db71bea59f9 Merge tag 'imx-drm-fixes-2019-04-=
25' of git://git.pengutronix.de/pza/linux into drm-fixes)
...
plug handling)
Merging arm-soc/for-next (1abbdcdf5cf4 ARM: Document merges)
...
nto for-next)
CONFLICT (content): Merge conflict in arch/arm/configs/multi_v7_defconfig
Merging clk/clk-next (6e356fb02bae Merge branch 'clk-parent-rewrite-1' into=
 clk-next)
...
Merging risc-v/for-next (bf0102a0fdd9 riscv: call pm_power_off from machine=
_halt / machine_power_off)
Merging sifive/for-next (467e050e9760 Merge branch 'i2c/for-current' of git=
://git.kernel.org/pub/scm/linux/kernel/git/wsa/linux)
Merging s390/features (6fd2ac760b9b locking/lockdep: check for freed initme=
m in static_obj())
...
Merging cifs/for-next (d008b979e8e6 cifs: zero-range does not require the f=
ile is sparse)
...
ion)
Merging nfs/linux-next (037904a22bf8 Merge branch 'x86-urgent-for-linus' of=
...
che' into for-next)
Merging printk/for-next (2046ddef4735 Merge branch 'for-5.2-vsprintf-harden=
ing' into for-next)
...
Merging pm/linux-next (f48640b8e0d4 Merge branch 'pm-domains' into linux-ne=
xt)
Merging cpufreq-arm/cpufreq/arm/linux-next (c1d1090c3c76 cpufreq: maple: Re=
move redundant code from maple_cpufreq_init())
...
q_ceil_by_volt())
Merging thermal/next (2d7c4e17811f Merge branches 'fixes' and 'thermal-inte=
l' into next)
...
it for-next)
Merging net-next/master (88d6272acaaa net: phy: avoid unneeded MDIO reads i=
n genphy_read_status)
...
Merging mlx5-next/mlx5-next (96780e4f46b2 net/mlx5: Introduce new TIR creat=
ion core API)
...
Merging wireless-drivers-next/master (9ef77fbedad9 brcmfmac: send mailbox i=
nterrupt twice for specific hardware device)
Merging bluetooth/master (bbd45e28039e dt-bindings: net: bluetooth: Add dev=
ice tree bindings for QTI chip WCN3998)
Merging mac80211-next/master (8828f81ad4a2 mac80211: probe unexercised mesh=
 links)
...
Merging amdgpu/drm-next (a9a3c0da1427 drm/amd/display: add explicit handsha=
ke between x86 and DMCU)
Merging drm-intel/for-linux-next (447811a686e8 drm/i915/icl: Fix MG_DP_MODE=
...
-next)
Merging sound/for-next (bba06868f716 ALSA: usx2y: fix a memory leak bug)
...
Merging mmc/next (71c733c4e1ae mmc: tegra: add sdhci tegra suspend and resu=
me)
...
secureboot_mode)
Merging selinux/next (c750e6929d3c selinux: Check address length before rea=
ding address family)
...
switch fall-through)
Merging iommu/next (9c39a1abe297 Merge branches 'iommu/fixes', 'arm/tegra',=
...
Merging devicetree/for-next (af3be70a3211 of: Improve of_phandle_iterator_n=
ext() error message)
...
Merging tip/auto-latest (f2831f7789f1 Merge branch 'core/core')
...
tix10 EDAC bindings)
Merging irqchip/irq/irqchip-next (fca269f201a8 irqchip/mbigen: Don't clear =
eventid when freeing an MSI)
...
Merging kvms390/next (8b905d28ee17 KVM: s390: provide kvm_arch_no_poll func=
tion)
...
ttr.cocci warnings)
Merging leds/for-next (aedf809bfa22 leds: Add basic support for Turris Omni=
a LEDs)
Merging ipmi/for-next (ed6c3a6d8996 ipmi: Remove warning if no slave addres=
s is present)
Merging driver-core/driver-core-next (edb16da34b08 driver core: platform: F=
ix the usage of platform device name(pdev->name))
CONFLICT (content): Merge conflict in block/blk-sysfs.c
Merging usb/usb-next (5afa0a5ed3da usb: xhci: add endpoint context tracing =
...
Merging char-misc/char-misc-next (c0286f568069 Merge tag 'thunderbolt-for-v=
5.2' of git://git.kernel.org/pub/scm/linux/kernel/git/westeri/thunderbolt i=
nto char-misc-next)
...
Merging scsi-mkp/for-next (a7634b6f7cbb scsi: aic7xxx: fix spelling mistake=
 "recevied" -> "received")
...
Merging livepatching/for-next (55ac3597df3f Merge branch 'for-5.1-upstream-=
fixes' into for-next)
Merging coresight/next (b627167ed8e6 coresight: funnel: Support static funn=
el)
Merging rtc/rtc-next (aedb144d7949 rtc: 88pm860x: prevent use-after-free on=
 device remove)
...
rflow
Merging akpm/master (ab9c1cebc5f8 drivers/media/platform/sti/delta/delta-ip=
...

=2Kj1
-----END PGP SIGNATURE-----
