...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EA30E1E776
	for <lists+linux-kernel@lfdr.de>; Wed, 15 May 2019 06:23:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726319AbfEOEXp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 15 May 2019 00:23:45 -0400
Received: from ozlabs.org ([203.11.71.1]:60897 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725876AbfEOEXp (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 15 May 2019 00:23:45 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 453hJC5bVHz9sBp;
        Wed, 15 May 2019 14:23:39 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1557894219;
        bh=ichROeYJ6t1ZQ9WM97P/Q3SHDinCIUiO2U/UnKd2kvI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 15 May 2019 14:23:38 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 15
Message-ID: <20190515142338.0258fe5b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/=6zj4EnNzfqcGDHqp9NFT.V"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/=6zj4EnNzfqcGDHqp9NFT.V
...
Non-merge commits (relative to Linus' tree): 2012
 2147 files changed, 64017 insertions(+), 20859 deletions(-)
...
Merging origin/master (35c99ffa20ed Merge tag 'for_linus' of git://git.kern=
...
Merging net/master (63863ee8e2f6 Merge tag 'gcc-plugins-v5.2-rc1' of ssh://=
gitolite.kernel.org/pub/scm/linux/kernel/git/kees/linux)
...
Merging staging.current/staging-linus (63863ee8e2f6 Merge tag 'gcc-plugins-=
v5.2-rc1' of ssh://gitolite.kernel.org/pub/scm/linux/kernel/git/kees/linux)
...
Merging kbuild/for-next (a9c700e8e082 Merge commit 'd90b7024c' into for-nex=
t)
...
or32)
Merging parisc-hd/for-next (f4fbee5f7837 parisc: Allow building 64-bit kern=
...
g with remount)
Merging cifs/for-next (ec3e6539e29e cifs: add support for SEEK_DATA and SEE=
K_HOLE)
...
Merging drm-misc/for-linux-next (3e01ae2612bd drm/pl111: Initialize clock s=
pinlock early)
...
in struct tb_path)
Merging staging/staging-next (63863ee8e2f6 Merge tag 'gcc-plugins-v5.2-rc1'=
 of ssh://gitolite.kernel.org/pub/scm/linux/kernel/git/kees/linux)
...
Merging scsi-mkp/for-next (a5b5077982fe scsi: smartpqi: Reporting unhandled=
 SCSI errors)
...
ling work)
Merging akpm-current/current (461d1c1eea1d ipc-do-cyclic-id-allocation-for-=
the-ipc-object-fix)
...
rflow
Merging akpm/master (dab17d889bb8 drivers/media/platform/sti/delta/delta-ip=
...

=lzPN
-----END PGP SIGNATURE-----
