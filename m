...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A6E2A189C46
	for <lists+linux-kernel@lfdr.de>; Wed, 18 Mar 2020 13:50:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726797AbgCRMuC (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 18 Mar 2020 08:50:02 -0400
Received: from mga07.intel.com ([134.134.136.100]:43533 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726550AbgCRMuB (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 18 Mar 2020 08:50:01 -0400
IronPort-SDR: TK+XqlIFnZ6QGI0GF2tJAGzYBUyWb0s0SmewQzdMMCQvfzzVMzSh0PUBh8hYxxZ9WLN9Etkeo6
 y46muKCTtQ9g==
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Mar 2020 05:49:53 -0700
IronPort-SDR: Nff0AqU2HwnzLHep3Xp0HBtyO5YEcFPAxD4jp87WO58Q+dsEq00bQqjHEpN0KGOgv31ZP9o5AU
 PWzthcOKNNug==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,567,1574150400"; 
   d="xz'?yaml'?scan'208";a="244813160"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga003.jf.intel.com with ESMTP; 18 Mar 2020 05:49:48 -0700
Date:   Wed, 18 Mar 2020 20:49:33 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     Song Liu <songliubraving@fb.com>
Cc:     peterz@infradead.org, linux-kernel@vger.kernel.org,
        kernel-team@fb.com, arnaldo.melo@gmail.com, jolsa@kernel.org,
...
In-Reply-To: <20200307000939.3533447-1-songliubraving@fb.com>
...
Content-Disposition: attachment; filename="config-5.6.0-rc4-00063-g64a7f64478e47"
...
export_top_env()
{
	...
	export job_origin='/lkp/lkp/.src-20200313-140355/allot/cyclic:p2:linux-devel:devel-hourly/lkp-hsw-d01/perf-event-tests.yaml'
...
queue_at_least_once'
	...
	export submit_id='5e708c9011c48b26d86beae3'
	export job_file='/lkp/jobs/scheduled/lkp-hsw-d01/perf-event-tests-disallow_raw_tracepoint-ucode=0x27-debian-x86_64-20191114.cgz-64a7f64478e47ef861dc0d7a82c761489c89939a-20200317-9944-1kmr6oz-21.yaml'
	export id='f8ddddc5f83e1efb7a183aaa8f531a0966dd6ed8'
	...
	export commit='64a7f64478e47ef861dc0d7a82c761489c89939a'
	export ucode='0x27'
...
CONFIG_ATA_PIIX'
	...
	export enqueue_time='2020-03-17 16:38:43 +0800'
	export _id='5e708c9311c48b26d86beaf7'
	export _rt='/result/perf-event-tests/disallow_raw_tracepoint-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a'
	export user='lkp'
	...
	export result_root='/result/perf-event-tests/disallow_raw_tracepoint-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/21'
	export scheduler_version='/lkp/lkp/.src-20200317-154037'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-hsw-d01/perf-event-tests-disallow_raw_tracepoint-ucode=0x27-debian-x86_64-20191114.cgz-64a7f64478e47ef861dc0d7a82c761489c89939a-20200317-9944-1kmr6oz-21.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020031221
commit=64a7f64478e47ef861dc0d7a82c761489c89939a
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/vmlinuz-5.6.0-rc4-00063-g64a7f64478e47
max_uptime=3600
RESULT_ROOT=/result/perf-event-tests/disallow_raw_tracepoint-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/21
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/modules.cgz'
	export bm_initrd='/osimage/deps/debian-x86_64-20180403.cgz/run-ipconfig_2018-04-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/lkp_2019-08-05.cgz,/osimage/deps/debian-x86_64-20180403.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/deps/debian-x86_64-20180403.cgz/perf-event-tests_2020-01-04.cgz,/osimage/pkg/debian-x86_64-20180403.cgz/perf-event-tests-x86_64-411ac86-1_2020-01-04.cgz,/osimage/deps/debian-x86_64-20180403.cgz/hw_2020-01-02.cgz'
	export linux_headers_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/linux-headers.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.6.0-rc5-07088-gf464157e09bc1'
	export repeat_to=24
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/vmlinuz-5.6.0-rc4-00063-g64a7f64478e47'
	export dequeue_time='2020-03-17 17:36:14 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-hsw-d01/perf-event-tests-disallow_raw_tracepoint-ucode=0x27-debian-x86_64-20191114.cgz-64a7f64478e47ef861dc0d7a82c761489c89939a-20200317-9944-1kmr6oz-21.cgz'
...
extract_stats()
{
	...
	$LKP_SRC/stats/wrapper perf-event-tests
...

fMjY9mvOAgAAADhE2DfGe7eAAAGq6QG+9QpiC3SgscRn+wIAAAAABFla
...
perf-event-tests:
  paranoid: disallow_raw_tracepoint
job_origin: "/lkp/lkp/.src-20200313-140355/allot/cyclic:p2:linux-devel:devel-hourly/lkp-hsw-d01/perf-event-tests.yaml"
...
submit_id: 5e6fd48411c48b1872b51f06
job_file: "/lkp/jobs/scheduled/lkp-hsw-d01/perf-event-tests-disallow_raw_tracepoint-ucode=0x27-debian-x86_64-20191114.cgz-64a7f64478e47ef861dc0d7a82c761489c89939a-20200317-6258-18wj0d-0.yaml"
id: 87d9d359547d11d1fa2dfc4a47417694a56cd9d5
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2020-03-17 03:33:27.730729599 +08:00
_id: 5e6fd48411c48b1872b51f06
_rt: "/result/perf-event-tests/disallow_raw_tracepoint-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a"
...
result_root: "/result/perf-event-tests/disallow_raw_tracepoint-ucode=0x27/lkp-hsw-d01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/0"
scheduler_version: "/lkp/lkp/.src-20200316-210616"
LKP_SERVER: inn
arch: x86_64
max_uptime: 3600
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-hsw-d01/perf-event-tests-disallow_raw_tracepoint-ucode=0x27-debian-x86_64-20191114.cgz-64a7f64478e47ef861dc0d7a82c761489c89939a-20200317-6258-18wj0d-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020031221
- commit=64a7f64478e47ef861dc0d7a82c761489c89939a
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/modules.cgz"
...
linux_headers_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/linux-headers.cgz"
...
#! user overrides
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/64a7f64478e47ef861dc0d7a82c761489c89939a/vmlinuz-5.6.0-rc4-00063-g64a7f64478e47"
dequeue_time: 2020-03-17 03:33:43.495246947 +08:00

#! /lkp/lkp/.src-20200316-210616/include/site/inn
job_state: finished
loadavg: 1.07 0.65 0.27 1/171 2809
start_time: '1584387264'
end_time: '1584387381'
version: "/lkp/lkp/.src-20200316-210651:33c58db9-dirty:366a5a29d"
