...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E514917F234
	for <lists+linux-kernel@lfdr.de>; Tue, 10 Mar 2020 09:44:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726622AbgCJIoD (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 10 Mar 2020 04:44:03 -0400
Received: from mga04.intel.com ([192.55.52.120]:31128 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726512AbgCJIoD (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 10 Mar 2020 04:44:03 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga104.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 10 Mar 2020 01:43:54 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,518,1574150400"; 
   d="yaml'?scan'208";a="321725278"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.3])
  by orsmga001.jf.intel.com with ESMTP; 10 Mar 2020 01:43:47 -0700
Date:   Tue, 10 Mar 2020 16:43:35 +0800
...
Cc:     Ingo Molnar <mingo@redhat.com>,
        ...
        Paul Turner <pjt@google.com>, lkp@lists.01.org
Subject: [sched] db8e976e4a: will-it-scale.per_process_ops 15.8% improvement
Message-ID: <20200310084335.GA5972@shao2-debian>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.6.0-rc4-00302-gdb8e976e4a08f"
...
queue_at_least_once'
	...
	export submit_id='5e66c7f74eb5115a2e7c96fe'
	export job_file='/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-ucode=0x11-debian-x86_64-20191114.cgz-db8e976e4a08f1f194a3503f88dec1319f9ee34f-20200310-23086-zqfs83-3.yaml'
	export id='e8b105b7d97ca4101ddaaa290de20214e42eca92'
	...
	export commit='db8e976e4a08f1f194a3503f88dec1319f9ee34f'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_SATA_AHCI'
	export ucode='0x11'
	export kconfig='x86_64-rhel-7.6'
	export compiler='gcc-7'
	export enqueue_time='2020-03-10 06:49:31 +0800'
	export _id='5e66c7fb4eb5115a2e7c96ff'
	export _rt='/result/will-it-scale/performance-process-100%-mmap1-ucode=0x11/lkp-knm01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f'
	export user='lkp'
	export head_commit='d4d977a483ac90cd9f039ffd4b5ab02fa28d6881'
	export base_commit='2c523b344dfa65a3738e7039832044aa133c75fb'
	export branch='linux-devel/devel-hourly-2020030910'
	export rootfs='debian-x86_64-20191114.cgz'
	export result_root='/result/will-it-scale/performance-process-100%-mmap1-ucode=0x11/lkp-knm01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-ucode=0x11-debian-x86_64-20191114.cgz-db8e976e4a08f1f194a3503f88dec1319f9ee34f-20200310-23086-zqfs83-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2020030910
commit=db8e976e4a08f1f194a3503f88dec1319f9ee34f
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/vmlinuz-5.6.0-rc4-00302-gdb8e976e4a08f
max_uptime=1500
RESULT_ROOT=/result/will-it-scale/performance-process-100%-mmap1-ucode=0x11/lkp-knm01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/3
LKP_SERVER=inn
nokaslr
selinux=0
debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/modules.cgz'
	...
	export last_kernel='5.6.0-rc5'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/vmlinuz-5.6.0-rc4-00302-gdb8e976e4a08f'
	export dequeue_time='2020-03-10 07:01:50 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-ucode=0x11-debian-x86_64-20191114.cgz-db8e976e4a08f1f194a3503f88dec1319f9ee34f-20200310-23086-zqfs83-3.cgz'
...
submit_id: 5e6676d24eb51154aa0920b6
...
id: 45e6a7ccc7b79a7915ef5c7bc66400eed403e5e5
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2020-03-10 01:03:17.895306502 +08:00
_id: 5e6676d24eb51154aa0920b6
_rt: "/result/will-it-scale/performance-process-100%-mmap1-ucode=0x11/lkp-knm01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f"

#! schedule options
user: lkp
head_commit: d4d977a483ac90cd9f039ffd4b5ab02fa28d6881
base_commit: 2c523b344dfa65a3738e7039832044aa133c75fb
branch: linux-devel/devel-hourly-2020030910
rootfs: debian-x86_64-20191114.cgz
result_root: "/result/will-it-scale/performance-process-100%-mmap1-ucode=0x11/lkp-knm01/debian-x86_64-20191114.cgz/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-ucode=0x11-debian-x86_64-20191114.cgz-db8e976e4a08f1f194a3503f88dec1319f9ee34f-20200310-21674-1g8yf9v-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2020030910
- commit=db8e976e4a08f1f194a3503f88dec1319f9ee34f
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/modules.cgz"
...
#! runtime status
last_kernel: 5.6.0-rc5
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/db8e976e4a08f1f194a3503f88dec1319f9ee34f/vmlinuz-5.6.0-rc4-00302-gdb8e976e4a08f"
dequeue_time: 2020-03-10 01:08:54.157754959 +08:00
job_state: finished
loadavg: 39.57 126.00 72.88 1/1851 11383
start_time: '1583773837'
end_time: '1583774145'
