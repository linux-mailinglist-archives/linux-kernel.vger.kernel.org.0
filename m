...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B187BD68BC
	for <lists+linux-kernel@lfdr.de>; Mon, 14 Oct 2019 19:43:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388680AbfJNRlT (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 14 Oct 2019 13:41:19 -0400
Received: from mail.kernel.org ([198.145.29.99]:54690 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730466AbfJNRlS (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 14 Oct 2019 13:41:18 -0400
Received: from gandalf.local.home (cpe-66-24-58-225.stny.res.rr.com [66.24.58.225])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 6F6F120854;
        Mon, 14 Oct 2019 17:41:14 +0000 (UTC)
Date:   Mon, 14 Oct 2019 13:41:12 -0400
...
Subject: [ANNOUNCE] 4.19.72-rt26
Message-ID: <20191014134112.0449bcb6@gandalf.local.home>
...
I'm pleased to announce the 4.19.72-rt26 stable release.
...
You can get this release via the git tree at:
  ...
  branch: v4.19-rt
  Head SHA1: b7f6c1696210ad738cb1b43ab1e96fbf75aa6d1c


Or to build 4.19.72-rt26 directly, the following patches should be applied:

  http://www.kernel.org/pub/linux/kernel/v4.x/linux-4.19.tar.xz

  http://www.kernel.org/pub/linux/kernel/v4.x/patch-4.19.72.xz

  http://www.kernel.org/pub/linux/kernel/projects/rt/4.19/patch-4.19.72-rt26.patch.xz



You can also build from 4.19.72-rt25 by applying the incremental patch:

  http://www.kernel.org/pub/linux/kernel/projects/rt/4.19/incr/patch-4.19.72-rt25-rt26.patch.xz
...
----
 ...
 localversion-rt                        |   2 +-
 19 files changed, 169 insertions(+), 347 deletions(-)
---------------------------
diff --git a/block/blk-core.c b/block/blk-core.c
index f7e16b4466f0..f0cb86ef8215 100644
--- a/block/blk-core.c
+++ b/block/blk-core.c
@@ -969,10 +969,10 @@ void blk_queue_exit(struct request_queue *q)
...
index 16dcf8521c2c..c74dd321f5b7 100644
--- a/fs/aio.c
+++ b/fs/aio.c
@@ -42,7 +42,6 @@
...
index 7b7c0bc6a514..45653e23e4cd 100644
