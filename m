...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6D78A176140
	for <lists+linux-kernel@lfdr.de>; Mon,  2 Mar 2020 18:40:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727430AbgCBRkq (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 2 Mar 2020 12:40:46 -0500
Received: from mail-pl1-f181.google.com ([209.85.214.181]:40725 "EHLO
        mail-pl1-f181.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727159AbgCBRkq (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 2 Mar 2020 12:40:46 -0500
Received: by mail-pl1-f181.google.com with SMTP id y1so52238plp.7;
        Mon, 02 Mar 2020 09:40:44 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=r6ufQLRZTifnybxHgamfWcduh7h+WN84+xcHqAx/GcA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=r6ufQLRZTifnybxHgamfWcduh7h+WN84+xcHqAx/GcA=;
        b=
X-Gm-Message-State: ANhLgQ2KzA5Sbq/8+EMWPUEg9JnTEo7xGuRQ+Uf4/K3APmt8VUOHUfwS
        z4LV2AHtBCnDtolPoufal1s=
X-Google-Smtp-Source: ADFU+vv90O1c+IhZ9cJHX2vI/qw38K5v0ej7FIH7Sl61RPENy5jepO54mT3itX6TBkxb499374aVsg==
X-Received: by 2002:a17:902:7c8f:: with SMTP id y15mr304306pll.55.1583170843402;
        Mon, 02 Mar 2020 09:40:43 -0800 (PST)
Received: from localhost.localdomain ([2405:204:800a:15c3:b0b0:78ba:d728:349e])
        by smtp.gmail.com with ESMTPSA id c184sm21764462pfa.39.2020.03.02.09.40.21
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 02 Mar 2020 09:40:42 -0800 (PST)
From:   Pragat Pandya <pragat.pandya@gmail.com>
To:     corbet@lwn.net
Cc:     linux-doc@vger.kernel.org, linux-kernel@vger.kernel.org,
        linux-kernel-mentees@lists.linuxfoundation.org,
        skhan@linuxfoundation.org, Pragat Pandya <pragat.pandya@gmail.com>
Subject: [PATCH 2/2] Documentation: Add a new .rst file under Documentation
Date:   Mon,  2 Mar 2020 23:09:20 +0530
Message-Id: <20200302173920.24626-3-pragat.pandya@gmail.com>
...
Add io_ordering.rst under Documentation and reference it in TOCTree of
...
---
 ...
 doc_make.log                                  | 369 +-----------------
 2 files changed, 16 insertions(+), 353 deletions(-)
...
index b3b86aff2484..eda6f8525b10 100644
--- a/doc_make.log
+++ b/doc_make.log
@@ -1,372 +1,35 @@
...
+reading sources... [ 33%] input/devices/index
+reading sources... [ 66%] io_ordering
+reading sources... [100%] trace/coresight/index
...
+checking consistency... Warning: The Sphinx 'sphinx_rtd_theme' HTML theme was not found. Make sure you have the theme installed to produce pretty HTML output. Falling back to the default theme.
+/home/pragat/Documents/linux_work/mainline/Documentation/driver-api/thermal/cpu-idle-cooling.rst: WARNING: document isn't included in any toctree
+/home/pragat/Documents/linux_work/mainline/Documentation/io_ordering.rst: WARNING: document isn't included in any toctree
 done
...
+writing output... [ 20%] input/devices/index
+writing output... [ 40%] input/index
+writing output... [ 60%] io_ordering
+writing output... [ 80%] trace/coresight/index
+writing output... [100%] trace/index
