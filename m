...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A61161AF78
	for <lists+linux-kernel@lfdr.de>; Mon, 13 May 2019 06:25:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727595AbfEMEZd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 13 May 2019 00:25:33 -0400
Received: from ozlabs.org ([203.11.71.1]:44895 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726626AbfEMEZc (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 13 May 2019 00:25:32 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 452SRB4ntDz9s7h;
        Mon, 13 May 2019 14:25:26 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1557721526;
        bh=R9SV7EVzzJJd81g6sQRSMqcO3YmGhnvBEaBS3UHVrBg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 13 May 2019 14:25:25 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 13
Message-ID: <20190513142525.43c0e826@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/.Y79o37/gwX1lmFUAiJe=QI"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/.Y79o37/gwX1lmFUAiJe=QI
...
Non-merge commits (relative to Linus' tree): 2578
 2423 files changed, 78339 insertions(+), 27133 deletions(-)
...
Merging origin/master (d7a02fa0a8f9 Merge tag 'upstream-5.2-rc1' of ssh://g=
itolite.kernel.org/pub/scm/linux/kernel/git/rw/ubifs)
...
Merging net/master (3285a9aa6570 net: dccp : proto: remove Unneeded variabl=
e "err")
Merging bpf/master (a5e4bff6105d bpf: add various test cases for backward j=
umps)
Merging ipsec/master (9b3040a6aafd ipv4: Define __ipv4_neigh_lookup_noref w=
hen CONFIG_INET is disabled)
Merging netfilter/master (92285a079eed netfilter: nf_tables: correct NFT_LO=
GLEVEL_MAX value)
...
b)
Merging sound-current/for-linus (891afcf2462d ALSA: hda/realtek - Corrected=
 fixup for System76 Gazelle (gaze14))
...
efault off))
Merging driver-core.current/driver-core-linus (8ea5b2abd07e Merge branch 'f=
ixes' of git://git.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
Merging tty.current/tty-linus (8ea5b2abd07e Merge branch 'fixes' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
Merging usb.current/usb-linus (8ea5b2abd07e Merge branch 'fixes' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
...
Merging staging.current/staging-linus (8ea5b2abd07e Merge branch 'fixes' of=
 git://git.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
Merging char-misc.current/char-misc-linus (8ea5b2abd07e Merge branch 'fixes=
...
Merging mips/mips-next (e6308b6d35ea MIPS: SGI-IP27: abstract chipset irq f=
rom bridge)
...
ion)
Merging nfs/linux-next (47782361aca2 Merge tag 'tag-chrome-platform-for-v5.=
2' of ssh://gitolite.kernel.org/pub/scm/linux/kernel/git/chrome-platform/li=
nux)
...
-next)
Merging pci/next (a03b3b50927b Merge branch 'pci/trivial')
...
a())
Merging pm/linux-next (9ed0985332a6 x86: intel_epb: Take CONFIG_PM into acc=
ount)
...
Merging net-next/master (b970afcfcabd Merge tag 'powerpc-5.2-1' of ssh://gi=
tolite.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
...
-next)
Merging sound/for-next (891afcf2462d ALSA: hda/realtek - Corrected fixup fo=
r System76 Gazelle (gaze14))
...
er)
Merging mfd/for-mfd-next (e7b9195d6c0a mfd: Use dev_get_drvdata() directly)
...
Merging driver-core/driver-core-next (8ea5b2abd07e Merge branch 'fixes' of =
git://git.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
Merging usb/usb-next (8ea5b2abd07e Merge branch 'fixes' of git://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs)
...
sm8998-qmp-ufs-phy)
Merging tty/tty-next (8ea5b2abd07e Merge branch 'fixes' of git://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs)
Merging char-misc/char-misc-next (8ea5b2abd07e Merge branch 'fixes' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
...
in struct tb_path)
Merging staging/staging-next (8ea5b2abd07e Merge branch 'fixes' of git://gi=
t.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
...
rflow
Merging akpm/master (6a013f596939 drivers/media/platform/sti/delta/delta-ip=
...

=veAD
-----END PGP SIGNATURE-----
