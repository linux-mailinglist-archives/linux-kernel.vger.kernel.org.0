...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 521124CC2B
	for <lists+linux-kernel@lfdr.de>; Thu, 20 Jun 2019 12:46:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726657AbfFTKqd (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 20 Jun 2019 06:46:33 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:39843 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726318AbfFTKqc (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 20 Jun 2019 06:46:32 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45Tz5875XDz9s4V;
        Thu, 20 Jun 2019 20:46:20 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1561027581;
        bh=/2HWQNh1B3sscZj89FkYqKcw09qrTtFPwaXZDmzQnac=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 20 Jun 2019 20:46:19 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 20
Message-ID: <20190620204619.213a7b30@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/ozf3NTBL6CSs1bZV.n=wFjz"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/ozf3NTBL6CSs1bZV.n=wFjz
...
Merging origin/master (abf02e2964b3 Merge tag 'pm-5.2-rc6' of git://git.ker=
...
Merging powerpc-fixes/fixes (84b028243ef0 KVM: PPC: Book3S HV: Only write D=
AWR[X] when handling h_set_dawr in real mode)
...
Merging netfilter/master (d470e720ef27 Merge git://git.kernel.org/pub/scm/l=
...
Merging sound-asoc-fixes/for-linus (97431fc908cc Merge branch 'asoc-5.2' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (97c29398d645 Merge branch 'spi-5.2' into spi-l=
inus)
...
' into staging-linus)
Merging char-misc.current/char-misc-linus (6ad805b82dc5 doc: fix documentat=
ion about UIO_MEM_LOGICAL using)
...
Merging mips-fixes/mips-fixes (db13a5ba2732 MIPS: ath79: fix ar933x uart pa=
rity mode)
...
lot via interrupt)
Merging arm/for-next (b33087b401c5 Merge commit commit 'drm-armada-devel^{/=
...
' into next)
Merging amlogic/for-next (d814a8b8223d Merge branch 'v5.3/drivers' into tmp=
/aml-rebuild)
...
Merging qcom/for-next (62d81d1a7b78 Merge tag 'qcom-dts-for-5.3' into initi=
al-for-5.3)
...
Merging tegra/for-next (701dc98f27d5 Merge branch for-5.3/arm64/defconfig i=
nto for-next)
...
Merging hwmon-staging/hwmon-next (5bc282b68533 hwmon: (max6650) Fix unused =
variable warning)
...
efile
Merging net-next/master (497ad9f5b2dc page_pool: fix compile warning when C=
ONFIG_PAGE_POOL is disabled)
...
de)
Merging netfilter-next/master (79ebb5bb4e38 netfilter: nf_tables: enable se=
t expiration time for set elements)
...
Merging drm-intel/for-linux-next (09c5ab384f6f drm/i915: Keep rings pinned =
...
Merging drm-msm/msm-next (01a090c74669 drm/msm/dsi: Add parentheses to quir=
ks check in dsi_phy_hw_v3_0_lane_settings)
...
Merging sound-asoc/for-next (d14444d26a07 Merge remote-tracking branch 'aso=
...
Merging spi/for-next (7679aa9e1f4a Merge remote-tracking branch 'spi/topic/=
...
G_I2C is set to m)
Merging driver-core/driver-core-next (5666d896e838 mei: no need to check re=
turn value of debugfs_create functions)
...
Merging scsi-mkp/for-next (818569ed3347 scsi: ufs-qcom: Add support for pla=
tforms booting ACPI)
...
Merging rtc/rtc-next (fedc459a3da3 rtc: pcf2123: fix negative offset roundi=
ng)
Merging nvdimm/libnvdimm-for-next (3b6047778c09 Merge branch 'for-5.3/libnv=
dimm' into libnvdimm-pending)
...
ys-next)
Merging afs/afs-next (40d06d40629f afs: afs_unlink() doesn't need to check =
dentry->d_inode)
Applying: Revert "macb: Add support for SiFive FU540-C000"
Applying: Revert "dm: enable synchronous dax"
Merging akpm-current/current (0bca7b365c0d include/linux/lz4.h: fix spellin=
...
Applying: Revert "drivers/base/memory.c: Get rid of find_memory_block_hinte=
d()"
$ git checkout -b akpm remotes/origin/akpm/master
Applying: pinctrl: fix pxa2xx.c build warnings
Applying: proc/sysctl: add shared variables for range check
CONFLICT (modify/delete): drivers/s390/char/sclp_async.c deleted in HEAD an=
d modified in proc/sysctl: add shared variables for range check. Version pr=
oc/sysctl: add shared variables for range check of drivers/s390/char/sclp_a=
sync.c left in tree.
...
rflow
Merging akpm/master (dc47ad5c7ae9 drivers/media/platform/sti/delta/delta-ip=
...

=Ygn1
-----END PGP SIGNATURE-----
