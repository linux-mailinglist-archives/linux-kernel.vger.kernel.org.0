...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 44DA3142105
	for <lists+linux-kernel@lfdr.de>; Mon, 20 Jan 2020 01:16:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729014AbgATAQF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 19 Jan 2020 19:16:05 -0500
Received: from mail-lj1-f194.google.com ([209.85.208.194]:43447 "EHLO
        mail-lj1-f194.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728841AbgATAQF (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 19 Jan 2020 19:16:05 -0500
Received: by mail-lj1-f194.google.com with SMTP id a13so31962881ljm.10
        for <linux-kernel@vger.kernel.org>; Sun, 19 Jan 2020 16:16:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google;
        h=mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=gHtVlyT5cejvHUL4aBerv08FSjf5Ntl5gJXsejYsIx0=;
        b=Qod4FZ58ad9cmyXMQo6mFINE06TYTFoc9z/a4ZzMRi1oKNMWc3pfpAOoqWjIJVWv5t
         L+u0TS3RsOwKTSGylJQpAN8Y+CJ0Lqt+MRJ5MC8QA3uZ17q0JVBJjc2Li6Nfh4VWw9gf
         DXIH7dxzXJQEBV9Um2MzI+XkIT8mhaAIwfEgA=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=gHtVlyT5cejvHUL4aBerv08FSjf5Ntl5gJXsejYsIx0=;
        b=
X-Gm-Message-State: APjAAAWptja6vTF/jzVwPb9UDi6o+SmMw9wl5bb6p9NABGhozrk/nTV0
        U3Cds+Po6i2jfD4nMZmCUXv7zBAavwE=
X-Google-Smtp-Source: APXvYqyZmxrRWrcZTkoudBrn0Nkefj0VOMybFDFp1/MwRmTSQJjVoDf/js209bw88r2idTa/AECPKg==
X-Received: by 2002:a2e:9052:: with SMTP id n18mr9222997ljg.251.1579479361483;
        Sun, 19 Jan 2020 16:16:01 -0800 (PST)
Received: from mail-lj1-f170.google.com (mail-lj1-f170.google.com. [209.85.208.170])
        by smtp.gmail.com with ESMTPSA id u24sm15737946ljo.77.2020.01.19.16.15.59
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 19 Jan 2020 16:16:00 -0800 (PST)
Received: by mail-lj1-f170.google.com with SMTP id j1so31951404lja.2
        for <linux-kernel@vger.kernel.org>; Sun, 19 Jan 2020 16:15:59 -0800 (PST)
X-Received: by 2002:a2e:990e:: with SMTP id v14mr11381699lji.23.1579479359422;
 Sun, 19 Jan 2020 16:15:59 -0800 (PST)
MIME-Version: 1.0
From:   Linus Torvalds <torvalds@linux-foundation.org>
Date:   Sun, 19 Jan 2020 16:15:43 -0800
X-Gmail-Original-Message-ID: <CAHk-=wjvkH0xJF6yF72VZOF7cifFv3nH9qhGGZh8urLg5xWt=Q@mail.gmail.com>
Message-ID: <CAHk-=wjvkH0xJF6yF72VZOF7cifFv3nH9qhGGZh8urLg5xWt=Q@mail.gmail.com>
...
Bijan Mottahedeh (1):
      io_uring: clear req->result always before issuing a read/write reques=
t
...
David Woodhouse (1):
      Documentation/process: Add Amazon contact for embargoed hardware issu=
es
...
Hans de Goede (4):
      efi/libstub/random: Initialize pointer variables to zero for mixed mo=
de
...
Ido Schimmel (4):
      ...
      mlxsw: spectrum: Do not enforce same firmware version for multiple AS=
ICs
...
Jin Yao (1):
      perf report: Fix incorrectly added dimensions as switch perf data fil=
e
...
Kai Vehmanen (2):
      ASoC: SOF: Intel: fix HDA codec driver probe with multiple controller=
s
...
endpoint dt nodes
      ARM: dts: am571x-idk: Fix gpios property to have the correct  gpio nu=
mber
...
Manivannan Sadhasivam (1):
      MAINTAINERS: Add myself as the co-maintainer for Actions Semi platfor=
ms
...
Martin Blumenstingl (4):
      ...
      soc: amlogic: meson-ee-pwrc: propagate PD provider registration error=
s
...
sysfs interfaces
      Documentation/ABI: Add missed attribute for mlxreg-io sysfs interface=
s
...
Yang Shi (1):
      mm: khugepaged: add trace status description for SCAN_PAGE_HAS_PRIVAT=
E
