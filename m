...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 461DE65420
	for <lists+linux-kernel@lfdr.de>; Thu, 11 Jul 2019 11:47:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728354AbfGKJrT (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 11 Jul 2019 05:47:19 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:51825 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726088AbfGKJrS (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 11 Jul 2019 05:47:18 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45krn90bhwz9sBt;
        Thu, 11 Jul 2019 19:47:09 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1562838429;
        bh=IKepRXKTw0RpI7a5syMlTMKj6PVZimn7Q4VH/A5zOEw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 11 Jul 2019 19:47:04 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 11
Message-ID: <20190711194704.2414ebb7@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/h7r3MAJ3eo=zns2xfXbH=JI"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/h7r3MAJ3eo=zns2xfXbH=JI
...
Non-merge commits (relative to Linus' tree): 9528
 8504 files changed, 770963 insertions(+), 272272 deletions(-)
...
Merging sound-asoc-fixes/for-linus (6970139ac330 Merge branch 'asoc-5.2' in=
to asoc-linus)
...
Merging ext3/for_next (12ce1a34a7f2 Pull UDF extent size fix from Steve Mag=
nani with added stable tag.)
...
in imxfb_probe())
Merging pm/linux-next (c1a5590578be Merge branch 'acpica' into linux-next)
...
' into linux-next)
Merging rdma/for-next (85de5d53366f RDMA/siw: Remove unnecessary kthread cr=
eate/destroy printouts)
Applying: rdma: attempt to build rdma_counter.h stand alone again
Merging net-next/master (1ff2f0fa450e net/mlx5e: Return in default case sta=
tement in tx_post_resync_params)
...
Merging bluetooth/master (1ff2f0fa450e net/mlx5e: Return in default case st=
atement in tx_post_resync_params)
...
t)
Merging drm-intel/for-linux-next (719d24002602 drm/i915/ehl: Enable DDI-D)
...
p' into for-next)
Merging sound-asoc/for-next (70b07cdfac41 Merge branch 'asoc-5.3' into asoc=
-next)
...
Merging block/for-next (b8b02e6f0e0e Merge branch 'for-linus' into for-next)
...
Merging akpm-current/current (288cd41ec3a4 selftests/seccomp/seccomp_bpf: u=
...
rflow
Merging akpm/master (215b1fcb5f9d drivers/media/platform/sti/delta/delta-ip=
...

=sc5K
-----END PGP SIGNATURE-----
