...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 81E8D445DC
	for <lists+linux-kernel@lfdr.de>; Thu, 13 Jun 2019 18:47:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2392947AbfFMQrL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 13 Jun 2019 12:47:11 -0400
Received: from sobre.alvarezp.com ([173.230.155.94]:43246 "EHLO
        sobre.alvarezp.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726740AbfFMFCc (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 13 Jun 2019 01:02:32 -0400
Received: from [192.168.15.64] (unknown [189.205.206.165])
        by sobre.alvarezp.com (Postfix) with ESMTPSA id 3E18C1E2B1;
        Thu, 13 Jun 2019 00:02:22 -0500 (CDT)
From:   Octavio Alvarez <octallk1@alvarezp.org>
Subject: PROBLEM: Marvell 88E8040 (sky2) fails after hibernation
...
Message-ID: <2cf2f745-0e29-13a7-6364-0a981dae758c@alvarezp.org>
Date:   Thu, 13 Jun 2019 00:02:20 -0500
...
I reported this to different people but I have not received a response 
[1] [2]. I am following the reporting procedure described in the kernel 
admin guide [3] so now I am escalating to you. What am I missing?

I noticed that Thomas' mailbox is filtering my mail because of some RBL 
and have not figured out why that is yet so maybe he has not gotten any 
e-mails from me. However, I already tried conacting using a different 
mail provider.

Hope you can advise; thanks in advance.

[1] https://marc.info/?l=linux-netdev&m=155819624508058&w=2

[2] https://marc.info/?l=linux-kernel&m=155939611901226&w=2

[3] https://www.kernel.org/doc/html/v5.1/admin-guide/reporting-bugs.html


PROBLEM: Marvell 88E8040 (sky2) fails after hibernation

It occurs since 4.15. It worked before.
...
Hibernating the machine and bringing it back does not properly bring 
back the Marvell NIC. Most of the time a module reload does not help.
...
mode")
     ...
     Link: 
https://lkml.kernel.org/r/alpine.DEB.2.20.1712291406420.1899@nanos
     Link: 
https://lkml.kernel.org/r/alpine.DEB.2.20.1712291409460.1899@nanos
