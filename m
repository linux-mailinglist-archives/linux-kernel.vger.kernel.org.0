...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EE7C8356B5
	for <lists+linux-kernel@lfdr.de>; Wed,  5 Jun 2019 08:14:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726633AbfFEGOp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 5 Jun 2019 02:14:45 -0400
Received: from ozlabs.org ([203.11.71.1]:44109 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726086AbfFEGOo (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 5 Jun 2019 02:14:44 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45JdmY0nqxz9s4Y;
        Wed,  5 Jun 2019 16:14:37 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1559715277;
        bh=NSbpoF9aR5EmgZEcKxfvve9Op/gRCPWdIWPWEU/OTm8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 5 Jun 2019 16:14:36 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 5
Message-ID: <20190605161436.3ac174f3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/7m0SirnVTyJcP7xquAjtlw/"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/7m0SirnVTyJcP7xquAjtlw/
...
Non-merge commits (relative to Linus' tree): 3901
 4307 files changed, 159819 insertions(+), 159401 deletions(-)
...
Merging s390-fixes/fixes (f2c7c76c5d0a Linux 5.2-rc3)
...
Merging net/master (2b66552eb2a4 Merge branch 'net-tls-redo-the-RX-resync-l=
ocking')
...
Merging drm-misc-fixes/for-linux-next-fixes (89a4aac0ab0e drm: don't block =
fb changes for async plane updates)
...
Merging arm64/for-next/core (616810360043 arm64/mm: Drop task_struct argume=
nt from __do_page_fault())
...
a_set_mask")
Merging soc-fsl/next (0c28de9502d7 soc/fsl/qe: qe.c: fold qe_get_num_of_snu=
ms into qe_snums_init)
...
rq work request)
Merging net-next/master (7dd73168e273 ipv6: Always allocate pcpu memory in =
a fib6_nh)
...
Merging bpf-next/master (6685699e4ef5 bpf: remove redundant assignment to e=
rr)
...
ith IB test (v2))
Merging drm-intel/for-linux-next (1d1b5490b91c drm/i915/gtt: Replace struct=
_mutex serialisation for allocation)
...
Merging drm-misc/for-linux-next (cbb32079149d drm/atmel-hlcdc: revert shift=
 by 8)
...
Merging chrome-platform/for-next (94383ce9608b platform/chrome: cros_ec: Ma=
...
rflow
Merging akpm/master (47f4c716f6f5 drivers/media/platform/sti/delta/delta-ip=
...

=rIbQ
-----END PGP SIGNATURE-----
