...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8F02F107A3
	for <lists+linux-kernel@lfdr.de>; Wed,  1 May 2019 13:53:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726378AbfEALwz (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 1 May 2019 07:52:55 -0400
Received: from ozlabs.org ([203.11.71.1]:60397 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726040AbfEALwy (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 1 May 2019 07:52:54 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 44vGww3NjFz9sNQ;
        Wed,  1 May 2019 21:52:48 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1556711568;
        bh=pIwOr/Q7wbryK5MzjHKG3n185JZENujCmIIbiaZQzW4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 1 May 2019 21:52:45 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 1
Message-ID: <20190501215245.74a3cb8f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/BhJ3lCM2rVAIZSmOziH3hS8"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/BhJ3lCM2rVAIZSmOziH3hS8
...
Merging origin/master (bf3bd966dfd7 Merge tag 'usb-5.1-rc8' of git://git.ke=
...
Merging net/master (34259977f23c Merge tag 'wireless-drivers-for-davem-2019=
-04-30' of git://git.kernel.org/pub/scm/linux/kernel/git/kvalo/wireless-dri=
vers)
...
_PTR() debugfs dirs)
Merging rdma-fixes/for-rc (d2360df0e4e6 Revert "RDMA/uverbs: Fix compilatio=
n error on s390 and mips platforms")
...
Merging omap-fixes/fixes (6a38df676a0a ARM: dts: logicpd-som-lv: Fix MMC1 c=
ard detect)
Merging kvm-fixes/master (6245242d9145 Merge tag 'kvmarm-fixes-for-5.1-2' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/kvmarm/kvmarm into kvm-mast=
er)
...
nto for-next)
Merging clk/clk-next (5b3c66ad8a80 Merge branch 'clk-parent-rewrite-1' into=
 clk-next)
...
Merging ext4/dev (a046f4dfac7f unicode: refactor the rule for regenerating =
utf8data.h)
...
ate)
Merging xfs/for-next (75efa57d0bf5 xfs: add online scrub for superblock cou=
nters)
...
Merging pm/linux-next (f9d6fbd8a37e Merge branch 'acpica-fixes' into linux-=
next)
...
it for-next)
Merging net-next/master (a658a3f2ecba Merge branch 'master' of git://git.ke=
...
Merging wireless-drivers-next/master (e3037485c68e rtw88: new Realtek 802.1=
1ac driver)
CONFLICT (content): Merge conflict in drivers/net/wireless/intel/iwlwifi/fw=
/file.h
Merging bluetooth/master (632c59624302 dt-bindings: net: bluetooth: Add dev=
...
Merging gfs2/for-next (79dc625c5d06 gfs2: fix race between gfs2_freeze_func=
 and unmount)
...
Merging modules/modules-next (7e470ea99bcd kernel/module: Reschedule while =
waiting for modules to finish loading)
...
dor-prefixes.txt
Merging block/for-next (e62243e75d22 Merge branch 'for-5.2/block' into for-=
next)
...
Merging kvm-arm/next (21137301de5a arm64: KVM: Fix perf cycle counter suppo=
rt for VHE)
...
ttr.cocci warnings)
Merging leds/for-next (c37f5a41b0f9 leds: turris_omnia: add I2C and MACH_AR=
...
Merging usb-serial/usb-next (80ed53707bb3 USB: serial: drop unused iflag ma=
cro)
...
in struct tb_path)
Merging staging/staging-next (39e8046240e2 staging: fieldbus: anybus-s: ren=
ame bus id field to avoid confusion)
...
rflow
Merging akpm/master (0095787e119c drivers/media/platform/sti/delta/delta-ip=
...

=jnF+
-----END PGP SIGNATURE-----
