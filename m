...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9A143192FB8
	for <lists+linux-kernel@lfdr.de>; Wed, 25 Mar 2020 18:48:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728165AbgCYRsN (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 25 Mar 2020 13:48:13 -0400
Received: from bombadil.infradead.org ([198.137.202.133]:47284 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727921AbgCYRru (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=YplXIifoc+nCmo1EfVgHxXtkBAnQMcukFKyI/1pNMjs=; b=M7Q8zdReu+d5YKlgZzskVw77v4
        ;
Received: from j217100.upc-j.chello.nl ([24.132.217.100] helo=noisy.programming.kicks-ass.net)
        by bombadil.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1jHA81-0008Qx-0h; Wed, 25 Mar 2020 17:47:45 +0000
Received: from hirez.programming.kicks-ass.net (hirez.programming.kicks-ass.net [192.168.1.225])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (Client did not present a certificate)
        by noisy.programming.kicks-ass.net (Postfix) with ESMTPS id C5D443023D1;
        Wed, 25 Mar 2020 18:47:42 +0100 (CET)
Received: by hirez.programming.kicks-ass.net (Postfix, from userid 0)
        id B0B4A29BD8A2C; Wed, 25 Mar 2020 18:47:42 +0100 (CET)
Message-Id: <20200325174605.621485565@infradead.org>
User-Agent: quilt/0.65
Date:   Wed, 25 Mar 2020 18:45:29 +0100
From:   Peter Zijlstra <peterz@infradead.org>
To:     tglx@linutronix.de, jpoimboe@redhat.com
Cc:     linux-kernel@vger.kernel.org, x86@kernel.org, peterz@infradead.org,
        mhiramat@kernel.org, mbenes@suse.cz
Subject: [PATCH v4 04/13] objtool: Fix !CFI insn_state propagation
...
@@ -2108,7 +2118,7 @@ static int validate_branch(struct objtoo
...
@@ -2116,11 +2126,11 @@ static int validate_branch(struct objtoo
 		}
...
@@ -2210,7 +2220,7 @@ static int validate_branch(struct objtoo
 			return 0;
...
@@ -2280,7 +2290,7 @@ static int validate_branch(struct objtoo
 			return 0;
...
+			if (state.cfi.cfa.base == CFI_UNDEFINED)
 			...
 			return 1;
@@ -2420,10 +2430,10 @@ static int validate_section(struct objto
