...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 79225D1EE1
	for <lists+linux-kernel@lfdr.de>; Thu, 10 Oct 2019 05:20:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732804AbfJJDTr (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 9 Oct 2019 23:19:47 -0400
Received: from mail-eopbgr780112.outbound.protection.outlook.com ([40.107.78.112]:21339
        "EHLO NAM03-BY2-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726621AbfJJDTo (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 9 Oct 2019 23:19:44 -0400
...
x-forefront-antispam-report: SFV:NSPM;SFS:(10019020)(7916004)(366004)(136003)(346002)(376002)(39850400004)(396003)(189003)(199004)(66066001)(66556008)(66476007)(66446008)(4326008)(66946007)(64756008)(14444005)(7736002)(33716001)(5024004)(2906002)(6246003)(107886003)(71200400001)(71190400001)(5660300002)(6116002)(256004)(3846002)(1076003)(561924002)(30864003)(86362001)(6916009)(25786009)(7416002)(386003)(8936002)(76176011)(6512007)(6506007)(446003)(26005)(9686003)(186003)(102836004)(99286004)(486006)(229853002)(6486002)(52116002)(6436002)(11346002)(476003)(316002)(54906003)(33656002)(14454004)(478600001)(81156014)(81166006)(8676002)(305945005)(559001)(569006);DIR:OUT;SFP:1102;SCL:1;SRVR:SN6PR04MB3806;H:SN6PR04MB4543.namprd04.prod.outlook.com;FPR:;SPF:None;LANG:en;PTR:InfoNoRecords;MX:1;A:1;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 10 Oct 2019 03:19:33.6040
 (UTC)
...
> > +	c =3D ((count - 1) << 4) | 0x09;
>=20
> If count =3D=3D 0 this would cause a problem.  But count is never invalid
> so that's okay.
>=20
...
> > +	}
> > +
> > +	platform->pdata.gpio_intr_hpd =3D
...
> > +
> > +	pdata->node.mipi_dsi_host_node =3D of_graph_get_remote_node(np, 0, 0)=
;
> > +	if (pdata->node.mipi_dsi_host_node) {
> > +		of_node_put(pdata->node.mipi_dsi_host_node);
> > +		pdata->dsi_supported =3D 1;
> > +		mipi_host_node =3D pdata->node.mipi_dsi_host_node;
> > +	} else {
...
> > +
> > +		mipi_host_node =3D pdata->node.mipi_dpi_host_node;
> > +	}
> > +
...
>=20
> > +
> > +	pdata->node.extcon_node =3D of_graph_get_port_by_id(np, 2);
> > +	pdata->node.internal_panel_node =3D of_graph_get_port_by_id(np, 3);
> > +	pdata->node.edp_node =3D of_graph_get_port_by_id(np, 4);
...
> > +		out_ep =3D of_get_child_by_name(pdata->node.internal_panel_node,
> > +					      "endpoint");
> > +		if (out_ep) {
>=20
...
>=20
> !=3D 0 is a double negative.  Only !=3D 0 and =3D=3D 0 when you are talki=
ng
> numbers or strcmp().
>=20
> 	if (nr =3D=3D 0) {
> 	if (strcmp(foo, bar) =3D=3D 0) {
>=20
...
> > +		goto err0;
>=20
> !=3D 0 is double negative.  Choose better label names.  Remove the obviou=
s
> comment.
>=20
> if (ret)
