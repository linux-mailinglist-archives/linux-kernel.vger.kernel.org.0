...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B48411970DF
	for <lists+linux-kernel@lfdr.de>; Mon, 30 Mar 2020 00:52:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729082AbgC2WwA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 29 Mar 2020 18:52:00 -0400
Received: from mail-lf1-f53.google.com ([209.85.167.53]:36641 "EHLO
        mail-lf1-f53.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727591AbgC2WwA (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 29 Mar 2020 18:52:00 -0400
Received: by mail-lf1-f53.google.com with SMTP id u15so3437357lfi.3
        for <linux-kernel@vger.kernel.org>; Sun, 29 Mar 2020 15:51:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google;
        h=mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=FfbUoTUrMeC0jL+DRJ5tSoSAJ6MLL048cab2JLPBXY4=;
        b=Pxu6qNcFPB7pwJ0WYiT1ywXg5vMvcE2iKEYwce2xe+0n4EpbYZ2AGdM/apm3jnDx/+
         lE6qyEVEfpLRSL+CYvDe2W4O8wVipXelURIcw5qHS4Qs5LcL5DB0j+bnPAX/6YUvGM5Y
         uiiNlejPxp0/Z4/oKUs9eE5t3Hy88bi6PaEDs=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=FfbUoTUrMeC0jL+DRJ5tSoSAJ6MLL048cab2JLPBXY4=;
        b=
X-Gm-Message-State: AGi0PuanWg42fUd90jRkNqK+DhgoutfOW75GTuheRbYh6oJLolvNq5Wj
        7zVFu+knTtjeYyFKLcVkcVYHUn1K4Nw=
X-Google-Smtp-Source: APiQypIUYL+XPnPrdnKFnGx0DJD4fnyRMNIv1OcFQs8Z3aMtdpUBoOF3m3UQ46PDbIdWWxxmyHffGg==
X-Received: by 2002:a19:84c7:: with SMTP id g190mr6354402lfd.204.1585522315126;
        Sun, 29 Mar 2020 15:51:55 -0700 (PDT)
Received: from mail-lj1-f182.google.com (mail-lj1-f182.google.com. [209.85.208.182])
        by smtp.gmail.com with ESMTPSA id w5sm3536883lfk.19.2020.03.29.15.51.54
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 29 Mar 2020 15:51:54 -0700 (PDT)
Received: by mail-lj1-f182.google.com with SMTP id p10so15849168ljn.1
        for <linux-kernel@vger.kernel.org>; Sun, 29 Mar 2020 15:51:54 -0700 (PDT)
X-Received: by 2002:a2e:7c1a:: with SMTP id x26mr5187972ljc.209.1585522313306;
 Sun, 29 Mar 2020 15:51:53 -0700 (PDT)
MIME-Version: 1.0
From:   Linus Torvalds <torvalds@linux-foundation.org>
Date:   Sun, 29 Mar 2020 15:51:35 -0700
X-Gmail-Original-Message-ID: <CAHk-=wi9ZT7Stg-uSpX0UWQzam6OP9Jzz6Xu1CkYu1cicpD5OA@mail.gmail.com>
Message-ID: <CAHk-=wi9ZT7Stg-uSpX0UWQzam6OP9Jzz6Xu1CkYu1cicpD5OA@mail.gmail.com>
Subject: Linux 5.6
...
Andrew Duggan (1):
      Input: synaptics-rmi4 - set reduced reporting mode only when requeste=
d
...
Arun Easi (1):
      scsi: qla2xxx: Fix I/Os being passed down when FC device is being del=
eted
...
Chen-Yu Tsai (4):
      ARM: dts: sun8i: a83t: Fix incorrect clk and reset macros for EMAC de=
vice
...
Martin K. Petersen (1):
      scsi: sd: Fix optimal I/O size for devices that change reported value=
s
...
Ondrej Jirman (3):
      ARM: dts: sun8i-a83t-tbs-a711: HM5065 doesn't like such a high voltag=
e
      ARM: dts: sun8i-a83t-tbs-a711: Fix USB OTG mode detection
      bus: sunxi-rsb: Return correct data when mixing 16-bit and 8-bit read=
s
...
cases on insertion
      netfilter: nft_set_rbtree: Introduce and use nft_rbtree_interval_star=
t()
...
Takashi Iwai (6):
      ...
      net: netdevsim: Use scnprintf() for avoiding potential buffer overflo=
w
