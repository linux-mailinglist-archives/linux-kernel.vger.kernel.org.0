...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D06E86830A
	for <lists+linux-kernel@lfdr.de>; Mon, 15 Jul 2019 06:49:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726293AbfGOEs6 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 15 Jul 2019 00:48:58 -0400
Received: from ozlabs.org ([203.11.71.1]:51085 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725385AbfGOEs5 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 15 Jul 2019 00:48:57 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45n9z462nlz9sBF;
        Mon, 15 Jul 2019 14:48:48 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1563166128;
        bh=Vo6Hj7M5OpuFzg751IH2OTtPcRmChpCn5fRoYMZ1WlU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 15 Jul 2019 14:48:48 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 15
Message-ID: <20190715144848.4cc41e07@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/h.BUwD0S+faTMPIY7m/o.Ih"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/h.BUwD0S+faTMPIY7m/o.Ih
...
Non-merge commits (relative to Linus' tree): 5001
 4262 files changed, 599496 insertions(+), 105089 deletions(-)
...
Merging origin/master (1d039859330b Merge branch 'perf-urgent-for-linus' of=
...
Merging net/master (76104862ccca sky2: Disable MSI on P5W DH Deluxe)
Merging bpf/master (af3c24e0e2ed selftests/bpf: fix compiling loop{1, 2, 3}=
.c on s390)
...
Merging driver-core.current/driver-core-linus (192f0f8e9db7 Merge tag 'powe=
rpc-5.3-1' of git://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging tty.current/tty-linus (d7d170a8e357 Merge tag 'tag-chrome-platform-=
for-v5.3' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/=
linux)
Merging usb.current/usb-linus (d7d170a8e357 Merge tag 'tag-chrome-platform-=
for-v5.3' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/=
linux)
...
pplies)
Merging staging.current/staging-linus (d7d170a8e357 Merge tag 'tag-chrome-p=
latform-for-v5.3' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-p=
latform/linux)
Merging char-misc.current/char-misc-linus (964a4eacef67 Merge tag 'dlm-5.3'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/teigland/linux-dlm)
...
Merging drm-misc-fixes/for-linux-next-fixes (2f040d27080d drm/panfrost: Fix=
 a double-free error)
Merging kbuild/for-next (0cee22f4fe90 kbuild: get rid of misleading $(AS) f=
rom documents)
Merging compiler-attributes/compiler-attributes (a188339ca5a3 Linux 5.2-rc1)
Merging leaks/leaks-next (9e98c678c2d6 Linux 5.1-rc1)
Merging dma-mapping/for-next (5ddacd4b47c8 dma-direct: Force unencrypted DM=
...
ion)
Merging nfs/linux-next (a101b043c44d SUNRPC: Fix transport accounting when =
caller specifies an rpc_xprt)
...
in imxfb_probe())
Merging pm/linux-next (255f790fa642 Merge branch 'acpi-misc' into linux-nex=
t)
CONFLICT (content): Merge conflict in Documentation/power/pm_qos_interface.=
rst
Applying: intel_rapl: need linux/cpuhotplug.h for enum cpuhp_state
...
Merging bpf-next/master (a131c2bf1656 Merge tag 'acpi-5.3-rc1-2' of git://g=
...
Merging bluetooth/master (84b0ddef7fcc Bluetooth: hci_qca: Send VS pre shut=
down command.)
...
Merging drm-intel/for-linux-next (a8120bc23eea drm/i915/uc: kill <g,h>uc_to=
_i915)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/gt/intel_workaro=
unds.c
...
Merging input/next (e2c063c89700 Input: auo-pixcir-ts - switch to using  de=
vm_add_action_or_reset())
...
convert to ReST)
Merging driver-core/driver-core-next (192f0f8e9db7 Merge tag 'powerpc-5.3-1=
' of git://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging usb/usb-next (d7d170a8e357 Merge tag 'tag-chrome-platform-for-v5.3'=
...
e() polling delay)
Merging tty/tty-next (d7d170a8e357 Merge tag 'tag-chrome-platform-for-v5.3'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/linux)
Merging char-misc/char-misc-next (964a4eacef67 Merge tag 'dlm-5.3' of git:/=
/git.kernel.org/pub/scm/linux/kernel/git/teigland/linux-dlm)
...
Merging staging/staging-next (d7d170a8e357 Merge tag 'tag-chrome-platform-f=
or-v5.3' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/l=
inux)
...
rflow
Merging akpm/master (3f5a96b7bfeb drivers/media/platform/sti/delta/delta-ip=
...

=AnZ2
-----END PGP SIGNATURE-----
