...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 805FF81216
	for <lists+linux-kernel@lfdr.de>; Mon,  5 Aug 2019 08:09:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727298AbfHEGJ3 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 5 Aug 2019 02:09:29 -0400
Received: from ozlabs.org ([203.11.71.1]:35309 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725976AbfHEGJ2 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 5 Aug 2019 02:09:28 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4626mK4Cvpz9sBF;
        Mon,  5 Aug 2019 16:09:21 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1564985361;
        bh=nGfVYTaW3N8uxnV2wBxaDNzMN1GR4jFnXYAprX/xnRs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 5 Aug 2019 16:09:21 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 5
Message-ID: <20190805160921.421f88bf@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/MGK6WDkTFmp6GQ04A9BPGP4";
...
Merging origin/master (4b6f23161b4e Merge tag 'powerpc-5.3-3' of git://git.=
...
Merging net/master (5e5412c365a3 net/socket: fix GCC8+ Wpacked-not-aligned =
warnings)
...
Merging sound-asoc-fixes/for-linus (592bd74de360 Merge branch 'asoc-5.3' in=
to asoc-linus)
Merging regmap-fixes/for-linus (609488bc979f Linux 5.3-rc2)
Merging regulator-fixes/for-linus (fa36b1b8cd35 Merge branch 'regulator-5.3=
...
k when in kgdb)
Merging usb.current/usb-linus (88d02c9ba2e8 usb: typec: tcpm: Ignore unsupp=
orted/unknown alternate mode requests)
...
optional confd gpio)
Merging drm-misc-fixes/for-linux-next-fixes (9b562437d388 drm/modes: Fix un=
terminated strncpy)
...
Merging btrfs-kdave/for-next (554aee18c00a Merge branch 'for-next-next-v5.3=
-20190802' into for-next-20190802)
Merging ceph/master (d31d07b97a5e ceph: fix end offset in truncate_inode_pa=
ges_range call)
Merging cifs/for-next (88445fd23ca8 cifs: fix error handling on chmod)
...
ion)
Merging nfs/linux-next (cf6c8aef16cc Merge branch 'i2c/for-current-fixed' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/wsa/linux)
...
st
Merging v4l-dvb/master (d3dd552da3eb media: dt-bindings: media: sunxi-ir: A=
dd H6 compatible)
Merging v4l-dvb-next/master (5f9e832c1370 Linus 5.3-rc1)
Merging fbdev/fbdev-for-next (732146a3f1dc video: fbdev: imxfb: fix a typo =
in imxfb_probe())
Merging pm/linux-next (802a5065c6ab Merge branch 'pm-s2idle-rework' into li=
nux-next)
...
Merging net-next/master (9e8fb25254f7 Merge branch 'net-l3-l4-functional-te=
sts')
...
.c
Merging drm-intel/for-linux-next (b40d73784ffc drm/i915: Replace struct_mut=
ex for batch pool serialisation)
...
Merging drm-misc/for-linux-next (05103ea9a315 drm/vblank: drop use of DRM_W=
AIT_ON())
...
-next)
Merging sound/for-next (b6fcab14ff02 ALSA: hda: Add support of Zhaoxin cont=
roller)
Merging sound-asoc/for-next (c409a9958ac5 Merge branch 'asoc-5.4' into asoc=
-next)
...
Merging regulator/for-next (b5c8c9c630d0 Merge branch 'regulator-5.4' into =
regulator-next)
...
Merging leds/for-next (be7fc2cc8617 Merge tag 'generic_lookup_helpers' into=
 for-next)
Merging ipmi/for-next (dc4033492e6d ipmi_si: Only schedule continuously in =
...
rflow
Merging akpm/master (6247a7ca629c drivers/media/platform/sti/delta/delta-ip=
...

=a+EA
-----END PGP SIGNATURE-----
