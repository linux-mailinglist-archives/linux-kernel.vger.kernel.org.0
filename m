...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8027E1167F4
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Dec 2019 09:09:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727192AbfLIIJa convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-kernel@lfdr.de>); Mon, 9 Dec 2019 03:09:30 -0500
Received: from mga03.intel.com ([134.134.136.65]:36813 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727044AbfLIIJa (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Dec 2019 03:09:30 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga103.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 09 Dec 2019 00:09:27 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,294,1571727600"; 
   d="scan'208";a="206814058"
Received: from shao2-debian.sh.intel.com (HELO [10.239.13.6]) ([10.239.13.6])
  by orsmga008.jf.intel.com with ESMTP; 09 Dec 2019 00:09:24 -0800
...
Message-ID: <a67a0920-472f-7f86-299a-097bc2986a1c@intel.com>
Date:   Mon, 9 Dec 2019 16:08:56 +0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.6.1
MIME-Version: 1.0
In-Reply-To: <20191209073152.GA14094@lst.de>
...
local,id=test_dev,path=/home/nfs/.lkp//result/kernel_selftests/kselftests-x86/vm-snb/debian-x86_64-2019-11-14.cgz/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/1,security_model=none 
-device virtio-9p-pci,fsdev=test_dev,mount_tag=9p/virtfs_mount -kernel 
vmlinuz-5.4.0-10082-gf216fdd77b565 -append root=/dev/ram0 user=lkp 
job=/lkp/jobs/scheduled/vm-snb-f9eef226434d/kernel_selftests-kselftests-x86-debian-x86_64-2019-11-14.cgz-f216fdd77-20191206-11813-1cb6s7n-3.yaml 
ARCH=x86_64 kconfig=x86_64-randconfig-h002-20191205 
branch=block/for-linus commit=f216fdd77b5654f8c4f6fac6020d6aabc58878ef 
BOOT_IMAGE=/pkg/linux/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/vmlinuz-5.4.0-10082-gf216fdd77b565 
erst_disable max_uptime=3600 
RESULT_ROOT=/result/kernel_selftests/kselftests-x86/vm-snb/debian-x86_64-2019-11-14.cgz/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/3 
...
-smp 2 -m 3725M -no-reboot -watchdog i6300esb -rtc base=localtime 
-device e1000,netdev=net0 -netdev user,id=net0 -display none -monitor 
null -serial stdio -drive 
file=/tmp/vdisk-nfs/disk-vm-snb-f9eef226434d-0,media=disk,if=virtio 
-drive 
file=/tmp/vdisk-nfs/disk-vm-snb-f9eef226434d-1,media=disk,if=virtio 
-drive 
file=/tmp/vdisk-nfs/disk-vm-snb-f9eef226434d-2,media=disk,if=virtio 
-drive 
file=/tmp/vdisk-nfs/disk-vm-snb-f9eef226434d-3,media=disk,if=virtio 
-drive 
file=/tmp/vdisk-nfs/disk-vm-snb-f9eef226434d-4,media=disk,if=virtio 
-drive 
file=/tmp/vdisk-nfs/disk-vm-snb-f9eef226434d-5,media=disk,if=virtio 
-drive file=/tmp/vdisk-nfs/disk-vm-snb-f9eef226434d-6,media=disk,if=virtio
early console in setup code
Wrong EFI loader signature.
early console in extract_kernel
input_data: 0x0000000005a772e9
input_len: 0x0000000001b894eb
output: 0x0000000001000000
output_len: 0x0000000005fe39f8
kernel_total_size: 0x0000000006626000
...
and I can reproduce with the following steps:
...
On 12/9/19 3:31 PM, Christoph Hellwig wrote:
> Can someone decode what this report is supposed to mean?  I've read
> through it a few times yesterday, and again this morning and I'm still
> 100% confused on what is reported.
>
> On Sun, Dec 08, 2019 at 11:39:23PM +0800, kernel test robot wrote:
...
>> 	export job_origin='/lkp-src/jobs/kernel_selftests_x86.yaml'
>> 	export queue_cmdline_keys='branch
>> commit
>> queue_at_least_once'
>> 	export queue='validate'
>> 	export testbox='vm-snb-f9eef226434d'
>> 	export tbox_group='vm-snb'
>> 	export branch='block/for-linus'
>> 	export commit='f216fdd77b5654f8c4f6fac6020d6aabc58878ef'
>> 	export kconfig='x86_64-randconfig-h002-20191205'
>> 	export repeat_to=4
>> 	export nr_vm=64
>> 	export submit_id='5de9c0bf12586f2e254797bb'
>> 	export job_file='/lkp/jobs/scheduled/vm-snb-f9eef226434d/kernel_selftests-kselftests-x86-debian-x86_64-2019-11-14.cgz-f216fdd77-20191206-11813-1cb6s7n-3.yaml'
>> 	export id='d75f696b18fe65b99382cf47ebc4a48dba2661b0'
...
>> 	export enqueue_time='2019-12-06 10:45:23 +0800'
>> 	export _id='5de9c0c612586f2e254797bc'
>> 	export _rt='/result/kernel_selftests/kselftests-x86/vm-snb/debian-x86_64-2019-11-14.cgz/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef'
>> 	export user='lkp'
>> 	export result_root='/result/kernel_selftests/kselftests-x86/vm-snb/debian-x86_64-2019-11-14.cgz/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/3'
>> 	export scheduler_version='/lkp/lkp/.src-20191206-101841'
...
>> job=/lkp/jobs/scheduled/vm-snb-f9eef226434d/kernel_selftests-kselftests-x86-debian-x86_64-2019-11-14.cgz-f216fdd77-20191206-11813-1cb6s7n-3.yaml
>> ARCH=x86_64
>> kconfig=x86_64-randconfig-h002-20191205
>> branch=block/for-linus
...
>> vga=normal
>> rw'
>> 	export modules_initrd='/pkg/linux/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/modules.cgz'
>> 	export bm_initrd='/osimage/deps/debian-x86_64-2018-04-03.cgz/run-ipconfig_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/lkp_2019-08-05.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/kernel_selftests_2019-12-01.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/kernel_selftests-x86_64-81b6b96475ac_2019-12-01.cgz'
>> 	export linux_headers_initrd='/pkg/linux/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/linux-headers.cgz'
>> 	export linux_selftests_initrd='/pkg/linux/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/linux-selftests.cgz'
...
>> 	export kernel='/pkg/linux/x86_64-randconfig-h002-20191205/gcc-7/f216fdd77b5654f8c4f6fac6020d6aabc58878ef/vmlinuz-5.4.0-10082-gf216fdd77b565'
>> 	export dequeue_time='2019-12-06 10:45:39 +0800'
>> 	export job_initrd='/lkp/jobs/scheduled/vm-snb-f9eef226434d/kernel_selftests-kselftests-x86-debian-x86_64-2019-11-14.cgz-f216fdd77-20191206-11813-1cb6s7n-3.cgz'
>>
>> 	[ -n "$LKP_SRC" ] ||
...
>>
>> 	run_test group='kselftests-x86' $LKP_SRC/tests/wrapper kernel_selftests
>> }
>>
>> extract_stats()
>> {
