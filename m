...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D6EEE82B93
	for <lists+linux-kernel@lfdr.de>; Tue,  6 Aug 2019 08:24:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731829AbfHFGYe (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 6 Aug 2019 02:24:34 -0400
Received: from mga02.intel.com ([134.134.136.20]:25640 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731594AbfHFGYe (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 6 Aug 2019 02:24:34 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga101.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 05 Aug 2019 23:24:05 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,352,1559545200"; 
   d="yaml'?scan'208";a="179062539"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by orsmga006.jf.intel.com with ESMTP; 05 Aug 2019 23:23:59 -0700
Date:   Tue, 6 Aug 2019 14:24:05 +0800
...
Subject: [locking/rwsem]  7813430057:  vm-scalability.median -42.5% regression
Message-ID: <20190806062405.GD10969@shao2-debian>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.3.0-rc1-00002-g78134300579a45"
...
export_top_env()
{
	...
	export runtime=300
	export size=
	export job_origin='/lkp/lkp/.src-20190803-134953/allot/cyclic:p1:linux-devel:devel-hourly/lkp-bdw-ep4/vm-scalability.yaml'
...
queue_at_least_once'
	...
	export submit_id='5d46b46a9f45d235ff638e29'
	export job_file='/lkp/jobs/scheduled/lkp-bdw-ep4/vm-scalability-performance-300s-small-allocs-mt-ucode=0xb000036-d-20190804-13823-1wezh4i-3.yaml'
	export id='5367dae0953e2cfeb3950234a77c5deb2c325d1c'
	export queuer_version='/lkp-src'
	export arch='x86_64'
	export need_kconfig='CONFIG_BLK_DEV_LOOP'
	export commit='78134300579a45f527ca173ec8fdb4701b69f16e'
	export ucode='0xb000036'
	export rootfs='debian-x86_64-2019-05-14.cgz'
	export kconfig='x86_64-rhel-7.6'
	export compiler='gcc-7'
	export enqueue_time='2019-08-04 18:33:28 +0800'
	export _id='5d46b4799f45d235ff638e2a'
	export _rt='/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0xb000036/lkp-bdw-ep4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e'
	export user='lkp'
	...
	export result_root='/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0xb000036/lkp-bdw-ep4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/3'
	export scheduler_version='/lkp/lkp/.src-20190803-134953'
	export LKP_SERVER='inn'
	export max_uptime=1500
	export initrd='/osimage/debian/debian-x86_64-2019-05-14.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-bdw-ep4/vm-scalability-performance-300s-small-allocs-mt-ucode=0xb000036-d-20190804-13823-1wezh4i-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019073002
commit=78134300579a45f527ca173ec8fdb4701b69f16e
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/vmlinuz-5.3.0-rc1-00002-g78134300579a45
max_uptime=1500
RESULT_ROOT=/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0xb000036/lkp-bdw-ep4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/3
LKP_SERVER=inn
debug
apic=debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/modules.cgz'
	export bm_initrd='/osimage/deps/debian-x86_64-2018-04-03.cgz/run-ipconfig_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/lkp_2019-06-26.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/perf_2019-06-26.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/perf-x86_64-git-1_2019-08-02.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/vm-scalability_2019-07-09.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/vm-scalability-x86_64-1.0-0_2019-07-09.cgz,/osimage/pkg/common/vm-scalability-x86_64.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/mpstat_2019-06-26.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/vmstat_2019-07-09.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/turbostat_2019-07-09.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/turbostat-x86_64-3.7-4_2019-07-09.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/mpstat-x86_64-git-1_2019-04-29.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/hw_2019-07-10.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/vmlinuz-5.3.0-rc1-00002-g78134300579a45'
	export dequeue_time='2019-08-04 19:00:02 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-bdw-ep4/vm-scalability-performance-300s-small-allocs-mt-ucode=0xb000036-d-20190804-13823-1wezh4i-3.cgz'
...
vm-scalability:
  test: small-allocs-mt
job_origin: "/lkp/lkp/.src-20190803-134953/allot/cyclic:p1:linux-devel:devel-hourly/lkp-bdw-ep4/vm-scalability.yaml"
...
submit_id: 5d4694849f45d2339610e2e4
job_file: "/lkp/jobs/scheduled/lkp-bdw-ep4/vm-scalability-performance-300s-small-allocs-mt-ucode=0xb000036-deb-20190804-13206-1gdza2r-0.yaml"
id: 9062f3e5cf0367e54aefb087964df04bbc4f746f
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2019-08-04 16:17:42.078586480 +08:00
_id: 5d4694849f45d2339610e2e4
_rt: "/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0xb000036/lkp-bdw-ep4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e"
...
branch: linux-devel/devel-hourly-2019073002
result_root: "/result/vm-scalability/performance-300s-small-allocs-mt-ucode=0xb000036/lkp-bdw-ep4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/0"
scheduler_version: "/lkp/lkp/.src-20190803-134953"
LKP_SERVER: inn
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-bdw-ep4/vm-scalability-performance-300s-small-allocs-mt-ucode=0xb000036-deb-20190804-13206-1gdza2r-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019073002
- commit=78134300579a45f527ca173ec8fdb4701b69f16e
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/78134300579a45f527ca173ec8fdb4701b69f16e/vmlinuz-5.3.0-rc1-00002-g78134300579a45"
dequeue_time: 2019-08-04 16:50:58.549485551 +08:00
job_state: finished
loadavg: 68.13 53.16 23.99 1/670 9810
start_time: '1564908732'
end_time: '1564909035'
version: "/lkp/lkp/.src-20190803-135026"
...
cd /lkp/benchmarks/vm-scalability
 ...
 truncate -s 135073071104 /tmp/vm-scalability-tmp/vm-scalability.img
 ...
 ./usemem --runtime 300 -t 88 --readonly --unit 40960 49977801262
