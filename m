...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 303D8186D9F
	for <lists+linux-kernel@lfdr.de>; Mon, 16 Mar 2020 15:43:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731954AbgCPOnb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 16 Mar 2020 10:43:31 -0400
Received: from mail-pf1-f195.google.com ([209.85.210.195]:37514 "EHLO
        mail-pf1-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731634AbgCPOna (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 16 Mar 2020 10:43:30 -0400
Received: by mail-pf1-f195.google.com with SMTP id 3so2212126pff.4
        for <linux-kernel@vger.kernel.org>; Mon, 16 Mar 2020 07:43:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=arista.com; s=googlenew;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=VfDXChHGdoSjfLnV3mfvgQ6aT9l1X7OLIoozsnEJ28E=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=VfDXChHGdoSjfLnV3mfvgQ6aT9l1X7OLIoozsnEJ28E=;
        b=
X-Gm-Message-State: ANhLgQ2xpVwkapOiAMmtG+on106GZsH17IVpwpCbxDEmYHisBVdi0UTX
        EAbbhCVTnIBNmnuYsB+OdmswrNx6/rH0Nw==
X-Google-Smtp-Source: ADFU+vslbJNSlR/4aZ4aBYmR+IUr/uWT+/7K65eoh/82qJWAVtjbb1zsYqD8a+3hn9osXwhGXVaUtQ==
X-Received: by 2002:aa7:9588:: with SMTP id z8mr10385907pfj.145.1584369807408;
        Mon, 16 Mar 2020 07:43:27 -0700 (PDT)
Received: from Mindolluin.aristanetworks.com ([2a02:8084:e84:2480:228:f8ff:fe6f:83a8])
        by smtp.gmail.com with ESMTPSA id i2sm81524pjs.21.2020.03.16.07.43.22
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 16 Mar 2020 07:43:26 -0700 (PDT)
...
Subject: [PATCHv2 50/50] kernel: Rename show_stack_loglvl() => show_stack()
Date:   Mon, 16 Mar 2020 14:39:16 +0000
Message-Id: <20200316143916.195608-51-dima@arista.com>
...
---
 ...
 lib/dump_stack.c                 |  2 +-
 39 files changed, 52 insertions(+), 198 deletions(-)
...
index c1ab7f613da4..c4cf9274b2b3 100644
...
@@ -2034,8 +2034,8 @@ unsigned long get_wchan(struct task_struct *p)
...
+		const char *loglvl)
 {
 	...
 	int count = 0;
@@ -2104,11 +2104,6 @@ void show_stack_loglvl(struct task_struct *tsk, unsigned long *stack,
 	put_task_stack(tsk);
 }
...
index b80a1d616e4e..697722fc58bd 100644
...
index c0fdf594709e..584016ff59b8 100644
...
index 9b8450eab02e..1f530479dd8b 100644
...
index fe1ffcbda194..aa9a95ed3758 100644
...
index bae2c84077bd..54b96d891f5d 100644
