...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7758B161B1B
	for <lists+linux-kernel@lfdr.de>; Mon, 17 Feb 2020 19:57:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728766AbgBQS5S (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 17 Feb 2020 13:57:18 -0500
Received: from amazon.4net.rs ([159.69.148.70]:38982 "EHLO amazon.4net.rs"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726646AbgBQS5R (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 17 Feb 2020 13:57:17 -0500
X-Greylist: delayed 891 seconds by postgrey-1.27 at vger.kernel.org; Mon, 17 Feb 2020 13:57:16 EST
Received: from localhost (amazon.4net.co.rs [127.0.0.1])
        by amazon.4net.rs (Postfix) with ESMTP id A49C36308DA1
        for <linux-kernel@vger.kernel.org>; Mon, 17 Feb 2020 19:42:24 +0100 (CET)
...
Received: from amazon.4net.rs ([127.0.0.1])
        ...
        with ESMTP id 9ZOF7itKs35G for <linux-kernel@vger.kernel.org>;
        Mon, 17 Feb 2020 19:42:23 +0100 (CET)
Received: from mail.4net.rs (green.4net.rs [10.188.221.8])
        by amazon.4net.rs (Postfix) with ESMTP id 153066308DA0
        for <linux-kernel@vger.kernel.org>; Mon, 17 Feb 2020 19:42:23 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
        by mail.4net.rs (Postfix) with ESMTP id C0449CB79E03F
        for <linux-kernel@vger.kernel.org>; Mon, 17 Feb 2020 19:42:22 +0100 (CET)
X-Virus-Scanned: amavisd-new at 4net.rs
Received: from mail.4net.rs ([127.0.0.1])
        by localhost (green.4net.rs [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id e_byEmq_aCvw for <linux-kernel@vger.kernel.org>;
        Mon, 17 Feb 2020 19:42:22 +0100 (CET)
Received: from mail.4net.rs (localhost [127.0.0.1])
        by mail.4net.rs (Postfix) with ESMTP id 8A07BCB7C3A70
        for <linux-kernel@vger.kernel.org>; Mon, 17 Feb 2020 19:42:22 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=4net.rs; h=from:subject:to
        :references:message-id:date:mime-version:in-reply-to
        :content-type:content-transfer-encoding; s=4netrs; bh=I6+iHE8NwJ
        MTD7SSicGS9OJqljs=; b=AgGZOXyOYcR7s335gLv9v/Yj7yp1V6aMKIF3vO5KNf
        uI6WK+Z5HrZtqSbO1hQfGIyIBRIlAQVP74kHQZ5vlOTyvOs9SNbAKIG5DIzAKOJU
        IR2qnaWelSSukQ2wL2x7tOsXWmICIrViDhGSPGyoH0Ysj6xFNrBnjZc1F9NPyKwx
        Q=
DomainKey-Signature: a=rsa-sha1; c=nofws; d=4net.rs; h=from:subject:to
        :references:message-id:date:mime-version:in-reply-to
        :content-type:content-transfer-encoding; q=dns; s=4netrs; b=QqUj
        T5fft3pQgQGHLkqZHpOx6FHM/fMtkhKQPMOc4Nf2leTMQFqSBqEQt01j1rx2AMEI
        VCJXN1lvURnHw+qLZqGxDrV4+sQ/TRkEOgQvSHnalNps/pg53ci4hiIPtYXiUxQ8
        FKuOVmTl4C2mzhkJZu8fLbRkLEjjQhosstf1PAY=
Received: from i5.4net.co.rs (mxb.poslovnisoftver.rs [89.216.122.132])
        by mail.4net.rs (Postfix) with ESMTPSA id 50FFDCB79E03F
        for <linux-kernel@vger.kernel.org>; Mon, 17 Feb 2020 19:42:22 +0100 (CET)
...
Message-ID: <99fb887f-4a1b-6c15-64a6-9d089773cdd4@4net.rs>
Date:   Mon, 17 Feb 2020 19:42:21 +0100
