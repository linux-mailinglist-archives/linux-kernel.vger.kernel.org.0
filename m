...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C385E5E317
	for <lists+linux-kernel@lfdr.de>; Wed,  3 Jul 2019 13:49:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726598AbfGCLtP (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 3 Jul 2019 07:49:15 -0400
Received: from ozlabs.org ([203.11.71.1]:39775 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725786AbfGCLtO (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 3 Jul 2019 07:49:14 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45dzsW3N75z9s00;
        Wed,  3 Jul 2019 21:49:03 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1562154543;
        bh=PJQAhUTm5lBmxyRkQDZYyNCExS3Z6A574lDfF2+vQl0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 3 Jul 2019 21:49:00 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 3
Message-ID: <20190703214900.45e94ae4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/UsB2Hb..qpJ0s4xG63bIr=c"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/UsB2Hb..qpJ0s4xG63bIr=c
...
Non-merge commits (relative to Linus' tree): 10749
 10302 files changed, 822934 insertions(+), 300818 deletions(-)
...
nker if necessary)
Merging arm-soc-fixes/arm/fixes (521a503f5247 soc: ti: fix irq-ti-sci link =
error)
...
Merging net/master (bc389fd101e5 Merge branch 'macsec-fix-some-bugs-in-the-=
receive-path')
...
Merging cifs/for-next (9d5894bd943a cifs: update internal module number)
...
$ git rm -f drivers/infiniband/hw/nes/Kconfig drivers/infiniband/hw/nes/Mak=
efile
[master 17ef3bdd1521] next-20190628/rdma
Merging net-next/master (dbcdb61aaf1a mlxsw: spectrum_ptp: Fix validation i=
n mlxsw_sp1_ptp_packet_finish())
...
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
re/eswitch.c
Merging netfilter-next/master (41fd0fdd4e53 netfilter: nft_meta: Add NFT_ME=
TA_BRI_IIFVPROTO support)
...
Merging amdgpu/drm-next (ba9e93c5faed drm/amdkfd: remove an unused variable)
Merging drm-intel/for-linux-next (096a93949b86 drm/i915/gtt: Don't check PP=
GTT presence on PPGTT-only platforms)
...
Merging block/for-next (228931b99a01 Merge branch 'for-5.3/libata' into for=
-next)
...
Merging device-mapper/for-next (54fa16ee5327 dm thin metadata: check if in =
fail_io mode when setting needs_check)
...
Merging usb/usb-next (aa9083faa10f Merge tag 'phy-for-5.3' of git://git.ker=
...
Merging char-misc/char-misc-next (c1829acefc08 Merge tag 'extcon-next-for-5=
.3' of git://git.kernel.org/pub/scm/linux/kernel/git/chanwoo/extcon into ch=
ar-misc-next)
...
Merging staging/staging-next (268d828144d2 staging: kpc2000: drop useless s=
oftdep statement)
...
U new events)
Merging hmm/hmm (9ec3f4cb35bc Merge tag 'v5.2-rc7' into rdma.git hmm)
...
rflow
Merging akpm/master (87754820b31c drivers/media/platform/sti/delta/delta-ip=
...

=nmXs
-----END PGP SIGNATURE-----
