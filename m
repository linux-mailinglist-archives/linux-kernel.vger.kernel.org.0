...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1387213A38A
	for <lists+linux-kernel@lfdr.de>; Tue, 14 Jan 2020 10:13:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728847AbgANJNB (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 14 Jan 2020 04:13:01 -0500
Received: from mail-wr1-f68.google.com ([209.85.221.68]:34177 "EHLO
        mail-wr1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725820AbgANJNB (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 14 Jan 2020 04:13:01 -0500
Received: by mail-wr1-f68.google.com with SMTP id t2so11365216wrr.1
        for <linux-kernel@vger.kernel.org>; Tue, 14 Jan 2020 01:12:54 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         :mime-version:content-disposition:content-transfer-encoding
         :in-reply-to:user-agent;
        bh=bgcRI6BWswIiSp/mb4DvaYQBi0B0YNOtZmT8ENGJ8sM=;
        b=
X-Gm-Message-State: APjAAAXqW2he2Fii+gcSd4YnVaR7CRFq2qDLkieXH8J2cyP0W1ENYdYx
        4A7x2yhGl0vpxxMYVTk+G6dOwjjH
X-Google-Smtp-Source: APXvYqweZNzwAHwxJKZqAgIDKEFDRadcfSAl7MH4O2qO12LqrYzQzWNxWi9hx9z8X5xC2hRjuXddTA==
X-Received: by 2002:a5d:530e:: with SMTP id e14mr23074066wrv.250.1578993172989;
        Tue, 14 Jan 2020 01:12:52 -0800 (PST)
Received: from localhost (prg-ext-pat.suse.com. [213.151.95.130])
        by smtp.gmail.com with ESMTPSA id r6sm19127575wrq.92.2020.01.14.01.12.51
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 14 Jan 2020 01:12:51 -0800 (PST)
Date:   Tue, 14 Jan 2020 10:12:51 +0100
...
Subject: Re: [mm/hugetlb] c77c0a8ac4: will-it-scale.per_process_ops 15.9%
 improvement
Message-ID: <20200114091251.GE19428@dhcp22.suse.cz>
References: <20200114085637.GA29297@shao2-debian>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20200114085637.GA29297@shao2-debian>
...
> 	export nr_task=96
> 	export job_origin='/lkp/lkp/.src-20191204-134248/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2ap3/will-it-scale-50.yaml'
...
> 	export submit_id='5e1c0e895ee6f15a720f2eba'
> 	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-page_fault3-ucode=0x500002c-debian-x86_64-2019-11-14.cgz-c77c0a8ac4c522638a8242fcb9de9496e-20200113-23154-oo7scw-3.yaml'
> 	export id='776e5adf6c79ff189b92d06bdf86cebe2b775037'
...
> 	export commit='c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d'
...
> 	export enqueue_time='2020-01-13 14:30:57 +0800'
> 	export _id='5e1c0ea15ee6f15a720f2ebb'
> 	export _rt='/result/will-it-scale/performance-process-50%-page_fault3-ucode=0x500002c/lkp-csl-2ap3/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d'
> 	export user='lkp'
> 	export head_commit='e6fdff488ae112671ec518b9212b48b0f6fef642'
> 	export base_commit='c79f46a282390e0f5b306007bf7b11a46d529538'
> 	export branch='internal-devel/devel-hourly-2020011207'
> 	export result_root='/result/will-it-scale/performance-process-50%-page_fault3-ucode=0x500002c/lkp-csl-2ap3/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/3'
> 	export scheduler_version='/lkp/lkp/.src-20200112-165410'
> 	export LKP_SERVER='inn'
> 	export max_uptime=1500
> 	export initrd='/osimage/debian/debian-x86_64-2019-11-14.cgz'
> 	export bootloader_append='root=/dev/ram0
> user=lkp
> job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-page_fault3-ucode=0x500002c-debian-x86_64-2019-11-14.cgz-c77c0a8ac4c522638a8242fcb9de9496e-20200113-23154-oo7scw-3.yaml
> ARCH=x86_64
> kconfig=x86_64-rhel-7.6
> branch=internal-devel/devel-hourly-2020011207
> commit=c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d
> BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/vmlinuz-5.5.0-rc4-00150-gc77c0a8ac4c52
> acpi_rsdp=0x67f44014
> max_uptime=1500
> RESULT_ROOT=/result/will-it-scale/performance-process-50%-page_fault3-ucode=0x500002c/lkp-csl-2ap3/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/3
> LKP_SERVER=inn
> nokaslr
> debug
> apic=debug
...
> vga=normal
> rw'
> 	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/modules.cgz'
> 	export bm_initrd='/osimage/deps/debian-x86_64-2018-04-03.cgz/run-ipconfig_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/lkp_2019-08-05.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/will-it-scale_2020-01-07.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/will-it-scale-x86_64-1eef89e-1_2020-01-07.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/mpstat_2020-01-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/vmstat_2020-01-07.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/turbostat_2020-01-06.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/turbostat-x86_64-3.7-4_2020-01-06.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/perf_2020-01-04.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/sar-x86_64-e011d97-1_2020-01-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/hw_2020-01-02.cgz'
> 	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
> 	export site='inn'
> 	export LKP_CGI_PORT=80
> 	export LKP_CIFS_PORT=139
> 	export last_kernel='4.20.0-04038-g7f9f852c75e7d'
> 	export repeat_to=4
> 	export schedule_notify_address=
> 	export queue_at_least_once=1
> 	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/vmlinuz-5.5.0-rc4-00150-gc77c0a8ac4c52'
> 	export dequeue_time='2020-01-13 14:44:07 +0800'
> 	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-page_fault3-ucode=0x500002c-debian-x86_64-2019-11-14.cgz-c77c0a8ac4c522638a8242fcb9de9496e-20200113-23154-oo7scw-3.cgz'
> 
> 	[ -n "$LKP_SRC" ] ||
...
>   mode: process
>   test: page_fault3
> job_origin: "/lkp/lkp/.src-20191204-134248/allot/cyclic:p1:internal-devel:devel-hourly/lkp-csl-2ap3/will-it-scale-50.yaml"
> 
> #! queue options
> queue_cmdline_keys:
> - branch
...
> submit_id: 5e1bf06f5ee6f1583926bc5a
> job_file: "/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-page_fault3-ucode=0x500002c-debian-x86_64-2019-11-14.cgz-c77c0a8ac4c522638a8242fcb9de9496e-20200113-22585-dmycdi-0.yaml"
> id: 15fbae0ca1579abc42d1625ba84c6a4e2d23be83
...
> enqueue_time: 2020-01-13 12:22:18.543393978 +08:00
> _id: 5e1bf06f5ee6f1583926bc5a
> _rt: "/result/will-it-scale/performance-process-50%-page_fault3-ucode=0x500002c/lkp-csl-2ap3/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d"
> 
> #! schedule options
> user: lkp
> head_commit: e6fdff488ae112671ec518b9212b48b0f6fef642
> base_commit: c79f46a282390e0f5b306007bf7b11a46d529538
> branch: internal-devel/devel-hourly-2020011207
> result_root: "/result/will-it-scale/performance-process-50%-page_fault3-ucode=0x500002c/lkp-csl-2ap3/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/0"
> scheduler_version: "/lkp/lkp/.src-20200112-165410"
> LKP_SERVER: inn
> max_uptime: 1500
...
> - root=/dev/ram0
> - user=lkp
> - job=/lkp/jobs/scheduled/lkp-csl-2ap3/will-it-scale-performance-process-50%-page_fault3-ucode=0x500002c-debian-x86_64-2019-11-14.cgz-c77c0a8ac4c522638a8242fcb9de9496e-20200113-22585-dmycdi-0.yaml
> - ARCH=x86_64
> - kconfig=x86_64-rhel-7.6
> - branch=internal-devel/devel-hourly-2020011207
> - commit=c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d
...
> - vga=normal
> - rw
> modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/modules.cgz"
...
> site: inn
> 
> #! /lkp/lkp/.src-20200112-165410/include/site/inn
> LKP_CGI_PORT: 80
> LKP_CIFS_PORT: 139
> oom-killer: 
> watchdog: 
> 
> #! runtime status
> last_kernel: 5.5.0-rc5
> repeat_to: 2
> schedule_notify_address: 
> 
> #! user overrides
> queue_at_least_once: 0
> kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/c77c0a8ac4c522638a8242fcb9de9496e3cdbb2d/vmlinuz-5.5.0-rc4-00150-gc77c0a8ac4c52"
> dequeue_time: 2020-01-13 12:44:29.462936529 +08:00
> job_state: finished
> loadavg: 74.55 58.43 26.44 1/1296 12528
> start_time: '1578890730'
> end_time: '1578891032'
> version: "/lkp/lkp/.src-20200112-165452:59ad4a31:a62010cb7-dirty"
...
> done
> 
>  "python2" "./runtest.py" "page_fault3" "295" "process" "96"
