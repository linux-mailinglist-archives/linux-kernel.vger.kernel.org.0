...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0543D167D6B
	for <lists+linux-kernel@lfdr.de>; Fri, 21 Feb 2020 13:24:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728314AbgBUMYA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 21 Feb 2020 07:24:00 -0500
Received: from lb2-smtp-cloud9.xs4all.net ([194.109.24.26]:43995 "EHLO
        lb2-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727063AbgBUMX7 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 21 Feb 2020 07:23:59 -0500
Received: from surfplank2.hierzo ([IPv6:2001:981:a812:0:b62e:99ff:fe92:5264])
        by smtp-cloud9.xs4all.net with ESMTPA
        id 57LZjJQdeyIme57LajpimF; Fri, 21 Feb 2020 13:23:58 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=xs4all.nl; s=s1;
        t=1582287838; bh=LSzj4BV6XQvsaS/fTonnIN1W9yKWL2rUr6PJa/PmQSo=;
        h=To:From:Subject:Message-ID:Date:MIME-Version:Content-Type:From:
         Subject;
        b=
To:     "linux-kernel@vger.kernel.org" <linux-kernel@vger.kernel.org>
From:   Udo van den Heuvel <udovdh@xs4all.nl>
Subject: 5.4.x: PAGE FAULT crashes the system multiple times / 24h; question
 w.r.t. bisect
...
Organization: hierzo
Message-ID: <ed5dafef-8dc4-a797-1f4f-7180e38ef050@xs4all.nl>
Date:   Fri, 21 Feb 2020 13:23:57 +0100
...
X-CMAE-Envelope: 
...
About the bisect process for
https://bugzilla.kernel.org/show_bug.cgi?id=206191 I do have a question:

How does one circumvent a situation when a bisect kernel lands you a
non-bootable kernel?
How to still get closer to the offending commit?

Or any other advice/tips/etc for this bug?
