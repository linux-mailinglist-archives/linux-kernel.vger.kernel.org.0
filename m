...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 226A2120489
	for <lists+linux-kernel@lfdr.de>; Mon, 16 Dec 2019 12:57:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727504AbfLPL5F (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 16 Dec 2019 06:57:05 -0500
Received: from mail-wr1-f65.google.com ([209.85.221.65]:42925 "EHLO
        mail-wr1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727400AbfLPL5F (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 16 Dec 2019 06:57:05 -0500
Received: by mail-wr1-f65.google.com with SMTP id q6so6869352wro.9
        for <linux-kernel@vger.kernel.org>; Mon, 16 Dec 2019 03:57:02 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=nI2eF0pLA33DL1cw2jBXqt1A65moiDYVII29BaAAJKk=;
        b=
X-Gm-Message-State: APjAAAWD/NA/gjeR9E6rc4bMrnnGxO9Q50j4Mx40sTqRjpZu86bKfLlo
        nYSpmLkqK6dKr1XEsQYWMv7Tjg==
...
On Mon, 04 Nov 2019, Gene Chen wrote:
...
struct mt6360_pmu_ddata *ddata;

> +	unsigned int reg_data = 0;

Why does this have to be pre-initialised?
...
Is it possible for ret to be >0?

If not, just use "if (ret)".
...
This is not a very user friendly log message.

"Failed to get new dummy I2C device for address 0x%x", mt6360_slave_addr[i]
...
"Failed to register subordinate devices" or similar.
...
Use probe2 and you can remove this table.
