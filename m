...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9DDD14C537
	for <lists+linux-kernel@lfdr.de>; Thu, 20 Jun 2019 04:10:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731172AbfFTCJ4 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 19 Jun 2019 22:09:56 -0400
Received: from mga14.intel.com ([192.55.52.115]:47363 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726349AbfFTCJz (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 19 Jun 2019 22:09:55 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 19 Jun 2019 19:09:49 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.63,395,1557212400"; 
   d="yaml'?scan'208";a="170735840"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by orsmga002.jf.intel.com with ESMTP; 19 Jun 2019 19:09:45 -0700
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="ncX6roZrNNHXnAbh"
...
Content-Disposition: attachment; filename="config-5.2.0-rc3-00259-gede61ca"
...
export_top_env()
{
	...
	export ip=3D'ipv4'
	export runtime=3D600
	export nr_threads=3D144
	export cluster=3D'cs-localhost'
	export job_origin=3D'/lkp/lkp/.src-20190329-153112/allot/cyclic:p1:linux-d=
evel:devel-hourly/lkp-skl-fpga01/netperf-full-threads.yaml'
	export queue_cmdline_keys=3D'branch
commit
queue_at_least_once'
	export queue=3D'reconfirm'
	export testbox=3D'lkp-skl-2sp7'
	export tbox_group=3D'lkp-skl-2sp7'
	export submit_id=3D'5d0a43e68906482aa706e97f'
	export job_file=3D'/lkp/jobs/scheduled/lkp-skl-2sp7/netperf-cs-localhost-p=
erformance-ipv4-200%-600s-TCP_STREAM-debi-20190619-10919-vqus47-3.yaml'
	export id=3D'bfca49b6e349ff17a614a4f8db1adb471e5bf83e'
	export queuer_version=3D'/lkp/lkp/src'
	export commit=3D'ede61ca474a0348b975d9824565b66c7595461de'
	export kconfig=3D'x86_64-rhel-7.6'
	export compiler=3D'gcc-7'
	export enqueue_time=3D'2019-06-19 22:17:12 +0800'
	export _id=3D'5d0a43e68906482aa706e97f'
	export _rt=3D'/result/netperf/cs-localhost-performance-ipv4-200%-600s-TCP_=
STREAM/lkp-skl-2sp7/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/ede6=
1ca474a0348b975d9824565b66c7595461de'
	export user=3D'feng'
	export head_commit=3D'ba4a1063dddb878af29e0bdcd32377d29e74b75e'
	export base_commit=3D'8c2ffd9174779014c3fe1f96d9dc3641d9175f00'
	export branch=3D'linus/master'
	export result_root=3D'/result/netperf/cs-localhost-performance-ipv4-200%-6=
00s-TCP_STREAM/lkp-skl-2sp7/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gc=
c-7/ede61ca474a0348b975d9824565b66c7595461de/3'
	export scheduler_version=3D'/lkp/lkp/.src-20190619-163124'
...
user=3Dfeng
job=3D/lkp/jobs/scheduled/lkp-skl-2sp7/netperf-cs-localhost-performance-ipv=
4-200%-600s-TCP_STREAM-debi-20190619-10919-vqus47-3.yaml
ARCH=3Dx86_64
kconfig=3Dx86_64-rhel-7.6
branch=3Dlinus/master
commit=3Dede61ca474a0348b975d9824565b66c7595461de
BOOT_IMAGE=3D/pkg/linux/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b975d9824565b6=
6c7595461de/vmlinuz-5.2.0-rc3-00259-gede61ca
acpi_rsdp=3D0x6c030014
max_uptime=3D2400
RESULT_ROOT=3D/result/netperf/cs-localhost-performance-ipv4-200%-600s-TCP_S=
TREAM/lkp-skl-2sp7/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/ede61=
ca474a0348b975d9824565b66c7595461de/3
LKP_SERVER=3Dinn
debug
apic=3Ddebug
...
vga=3Dnormal
rw'
	export modules_initrd=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b=
975d9824565b66c7595461de/modules.cgz'
...
er_2016-11-24.cgz'
	export lkp_initrd=3D'/lkp/feng/lkp-x86_64.cgz'
	export site=3D'inn'
	export LKP_CGI_PORT=3D80
	export LKP_CIFS_PORT=3D139
	export repeat_to=3D5
...
2321P2OGN-part*'
	...
	export queue_at_least_once=3D0
	export kernel=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b975d9824=
565b66c7595461de/vmlinuz-5.2.0-rc3-00259-gede61ca'
	export dequeue_time=3D'2019-06-19 22:25:10 +0800'
	export node_roles=3D'server client'
	export job_initrd=3D'/lkp/jobs/scheduled/lkp-skl-2sp7/netperf-cs-localhost=
-performance-ipv4-200%-600s-TCP_STREAM-debi-20190619-10919-vqus47-3.cgz'
...
if role client:
  netperf:
    test: TCP_STREAM
job_origin: "/lkp/lkp/.src-20190329-153112/allot/cyclic:p1:linux-devel:devel-hourly/lkp-skl-fpga01/netperf-full-threads.yaml"
queue_cmdline_keys:
- user
queue: vip
testbox: lkp-skl-2sp7
tbox_group: lkp-skl-2sp7
submit_id: 5d09c7350b9a9337120961a0
job_file: "/lkp/jobs/scheduled/lkp-skl-2sp7/netperf-cs-localhost-performance-ipv4-200%-600s-TCP_STREAM-debian-x86-20190619-14098-v7hckx-wait_kernel-0.yaml"
id: 22181583dc1c1be5ef5eaf035d74fe26ecbbee18
queuer_version: "/lkp/feng/.src-20190614-171147"
kmsg: 
boot-time: 
iostat: 
heartbeat: 
...
compiler: gcc-7
enqueue_time: 2019-06-19 13:25:11.323702010 +08:00
_id: 5d09c7350b9a9337120961a0
_rt: "/result/netperf/cs-localhost-performance-ipv4-200%-600s-TCP_STREAM/lkp-skl-2sp7/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b975d9824565b66c7595461de"
user: feng
head_commit: ba4a1063dddb878af29e0bdcd32377d29e74b75e
base_commit: 8c2ffd9174779014c3fe1f96d9dc3641d9175f00
branch: linus/master
result_root: "/result/netperf/cs-localhost-performance-ipv4-200%-600s-TCP_STREAM/lkp-skl-2sp7/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b975d9824565b66c7595461de/0"
scheduler_version: "/lkp/lkp/.src-20190619-133416"
LKP_SERVER: inn
max_uptime: 2400
...
- root=/dev/ram0
- user=feng
- job=/lkp/jobs/scheduled/lkp-skl-2sp7/netperf-cs-localhost-performance-ipv4-200%-600s-TCP_STREAM-debian-x86-20190619-14098-v7hckx-wait_kernel-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linus/master
- commit=ede61ca474a0348b975d9824565b66c7595461de
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b975d9824565b66c7595461de/vmlinuz-5.2.0-rc3-00259-gede61ca
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b975d9824565b66c7595461de/modules.cgz"
...
lkp_initrd: "/lkp/feng/lkp-x86_64.cgz"
site: inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
...
#! schedule options
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/ede61ca474a0348b975d9824565b66c7595461de/vmlinuz-5.2.0-rc3-00259-gede61ca"
dequeue_time: 2019-06-19 13:50:21.491106974 +08:00

#! /lkp/lkp/.src-20190619-133416/include/site/inn

#! runtime status
job_state: finished
loadavg: 81.73 129.02 78.68 1/580 16669
start_time: '1560923467'
end_time: '1560924069'
version: "/lkp/feng/.src-20190614-171147"
...
netserver -4 -D
netperf -4 -H 127.0.0.1 -t TCP_STREAM -c -C -l 600  &
netperf -4 -H 127.0.0.1 -t TCP_STREAM -c -C -l 600  &
netperf -4 -H 127.0.0.1 -t TCP_STREAM -c -C -l 600  &
netperf -4 -H 127.0.0.1 -t TCP_STREAM -c -C -l 600  &
netperf -4 -H 127.0.0.1 -t TCP_STREAM -c -C -l 600  &
