...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id AFD7DE000D
	for <lists+linux-kernel@lfdr.de>; Tue, 22 Oct 2019 10:54:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387889AbfJVIyi (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 22 Oct 2019 04:54:38 -0400
Received: from mail-il1-f193.google.com ([209.85.166.193]:33741 "EHLO
        mail-il1-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731135AbfJVIyh (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 22 Oct 2019 04:54:37 -0400
Received: by mail-il1-f193.google.com with SMTP id v2so14693314ilm.0
        for <linux-kernel@vger.kernel.org>; Tue, 22 Oct 2019 01:54:36 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1+Y2oLc8CZxiBXT9nt5bQCVpd5pf4QmacmLCh5cRnlg=;
        b=
X-Gm-Message-State: APjAAAWpvfS6WzWehmbggcU0n0svZxNZrvZisMVJcit2wKjLmxHfYNUO
        CvXIIeAPPC9tPX5oH/wZJapp91F1F1UgjxRZH3A=
X-Google-Smtp-Source: APXvYqxC0s47o10/r96+giWBx+NAoiZqd0lYb3HnchfNR0i5SOS05ao2XsufBGXrllo74C/IoTl+6HdTTEqZyzm3PrU=
X-Received: by 2002:a05:6e02:cd3:: with SMTP id c19mr11407571ilj.266.1571734475430;
...
References: <1569338741-2784-1-git-send-email-gene.chen.richtek@gmail.com>
 ...
 <CAE+NS37TEcfxOy97WL0kQ2u8zM9sbROaEr-1b81hX2eoqh-sfg@mail.gmail.com> <20191016100438.GF4365@dell>
...
-history/+/master/Next/merge.log
>
> It's here:
>
> Merging mfd/for-mfd-next (38a6fc63a3ea mfd: db8500-prcmu: Example using n=
ew
...
>  include/linux/mfd/core.h     |  29 +++++++++                <=3D=3D=3D=
=3D=3D [THIS
> ONE]
...
>
> https://kernel.googlesource.com/pub/scm/linux/kernel/git/next/linux-next-=
history/+/master/Next/merge.log#4470
>
...
>> e.g. we pull this patch and build pass, new patch without add macro
>> define
>>
>> 2019-10-08 2:24 GMT+08:00, Gene Chen <gene.chen.richtek@gmail.com>:
>> > Hi Jones,
>> >
>> > Thanks for review, we will fix some comment which your suggestion in
>> > next
>> > patch
>> >
>> > Lee Jones <lee.jones@linaro.org> =E6=96=BC 2019=E5=B9=B410=E6=9C=884=
=E6=97=A5 =E9=80=B1=E4=BA=94 =E4=B8=8B=E5=8D=889:33=E5=AF=AB=E9=81=93=EF=BC=
=9A
>> >>
>> >> Wolfram,
>> >>
...
>> >> > +     }
>> >>
>> >> Please do not roll your own MACROS like this.  If they are helpful fo=
r
>> >> you, they are likely to be helpful for others.  However, this is your
>> >> lucky day, as we've been here before.  Please rebase onto the MFD tre=
e
...
>> >> > +     DEFINE_RES_IRQ_NAMED(MT6360_FLED2_SHORT_EVT,
>> >> > "fled2_short_evt"),
>> >> > +     DEFINE_RES_IRQ_NAMED(MT6360_FLED1_SHORT_EVT,
>> >> > "fled1_short_evt"),
...
>> > ACK
>> >
>> >> > +     ret =3D regmap_read(mpi->regmap, MT6360_PMU_DEV_INFO,
>> >> > &reg_data);
>> >> > +     if (ret < 0) {
...
>> >
>> >> > +     /* mfd cell register */
>> >> > +     ret =3D devm_mfd_add_devices(&client->dev, PLATFORM_DEVID_AUT=
O,
>> >> > +                                mt6360_devs,
...
>> >> > diff --git a/include/linux/mfd/mt6360.h b/include/linux/mfd/mt6360.=
h
>> >> > new file mode 100644
