...
Subject: [PATCH v4 09/11] mfd: cros_ec: Add convenience struct to define autodetectable CrOS EC subdevices
Date:   Thu, 27 Jun 2019 12:40:37 +0200
Message-Id: <20190627104039.26285-10-enric.balletbo@collabora.com>
...
index 72799331d804..73f186b9fda8 100644
...
@@ -69,6 +81,48 @@ static const struct cros_feature_to_name cros_mcu_devices[] = {
 	},
 };
...
@@ -294,30 +348,6 @@ static void cros_ec_accel_legacy_register(struct cros_ec_dev *ec)
...
-
 ...
 {
 	int retval = -ENOMEM;
@@ -378,42 +408,27 @@ static int ec_device_probe(struct platform_device *pdev)
