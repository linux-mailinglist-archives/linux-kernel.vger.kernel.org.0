...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1ECC91AF19
	for <lists+linux-kernel@lfdr.de>; Mon, 13 May 2019 05:17:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727447AbfEMDRR (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 12 May 2019 23:17:17 -0400
Received: from mga17.intel.com ([192.55.52.151]:20306 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727361AbfEMDRR (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 12 May 2019 23:17:17 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 12 May 2019 20:17:13 -0700
X-ExtLoop1: 1
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga001.fm.intel.com with ESMTP; 12 May 2019 20:17:10 -0700
Date:   Mon, 13 May 2019 11:17:33 +0800
...
Subject: [btrfs]  8d47a0d8f7:  fio.write_bw_MBps -28.6% regression
Message-ID: <20190513031733.GI31424@shao2-debian>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.1.0-rc7-00135-g8d47a0d8"
...
commit'
	...
	export testbox='lkp-hsw-ep2'
	export tbox_group='lkp-hsw-ep2'
	export submit_id='5cd6c4ae0b9a93043c1143ab'
	export job_file='/lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100-20190511-1084-vz8xr5-2.yaml'
	export id='f1120905fa7c70ed388aa5c21bddce34ba8384f3'
...
CONFIG_BTRFS_FS'
	export commit='8d47a0d8f7947422dd359ac8e462687f81a7a137'
	export kconfig='x86_64-rhel-7.6'
	export compiler='gcc-7'
	export rootfs='debian-x86_64-2018-04-03.cgz'
	export enqueue_time='2019-05-11 20:48:51 +0800'
	export _id='5cd6c4b40b9a93043c1143ac'
	export _rt='/result/fio-basic/4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-tb-ucode=0x3d/lkp-hsw-ep2/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137'
	export user='lkp'
	...
	export result_root='/result/fio-basic/4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-tb-ucode=0x3d/lkp-hsw-ep2/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100-20190511-1084-vz8xr5-2.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019051018
commit=8d47a0d8f7947422dd359ac8e462687f81a7a137
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137/vmlinuz-5.1.0-rc7-00135-g8d47a0d8
memmap=104G!4G
memmap=104G!132G
max_uptime=1200
RESULT_ROOT=/result/fio-basic/4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-tb-ucode=0x3d/lkp-hsw-ep2/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137/3
LKP_SERVER=inn
debug
apic=debug
...
rw'
	...
	export hdd_partitions='/dev/disk/by-id/ata-ST4000NM0033-9ZM170_Z1ZBJHKB-part1'
	export ssd_partitions='/dev/disk/by-id/ata-INTEL_SSDSC2BA800G3_BTTV451305A2800JGN-part1'
	export swap_partitions=
	export rootfs_partition='LABEL=LKP-ROOTFS'
	export brand='Intel(R) Xeon(R) CPU E5-2699 v3 @ 2.30GHz'
	export ucode='0x3d'
	export job_origin='/lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100-20190511-1084-vz8xr5-2.yaml'
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137/vmlinuz-5.1.0-rc7-00135-g8d47a0d8'
	export dequeue_time='2019-05-11 21:09:45 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100-20190511-1084-vz8xr5-2.cgz'
...
run_job()
{
	...
	run_setup rw='randwrite' bs='4k' ioengine='libaio' test_size='100G' $LKP_SRC/setup/fio-setup-basic
...
#! /lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-20190511-69764-1nqp59q-0.yaml
...
submit_id: 5cd6bec80b9a9310842054b8
job_file: "/lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-20190511-69764-1nqp59q-0.yaml"
id: 181ff6258732288555e6fad2a6447ca722ed1450
queuer_version: "/lkp/lkp/.src-20190510-135208"
arch: x86_64
...
enqueue_time: 2019-05-11 20:23:40.807104306 +08:00
_id: 5cd6bec80b9a9310842054b8
_rt: "/result/fio-basic/4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-tb-ucode=0x3d/lkp-hsw-ep2/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137"
...
branch: linux-devel/devel-hourly-2019051018
result_root: "/result/fio-basic/4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-tb-ucode=0x3d/lkp-hsw-ep2/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-20190511-69764-1nqp59q-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019051018
- commit=8d47a0d8f7947422dd359ac8e462687f81a7a137
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137/modules.cgz"
...
memory: 256G
nr_ssd_partitions: 1
hdd_partitions: "/dev/disk/by-id/ata-ST4000NM0033-9ZM170_Z1ZBJHKB-part1"
ssd_partitions: "/dev/disk/by-id/ata-INTEL_SSDSC2BA800G3_BTTV451305A2800JGN-part1"
swap_partitions: 
...
#! user overrides
job_origin: "/lkp/jobs/scheduled/lkp-hsw-ep2/fio-basic-4k-performance-2pmem-btrfs-libaio-50%-200s-randwrite-100G-20190511-69764-1nqp59q-0.yaml"
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/8d47a0d8f7947422dd359ac8e462687f81a7a137/vmlinuz-5.1.0-rc7-00135-g8d47a0d8"
dequeue_time: 2019-05-11 20:33:56.735790298 +08:00
...
rw=randwrite
directory=/fs/pmem1
numjobs=18' | fio --output-format=json -
umount /fs/pmem0
umount /fs/pmem1
