...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 617E922B37
	for <lists+linux-kernel@lfdr.de>; Mon, 20 May 2019 07:38:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730461AbfETFii (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 20 May 2019 01:38:38 -0400
Received: from mga12.intel.com ([192.55.52.136]:11843 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730381AbfETFif (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 20 May 2019 01:38:35 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga106.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 19 May 2019 22:38:33 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.60,490,1549958400"; 
   d="yaml'?scan'208";a="173508221"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga002.fm.intel.com with ESMTP; 19 May 2019 22:38:30 -0700
Date:   Mon, 20 May 2019 13:38:51 +0800
...
Message-ID: <20190520053851.GY31424@shao2-debian>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.1.0-00001-gf0996bc"
...
export_top_env()
{
	...
	export nr_threads=3D16
	export cluster=3D'cs-localhost'
	export queue_cmdline_keys=3D'branch
commit'
	export queue=3D'validate'
	export testbox=3D'lkp-hsw-d01'
	export tbox_group=3D'lkp-hsw-d01'
	export submit_id=3D'5ce006790b9a934d2e153146'
	export job_file=3D'/lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-pe=
rformance-ipv4-200%-300s-TCP_RR-ucode=3D0x27-20190518-85294-vbpjoe-3.yaml'
	export id=3D'a7336fe89954e052983a9ba5be82d103d57330fc'
	export queuer_version=3D'/lkp/lkp/.src-20190518-042017'
	export arch=3D'x86_64'
	export commit=3D'f0996bc2978e02d2ea898101462b960f6119b18f'
	export kconfig=3D'x86_64-rhel-7.6'
	export compiler=3D'gcc-7'
	export enqueue_time=3D'2019-05-18 21:19:58 +0800'
	export _id=3D'5ce0067e0b9a934d2e153147'
	export _rt=3D'/result/netperf/cs-localhost-performance-ipv4-200%-300s-TCP_=
RR-ucode=3D0x27/lkp-hsw-d01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gc=
c-7/f0996bc2978e02d2ea898101462b960f6119b18f'
	export user=3D'lkp'
	export head_commit=3D'd54e1fe175b9d38cadbe96c92117b1bcca683357'
	export base_commit=3D'e93c9c99a629c61837d5a7fc2120cd2b6c70dbdd'
	export branch=3D'linux-devel/devel-hourly-2019051616'
	export result_root=3D'/result/netperf/cs-localhost-performance-ipv4-200%-3=
00s-TCP_RR-ucode=3D0x27/lkp-hsw-d01/debian-x86_64-2019-05-14.cgz/x86_64-rhe=
l-7.6/gcc-7/f0996bc2978e02d2ea898101462b960f6119b18f/3'
...
user=3Dlkp
job=3D/lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-performance-ipv4=
-200%-300s-TCP_RR-ucode=3D0x27-20190518-85294-vbpjoe-3.yaml
ARCH=3Dx86_64
kconfig=3Dx86_64-rhel-7.6
branch=3Dlinux-devel/devel-hourly-2019051616
commit=3Df0996bc2978e02d2ea898101462b960f6119b18f
BOOT_IMAGE=3D/pkg/linux/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101462b9=
60f6119b18f/vmlinuz-5.1.0-00001-gf0996bc
max_uptime=3D1500
RESULT_ROOT=3D/result/netperf/cs-localhost-performance-ipv4-200%-300s-TCP_R=
R-ucode=3D0x27/lkp-hsw-d01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc=
-7/f0996bc2978e02d2ea898101462b960f6119b18f/3
LKP_SERVER=3Dinn
debug
apic=3Ddebug
...
vga=3Dnormal
rw'
	export modules_initrd=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2=
ea898101462b960f6119b18f/modules.cgz'
...
er_2016-11-24.cgz'
	...
	export brand=3D'Intel(R) Core(TM) i7-4770 CPU @ 3.40GHz'
	export ucode=3D'0x27'
	export rootfs=3D'debian-x86_64-2019-05-14.cgz'
	export job_origin=3D'/lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-=
performance-ipv4-200%-300s-TCP_RR-ucode=3D0x27-20190518-85294-vbpjoe-3.yaml'
	export kernel=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101=
462b960f6119b18f/vmlinuz-5.1.0-00001-gf0996bc'
	export dequeue_time=3D'2019-05-18 21:31:52 +0800'
	export node_roles=3D'server client'
	export job_initrd=3D'/lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-=
performance-ipv4-200%-300s-TCP_RR-ucode=3D0x27-20190518-85294-vbpjoe-3.cgz'
...
run_job()
{
	...
	if role client
	then
		run_test test=3D'TCP_RR' $LKP_SRC/tests/wrapper netperf
	fi
}
...
#! /lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-performance-ipv4-200%-300s-TCP_RR-ucode=0x27-d-20190518-39560-j5qfqt-0.yaml

#! /lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-performance-ipv4-20-20190516-3483-3ml475-0.yaml
...
submit_id: 5cdffb020b9a939a880b239a
job_file: "/lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-performance-ipv4-200%-300s-TCP_RR-ucode=0x27-d-20190518-39560-j5qfqt-0.yaml"
id: fc99cdf420e31ad6e5f8eca6fa063c6b4c20b2e4
queuer_version: "/lkp/lkp/.src-20190518-042017"
arch: x86_64
...
compiler: gcc-7
enqueue_time: 2019-05-18 20:31:02.838222778 +08:00
_id: 5cdffb020b9a939a880b239a
_rt: "/result/netperf/cs-localhost-performance-ipv4-200%-300s-TCP_RR-ucode=0x27/lkp-hsw-d01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101462b960f6119b18f"
...
result_root: "/result/netperf/cs-localhost-performance-ipv4-200%-300s-TCP_RR-ucode=0x27/lkp-hsw-d01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101462b960f6119b18f/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-performance-ipv4-200%-300s-TCP_RR-ucode=0x27-d-20190518-39560-j5qfqt-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019051616
- commit=f0996bc2978e02d2ea898101462b960f6119b18f
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101462b960f6119b18f/vmlinuz-5.1.0-00001-gf0996bc
- max_uptime=1500
- RESULT_ROOT=/result/netperf/cs-localhost-performance-ipv4-200%-300s-TCP_RR-ucode=0x27/lkp-hsw-d01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101462b960f6119b18f/0
- LKP_SERVER=inn
- debug
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101462b960f6119b18f/modules.cgz"
...
#! user overrides
job_origin: "/lkp/jobs/scheduled/lkp-hsw-d01/netperf-cs-localhost-performance-ipv4-200%-300s-TCP_RR-ucode=0x27-d-20190518-39560-j5qfqt-0.yaml"
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/f0996bc2978e02d2ea898101462b960f6119b18f/vmlinuz-5.1.0-00001-gf0996bc"
dequeue_time: 2019-05-18 21:05:26.142592130 +08:00

#! /lkp/lkp/.src-20190518-210139/include/site/inn
job_state: finished
loadavg: 15.53 11.31 5.04 1/167 4932
start_time: '1558184814'
end_time: '1558185116'
