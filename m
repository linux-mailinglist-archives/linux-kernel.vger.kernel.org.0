...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D6F1E38452
	for <lists+linux-kernel@lfdr.de>; Fri,  7 Jun 2019 08:29:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727324AbfFGG3T (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 7 Jun 2019 02:29:19 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:47205 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725962AbfFGG3S (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 7 Jun 2019 02:29:18 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45Kt0R2j96z9sNR;
        Fri,  7 Jun 2019 16:29:11 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1559888951;
        bh=QucryEqSK5uyW60QTFZvyev6rzv7nAKM+XuPAnouvQg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 7 Jun 2019 16:29:06 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 7
Message-ID: <20190607162906.73d12666@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/eb08pp8IWtwDHFEX/XFLDM0"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/eb08pp8IWtwDHFEX/XFLDM0
...
Non-merge commits (relative to Linus' tree): 4552
 4924 files changed, 175571 insertions(+), 167902 deletions(-)
...
Merging origin/master (16d72dd4891f Merge branch 'parisc-5.2-3' of git://gi=
...
Merging net/master (720f1de4021f pktgen: do not sleep with the thread lock =
held.)
...
Merging sound-asoc-fixes/for-linus (45b2461230bf Merge branch 'asoc-5.2' in=
to asoc-linus)
Merging regmap-fixes/for-linus (38ee2a8cc70e Merge branch 'regmap-5.2' into=
 regmap-linus)
Merging regulator-fixes/for-linus (2061c4be6a8e Merge branch 'regulator-5.2=
' into regulator-linus)
Merging spi-fixes/for-linus (25799698910e Merge branch 'spi-5.2' into spi-l=
inus)
...
Merging char-misc.current/char-misc-linus (e7bf2ce83747 Merge tag 'misc-hab=
analabs-fixes-2019-06-06' of git://people.freedesktop.org/~gabbayo/linux in=
to char-misc-linus)
...
Merging hwmon-fixes/hwmon (4a60570dce65 hwmon: (pmbus/core) Treat parameter=
...
Merging drm-fixes/drm-fixes (bcc9d0e346f9 Merge branch 'malidp-fixes' of gi=
t://linux-arm.org/linux-ld into drm-fixes)
...
' into next)
Merging amlogic/for-next (f3941d20431c Merge branch 'v5.3/drivers' into tmp=
/aml-rebuild)
...
Merging bcm2835/for-next (08e3c4158538 ARM: bcm283x: Enable DMA support for=
 SPI controller)
Merging imx-mxs/for-next (bb27e33181d8 Merge branch 'imx/defconfig' into fo=
r-next)
...
or32)
Merging parisc-hd/for-next (e626e6b4f4c3 parisc: add dynamic ftrace)
...
())
Merging cifs/for-next (28290abeaef1 Add SMB3.1.1 GCM to negotiated crypto a=
lgorigthms)
...
Merging hwmon-staging/hwmon-next (da4512d2a0ec hwmon: (core) Add comment de=
scribing how hwdev is freed in error path)
...
rq work request)
Merging net-next/master (96524ea4be04 Merge branch 'Xilinx-axienet-driver-u=
pdates')
...
Merging drm-intel/for-linux-next (ac543d7145bf drm/i915: Report an earlier =
wedged event when suspending the engines)
Merging drm-tegra/drm/tegra/for-next (f3b0d8793c16 drm/tegra: dpaux: Make V=
DD supply optional)
Merging drm-misc/for-linux-next (7355965da22b drm/vkms: Forward timer right=
 after drm_crtc_handle_vblank)
...
Merging sound-asoc/for-next (8320a046b9e3 Merge branch 'asoc-5.3' into asoc=
-next)
...
Merging regulator/for-next (2c447cd09251 Merge branch 'regulator-5.3' into =
regulator-next)
...
Merging spi/for-next (65b65b97734b Merge remote-tracking branch 'spi/topic/=
...
used variable)
Merging usb/usb-next (cf2b5010f416 usbip: Replace unused kvec array with si=
ngle variable in vhci_send_cmd_unlink())
...
rflow
Merging akpm/master (5763cc9941d6 drivers/media/platform/sti/delta/delta-ip=
...

=96Ri
-----END PGP SIGNATURE-----
