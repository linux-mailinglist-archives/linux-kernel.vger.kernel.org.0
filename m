...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3D355CE264
	for <lists+linux-kernel@lfdr.de>; Mon,  7 Oct 2019 14:56:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728152AbfJGMyI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 7 Oct 2019 08:54:08 -0400
Received: from mx1.redhat.com ([209.132.183.28]:33850 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728126AbfJGMyG (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 7 Oct 2019 08:54:06 -0400
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.phx2.redhat.com [10.5.11.14])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id E060510CC1E6;
        Mon,  7 Oct 2019 12:54:05 +0000 (UTC)
Received: from krava.brq.redhat.com (unknown [10.43.17.61])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 1C8835D9CC;
...
Subject: [PATCH 09/36] libperf: Add perf_mmap__consume() function
Date:   Mon,  7 Oct 2019 14:53:17 +0200
Message-Id: <20191007125344.14268-10-jolsa@kernel.org>
In-Reply-To: <20191007125344.14268-1-jolsa@kernel.org>
References: <20191007125344.14268-1-jolsa@kernel.org>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.14
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.6.2 (mx1.redhat.com [10.5.110.65]); Mon, 07 Oct 2019 12:54:06 +0000 (UTC)
...
Link: http://lore.kernel.org/lkml/20190913132355.21634-49-jolsa@kernel.org
...
index bb5130d02155..ed1e14a84be0 100644
...
@@ -3460,7 +3461,7 @@ static int trace__run(struct trace *trace, int argc, const char **argv)
 			if (err)
 				goto out_disable;
...
index ea46f325fa98..5b1859671fa8 100644
...
@@ -58,3 +61,32 @@ void perf_mmap__put(struct perf_mmap *map)
...
index bcfe0d1b6e63..4b508d7e8e99 100644
...
@@ -1749,7 +1750,7 @@ static void *perf_evlist__poll_thread(void *arg)
 				else
...
index 53f31053a27a..3c1546cadbfe 100644
