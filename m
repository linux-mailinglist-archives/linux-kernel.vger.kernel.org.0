...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 50AC02AD51
	for <lists+linux-kernel@lfdr.de>; Mon, 27 May 2019 05:15:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726377AbfE0DPs (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 26 May 2019 23:15:48 -0400
Received: from mga01.intel.com ([192.55.52.88]:9165 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725996AbfE0DPr (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 26 May 2019 23:15:47 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga101.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 26 May 2019 20:15:42 -0700
X-ExtLoop1: 1
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by orsmga001.jf.intel.com with ESMTP; 26 May 2019 20:15:37 -0700
Date:   Mon, 27 May 2019 11:15:56 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     Jan Kara <jack@suse.cz>
Cc:     Theodore Ts'o <tytso@mit.edu>, Ira Weiny <ira.weiny@intel.com>,
        LKML <linux-kernel@vger.kernel.org>, linux-ext4@vger.kernel.org,
        lkp@01.org
Subject: [ext4]  079f9927c7:  aim7.jobs-per-min 376.0% improvement
Message-ID: <20190527031556.GQ19312@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Jbyekxk18hnEXT0m"
...
commit'
	...
	export submit_id='5cea79640b9a934f371d8369'
	export job_file='/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-20190526-20279-14b38ss-3.yaml'
	export id='72592e3366913b80f28d5aa78b7b365986b97120'
	export queuer_version='/lkp/lkp/.src-20190525-175646'
	export arch='x86_64'
	export need_kconfig='CONFIG_LATENCYTOP=y
CONFIG_BLK_DEV_RAM=m
CONFIG_BLK_DEV=y
CONFIG_BLOCK=y
CONFIG_EXT4_FS'
	...
	export enqueue_time='2019-05-26 19:32:56 +0800'
	export _id='5cea79680b9a934f371d836a'
	export _rt='/result/aim7/performance-1BRD_48G-ext4-1000-creat-clo/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534'
	export user='lkp'
	export head_commit='fe0b7f1cd59dbbf13ebb124ad3643f355e77e333'
	export base_commit='a188339ca5a396acc588e5851ed7e19f66b0ebd9'
	export branch='linux-devel/devel-hourly-2019052605'
	export result_root='/result/aim7/performance-1BRD_48G-ext4-1000-creat-clo/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534/3'
	export scheduler_version='/lkp/lkp/.src-20190525-175646'
	export LKP_SERVER='inn'
	export max_uptime=1501.32
	export initrd='/osimage/debian/debian-x86_64-2018-04-03.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-20190526-20279-14b38ss-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019052605
...
max_uptime=1501
RESULT_ROOT=/result/aim7/performance-1BRD_48G-ext4-1000-creat-clo/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534/3
LKP_SERVER=inn
debug
apic=debug
...
rw'
	...
	export job_origin='/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-20190526-20279-14b38ss-3.yaml'
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534/vmlinuz-5.1.0-rc3-00039-g079f992'
	export dequeue_time='2019-05-26 19:38:47 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-20190526-20279-14b38ss-3.cgz'
...
run_job()
{
	...
	run_test test='creat-clo' load=1000 $LKP_SRC/tests/wrapper aim7
}
...
#! /lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-0-20190526-67254-t2af31-0.yaml

#! /lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-cr-20190525-49826-y9j7wu-0.yaml
...
submit_id: 5cea49090b9a9306b655dc21
job_file: "/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-0-20190526-67254-t2af31-0.yaml"
id: f32c905c73770511f682bdbff20977529f86d45d
...
enqueue_time: 2019-05-26 16:06:38.798121854 +08:00
_id: 5cea49090b9a9306b655dc21
_rt: "/result/aim7/performance-1BRD_48G-ext4-1000-creat-clo/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534"

#! schedule options
user: lkp
head_commit: fe0b7f1cd59dbbf13ebb124ad3643f355e77e333
base_commit: a188339ca5a396acc588e5851ed7e19f66b0ebd9
branch: linux-devel/devel-hourly-2019052605
result_root: "/result/aim7/performance-1BRD_48G-ext4-1000-creat-clo/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534/0"
scheduler_version: "/lkp/lkp/.src-20190525-175646"
LKP_SERVER: inn
max_uptime: 1501.32
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-0-20190526-67254-t2af31-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019052605
- commit=079f9927c7bfa026d963db1455197159ebe5b534
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534/modules.cgz"
...
#! /lkp/lkp/.src-20190525-175646/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! user overrides
job_origin: "/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-1BRD_48G-ext4-1000-creat-clo-debian-x86_64-2018-0-20190526-67254-t2af31-0.yaml"
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/079f9927c7bfa026d963db1455197159ebe5b534/vmlinuz-5.1.0-rc3-00039-g079f992"
dequeue_time: 2019-05-26 16:10:37.876162337 +08:00
job_state: finished
loadavg: 502.46 189.07 68.18 1/410 4813
start_time: '1558858320'
end_time: '1558858403'
version: "/lkp/lkp/.src-20190525-175646"
