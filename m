...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EAF05229C6
	for <lists+linux-kernel@lfdr.de>; Mon, 20 May 2019 03:56:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729158AbfETBzh (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 19 May 2019 21:55:37 -0400
Received: from ozlabs.org ([203.11.71.1]:49749 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726010AbfETBzg (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 19 May 2019 21:55:36 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 456hmy61jSz9s7h;
        Mon, 20 May 2019 11:55:30 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1558317330;
        bh=9k1/F3lfhVhalZcXKZ5MtPZIicJta2DJmEA6AFMn9l8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 20 May 2019 11:55:30 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 20
Message-ID: <20190520115530.46cf100d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/LNh.51/4xoe1ZCINgADYz=e"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/LNh.51/4xoe1ZCINgADYz=e
...
Merging origin/master (cb6f8739fbf9 Merge branch 'akpm' (patches from Andre=
w))
...
Merging bpf/master (9c3ddee12464 bpftool: fix BTF raw dump of FWD's fwd_kin=
d)
Merging ipsec/master (9b3040a6aafd ipv4: Define __ipv4_neigh_lookup_noref w=
hen CONFIG_INET is disabled)
Merging netfilter/master (ee8a2b95b737 Merge branch 'mlxsw-Two-port-module-=
fixes')
...
Merging staging.current/staging-linus (a6a4b66bd8f4 Merge tag 'for-linus-20=
190516' of git://git.kernel.dk/linux-block)
...
ion)
Merging nfs/linux-next (ff8583d6e4e3 Merge tag 'kbuild-v5.2-2' of git://git=
...
-next)
Merging i2c/i2c/for-next (b8f5fe3bc5b9 i2c: core: add device-managed versio=
n of i2c_new_dummy)
...
in struct tb_path)
Merging staging/staging-next (a6a4b66bd8f4 Merge tag 'for-linus-20190516' o=
...
rflow
Merging akpm/master (c6539c73f435 drivers/media/platform/sti/delta/delta-ip=
...

=4NoV
-----END PGP SIGNATURE-----
