...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 445724E7A6
	for <lists+linux-kernel@lfdr.de>; Fri, 21 Jun 2019 13:59:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727053AbfFUL7A (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 21 Jun 2019 07:59:00 -0400
Received: from mx1.redhat.com ([209.132.183.28]:41390 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726706AbfFUL6D (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
...
Subject: [PATCH v2 11/18] drm/ttm: switch ttm core from bo->resv to bo->base.resv
...
X-Greylist: Sender IP whitelisted, not delayed by milter-greylist-4.5.16 (mx1.redhat.com [10.5.110.32]); Fri, 21 Jun 2019 11:58:02 +0000 (UTC)
...
index 3e605b9ee2f3..e0792fd38b54 100644
...
@@ -1361,7 +1361,7 @@ int ttm_bo_init_reserved(struct ttm_bo_device *bdev,
...
@@ -1805,13 +1805,13 @@ int ttm_bo_wait(struct ttm_buffer_object *bo,
 	long timeout = 15 * HZ;
...
+	timeout = reservation_object_wait_timeout_rcu(bo->base.resv, true,
 	...
 	if (timeout < 0)
 		return timeout;
@@ -1819,7 +1819,7 @@ int ttm_bo_wait(struct ttm_buffer_object *bo,
 	if (timeout == 0)
 		return -EBUSY;
...
@@ -1935,7 +1935,7 @@ int ttm_bo_swapout(struct ttm_bo_global *glob, struct ttm_operation_ctx *ctx)
...
@@ -1973,14 +1973,14 @@ int ttm_bo_wait_unreserved(struct ttm_buffer_object *bo)
...
index 59f1b979b0da..a8671ec5f98a 100644
