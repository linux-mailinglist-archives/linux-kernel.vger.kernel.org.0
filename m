...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 13A2758117
	for <lists+linux-kernel@lfdr.de>; Thu, 27 Jun 2019 13:03:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726645AbfF0LDV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 27 Jun 2019 07:03:21 -0400
Received: from ozlabs.org ([203.11.71.1]:60515 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726315AbfF0LDV (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 27 Jun 2019 07:03:21 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45ZH7N5L9Qz9s8m;
        Thu, 27 Jun 2019 21:03:12 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1561633392;
        bh=FMgllKVAiIt9M5hm3DCPXFjg7m05EF0Dok0iyhFRNvg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 27 Jun 2019 21:03:11 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 27
Message-ID: <20190627210311.0c9d36a7@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/DSnXRxf6G9ZAFOGH8NVNUX_"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/DSnXRxf6G9ZAFOGH8NVNUX_
...
Merging net/master (13696531dc90 Merge branch 'ipv6-fix-neighbour-resolutio=
n-with-raw-socket')
...
go)
Merging netfilter/master (e7600865db32 netfilter: ctnetlink: Fix regression=
 in conntrack entry deletion)
...
Merging sound-asoc-fixes/for-linus (3c4d8340f960 Merge branch 'asoc-5.2' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (eb6398f27a61 Merge branch 'spi-5.2' into spi-l=
inus)
...
es)
Merging drm-misc-fixes/for-linux-next-fixes (41de4be6f6ef drm/virtio: move =
...
Merging arm64/for-next/core (7b71665603bb arm64: rename dump_instr as dump_=
kernel_instr)
...
Merging rockchip/for-next (0e4af765a740 Merge branch 'v5.3-armsoc/dts64' in=
to for-next)
...
Merging csky/linux-next (afa9fb9f5370 perf annotate csky: Add perf annotate=
 support)
...
Merging f2fs/dev (dfc06c892ea3 f2fs: fix is_idle() check for discard type)
...
Merging i2c/i2c/for-next (99dd4dc1524c Merge branch 'i2c/for-5.3' into i2c/=
for-next)
...
Merging jc_docs/docs-next (7c116d22ad23 docs: filesystems: Remove uneeded .=
rst extension on toctables)
...
Merging fbdev/fbdev-for-next (c2d3c8a42430 Merge tag 'topic/remove-fbcon-no=
tifiers-2019-06-26' of git://anongit.freedesktop.org/drm/drm-misc into fbde=
v-for-next)
...
efile
Merging net-next/master (8b89d8dad5df Merge branch 'macb-build-fixes')
...
Merging bpf-next/master (c492b90f2a96 Merge branch 'bpf-af-xdp-mlx5e')
...
Merging drm/drm-next (14808a12bdbd Merge tag 'drm-next-5.3-2019-06-25' of g=
...
Merging drm-intel/for-linux-next (5ed7a0cf3394 drm/i915: Move OA files to s=
eparate folder)
Merging drm-tegra/drm/tegra/for-next (eb7cf945a8da host1x: debugfs_create_d=
ir() can never return NULL)
Merging drm-misc/for-linux-next (daed277e4d5a Merge tag 'topic/remove-fbcon=
-notifiers-2019-06-26' into drm-misc-next-fixes)
...
Merging sound-asoc/for-next (0b766a156fab Merge remote-tracking branch 'aso=
...
Merging block/for-next (90823cf3ad6a Merge branch 'for-5.3/block' into for-=
next)
...
er)
Merging mfd/for-mfd-next (748fbb411bcc mfd: cs5535-mfd: Remove ifdef OLPC n=
oise)
CONFLICT (content): Merge conflict in include/linux/mfd/cros_ec_commands.h
Merging backlight/for-backlight-next (87194ef3d04f backlight: pwm_bl: Fix h=
...
Merging keys/keys-next (8adf4f91dc2d Merge tag 'keys-acl-20190626' into key=
s-next)
...
Merging spi/for-next (c0b21ad320f7 Merge remote-tracking branch 'spi/topic/=
...
Merging chrome-platform/for-next (0451cc8ce272 iio: cros_ec: Add lid angle =
driver)
...
Merging gpio/for-next (19cca7f21bcd Merge branch 'devel' into for-next)
Merging gpio-brgl/gpio/for-next (690499d969bc gpio: madera: Fixup SPDX head=
ers)
Merging pinctrl/for-next (8b887727a182 Merge branch 'devel' into for-next)
...
on-blocking)
Merging akpm-current/current (1699f10d7df6 include/linux/lz4.h: fix spellin=
...
rflow
Merging akpm/master (67cc272f90d6 drivers/media/platform/sti/delta/delta-ip=
...

=XR5W
-----END PGP SIGNATURE-----
