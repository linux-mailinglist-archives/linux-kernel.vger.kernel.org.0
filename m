...
Received: from nanos.tec.linutronix.de (localhost [IPv6:::1])
        by nanos.tec.linutronix.de (Postfix) with ESMTP id 33913104084
...
Subject: [patch V3 06/23] bug: Annotate WARN/BUG/stackfail as noinstr safe
