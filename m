...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8E676158250
	for <lists+linux-kernel@lfdr.de>; Mon, 10 Feb 2020 19:30:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727477AbgBJSaf (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 10 Feb 2020 13:30:35 -0500
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:32348 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726950AbgBJSae (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 10 Feb 2020 13:30:34 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1581359432;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
        bh=q/FFQFuE5ZjN0FyQs96OtAJ7mVxl6Vlq+KdzOl1+8Jc=;
        b=APwdIFue62WXh133+3qc24bOgl6YbUHq600e2kN1oL0+Go+XA2dCSG5+0Jv5gQ2C6SVqLa
        6V41v544hL96HFTLahWdlrtgo3SuoCqGqffTYxNbz+2rBdyF6FERd9BMjnxKVxB/nU6iie
        QmdYvUi7AaYSr91cRR9SOCM4MK+sZAI=
...
>> + Vasily for real
>>
>> On Fri, Feb 7, 2020, 11:02 PM Nick Desaulniers <ndesaulniers@google.co=
m>
>> wrote:
>>
...
> (with jump labels and ftrace disabled), thanks to contributions from Ar=
nd
> Bergmann. With asm goto support in clang 9 and now everything for ftrac=
e
> in place in clang 10 s390 kernel should be in a good shape feature wise
> (including KASAN). At this stage clang based tooling is the main intere=
st.
>=20
>>>
>>> Can I boot this in qemu?
>>>
> qemu tcg seems to work fine for gcc built s390 kernels. While clang bui=
lt
> kernels run smoothly natively and with accel=3Dkvm there is still somet=
hing
> to be fixed for accel=3Dtcg (kernel fails to boot on both s390 and x86)=
.
>=20
