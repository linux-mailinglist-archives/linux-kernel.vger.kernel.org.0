...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D314A1571DE
	for <lists+linux-kernel@lfdr.de>; Mon, 10 Feb 2020 10:38:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727567AbgBJJiW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 10 Feb 2020 04:38:22 -0500
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:59011 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1727507AbgBJJiW (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 10 Feb 2020 04:38:22 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1581327501;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
        bh=zC1wxKXo1uidgu4KRoB+bUUgf/UV+X7/Kq+jTW6HCAc=;
        b=L5Kw/NHzGQGXgVC7Lh2i5m/Zd2iQiwkYqVGQ3F1eaFkJoeiwXmF4a7I3jQUpp/2BmT7BIf
        QWkgPEVKasR2K+Xbr2Xl/dGJCtRDOyPm06E/vCulq3pgbKruZRig4cyO5BtPOemAb6tBrF
        OrVZV8SrwZYBoH9NbxD3TxwZP1nsMZY=
...
> Fix
>=20
>   drivers/virtio/virtio_balloon.c: In function =E2=80=98virtballoon_pro=
be=E2=80=99:
>   drivers/virtio/virtio_balloon.c:963:1: warning: label =E2=80=98out_de=
l_vqs=E2=80=99 defined but not used [-Wunused-label]
>     963 | out_del_vqs:
>         | ^~
>=20
...
> @@ -959,9 +959,9 @@ static int virtballoon_probe(struct virtio_device *=
vdev)
