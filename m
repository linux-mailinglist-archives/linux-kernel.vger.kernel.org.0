...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5D80084797
	for <lists+linux-kernel@lfdr.de>; Wed,  7 Aug 2019 10:36:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387608AbfHGIgV (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 7 Aug 2019 04:36:21 -0400
Received: from ozlabs.org ([203.11.71.1]:56515 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727541AbfHGIgV (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 7 Aug 2019 04:36:21 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 463Pws3rSZz9sDB;
        Wed,  7 Aug 2019 18:36:13 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1565166973;
        bh=rRkbDxYxODkVo3OIYrLKsZ4iWmJnd63YPo0t9WjkUvk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 7 Aug 2019 18:36:06 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 7
Message-ID: <20190807183606.372ca1a4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/iHOF1/wSn=_NSYqyIW2+SNW";
...
Merging origin/master (76d7961ff4ee Merge tag 'mips_fixes_5.3_1' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/mips/linux)
Merging fixes/master (609488bc979f Linux 5.3-rc2)
Merging kbuild-current/fixes (8bf63e8da5e5 kbuild: revive single target %.k=
o)
...
Merging sound-current/for-linus (c1c6c877b0c7 ALSA: hda - Don't override gl=
obal PCM hw info flag)
...
pend DP late)
Merging kspp-gustavo/for-next/kspp (5dfc1167928d scsi: fas216: Mark expecte=
...
Merging arm64/for-next/core (a36ed99a8cd7 Merge branch 'for-next/tbi' into =
for-next/core)
Applying: Revert "arm64: Add support for relocating the kernel with RELR re=
locations"
...
Merging qcom/for-next (753d0414f8c1 Merge branches 'arm64-for-5.4' and 'dri=
...
Merging sunxi/sunxi/for-next (5013ec0cdcf7 Merge branches 'sunxi/dt-for-5.4=
...
n whitespace)
Merging net-next/master (05bb520376af Merge branch '40GbE' of git://git.ker=
nel.org/pub/scm/linux/kernel/git/jkirsher/next-queue)
...
om xfrm_type)
Merging mlx5-next/mlx5-next (694a296024d4 net/mlx5: remove self-assignment =
on esw->dev)
...
.c
Merging drm-intel/for-linux-next (033a856c7368 drm/i915/dmc: Load DMC on TG=
L)
Merging drm-tegra/drm/tegra/for-next (2a6fc3cb5cb6 drm/tegra: Fix gpiod_get=
_from_of_node() regression)
Merging drm-misc/for-linux-next (178e5f3a5bc1 drm/crc-debugfs: Add notes ab=
out CRC<->commit interactions)
...
Merging block/for-next (de95f8645c6e Merge branch 'for-5.4/block' into for-=
next)
...
Merging usb/usb-next (c5d1653783ca Merge tag 'dev_groups_all_drivers' of gi=
t://git.kernel.org/pub/scm/linux/kernel/git/gregkh/driver-core into usb-nex=
t)
...
Merging tty/tty-next (480a98c73807 tty: serial: qcom_geni_serial: use devm_=
platform_ioremap_resource() to simplify code)
...
w location)
Merging akpm-current/current (ca26aeea8338 ipc/msg.c: consolidate all xxxct=
l_down() functions)
...
rflow
Merging akpm/master (24a3eaea5312 drivers/media/platform/sti/delta/delta-ip=
...

=orV5
-----END PGP SIGNATURE-----
