...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 949621128BA
	for <lists+linux-kernel@lfdr.de>; Wed,  4 Dec 2019 10:59:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727466AbfLDJ7F (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 4 Dec 2019 04:59:05 -0500
Received: from mga05.intel.com ([192.55.52.43]:11178 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726632AbfLDJ7F (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 4 Dec 2019 04:59:05 -0500
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga105.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 04 Dec 2019 01:58:59 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,277,1571727600"; 
   d="yaml'?scan'208";a="242778609"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga002.fm.intel.com with ESMTP; 04 Dec 2019 01:58:56 -0800
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="c6YcJYqqMhegfX14"
...
Content-Disposition: attachment; filename="config-4.20.0-rc1-00216-g344e9ffcbd189"
...
export_top_env()
{
	...
	export job_origin=3D'/lkp/lkp/.src-20191127-232954/allot/cyclic:p1:linux-d=
evel:devel-hourly/lkp-csl-2sp7/fsmark-1ssd.yaml'
...
queue_at_least_once'
	...
	export submit_id=3D'5de47518a94ce0819efb753c'
	export job_file=3D'/lkp/jobs/scheduled/lkp-csl-2sp7/fsmark-performance-1SS=
D-9B-xfs-1x-16d-256fpd-32t-fsyncBeforeClos-20191202-33182-uok9bo-3.yaml'
	export id=3D'efe88ebef5ba2d7b4d8105408cf054922212f21b'
...
CONFIG_NFSD
CONFIG_XFS_FS'
	export commit=3D'344e9ffcbd1898e1dc04085564a6e05c30ea8199'
...
CONFIG_SATA_AHCI'
	...
	export enqueue_time=3D'2019-12-02 10:21:17 +0800'
	export _id=3D'5de4751ea94ce0819efb753d'
	export _rt=3D'/result/fsmark/performance-1SSD-9B-xfs-1x-16d-256fpd-32t-fsy=
ncBeforeClose-400M-ucode=3D0x500002b/lkp-csl-2sp7/debian-x86_64-2019-09-23.=
cgz/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199'
	export user=3D'lkp'
	export head_commit=3D'882c7aae4a15dd26a483ea518919544160045f90'
	export base_commit=3D'219d54332a09e8d8741c1e1982f5eae56099de85'
	export branch=3D'linux-devel/devel-hourly-2019112619'
	export result_root=3D'/result/fsmark/performance-1SSD-9B-xfs-1x-16d-256fpd=
-32t-fsyncBeforeClose-400M-ucode=3D0x500002b/lkp-csl-2sp7/debian-x86_64-201=
9-09-23.cgz/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199/=
3'
	export scheduler_version=3D'/lkp/lkp/.src-20191201-135720'
	export LKP_SERVER=3D'inn'
	export max_uptime=3D1281.8400000000001
	export initrd=3D'/osimage/debian/debian-x86_64-2019-09-23.cgz'
	export bootloader_append=3D'root=3D/dev/ram0
user=3Dlkp
job=3D/lkp/jobs/scheduled/lkp-csl-2sp7/fsmark-performance-1SSD-9B-xfs-1x-16=
d-256fpd-32t-fsyncBeforeClos-20191202-33182-uok9bo-3.yaml
ARCH=3Dx86_64
kconfig=3Dx86_64-rhel-7.6
branch=3Dlinux-devel/devel-hourly-2019112619
commit=3D344e9ffcbd1898e1dc04085564a6e05c30ea8199
BOOT_IMAGE=3D/pkg/linux/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e=
05c30ea8199/vmlinuz-4.20.0-rc1-00216-g344e9ffcbd189
max_uptime=3D1281
RESULT_ROOT=3D/result/fsmark/performance-1SSD-9B-xfs-1x-16d-256fpd-32t-fsyn=
cBeforeClose-400M-ucode=3D0x500002b/lkp-csl-2sp7/debian-x86_64-2019-09-23.c=
gz/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199/3
LKP_SERVER=3Dinn
debug
apic=3Ddebug
...
vga=3Dnormal
rw'
	export modules_initrd=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1=
dc04085564a6e05c30ea8199/modules.cgz'
...
debian-x86_64-2018-04-03.cgz/fsmark_2018-05-17.cgz,/osimage/pkg/debian-x86_=
64-2018-04-03.cgz/fsmark-x86_64-3.3-1_2019-10-10.cgz,/osimage/deps/debian-x=
86_64-2018-04-03.cgz/mpstat_2019-10-10.cgz,/osimage/deps/debian-x86_64-2018=
-04-03.cgz/vmstat_2019-10-11.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz=
/turbostat_2019-10-11.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/turbost=
at-x86_64-3.7-4_2019-10-11.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/p=
erf_2019-10-10.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/perf-x86_64-6c=
9594bdd474-1_2019-11-16.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/sar-x=
86_64-c582fe4-1_2019-10-10.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/h=
w_2019-10-09.cgz'
	export lkp_initrd=3D'/osimage/user/lkp/lkp-x86_64.cgz'
	export site=3D'inn'
	export LKP_CGI_PORT=3D80
	export LKP_CIFS_PORT=3D139
	export last_kernel=3D'5.4.0-zen-09917-g882c7aae4a15d'
	export repeat_to=3D4
	export schedule_notify_address=3D
	export queue_at_least_once=3D1
	export kernel=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc040855=
64a6e05c30ea8199/vmlinuz-4.20.0-rc1-00216-g344e9ffcbd189'
	export dequeue_time=3D'2019-12-02 10:27:21 +0800'
	export job_initrd=3D'/lkp/jobs/scheduled/lkp-csl-2sp7/fsmark-performance-1=
SSD-9B-xfs-1x-16d-256fpd-32t-fsyncBeforeClos-20191202-33182-uok9bo-3.cgz'
...
run_job()
{
	...
	run_test filesize=3D'9B' test_size=3D'400M' sync_method=3D'fsyncBeforeClos=
e' nr_directories=3D'16d' nr_files_per_directory=3D'256fpd' $LKP_SRC/tests/=
wrapper fsmark
}
...
fsmark:
  ...
  nr_directories: 16d
  nr_files_per_directory: 256fpd
job_origin: "/lkp/lkp/.src-20191127-232954/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2sp7/fsmark-1ssd.yaml"
...
submit_id: 5de452eba94ce07f273101cb
job_file: "/lkp/jobs/scheduled/lkp-csl-2sp7/fsmark-performance-1SSD-9B-xfs-1x-16d-256fpd-32t-fsyncBeforeClose--20191202-32551-fz2jck-0.yaml"
id: 94c255c6c147e539e689caffa962d5bacd9d2d76
...
enqueue_time: 2019-12-02 07:56:43.337883594 +08:00
_id: 5de452eba94ce07f273101cb
_rt: "/result/fsmark/performance-1SSD-9B-xfs-1x-16d-256fpd-32t-fsyncBeforeClose-400M-ucode=0x500002b/lkp-csl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199"
...
result_root: "/result/fsmark/performance-1SSD-9B-xfs-1x-16d-256fpd-32t-fsyncBeforeClose-400M-ucode=0x500002b/lkp-csl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199/0"
scheduler_version: "/lkp/lkp/.src-20191201-135720"
LKP_SERVER: inn
max_uptime: 1281.8400000000001
initrd: "/osimage/debian/debian-x86_64-2019-09-23.cgz"
bootloader_append:
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2sp7/fsmark-performance-1SSD-9B-xfs-1x-16d-256fpd-32t-fsyncBeforeClose--20191202-32551-fz2jck-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019112619
- commit=344e9ffcbd1898e1dc04085564a6e05c30ea8199
- BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199/vmlinuz-4.20.0-rc1-00216-g344e9ffcbd189
- max_uptime=1281
- RESULT_ROOT=/result/fsmark/performance-1SSD-9B-xfs-1x-16d-256fpd-32t-fsyncBeforeClose-400M-ucode=0x500002b/lkp-csl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199/0
- LKP_SERVER=inn
- debug
...
#! runtime status
last_kernel: 4.19.0-rc8-00076-g523983401644e
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/344e9ffcbd1898e1dc04085564a6e05c30ea8199/vmlinuz-4.20.0-rc1-00216-g344e9ffcbd189"
dequeue_time: 2019-12-02 09:00:18.633103108 +08:00

#! /lkp/lkp/.src-20191201-135720/include/site/inn
job_state: finished
loadavg: 3.46 0.96 0.33 2/883 3245
start_time: '1575248564'
end_time: '1575248572'
version: "/lkp/lkp/.src-20191201-135819:a73982f2:516cb43fd-dirty"
