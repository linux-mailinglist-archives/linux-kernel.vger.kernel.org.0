...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 42229C8A73
	for <lists+linux-kernel@lfdr.de>; Wed,  2 Oct 2019 16:05:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727691AbfJBOF2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 2 Oct 2019 10:05:28 -0400
Received: from mga07.intel.com ([134.134.136.100]:35311 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726087AbfJBOF1 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 2 Oct 2019 10:05:27 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by orsmga105.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 02 Oct 2019 07:05:21 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,574,1559545200"; 
   d="yaml'?scan'208";a="221413626"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga002.fm.intel.com with ESMTP; 02 Oct 2019 07:05:17 -0700
Date:   Wed, 2 Oct 2019 22:05:03 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     Kairui Song <kasong@redhat.com>
Cc:     Thomas Gleixner <tglx@linutronix.de>, Baoquan He <bhe@redhat.com>,
        Jiri Bohac <jbohac@suse.cz>, Borislav Petkov <bp@alien8.de>,
...
Content-Disposition: attachment; filename="config-5.1.0-rc1-00013-gffc8599aa9763"
...
export_top_env()
{
	...
	export nr_task=192
	export job_origin='/lkp/lkp/.src-20190927-163923/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2ap4/will-it-scale-100.yaml'
...
queue_at_least_once'
	...
	export submit_id='5d91bdbbfbc7a42f659214df'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap4/will-it-scale-performance-thread-100%-sched_yield-debian-x86_64--20190930-12133-1ymt0op-3.yaml'
	export id='25e42a7d2b358cf2685ac6d96cfc3589cb39994f'
	...
	export commit='ffc8599aa9763f39f6736a79da4d1575e7006f9a'
	export need_kconfig_hw='CONFIG_IGB=y'
	export kconfig='x86_64-rhel-7.6'
	export compiler='gcc-7'
	export rootfs='debian-x86_64-2019-05-14.cgz'
	export enqueue_time='2019-09-30 16:35:09 +0800'
	export _id='5d91be3efbc7a42f659214e0'
	export _rt='/result/will-it-scale/performance-thread-100%-sched_yield/lkp-csl-2ap4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a'
	export user='lkp'
	...
	export result_root='/result/will-it-scale/performance-thread-100%-sched_yield/lkp-csl-2ap4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/3'
	export scheduler_version='/lkp/lkp/.src-20190930-112729'
	export LKP_SERVER='inn'
	export max_uptime=1500
	export initrd='/osimage/debian/debian-x86_64-2019-05-14.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap4/will-it-scale-performance-thread-100%-sched_yield-debian-x86_64--20190930-12133-1ymt0op-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019092903
commit=ffc8599aa9763f39f6736a79da4d1575e7006f9a
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/vmlinuz-5.1.0-rc1-00013-gffc8599aa9763
acpi_rsdp=0x67f44014
max_uptime=1500
RESULT_ROOT=/result/will-it-scale/performance-thread-100%-sched_yield/lkp-csl-2ap4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/3
LKP_SERVER=inn
debug
apic=debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/vmlinuz-5.1.0-rc1-00013-gffc8599aa9763'
	export dequeue_time='2019-09-30 16:42:44 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap4/will-it-scale-performance-thread-100%-sched_yield-debian-x86_64--20190930-12133-1ymt0op-3.cgz'
...
will-it-scale:
  mode: thread
  test: sched_yield
job_origin: "/lkp/lkp/.src-20190927-163923/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2ap4/will-it-scale-100.yaml"
...
submit_id: 5d9196f3fbc7a429b790c2a9
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap4/will-it-scale-performance-thread-100%-sched_yield-debian-x86_64-20-20190930-10679-10u9m2z-0.yaml"
id: b6179874303524f735dd618eb42ee701e069a781
...
enqueue_time: 2019-09-30 13:49:08.809402946 +08:00
_id: 5d9196f3fbc7a429b790c2a9
_rt: "/result/will-it-scale/performance-thread-100%-sched_yield/lkp-csl-2ap4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a"
...
branch: linux-devel/devel-hourly-2019092903
result_root: "/result/will-it-scale/performance-thread-100%-sched_yield/lkp-csl-2ap4/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/0"
scheduler_version: "/lkp/lkp/.src-20190930-112729"
LKP_SERVER: inn
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap4/will-it-scale-performance-thread-100%-sched_yield-debian-x86_64-20-20190930-10679-10u9m2z-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019092903
- commit=ffc8599aa9763f39f6736a79da4d1575e7006f9a
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/ffc8599aa9763f39f6736a79da4d1575e7006f9a/vmlinuz-5.1.0-rc1-00013-gffc8599aa9763"
dequeue_time: 2019-09-30 14:04:20.995294992 +08:00

#! /lkp/lkp/.src-20190930-112729/include/site/inn
job_state: finished
loadavg: 136.86 114.66 52.45 1/1304 12318
start_time: '1569823533'
end_time: '1569823835'
version: "/lkp/lkp/.src-20190930-112754"
...
do
 ...
 "python2" "./runtest.py" "sched_yield" "295" "thread" "192"
