...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8109A172AA
	for <lists+linux-kernel@lfdr.de>; Wed,  8 May 2019 09:34:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727208AbfEHHeL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 8 May 2019 03:34:11 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:42883 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727124AbfEHHeK (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 8 May 2019 03:34:10 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 44zSs91Ykdz9s4V;
        Wed,  8 May 2019 17:34:05 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1557300845;
        bh=O7pJIGZBWqKa93GZ7dEkVaCD9JPbgH8/JiadPx+mOy4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 8 May 2019 17:34:03 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 8
Message-ID: <20190508173403.6088d0db@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/n2SVV+yVZ=OX/umbMMXmqpd"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/n2SVV+yVZ=OX/umbMMXmqpd
...
Merging origin/master (f678d6da7499 Merge tag 'char-misc-5.2-rc1-part2' of =
...
Merging net/master (a3147770bea7 cxgb4: Fix error path in cxgb4_init_module)
Merging bpf/master (a3147770bea7 cxgb4: Fix error path in cxgb4_init_module)
Merging ipsec/master (9b3040a6aafd ipv4: Define __ipv4_neigh_lookup_noref w=
hen CONFIG_INET is disabled)
Merging netfilter/master (8cd2bc981c53 netfilter: nf_flow_table: do not flo=
w offload deleted conntrack entries)
...
b)
Merging sound-current/for-linus (d4c2ccdb5855 ALSA: hda/intel: add CometLak=
e PCI IDs)
CONFLICT (content): Merge conflict in MAINTAINERS
Merging sound-asoc-fixes/for-linus (d7ac306f9026 Merge branch 'asoc-5.1' in=
to asoc-linus)
...
Merging crypto-current/master (e59f755ceb6d crypto: ccree - use a proper le=
32 type for le32 val)
...
Merging kbuild/for-next (289aebbc5c16 Merge branch 'kconfig' into for-next)
...
Merging amlogic/for-next (d95bbb5a106c Merge branch 'v5.2/fixes' into tmp/a=
ml-rebuild)
...
Merging mips/mips-next (3751cbda8f22 mips: Manually call fdt_init_reserved_=
mem() method)
...
or32)
Merging parisc-hd/for-next (62217beb394e parisc: Add static branch and JUMP=
_LABEL feature)
Merging powerpc/next (04a1942933ce powerpc/mm: Fix hugetlb page initializat=
ion)
...
Merging s390/features (5c781de835b6 s390/qdio: optimize state inspection of=
 HW-owned SBALs)
...
g with remount)
Merging cifs/for-next (b00c40f57bd5 cifs: fix strcat buffer overflow and re=
duce raciness in smb21_set_oplock_level())
...
Merging ext4/dev (db90f41916cf ext4: export /sys/fs/ext4/feature/casefold i=
f Unicode support is present)
Merging f2fs/dev (0ca9337b2583 f2fs: fix to avoid potential race on sbi->un=
usable_block_count access/update)
Merging fuse/for-next (829f949b6e06 fuse: clean up fuse_alloc_inode)
CONFLICT (content): Merge conflict in fs/fuse/inode.c
Merging jfs/jfs-next (a5fdd713d256 jfs: fix bogus variable self-initializat=
ion)
Merging nfs/linux-next (e93c9c99a629 Linux 5.1)
Merging nfs-anna/linux-next (3be130ebda76 NFSv4: don't mark all open state =
for recovery when handling recallable state revoked flag)
...
Merging overlayfs/overlayfs-next (98487de318a6 ovl: check the capability be=
fore cred overridden)
Merging ubifs/linux-next (04d37e5a8b1f ubi: wl: Fix uninitialized variable)
CONFLICT (content): Merge conflict in fs/ubifs/auth.c
...
ing' into for-next)
Merging pci/next (a74b0eec81e7 Merge branch 'pci/trivial')
...
r TMP75B)
Merging jc_docs/docs-next (d9defe448f4c docs/livepatch: Unify style of live=
patch documentation in the ReST format)
...
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
zoran/zr36060.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zr36060.c deleted in =
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
zoran/zr36060.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zr36057.h deleted in =
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
zoran/zr36057.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zr36050.h deleted in =
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
zoran/zr36050.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zr36050.c deleted in =
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
zoran/zr36050.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zr36016.h deleted in =
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
zoran/zr36016.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zr36016.c deleted in =
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
zoran/zr36016.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran_procfs.h delete=
d in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/m=
edia/zoran/zoran_procfs.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran_procfs.c delete=
d in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/m=
edia/zoran/zoran_procfs.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran_driver.c delete=
d in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/m=
edia/zoran/zoran_driver.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran_device.h delete=
d in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/m=
edia/zoran/zoran_device.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran_device.c delete=
d in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/m=
edia/zoran/zoran_device.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran_card.h deleted =
in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/med=
ia/zoran/zoran_card.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran_card.c deleted =
in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/med=
ia/zoran/zoran_card.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/zoran.h deleted in v4=
l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/zo=
ran/zoran.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/videocodec.h deleted =
in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/med=
ia/zoran/videocodec.h left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/videocodec.c deleted =
in v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/med=
ia/zoran/videocodec.c left in tree.
CONFLICT (modify/delete): drivers/staging/media/zoran/Kconfig deleted in v4=
l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/zo=
ran/Kconfig left in tree.
CONFLICT (modify/delete): drivers/staging/media/mt9t031/Makefile deleted in=
 v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media=
/mt9t031/Makefile left in tree.
CONFLICT (modify/delete): drivers/staging/media/mt9t031/Kconfig deleted in =
v4l-dvb/master and modified in HEAD. Version HEAD of drivers/staging/media/=
mt9t031/Kconfig left in tree.
$ git rm -f drivers/staging/media/mt9t031/Kconfig drivers/staging/media/mt9=
t031/Makefile drivers/staging/media/zoran/Kconfig drivers/staging/media/zor=
an/videocodec.c drivers/staging/media/zoran/videocodec.h drivers/staging/me=
dia/zoran/zoran.h drivers/staging/media/zoran/zoran_card.c drivers/staging/=
media/zoran/zoran_card.h drivers/staging/media/zoran/zoran_device.c drivers=
/staging/media/zoran/zoran_device.h drivers/staging/media/zoran/zoran_drive=
r.c drivers/staging/media/zoran/zoran_procfs.c drivers/staging/media/zoran/=
zoran_procfs.h drivers/staging/media/zoran/zr36016.c drivers/staging/media/=
zoran/zr36016.h drivers/staging/media/zoran/zr36050.c drivers/staging/media=
/zoran/zr36050.h drivers/staging/media/zoran/zr36057.h drivers/staging/medi=
a/zoran/zr36060.c drivers/staging/media/zoran/zr36060.h
...
Merging rdma/for-next (943bd984b108 RDMA/core: Allow detaching gid attribut=
e netdevice for RoCE)
Merging net-next/master (a9e41a529681 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/davem/net)
...
Merging bpf-next/master (23bfaa594002 net: phy: improve pause mode reportin=
g in phy_print_status)
...
et)
Merging netfilter-next/master (54516da1ea85 Merge branch 'r8169-replace-som=
e-magic-with-more-speaking-functions')
...
Merging gfs2/for-next (f4686c26ecc3 gfs2: read journal in large chunks)
...
for le32 val)
Merging drm/drm-next (30d62d4453e4 drm: add non-desktop quirk for Valve HMD=
s)
...
Merging amdgpu/drm-next (1828c3e36a3d drm/amd/display: Expose send immediat=
e sdp message interface)
Merging drm-intel/for-linux-next (23372cce8fe7 Merge tag 'gvt-next-fixes-20=
19-05-07' of https://github.com/intel/gvt-linux into drm-intel-next-fixes)
...
Merging drm-misc/for-linux-next (0cbd0adc4429 drm: Fix timestamp docs for v=
ariable refresh properties.)
...
-next)
Merging sound/for-next (d4c2ccdb5855 ALSA: hda/intel: add CometLake PCI IDs)
Merging sound-asoc/for-next (9cd95a591bd1 Merge branch 'asoc-5.2' into asoc=
-next)
...
Merging input/next (0981949da8f7 Input: libps2 - mark expected switch fall-=
through)
CONFLICT (content): Merge conflict in Documentation/devicetree/bindings/ven=
dor-prefixes.txt
Merging block/for-next (b3446034e757 Merge branch 'for-5.2/io_uring' into f=
or-next)
...
Applying: gfs2: fix for "block: remove the i argument to bio_for_each_segme=
nt_all"
Merging device-mapper/for-next (88ad5d1eb147 dm integrity: update documenta=
tion)
...
Merging battery/for-next (9a2688e42638 power: supply: Add driver for Microc=
hip UCS1002)
...
et random")
Merging watchdog/master (e9974166a53a watchdog: stm32: add dynamic prescale=
r support)
...
Merging vfio/next (405ecbf72f2e vfio/mdev: Avoid inline get and put parent =
helpers)
...
Merging drivers-x86/for-next (2c7b8fa89998 platform/x86: asus-wmi: Add fn-l=
ock mode switch support)
...
s is present)
Merging driver-core/driver-core-next (70e16a620e07 kobject: clean up the ko=
bject add documentation a bit more)
Merging usb/usb-next (3515468a87a4 Merge tag 'usb-for-v5.2' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/balbi/usb into usb-next)
...
ART)
Merging char-misc/char-misc-next (aad14ad3cf3a intel_th: msu: Add current w=
indow tracking)
...
in struct tb_path)
Merging staging/staging-next (e2a5be107f52 staging: kpc2000: kpc_spi: Fix b=
uild error for {read,write}q)
...
nel status)
Merging cgroup/for-next (326b27854a9c Merge branch 'for-5.2' into for-next)
...
_entropy)
Merging kselftest/next (fdeb89d84eb2 rseq/selftests: add -no-integrated-as =
for clang)
...
el)
Merging rtc/rtc-next (6950394bc567 rtc: snvs: Use __maybe_unused instead of=
 #if CONFIG_PM_SLEEP)
...
rflow
Merging akpm/master (563646f730d5 drivers/media/platform/sti/delta/delta-ip=
...

=7xSE
-----END PGP SIGNATURE-----
