...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9DB095BBF3
	for <lists+linux-kernel@lfdr.de>; Mon,  1 Jul 2019 14:42:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729165AbfGAMmi (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 1 Jul 2019 08:42:38 -0400
Received: from ozlabs.org ([203.11.71.1]:57225 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727049AbfGAMmh (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 1 Jul 2019 08:42:37 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45cn876DcWz9sPH;
        Mon,  1 Jul 2019 22:42:31 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1561984952;
        bh=3ebGopFxH/JEDO0nemTjb7/K8Wx6CJIAq0Y9qHiQxnI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 1 Jul 2019 22:42:28 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 1
Message-ID: <20190701224228.54324e0e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/J=iX_v4CasDpXmAfdrd4RNW"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/J=iX_v4CasDpXmAfdrd4RNW
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20190628:

The dma-mapping tree gained a conflict against Linus' tree.

The xfs tree gained conflicts against the f2fs tree and a build failure
so I used the version from next-20190628.

The pm tree gained a conflict against the pci tree and a build failure,
so I used the version fron next-20190628.

The rdma tree gained build failures so I used the version from
next-20190628.
...
The pidfd tree gained conflicts against Linus' tree.

The hmm tree gained build failures due to interactions with the tip and
drm trees for which I added a merge fix patch abd disabled a driver.

Non-merge commits (relative to Linus' tree): 10153
 9934 files changed, 801739 insertions(+), 292252 deletions(-)
...
Merging net/master (7b75e49de424 net: dsa: mv88e6xxx: wait after reset deac=
tivation)
...
go)
Merging netfilter/master (5d1549847c76 netfilter: Fix remainder of pseudo-h=
eader protocol 0)
...
Merging sound-current/for-linus (c3ea60c23144 ALSA: seq: fix incorrect orde=
r of dest_client/dest_ports arguments)
...
ext-fixes)
Merging vfs-fixes/fixes (9154d54e687a vfs: move_mount: reject moving kernel=
 internal mounts)
...
Merging arm64/for-next/core (b07d7d5c7b42 x86/entry: Simplify _TIF_SYSCALL_=
EMU handling)
...
' into next)
Merging amlogic/for-next (e754c3451b9a Merge branch 'v5.3/fixes' into tmp/a=
ml-rebuild)
...
Merging csky/linux-next (d7cbdef1ca6b csky: Fixup abiv1 memset error)
...
_init)
Merging xfs/for-next (332b9caf2d7b Merge remote-tracking branch 'korg/vfs-5=
.3-merge' into for-next-5.3)
CONFLICT (content): Merge conflict in fs/f2fs/file.c
$ git reset --hard HEAD^
Merging next-20190628 version of xfs
...
Merging hwmon-staging/hwmon-next (479a503fa073 hwmon: (lm90) Fix max6658 sp=
oradic wrong temperature reading)
...
Merging pm/linux-next (4c18beedaeb0 Merge branch 'pm-cpufreq' into linux-ne=
xt)
CONFLICT (content): Merge conflict in Documentation/power/pm_qos_interface.=
rst
$ git reset --hard HEAD^
Merging next-20190628 version of pm
...
$ git rm -f drivers/infiniband/hw/nes/Kconfig drivers/infiniband/hw/nes/Mak=
efile
[master fe088f24267d] next-20190628/rdma
Merging net-next/master (954a5a029472 Merge tag 'mlx5e-updates-2019-06-28' =
...
Merging mlx5-next/mlx5-next (92ab1eb392c6 net/mlx5: E-Switch, Enable vport =
...
Merging wireless-drivers-next/master (1375da478712 Merge tag 'iwlwifi-next-=
for-kalle-2019-06-29' of git://git.kernel.org/pub/scm/linux/kernel/git/iwlw=
ifi/iwlwifi-next)
Merging bluetooth/master (f072218cca5b r8169: remove not needed call to dma=
...
Merging amdgpu/drm-next (440e80ce02cd drm/amd/display: fix a couple of spel=
ling mistakes)
Merging drm-intel/for-linux-next (501ec325f1ec drm/i915: rework reading pip=
e disable fuses)
Merging drm-tegra/drm/tegra/for-next (eb7cf945a8da host1x: debugfs_create_d=
ir() can never return NULL)
Merging drm-misc/for-linux-next (dd2b5959785c drm/bochs: fix framebuffer se=
tup.)
...
-next)
Merging sound/for-next (973b059ca980 ALSA: firewire-lib: fix to process MID=
I conformant data channel for AM824 format)
...
Merging input/next (8d3c60c7688e Input: joydev - extend absolute mouse dete=
ction)
...
Merging drivers-x86/for-next (368bae878878 platform/x86: acer-wmi: Mark exp=
ected switch fall-throughs)
...
Merging rpmsg/for-next (89769d9f487c Merge branches 'hwspinlock-next', 'rpm=
...
rflow
Merging akpm/master (88ef5e68e520 drivers/media/platform/sti/delta/delta-ip=
...

=oVUH
-----END PGP SIGNATURE-----
