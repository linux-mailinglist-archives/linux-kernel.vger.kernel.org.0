...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8121849E96
	for <lists+linux-kernel@lfdr.de>; Tue, 18 Jun 2019 12:50:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729615AbfFRKuE (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 18 Jun 2019 06:50:04 -0400
Received: from ozlabs.org ([203.11.71.1]:39407 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729098AbfFRKuD (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 18 Jun 2019 06:50:03 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45SlGD6r5fz9sBr;
        Tue, 18 Jun 2019 20:49:56 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1560854997;
        bh=Mci8+53Gvv/Z6NzZzqFRwBVFDoV0CraSATzyBWe9SzA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 18 Jun 2019 20:49:54 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 18
Message-ID: <20190618204954.3447195b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/fDhS6e+cLmK_VF=ZBrwz4gC"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/fDhS6e+cLmK_VF=ZBrwz4gC
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20190617:

Non-merge commits (relative to Linus' tree): 6205
 6844 files changed, 253749 insertions(+), 215807 deletions(-)
...
Merging origin/master (29f785ff76b6 Merge branch 'fixes' of git://git.kerne=
...
Merging net/master (29f785ff76b6 Merge branch 'fixes' of git://git.kernel.o=
...
Merging sound-asoc-fixes/for-linus (bd1c91900582 Merge branch 'asoc-5.2' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (2bad960f35d3 Merge branch 'spi-5.2' into spi-l=
inus)
...
Merging usb.current/usb-linus (c19dffc0a951 usb: chipidea: udc: workaround =
for endpoint conflict issue)
...
Merging mmc-fixes/fixes (0685be22f17e brcmfmac: sdio: Don't tune while the =
card is off)
...
Merging arm-soc/for-next (0a07f225c751 ARM: Document merges)
...
Merging qcom/for-next (7b901de0a8f3 Merge branches 'arm64-for-5.3', 'driver=
s-for-5.3' and 'dts-for-5.3' into for-next)
Merging renesas/next (db5977f0f564 Merge branches 'arm64-dt-for-v5.3' and '=
dt-bindings-for-v5.3' into next)
...
ion)
Merging nfs/linux-next (9e0babf2c06c Linux 5.2-rc5)
...
Merging pm/linux-next (d450f85f9196 Merge branches 'acpi-pm', 'acpi-osl', '=
acpi-tables' and 'acpi-tools' into linux-next)
...
Merging net-next/master (13091aa30535 Merge git://git.kernel.org/pub/scm/li=
...
Merging bpf-next/master (4d18f6de6ac1 samples: bpf: refactor header include=
 path)
...
Merging drm-intel/for-linux-next (c6f7acb80abf drm/i915/ehl: Introduce Mule=
 Creek Canyon PCH)
...
-next)
Merging sound/for-next (7bc93821a70a ALSA: firewire-lib: split allocation o=
f isochronous resources from establishment of connection)
CONFLICT (content): Merge conflict in sound/pci/rme9652/hdspm.c
Merging sound-asoc/for-next (582549029e1c Merge remote-tracking branch 'aso=
...
Merging mmc/next (60e60ef7d91f Merge branch 'fixes' into next)
...
Merging regulator/for-next (163377e21dec Merge branch 'regulator-5.3' into =
regulator-next)
...
Merging spi/for-next (86e090d2b812 Merge remote-tracking branch 'spi/topic/=
...
Merging edac-amd/for-next (b2572772d13e EDAC: Make edac_debugfs_create_x*()=
 return void)
Merging irqchip/irq/irqchip-next (702655234dd1 irqchip/gic: Add dependency =
for ARM_GIC_MAX_NR)
...
Merging chrome-platform/for-next (75589e37d1dc platform/chrome: wilco_ec: A=
dd circular buffer as event queue)
CONFLICT (content): Merge conflict in include/linux/mfd/cros_ec_commands.h
...
d variable)
Merging usb/usb-next (a954e5fb4bc2 Merge 5.2-rc5 into usb-next)
...
Merging staging/staging-next (76bc27a26acc staging: erofs: rename data_mapp=
ing_mode to datamode)
...
o for-next)
Merging coresight/next (517cbf2428a8 coresight: platform: add OF/APCI depen=
dency)
...
rflow
Merging akpm/master (e6f9b7b6f426 drivers/media/platform/sti/delta/delta-ip=
...

=iMiW
-----END PGP SIGNATURE-----
