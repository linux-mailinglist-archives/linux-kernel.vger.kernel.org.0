...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 12C1F57206
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Jun 2019 21:49:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726524AbfFZTtn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Jun 2019 15:49:43 -0400
Received: from mail.kernel.org ([198.145.29.99]:33460 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726354AbfFZTtm (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Jun 2019 15:49:42 -0400
Received: from archlinux (cpc149474-cmbg20-2-0-cust94.5-4.cable.virginm.net [82.4.196.95])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 2CBA82085A;
        Wed, 26 Jun 2019 19:49:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1561578581;
        bh=i+GHS8wjDU9C3Y0t/ankpvFhnWYCQBIvo0sWjX8gRRM=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=uVAhQXWGGKt0YXHGepbq/fbxly9qpjStcXu2kwm+aOfN82ru470ia9zXKDL/bzIHk
         s3XMQ/Cbn43EgEcn95dHMjJNB0j1DoEcmJLvDsXJvPu4Nj097rq6zc4Cos6lLTPtOd
         PUZGOZdFyyDuI9zawiyjfDgZsMI2MfX/J5Ffm5ls=
...
In-Reply-To: <03D5EE82-D6C7-4A03-9404-45B48F1EF5B6@fel.cvut.cz>
...
Zbyn=C4=9Bk Kocur <zbynek.kocur@fel.cvut.cz> wrote:

> Hello, Andreas,
>=20
> Your patch seems to solve my question. I haven't had time to test it beca=
use of holidays. I'll test it as soon as possible.
...
> >  =20
> >> The measured time value in the driver is limited to the maximum distan=
ce
...
> >> Signed-off-by: Andreas Klinger <ak@it-klinger.de> =20
...
> >>=20
> >> diff --git a/drivers/iio/proximity/srf04.c b/drivers/iio/proximity/srf=
04.c
...
> >> 	 *   and speed in m/s
> >> 	 *
> >> -	 * use 343 m/s as ultrasonic speed at 20 =C2=B0C here in absence of =
the
> >> +	 * use 343,5 m/s as ultrasonic speed at 20 =C2=B0C here in absence o=
f the
> >> 	 * temperature
> >> 	 *
> >> 	 * therefore:
