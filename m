...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 93557F7772
	for <lists+linux-kernel@lfdr.de>; Mon, 11 Nov 2019 16:13:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726943AbfKKPNy (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 11 Nov 2019 10:13:54 -0500
Received: from albert.telenet-ops.be ([195.130.137.90]:59234 "EHLO
        albert.telenet-ops.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726811AbfKKPNx (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 11 Nov 2019 10:13:53 -0500
Received: from ramsan ([84.195.182.253])
        by albert.telenet-ops.be with bizsmtp
        id QfDl210095USYZQ06fDl1n; Mon, 11 Nov 2019 16:13:45 +0100
Received: from rox.of.borg ([192.168.97.57])
        by ramsan with esmtp (Exim 4.90_1)
        (envelope-from <geert@linux-m68k.org>)
        id 1iUBNx-0004Vf-1p
        for linux-kernel@vger.kernel.org; Mon, 11 Nov 2019 16:13:45 +0100
...
Subject: Build regressions/improvements in v5.4-rc7
Date:   Mon, 11 Nov 2019 16:13:44 +0100
Message-Id: <20191111151344.7401-1-geert@linux-m68k.org>
...
v5.4-rc7[1] compared to v5.3[2].

Summarized:
  - build errors: +7/-3
  - build warnings: +145/-156
...
145 warning regressions:
  ...
  + /kisskb/src/drivers/net/phy/mdio-cavium.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]:  => 54:16, 21:16, 24:2, 138:16, 86:2, 93:16, 39:2, 47:2, 131:2, 125:2
  ...
  + /kisskb/src/drivers/net/phy/mdio-octeon.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]:  => 56:2, 77:2, 91:2
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U1640>]' may be used uninitialized in this function [-Wuninitialized]:  => 140:32, 121:34
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U2c80>]' may be used uninitialized in this function [-Wuninitialized]: 140:32 => 140:32, 121:34
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U7960>]' may be used uninitialized in this function [-Wuninitialized]:  => 140:32
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U7e60>]' may be used uninitialized in this function [-Wuninitialized]:  => 140:32
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U8500>]' may be used uninitialized in this function [-Wuninitialized]: 121:34 => 140:32, 121:34
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U9320>]' may be used uninitialized in this function [-Wuninitialized]:  => 121:34, 140:32
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<Ua6e0>]' may be used uninitialized in this function [-Wuninitialized]:  => 121:34
...
156 warning improvements:
  ...
  - /kisskb/src/drivers/scsi/cxlflash/main.c: warning: this statement may fall through [-Wimplicit-fallthrough=]: 757:3, 975:3, 983:3, 980:3, 759:3, 3018:6, 2347:6, 754:6, 978:3 => 
  ...
  - /kisskb/src/drivers/scsi/ncr53c8xx.c: warning: this statement may fall through [-Wimplicit-fallthrough=]: 6713:6, 3914:7, 3908:7, 3917:18 => 
