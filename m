...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EC77717CDB2
	for <lists+linux-kernel@lfdr.de>; Sat,  7 Mar 2020 11:54:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726174AbgCGKtp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 7 Mar 2020 05:49:45 -0500
Received: from lb3-smtp-cloud9.xs4all.net ([194.109.24.30]:60509 "EHLO
        lb3-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726017AbgCGKtp (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 7 Mar 2020 05:49:45 -0500
Received: from surfplank2.hierzo ([IPv6:2001:981:a812:0:b62e:99ff:fe92:5264])
        by smtp-cloud9.xs4all.net with ESMTPA
        id AX1ajxOR49Im2AX1bjJGQt; Sat, 07 Mar 2020 11:49:43 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=xs4all.nl; s=s1;
        t=1583578183; bh=8+CdhLqN+EFMchvHN7q9b1+FQEq1LdFQ4kBZxe3x48U=;
        h=To:From:Subject:Message-ID:Date:MIME-Version:Content-Type:From:
         Subject;
        b=
To:     "linux-kernel@vger.kernel.org" <linux-kernel@vger.kernel.org>
From:   Udo van den Heuvel <udovdh@xs4all.nl>
Subject: 5.5.x, 5.4.x: PAGE FAULT crashes the system multiple times / 24h <-
 HELP needed
...
Organization: hierzo
Message-ID: <36e8696a-fb99-23dc-c458-21824fc807fb@xs4all.nl>
Date:   Sat, 7 Mar 2020 11:49:42 +0100
...
X-CMAE-Envelope: 
...
What patches, tricks or parameters could I try?
What is the meaning of the blocking status?

3.6.18 can stay up for days, perhaps weeks but 5.5.8, also 5.4.x crashes
within a day.

Please let me know how to (help) solve this issue.
