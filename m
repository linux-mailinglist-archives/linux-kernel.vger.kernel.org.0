...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3AA661610D8
	for <lists+linux-kernel@lfdr.de>; Mon, 17 Feb 2020 12:15:56 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728423AbgBQLPv (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 17 Feb 2020 06:15:51 -0500
Received: from foss.arm.com ([217.140.110.172]:34140 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726823AbgBQLPu (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 17 Feb 2020 06:15:50 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 3176D328;
        Mon, 17 Feb 2020 03:15:49 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id D76583F6CF;
        Mon, 17 Feb 2020 03:15:46 -0800 (PST)
Subject: Re: [patch V2 16/17] lib/vdso: Allow architectures to override the ns
 shift operation
...
References: <20200207123847.339896630@linutronix.de>
 <20200207124403.857649978@linutronix.de>
From:   Vincenzo Frascino <vincenzo.frascino@arm.com>
X-Pep-Version: 2.0
Message-ID: <b599d1ad-d278-7c5b-fc1d-f5a6b080c16e@arm.com>
Date:   Mon, 17 Feb 2020 11:15:45 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <20200207124403.857649978@linutronix.de>
Content-Type: multipart/mixed;
 boundary="------------A35F26B07A70645FC9B4729A"
...
>=20
> On powerpc/32, GCC (8.1) generates pretty bad code for the ns >>=3D vd-=
>shift
> operation taking into account that the shift is always <=3D 32 and the =
upper
> part of the result is likely to be zero. GCC makes reversed assumptions=

> considering the shift to be likely >=3D 32 and the upper part to be lik=
e not
> zero.
>=20
...
>   44:	4e 80 00 20 	blr
>=20
> Even when forcing the shift to be smaller than 32 with an &=3D 31, it s=
till
> considers the shift as likely >=3D 32.
>=20
> Move the default shift implementation into an inline which can be redef=
ined
...
> Link: https://lore.kernel.org/r/b3d449de856982ed060a71e6ace8eeca4654e68=
5.1580399657.git.christophe.leroy@c-s.fr
>=20
