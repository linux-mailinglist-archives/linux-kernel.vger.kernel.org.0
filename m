...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0314A1856B
	for <lists+linux-kernel@lfdr.de>; Thu,  9 May 2019 08:27:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726862AbfEIG1W (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 9 May 2019 02:27:22 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:38723 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726683AbfEIG1W (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 9 May 2019 02:27:22 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4503Kb0KRBz9sBV;
        Thu,  9 May 2019 16:27:15 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1557383235;
        bh=bJhIaJHYHoXHfj+dVJ/iB7uePLIzzIqDTcR+Q3fZf9k=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 9 May 2019 16:27:10 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 9
Message-ID: <20190509162710.47b45475@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/ovmc.XWFwwVn/GnEz36=JZ9"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/ovmc.XWFwwVn/GnEz36=JZ9
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20190508:

The jc_docs tree gained a conflict against Linus' tree.

The mfd tree gained a conflict against Linus' tree.

The akpm-current tree gained conflicts against the rdma and parisc-hd
trees.

Non-merge commits (relative to Linus' tree): 5622
 4856 files changed, 218813 insertions(+), 78495 deletions(-)
...
Merging origin/master (ef75bd71c5d3 Merge tag 'gfs2-for-5.2' of git://git.k=
...
Merging net/master (3b2c4f4d63a5 net: dsa: sja1105: Don't return a negative=
 in u8 sja1105_stp_state_get)
...
b)
Merging sound-current/for-linus (89d8b8d60d97 Merge tag 'asoc-v5.2-4' of gi=
t://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-linus)
CONFLICT (content): Merge conflict in MAINTAINERS
Merging sound-asoc-fixes/for-linus (abcf6fd4008c Merge branch 'asoc-5.1' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (2a200034ac73 Merge branch 'spi-5.1' into spi-l=
inus)
Merging pci-current/for-linus (9c9c5fc89b09 PCI/LINK: Add Kconfig option (d=
efault off))
Merging driver-core.current/driver-core-linus (e7a1414f9dc3 Merge tag 'medi=
a/v5.1-2' of git://git.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-me=
dia)
Merging tty.current/tty-linus (e7a1414f9dc3 Merge tag 'media/v5.1-2' of git=
://git.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
Merging usb.current/usb-linus (e7a1414f9dc3 Merge tag 'media/v5.1-2' of git=
://git.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
...
Merging staging.current/staging-linus (e7a1414f9dc3 Merge tag 'media/v5.1-2=
' of git://git.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
Merging char-misc.current/char-misc-linus (80f232121b69 Merge git://git.ker=
nel.org/pub/scm/linux/kernel/git/davem/net-next)
...
Merging kbuild/for-next (ff28a8f6ecf7 Merge branch 'kconfig' into for-next)
...
or32)
Merging parisc-hd/for-next (98429dded340 parisc: Enable SPARSEMEM_VMEMMAP)
...
g with remount)
Merging cifs/for-next (cb4f7bf6be10 cifs: update module internal version nu=
mber)
...
CONFLICT (modify/delete): Documentation/x86/x86_64/mm.txt deleted in jc_doc=
s/docs-next and modified in HEAD. Version HEAD of Documentation/x86/x86_64/=
mm.txt left in tree.
$ git rm -f Documentation/x86/x86_64/mm.txt
Applying: Documentation: x86: update for "x86/mm: Fix the 56-bit addresses =
memory map in Documentation/x86/x86_64/mm.txt"
...
Merging net-next/master (80f232121b69 Merge git://git.kernel.org/pub/scm/li=
...
for le32 val)
Merging drm/drm-next (eb85d03e01c3 Merge tag 'drm-misc-next-fixes-2019-05-0=
8' of git://anongit.freedesktop.org/drm/drm-misc into drm-next)
...
Merging drm-misc/for-linux-next (15273ffd7efd drm/msm/a6xx: No zap shader i=
s not an error)
...
-next)
Merging sound/for-next (89d8b8d60d97 Merge tag 'asoc-v5.2-4' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/broonie/sound into for-linus)
Merging sound-asoc/for-next (d7b9e92cf86c Merge branch 'asoc-5.2' into asoc=
-next)
...
er)
Merging mfd/for-mfd-next (b0f933b44cdf mfd: cros_ec: Instantiate properly C=
rOS Touchpad MCU device)
CONFLICT (content): Merge conflict in MAINTAINERS
...
Merging spi/for-next (e40f7182cbdb Merge branch 'spi-5.2' into spi-next)
...
rotection)
Merging percpu/for-next (1b63cdb2c288 Merge branch 'for-5.2' into for-next)
...
s is present)
Merging driver-core/driver-core-next (e7a1414f9dc3 Merge tag 'media/v5.1-2'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
Merging usb/usb-next (e7a1414f9dc3 Merge tag 'media/v5.1-2' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
...
sm8998-qmp-ufs-phy)
Merging tty/tty-next (e7a1414f9dc3 Merge tag 'media/v5.1-2' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
Merging char-misc/char-misc-next (80f232121b69 Merge git://git.kernel.org/p=
ub/scm/linux/kernel/git/davem/net-next)
...
in struct tb_path)
Merging staging/staging-next (e7a1414f9dc3 Merge tag 'media/v5.1-2' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
...
rflow
Merging akpm/master (2ad7824c0d55 drivers/media/platform/sti/delta/delta-ip=
...

=KPKy
-----END PGP SIGNATURE-----
