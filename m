...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DF8FE1865FE
	for <lists+linux-kernel@lfdr.de>; Mon, 16 Mar 2020 08:59:15 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729961AbgCPH7J (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 16 Mar 2020 03:59:09 -0400
Received: from baptiste.telenet-ops.be ([195.130.132.51]:33744 "EHLO
        baptiste.telenet-ops.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728302AbgCPH7J (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 16 Mar 2020 03:59:09 -0400
Received: from ramsan ([84.195.182.253])
        by baptiste.telenet-ops.be with bizsmtp
        id Evyx2200W5USYZQ01vyxBZ; Mon, 16 Mar 2020 08:58:58 +0100
Received: from rox.of.borg ([192.168.97.57])
        by ramsan with esmtp (Exim 4.90_1)
        (envelope-from <geert@linux-m68k.org>)
        id 1jDkeH-0003dM-LA
        for linux-kernel@vger.kernel.org; Mon, 16 Mar 2020 08:58:57 +0100
...
Subject: Build regressions/improvements in v5.6-rc6
Date:   Mon, 16 Mar 2020 08:58:57 +0100
Message-Id: <20200316075857.32248-1-geert@linux-m68k.org>
...
v5.6-rc6[1] compared to v5.5[2].

Summarized:
  - build errors: +5/-0
  - build warnings: +148/-181

JFYI, when comparing v5.6-rc6[1] to v5.6-rc5[3], the summaries are:
  - build errors: +0/-0
  - build warnings: +1/-1
...
[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/fb33c6510d5595144d585aa194d377cf74d31911/ (all 239 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/d5226fa6dbae0569ee43ecfc08bdcd6770fc4755/ (232 out of 239 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/2c523b344dfa65a3738e7039832044aa133c75fb/ (all 239 configs)
...
148 warning regressions:
  + .config: warning: override: reassigning to symbol MIPS_CPS_NS16550_SHIFT:  => 11986, 11982, 11985, 11980
  ...
  + .config: warning: override: reassigning to symbol UML_NET_SLIRP:  => 4178, 4202
  ...
  + /kisskb/src/drivers/usb/gadget/udc/fsl_qe_udc.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]:  => 1491:27, 1491:4, 965:5, 837:5, 965:28, 837:28
  + /kisskb/src/drivers/usb/gadget/udc/fsl_qe_udc.c: warning: this statement may fall through [-Wimplicit-fallthrough=]:  => 580:8, 542:37, 566:8, 563:8, 596:5
  ...
  + /kisskb/src/fs/io_uring.c: warning: 'err' may be used uninitialized in this function [-Wuninitialized]:  => 5842:13
...
181 warning improvements:
  ...
  - /kisskb/src/drivers/block/null_blk_main.c: warning: 'new_value' may be used uninitialized in this function [-Wuninitialized]: 324:1, 310:1, 311:1, 326:1 => 
