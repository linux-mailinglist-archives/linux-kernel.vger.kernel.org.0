...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5585C116E5A
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Dec 2019 14:58:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727795AbfLIN6f (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 Dec 2019 08:58:35 -0500
Received: from bombadil.infradead.org ([198.137.202.133]:51618 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727669AbfLIN6d (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Dec 2019 08:58:33 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=leWIoV3qnK8sazHWC0kIrJ5YtzVoDKZsjiybcitV958=; b=E+Qpzsyjb3vAO9T1IjuSyzEl4j
        ;
Received: from clnet-p19-102.ikbnet.co.at ([83.175.77.102] helo=localhost)
        by bombadil.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1ieJYT-0001bA-Lk; Mon, 09 Dec 2019 13:58:30 +0000
...
Subject: [PATCH 2/2] remove ioremap_nocache and devm_ioremap_nocache
Date:   Mon,  9 Dec 2019 14:58:22 +0100
Message-Id: <20191209135823.28465-3-hch@lst.de>
...
---
 ...
 368 files changed, 513 insertions(+), 578 deletions(-)
...
index 539e3efcf39c..f42d9973e7d6 100644
--- a/arch/hexagon/include/asm/io.h
+++ b/arch/hexagon/include/asm/io.h
@@ -172,8 +172,6 @@ static inline void writel(u32 data, volatile void __iomem *addr)
...
index 6239a9adbf14..f24064893b30 100644
...
index 568c52317757..27bde309e6f7 100644
...
index 8f5021091eee..a83dc5184f33 100644
...
index 992c773620ec..4b9f7ae25dc7 100644
...
index cdab916fbf92..5ea5245b8b15 100644
...
index 07d1b911e72f..e268a5d6a260 100644
--- a/drivers/platform/x86/pmc_atom.c
+++ b/drivers/platform/x86/pmc_atom.c
@@ -481,7 +481,7 @@ static int pmc_setup_dev(struct pci_dev *pdev, const struct pci_device_id *ent)
...
index 7b7ef3acb504..5b1e99c5209b 100644
...
index c4a9196d794c..dbebf05f5931 100644
...
index 0bf5640f1f07..ae5edf1837ca 100644
