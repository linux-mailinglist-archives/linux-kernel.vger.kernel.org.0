...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 028A045B07
	for <lists+linux-kernel@lfdr.de>; Fri, 14 Jun 2019 12:58:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727412AbfFNK6a (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 14 Jun 2019 06:58:30 -0400
Received: from ozlabs.org ([203.11.71.1]:57621 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727168AbfFNK6a (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 14 Jun 2019 06:58:30 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45QHdn06Vwz9s00;
        Fri, 14 Jun 2019 20:58:20 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1560509901;
        bh=Sg2Z2dyiQKrOFf6Fvf4cMko93TKk4OxSmdH8GtKCKKI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 14 Jun 2019 20:58:21 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 14
Message-ID: <20190614205821.3bb6fb3f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/hBZn0iYW2pBqDin_i7OBXHF"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/hBZn0iYW2pBqDin_i7OBXHF
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20190613:

The rdma tree gained a conflict against Linus' tree.

The drm-misc tree gained a build failure for which I applied a merge
fix patch.

The integrity tree gained a build failure so I used the version from
next-20190613.

The tty tree lost its build failure.

The akpm-current tree gained a conflict against the m68knommu tree.

Non-merge commits (relative to Linus' tree): 5819
 6183 files changed, 227142 insertions(+), 201028 deletions(-)
...
Merging origin/master (c11fb13a117e Merge branch 'for-linus' of git://git.k=
...
filtering')
Merging bpf/master (09f6ac2c31f3 Merge branch 'bpf-ppc-div-fix')
...
Merging mac80211/master (7341ef5c5e21 mac80211: drop robust management fram=
es from unknown TA)
Merging rdma-fixes/for-rc (d1fdb6d8f6a4 Linux 5.2-rc4)
Merging sound-current/for-linus (84396d141894 Merge tag 'asoc-fix-v5.2-rc4'=
 of https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-=
linus)
Merging sound-asoc-fixes/for-linus (21d1d9510aac Merge branch 'asoc-5.2' in=
to asoc-linus)
...
g)
Merging drm-fixes/drm-fixes (febe80307d2c Merge tag 'drm-intel-fixes-2019-0=
6-13' of git://anongit.freedesktop.org/drm/drm-intel into drm-fixes)
...
())
Merging cifs/for-next (59016d1bb67a [CIFS] Fix match_server check to allow =
for auto dialect negotiate)
...
ion)
Merging nfs/linux-next (c11fb13a117e Merge branch 'for-linus' of git://git.=
kernel.org/pub/scm/linux/kernel/git/hid/hid)
...
Merging net-next/master (425b0fad9c7e Merge branch 'net-stmmac-Convert-to-p=
hylink')
...
Merging mlx5-next/mlx5-next (1f8a7bee27e6 net/mlx5: Add EQ enable/disable A=
PI)
...
Merging drm-intel/for-linux-next (0cf289bd5de3 drm/i915: Move fence registe=
r tracking from i915->mm to ggtt)
Merging drm-tegra/drm/tegra/for-next (eb7cf945a8da host1x: debugfs_create_d=
ir() can never return NULL)
Merging drm-misc/for-linux-next (9f9b25593ab4 drm/connector: Fix kerneldoc =
warning in HDR_OUTPUT_METADATA description)
...
_types.h"
Applying: fixup for "drm: Convert connector_helper_funcs->atomic_check to a=
ccept drm_atomic_state"
...
-next)
Merging sound/for-next (855b5e01c073 ALSA: hda/hdmi - consider eld_valid al=
so in sync_eld_via_acomp())
CONFLICT (content): Merge conflict in sound/pci/rme9652/hdspm.c
Merging sound-asoc/for-next (1c4747d2498e Merge branch 'asoc-5.3' into asoc=
-next)
...
Merging integrity/next-integrity (33fa2a9ce398 ima: Make arch_policy_entry =
static)
$ git reset --hard HEAD^
Merging next-20190613 version of integrity
...
Merging devicetree/for-next (4c0a59e1123f Documentation: arm: Link idle-sta=
tes binding to "enable-method" property)
...
Merging edac-amd/for-next (110f1e27d954 EDAC/ghes: Fix grain calculation)
...
G_I2C is set to m)
Merging driver-core/driver-core-next (dad4afe746b3 f2fs: replace ktype defa=
ult_attrs with default_groups)
...
Merging staging/staging-next (7c11bb40f125 staging: rtl8723bs: Remove rtw_b=
tcoex_Initialize())
...
on-blocking)
Merging akpm-current/current (52228ca8d0f6 include/linux/lz4.h: fix spellin=
...
rflow
Merging akpm/master (5f3e5fb6cab8 drivers/media/platform/sti/delta/delta-ip=
...

=2Z/M
-----END PGP SIGNATURE-----
