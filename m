...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A60B618CE91
	for <lists+linux-kernel@lfdr.de>; Fri, 20 Mar 2020 14:16:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727403AbgCTNQk (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 20 Mar 2020 09:16:40 -0400
Received: from Galois.linutronix.de ([193.142.43.55]:35743 "EHLO
        Galois.linutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727347AbgCTNQh (ORCPT
...
Received: from nanos.tec.linutronix.de (localhost [IPv6:::1])
        by nanos.tec.linutronix.de (Postfix) with ESMTP id 7AEE51039FD
        for <linux-kernel@vger.kernel.org>; Fri, 20 Mar 2020 14:16:26 +0100 (CET)
Message-Id: <20200320131509.564059710@linutronix.de>
User-Agent: quilt/0.65
Date:   Fri, 20 Mar 2020 14:13:54 +0100
...
Subject: [patch 09/22] cpufreq: Convert to new X86 CPU match macros
...
---
 ...
 drivers/cpufreq/speedstep-centrino.c   |   15 +-----
 drivers/cpufreq/speedstep-ich.c        |   10 +---
 drivers/cpufreq/speedstep-smi.c        |   10 +---
 15 files changed, 59 insertions(+), 74 deletions(-)
...
@@ -145,7 +145,7 @@ static void __exit amd_freq_sensitivity_
...
@@ -1908,51 +1908,51 @@ static const struct pstate_funcs knl_fun
...
@@ -2725,13 +2725,14 @@ static inline void intel_pstate_request_
...
@@ -520,18 +520,11 @@ static struct cpufreq_driver centrino_dr
  * or ASCII model IDs.
  */
