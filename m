...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 91020F4234
	for <lists+linux-kernel@lfdr.de>; Fri,  8 Nov 2019 09:35:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730374AbfKHIfi (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 8 Nov 2019 03:35:38 -0500
Received: from mga17.intel.com ([192.55.52.151]:19003 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725975AbfKHIfh (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 8 Nov 2019 03:35:37 -0500
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 08 Nov 2019 00:35:34 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,280,1569308400"; 
   d="yaml'?scan'208";a="233561125"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga002.fm.intel.com with ESMTP; 08 Nov 2019 00:35:30 -0800
Date:   Fri, 8 Nov 2019 16:35:13 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     Eric Dumazet <edumazet@google.com>
Cc:     "David S. Miller" <davem@davemloft.net>, Willy Tarreau <w@1wt.eu>,
...
Message-ID: <20191108083513.GB29418@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="OrGWVCPA5Dd3PCYV"
...
Content-Disposition: attachment; filename="config-5.4.0-rc3-00493-g19f92a030ca6d"
...
export_top_env()
{
	...
	export job_origin='/lkp/lkp/.src-20191106-090300/allot/cyclic:p2:linux-devel:devel-hourly/lkp-bdw-de1/apachebench.yaml'
...
queue_at_least_once'
	...
	export submit_id='5dc4e38ac1a9bc4c9b6b1f14'
	export job_file='/lkp/jobs/scheduled/lkp-bdw-de1/apachebench-cs-localhost-4000-performance-300s-ucode=0x7000019-de-20191108-19611-hgtcf5-3.yaml'
	export id='82974064eb768dc546c9e8838a31a88475dcbd8f'
	...
	export commit='19f92a030ca6d772ab44b22ee6a01378a8cb32d4'
...
CONFIG_HAS_DMA=y'
	...
	export enqueue_time='2019-11-08 11:40:03 +0800'
	export _id='5dc4e393c1a9bc4c9b6b1f15'
	export _rt='/result/apachebench/cs-localhost-4000-performance-300s-ucode=0x7000019/lkp-bdw-de1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4'
	export user='lkp'
	export head_commit='95187e45e9fa66519686ca34a19663387675c401'
	export base_commit='a99d8080aaf358d5d23581244e5da23b35e340b9'
	export branch='linux-devel/devel-hourly-2019110803'
	export result_root='/result/apachebench/cs-localhost-4000-performance-300s-ucode=0x7000019/lkp-bdw-de1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/3'
	export scheduler_version='/lkp/lkp/.src-20191108-094948'
	export LKP_SERVER='inn'
	export max_uptime=1500
	export initrd='/osimage/debian/debian-x86_64-2019-09-23.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-bdw-de1/apachebench-cs-localhost-4000-performance-300s-ucode=0x7000019-de-20191108-19611-hgtcf5-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019110803
commit=19f92a030ca6d772ab44b22ee6a01378a8cb32d4
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/vmlinuz-5.4.0-rc3-00493-g19f92a030ca6d
console=ttyS1,115200 console=tty0
max_uptime=1500
RESULT_ROOT=/result/apachebench/cs-localhost-4000-performance-300s-ucode=0x7000019/lkp-bdw-de1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/3
LKP_SERVER=inn
nokaslr
debug
apic=debug
...
console=tty0
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/modules.cgz'
	export bm_initrd='/osimage/deps/debian-x86_64-2018-04-03.cgz/run-ipconfig_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/lkp_2019-08-05.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/apachebench_2019-10-09.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/mpstat_2019-10-10.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/vmstat_2019-10-11.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/turbostat_2019-10-11.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/turbostat-x86_64-3.7-4_2019-10-11.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/perf_2019-10-10.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/perf-x86_64-bc88f85c6c09_2019-10-17.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/sar-x86_64-c582fe4-1_2019-10-10.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/hw_2019-10-09.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/cluster_2016-11-24.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.4.0-rc6-02234-g95187e45e9fa6'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/vmlinuz-5.4.0-rc3-00493-g19f92a030ca6d'
	export dequeue_time='2019-11-08 11:59:34 +0800'
	export node_roles='server client'
	export job_initrd='/lkp/jobs/scheduled/lkp-bdw-de1/apachebench-cs-localhost-4000-performance-300s-ucode=0x7000019-de-20191108-19611-hgtcf5-3.cgz'
...
if role client:
  apachebench: 
job_origin: "/lkp/lkp/.src-20191106-090300/allot/cyclic:p2:linux-devel:devel-hourly/lkp-bdw-de1/apachebench.yaml"
...
submit_id: 5dc4ddcfc1a9bc4bbb7f3180
job_file: "/lkp/jobs/scheduled/lkp-bdw-de1/apachebench-cs-localhost-4000-performance-300s-ucode=0x7000019-debi-20191108-19387-kkpg4p-0.yaml"
id: a841d79431b675aa27ade432c0261ae174d918d2
...
enqueue_time: 2019-11-08 11:15:34.575435374 +08:00
_id: 5dc4ddcfc1a9bc4bbb7f3180
_rt: "/result/apachebench/cs-localhost-4000-performance-300s-ucode=0x7000019/lkp-bdw-de1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4"

#! schedule options
user: lkp
head_commit: 95187e45e9fa66519686ca34a19663387675c401
base_commit: a99d8080aaf358d5d23581244e5da23b35e340b9
branch: linux-devel/devel-hourly-2019110803
result_root: "/result/apachebench/cs-localhost-4000-performance-300s-ucode=0x7000019/lkp-bdw-de1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/0"
scheduler_version: "/lkp/lkp/.src-20191108-094948"
LKP_SERVER: inn
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-bdw-de1/apachebench-cs-localhost-4000-performance-300s-ucode=0x7000019-debi-20191108-19387-kkpg4p-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019110803
- commit=19f92a030ca6d772ab44b22ee6a01378a8cb32d4
...
- console=tty0
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/modules.cgz"
...
#! /lkp/lkp/.src-20191107-185039/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! runtime status
last_kernel: 5.4.0-rc6-02132-g3c00d966492fd
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/19f92a030ca6d772ab44b22ee6a01378a8cb32d4/vmlinuz-5.4.0-rc3-00493-g19f92a030ca6d"
dequeue_time: 2019-11-08 11:28:16.940480662 +08:00

#! /lkp/lkp/.src-20191108-094948/include/site/inn
job_state: finished
loadavg: 2.00 0.72 0.26 1/382 4151
start_time: '1573183767'
end_time: '1573183808'
version: "/lkp/lkp/.src-20191108-095021:cde7d027-dirty:825849823-dirty"
