...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1946A15FF4B
	for <lists+linux-kernel@lfdr.de>; Sat, 15 Feb 2020 17:54:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726438AbgBOQy2 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 15 Feb 2020 11:54:28 -0500
Received: from mail.kernel.org ([198.145.29.99]:52308 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726137AbgBOQy2 (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 15 Feb 2020 11:54:28 -0500
Received: from archlinux (cpc149474-cmbg20-2-0-cust94.5-4.cable.virginm.net [82.4.196.95])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 9B4DB2083B;
        Sat, 15 Feb 2020 16:54:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1581785665;
        bh=QGY0AV8fvUBcbAsy7GJuCEhOdB7SoFUknrJWBZbFXcg=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=NN2bIvfxNa/JFCgw8zdCKpJ7bi06AMVuZLEpc6seV5kZzOnlWTqLVlSQ2n3+Vxb9X
         gqQqW31TpvEGCGymmP9i8BLUhsfIhnaLyP2vyfJXPEy5G4ytW3u2oEl9kMtjbslkuK
         w8p7oiz09jk/Uph6bWo5A9h3+yd/iP+5mpAhRDzI=
Date:   Sat, 15 Feb 2020 16:54:20 +0000
...
Subject: Re: [PATCH v3] iio: Add SEMTECH SX9310/9311 sensor driver
Message-ID: <20200215165420.4c25e579@archlinux>
In-Reply-To: <20200212115458.1.I1f56fe698017f22d6e825c913c256d5afc2ad69f@changeid>
References: <20200212115458.1.I1f56fe698017f22d6e825c913c256d5afc2ad69f@changeid>
...
On Wed, 12 Feb 2020 11:56:21 -0700
...
A few really minor bits inline from this pass.  Biggest one to
my mind is that you are adding ABI and haven't documented it.  Note
you need to cover all the sysfs files that are non standard
(ones with COMB in them).
We don't have hard rules on it, but does feel like lower
case would fit nicer with rest of the interface... So.
in_proximity3_comb_raw?
...
Seems to have a DT binding so why depends on ACPI?
...
This is new ABI so needs documentation in
