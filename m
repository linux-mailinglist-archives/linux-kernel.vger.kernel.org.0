...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2234A185875
	for <lists+linux-kernel@lfdr.de>; Sun, 15 Mar 2020 03:10:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727671AbgCOCKL (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 14 Mar 2020 22:10:11 -0400
Received: from st43p00im-ztbu10073601.me.com ([17.58.63.184]:40134 "EHLO
        st43p00im-ztbu10073601.me.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726998AbgCOCKK (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 14 Mar 2020 22:10:10 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=me.com; s=1a1hai;
        t=1584161541; bh=s+bEuN4zHc9v0waXkCiEz3gjhS2jo/FR/QLQy609NfA=;
        h=Date:From:To:Subject:Message-ID:Content-Type;
        b=
Received: from shwetrath.localdomain (unknown [66.199.8.131])
        by st43p00im-ztbu10073601.me.com (Postfix) with ESMTPSA id CD582820644;
        Sat, 14 Mar 2020 04:52:20 +0000 (UTC)
Date:   Sat, 14 Mar 2020 00:52:18 -0400
...
Subject: Re: [PATCH v4 3/3] perf vendor events amd: update Zen1 events to V2
Message-ID: <20200314045218.GA83097@shwetrath.localdomain>
References: <20200314044453.82554-1-vijaythakkar@me.com>
 <20200314044453.82554-4-vijaythakkar@me.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200314044453.82554-4-vijaythakkar@me.com>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 suspectscore=2 malwarescore=0
 ...
 scancount=1 engine=8.0.1-1908290000 definitions=main-2003140025
...
As you can see, my diff for Patch 3 has inflated since the last version.
This is mostly because I have updated the descriptions of the counters
that were already in zen1 based on your review for the patch for zen2.
...
>  .../pmu-events/arch/x86/amdzen1/cache.json    | 107 ++++++------------
>  .../pmu-events/arch/x86/amdzen1/core.json     |  15 +--
>  .../arch/x86/amdzen1/floating-point.json      |  64 ++++++++++-
>  .../pmu-events/arch/x86/amdzen1/memory.json   |  82 +++++++++-----
>  .../pmu-events/arch/x86/amdzen1/other.json    |  27 ++---
...
> index 6221a840fcea..404d4c569c01 100644
...
> index b26a00d05a2e..ff780098d36e 100644
