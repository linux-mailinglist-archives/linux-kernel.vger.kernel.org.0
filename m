...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 735149A7E1
	for <lists+linux-kernel@lfdr.de>; Fri, 23 Aug 2019 08:56:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2404751AbfHWG4S (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Fri, 23 Aug 2019 02:56:18 -0400
Received: from mga18.intel.com ([134.134.136.126]:53107 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2404280AbfHWG4R (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Fri, 23 Aug 2019 02:56:17 -0400
X-Amp-Result: UNSCANNABLE
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by orsmga106.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 22 Aug 2019 23:56:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,420,1559545200"; 
   d="yaml'?scan'208";a="379672704"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga006.fm.intel.com with ESMTP; 22 Aug 2019 23:56:07 -0700
Date:   Fri, 23 Aug 2019 14:56:06 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     Christoph Hellwig <hch@lst.de>
Cc:     "Darrick J. Wong" <darrick.wong@oracle.com>,
        LKML <linux-kernel@vger.kernel.org>,
        Linus Torvalds <torvalds@linux-foundation.org>, lkp@01.org
Subject: [xfs] 79b54d9bfc: aim7.jobs-per-min -2.8% regression
Message-ID: <20190823065606.GA22771@shao2-debian>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.2.0-rc4-00036-g79b54d9bfcdcd"
...
export_top_env()
{
	...
	export job_origin='/lkp/lkp/.src-20190809-195017/allot/cyclic:p1:linux-devel:devel-hourly/lkp-ivb-ep01/aim7-fs-raid.yaml'
...
queue_at_least_once'
	...
	export submit_id='5d5e4cc141f90118727f7f90'
	export job_file='/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-x86_6-20190822-6258-163ziml-3.yaml'
	export id='f53d1bee676227257391de57f7e6f870a95f9395'
	export queuer_version='/lkp-src'
	export arch='x86_64'
	export commit='79b54d9bfcdcd0a431bb3501013885f8f00cdb43'
...
CONFIG_XFS_FS'
	...
	export enqueue_time='2019-08-22 16:05:35 +0800'
	export _id='5d5e4ccf41f90118727f7f91'
	export _rt='/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-ivb-ep01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43'
	export user='lkp'
	...
	export result_root='/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-ivb-ep01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43/3'
	export scheduler_version='/lkp/lkp/.src-20190822-152443'
	export LKP_SERVER='inn'
	export max_uptime=3600
	export initrd='/osimage/debian/debian-x86_64-2019-05-14.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-x86_6-20190822-6258-163ziml-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019073002
commit=79b54d9bfcdcd0a431bb3501013885f8f00cdb43
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43/vmlinuz-5.2.0-rc4-00036-g79b54d9bfcdcd
cma=0
max_uptime=3600
RESULT_ROOT=/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-ivb-ep01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43/3
LKP_SERVER=inn
debug
apic=debug
...
rw'
	...
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43/vmlinuz-5.2.0-rc4-00036-g79b54d9bfcdcd'
	export dequeue_time='2019-08-22 16:28:44 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-x86_6-20190822-6258-163ziml-3.cgz'
...
aim7:
  test: sync_disk_rw
  load: 300
job_origin: "/lkp/lkp/.src-20190806-201907/allot/cyclic:p1:linux-devel:devel-hourly/lkp-ivb-ep01/aim7-fs-raid.yaml"
...
submit_id: 5d5db7195849181460d706ac
job_file: "/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-x86_64--20190822-5216-lsy3ot-0.yaml"
id: a81c4a1a3c19abd243423ab1eccb94f2749260ca
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2019-08-22 05:27:00.509160509 +08:00
_id: 5d5db7195849181460d706ac
_rt: "/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-ivb-ep01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43"
...
branch: linux-devel/devel-hourly-2019073002
result_root: "/result/aim7/performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw/lkp-ivb-ep01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43/0"
scheduler_version: "/lkp/lkp/.src-20190822-091334"
LKP_SERVER: inn
max_uptime: 3600
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-ivb-ep01/aim7-performance-4BRD_12G-xfs-300-RAID1-sync_disk_rw-debian-x86_64--20190822-5216-lsy3ot-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019073002
- commit=79b54d9bfcdcd0a431bb3501013885f8f00cdb43
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43/modules.cgz"
...
#! /lkp/lkp/.src-20190809-195017/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/79b54d9bfcdcd0a431bb3501013885f8f00cdb43/vmlinuz-5.2.0-rc4-00036-g79b54d9bfcdcd"
dequeue_time: 2019-08-22 09:28:09.448638945 +08:00

#! /lkp/lkp/.src-20190822-091334/include/site/inn
job_state: finished
loadavg: 228.58 242.08 134.88 1/456 16691
start_time: '1566437355'
end_time: '1566437929'
version: "/lkp/lkp/.src-20190822-091400"
