...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2502C328C4
	for <lists+linux-kernel@lfdr.de>; Mon,  3 Jun 2019 08:47:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727321AbfFCGrn (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 3 Jun 2019 02:47:43 -0400
Received: from smtp2200-217.mail.aliyun.com ([121.197.200.217]:49779 "EHLO
        smtp2200-217.mail.aliyun.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726896AbfFCGrl (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 3 Jun 2019 02:47:41 -0400
X-Alimail-AntiSpam: AC=CONTINUE;BC=0.07436282|-1;CH=green;DM=CONTINUE|CONTINUE|true|0.235987-0.0191047-0.744908;FP=0|0|0|0|0|-1|-1|-1;HT=e01a16368;MF=han_mao@c-sky.com;NM=1;PH=DS;RN=4;RT=4;SR=0;TI=SMTPD_---.Egloi3U_1559544453;
Received: from localhost(mailfrom:han_mao@c-sky.com fp:SMTPD_---.Egloi3U_1559544453)
...
Subject: [PATCH V3 3/6] csky: Add pmu interrupt support
Date:   Mon,  3 Jun 2019 14:46:22 +0800
Message-Id: <d4ee04c652e2c2fbd4dffb6159f552cc09b60d2e.1559544301.git.han_mao@c-sky.com>
...
+#define to_csky_pmu(p)  (container_of(p, struct csky_pmu, pmu))
 ...
 #define cprgr(reg)				\
@@ -803,6 +835,51 @@ static const int csky_pmu_cache_map[C(MAX)][C(OP_MAX)][C(RESULT_MAX)] = {
 	},
 };
...
@@ -1053,15 +1286,43 @@ int csky_pmu_device_probe(struct platform_device *pdev,
