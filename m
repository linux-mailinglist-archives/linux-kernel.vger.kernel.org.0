...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CE6A0114B64
	for <lists+linux-kernel@lfdr.de>; Fri,  6 Dec 2019 04:24:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726266AbfLFDYM (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 5 Dec 2019 22:24:12 -0500
Received: from mail.kernel.org ([198.145.29.99]:35352 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726076AbfLFDYL (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 5 Dec 2019 22:24:11 -0500
Received: from paulmck-ThinkPad-P72.home (50-39-105-78.bvtn.or.frontiernet.net [50.39.105.78])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 96FAD2077B;
        Fri,  6 Dec 2019 03:23:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1575602635;
        bh=IsNmU9/+oCsmI2qvVUYeXWDi4ZG8K1a7Chkz9taAXeg=;
        h=Date:From:To:Cc:Subject:Reply-To:References:In-Reply-To:From;
        b=PB0BHnq/CAx9fgWCRJez8qzndxGoHXaQs7L1JUf0+6ITcXtw5JmBSQ8CTPTR++BGv
         /q9w3buX8N4P2iq5Bpa5yx7OHFuvIlWYG4HgBly7Huj4s5XuaUlflfPVv8WPc0yyvM
         wVHmIvBJwl+olTUIp1V/Pb5bhPh/PqusNqiEFiWg=
Received: by paulmck-ThinkPad-P72.home (Postfix, from userid 1000)
        id 6B2863522782; Thu,  5 Dec 2019 19:23:54 -0800 (PST)
Date:   Thu, 5 Dec 2019 19:23:54 -0800
...
Message-ID: <20191206032354.GZ2889@paulmck-ThinkPad-P72>
...
References: <f6fc58e5-2133-9560-a5bd-5cadc107ac51@huawei.com>
 ...
 <e8e7a98a-b078-668f-31ab-9d4410145d35@huawei.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <e8e7a98a-b078-668f-31ab-9d4410145d35@huawei.com>
...
On Thu, Dec 05, 2019 at 10:37:46AM +0000, John Garry wrote:
...
> [  138.166003][    T1] -----------------------------
> [  138.170836][    T1] kernel/kprobes.c:329 RCU-list traversed in non-reader
> section!!
> 
> [  148.634087][    T1] =============================
...
Feel free, but these are usually usage issues.  Using RCU read-side
primitives without being in an RCU read-side critical section is about
as good for your kernel's health and well-being as is manipulating data
protected by a given lock without holding that lock.  ;-)

Left to myself, I suggest bisecting to find the offending commit, if
you have not already done so.  But maybe Corey has some other ideas.
...
> 
> #
> # Compiler: aarch64-linux-gnu-gcc (Linaro GCC 7.3-2018.05-rc1) 7.3.1 20180425 [linaro-7.3-2018.05-rc1 revision 38aec9a676236eaa42ca03ccb3a6c1dd0182c29f]
> #
> CONFIG_CC_IS_GCC=y
