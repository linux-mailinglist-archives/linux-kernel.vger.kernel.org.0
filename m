...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 82A1A14930
	for <lists+linux-kernel@lfdr.de>; Mon,  6 May 2019 13:56:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726095AbfEFL4D (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 6 May 2019 07:56:03 -0400
Received: from ozlabs.org ([203.11.71.1]:42903 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725827AbfEFL4D (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 6 May 2019 07:56:03 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 44yLmB12P8z9s4V;
        Mon,  6 May 2019 21:55:54 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1557143754;
        bh=2qcpvn+hj9nVGpkz2IEqw4FuKDUQlblaJ6CiCMm1FwQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 6 May 2019 21:55:51 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 6
Message-ID: <20190506215551.48541da8@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/Cnr0NYWvzhrh6MCWKOML9_L"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/Cnr0NYWvzhrh6MCWKOML9_L
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20190503:

The kbuild tree gained some build failure for which I added some patches.
...
gfs2 tree for which I applied a merge fix patch.

The tip tree gained a conflict against the s390 tree.

The akpm-current tree gained conflicts against the net-next and rdma trees.

Non-merge commits (relative to Linus' tree): 11190
 10788 files changed, 488165 insertions(+), 312584 deletions(-)
...
Merging origin/master (6203838dec05 Merge tag 'powerpc-5.1-7' of git://git.=
...
Merging sound-asoc-fixes/for-linus (6788d77b3b1c Merge branch 'asoc-5.1' in=
to asoc-linus)
Merging regmap-fixes/for-linus (7fdc9fc87492 Merge branch 'regmap-5.1' into=
 regmap-linus)
Merging regulator-fixes/for-linus (c346c232be72 Merge branch 'regulator-5.1=
...
Merging drm-fixes/drm-fixes (1daa0449d287 Merge tag 'drm-misc-fixes-2019-05=
...
Merging mmc-fixes/fixes (401135293777 mmc: core: Fix tag set memory leak)
...
Merging kbuild/for-next (5c6f64a99942 Merge branch 'kconfig' into for-next)
CONFLICT (content): Merge conflict in Makefile
Applying: arm: omap: remove unused MODULE_ALIAS from dma.c
Applying: arm: omap: remove unused MODULE_ALIAS from timer-ti-dm.c
Applying: mfd: omap: remove unused MODULE_ALIAS from omap-usb-tll.c
...
Merging cifs/for-next (486547af06c1 cifs: update module internal version nu=
mber)
...
ion)
Merging nfs/linux-next (6203838dec05 Merge tag 'powerpc-5.1-7' of git://git=
.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
...
Merging rdma/for-next (923abb9d797b RDMA/core: Introduce RDMA subsystem ibd=
ev_* print functions)
Merging net-next/master (d1f5050b4549 r8169: speed up rtl_loop_wait)
...
Merging bpf-next/master (7080da890984 libbpf: add libbpf_util.h to header i=
nstall.)
...
et)
Merging netfilter-next/master (522e4077e8dc netfilter: slightly optimize nf=
_inet_addr_mask)
...
-next)
Merging sound/for-next (78ff2afc2625 MAINTAINERS: update git tree for sound=
 entries)
Merging sound-asoc/for-next (6455a8745ac1 Merge branch 'asoc-5.2' into asoc=
-next)
...
dor-prefixes.txt
Merging block/for-next (6959dd358ee4 Merge branch 'for-5.2/block' into for-=
next)
...
Merging mmc/next (eab97a5494c3 dt-bindings: mmc: Add support for MT8516 to =
mtk-sd)
...
hip UCS1002)
Merging regulator/for-next (78c5484771c1 Merge branch 'regulator-5.2' into =
regulator-next)
...
rflow
Merging akpm/master (24d7f810c3ea drivers/media/platform/sti/delta/delta-ip=
...

=Rljt
-----END PGP SIGNATURE-----
