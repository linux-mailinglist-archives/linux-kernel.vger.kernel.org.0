...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 74A81D70FE
	for <lists+linux-kernel@lfdr.de>; Tue, 15 Oct 2019 10:29:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728895AbfJOI3i (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 15 Oct 2019 04:29:38 -0400
Received: from mail-eopbgr150087.outbound.protection.outlook.com ([40.107.15.87]:64894
        "EHLO EUR01-DB5-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726702AbfJOI3i (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 15 Oct 2019 04:29:38 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=L6XR8XCj1YvBOTAEzSfXwOK3puBh2iTiiZr3lBvJUUM=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Mellanox.com;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=L6XR8XCj1YvBOTAEzSfXwOK3puBh2iTiiZr3lBvJUUM=;
 b=sYiw0JzujZtA5rY0vufsvgBMa5Z57jKqxVqpX7Us0Z00pvFfkmpvMF9wEiHIwscx+hcuQXZyw2P84ArUA5zr6GvWvxHo1W9It1zpER5XQpMVeg+ygp6/rFIczmqPAEfoVRUvb7pzD3H/q0FEXJBSsaUlqV3KXVxAZtg3kYR8nb0=
Received: from DBBPR05MB6364.eurprd05.prod.outlook.com (20.179.43.22) by
 DBBPR05MB6393.eurprd05.prod.outlook.com (20.179.43.204) with Microsoft SMTP
 Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.2347.16; Tue, 15 Oct 2019 08:28:52 +0000
Received: from DBBPR05MB6364.eurprd05.prod.outlook.com
 ([fe80::a04c:f641:fd:e53f]) by DBBPR05MB6364.eurprd05.prod.outlook.com
 ([fe80::a04c:f641:fd:e53f%4]) with mapi id 15.20.2347.023; Tue, 15 Oct 2019
 08:28:52 +0000
...
Subject: Re: [netdevsim] 4418f862d6: kernel_selftests.bpf.test_offload.py.fail
Thread-Topic: [netdevsim] 4418f862d6:
 kernel_selftests.bpf.test_offload.py.fail
Thread-Index: AQHVgvFB/BesWSyTRkWTtEBITYWiQ6dbXz6A
Date:   Tue, 15 Oct 2019 08:28:52 +0000
Message-ID: <20191015082847.GK2322@nanopsycho>
References: <20191015004047.GR9415@shao2-debian>
In-Reply-To: <20191015004047.GR9415@shao2-debian>
Accept-Language: en-US
Content-Language: en-US
X-MS-Has-Attach: 
X-MS-TNEF-Correlator: 
x-clientproxiedby: MR2P264CA0019.FRAP264.PROD.OUTLOOK.COM
 (2603:10a6:500:1::31) To DBBPR05MB6364.eurprd05.prod.outlook.com
 (2603:10a6:10:cc::22)
authentication-results: spf=none (sender IP is )
 smtp.mailfrom=jiri@mellanox.com; 
x-ms-exchange-messagesentrepresentingtype: 1
x-originating-ip: [89.177.225.135]
x-ms-publictraffictype: Email
x-ms-office365-filtering-correlation-id: 177c9b1d-4ac6-4d33-0ef3-08d75149b56f
x-ms-office365-filtering-ht: Tenant
x-ms-traffictypediagnostic: DBBPR05MB6393:|DBBPR05MB6393:
x-ms-exchange-purlcount: 3
x-ms-exchange-transport-forked: True
x-microsoft-antispam-prvs: <DBBPR05MB639323B2ACAA336B99059B35BD930@DBBPR05MB6393.eurprd05.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:4125;
x-forefront-prvs: 01917B1794
x-forefront-antispam-report: SFV:NSPM;SFS:(10009020)(7916004)(1496009)(4636009)(39860400002)(376002)(346002)(366004)(136003)(396003)(199004)(189003)(6916009)(5660300002)(66574012)(386003)(26005)(99286004)(7736002)(4326008)(305945005)(486006)(316002)(52116002)(76176011)(1076003)(30864003)(54906003)(25786009)(11346002)(2906002)(476003)(33656002)(446003)(4001150100001)(6506007)(8936002)(966005)(6116002)(3846002)(102836004)(45080400002)(186003)(86362001)(478600001)(81166006)(66946007)(8676002)(81156014)(71200400001)(6436002)(71190400001)(6512007)(33716001)(9686003)(5024004)(14444005)(256004)(6306002)(64756008)(66446008)(66556008)(66476007)(229853002)(14454004)(6486002)(6246003)(66066001)(95444002)(579004)(569006);DIR:OUT;SFP:1101;SCL:1;SRVR:DBBPR05MB6393;H:DBBPR05MB6364.eurprd05.prod.outlook.com;FPR:;SPF:None;LANG:en;PTR:InfoNoRecords;A:1;MX:1;
received-spf: None (protection.outlook.com: mellanox.com does not designate
 permitted sender hosts)
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
Content-Type: text/plain; charset="us-ascii"
Content-ID: <055FD309150FC94AACE821727A49677B@eurprd05.prod.outlook.com>
Content-Transfer-Encoding: quoted-printable
MIME-Version: 1.0
X-OriginatorOrg: Mellanox.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 177c9b1d-4ac6-4d33-0ef3-08d75149b56f
X-MS-Exchange-CrossTenant-originalarrivaltime: 15 Oct 2019 08:28:52.1317
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: a652971c-7d2e-4d9b-a6a4-d149256f461b
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: 9VcLDGu8FVdRvhXRHpmIkTKJuls0s1cdYSk5RREUcMOKzXJupRsObbnYjF0A54+FcC1jwnwod8tZ1z9s4ltmLQ==
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DBBPR05MB6393
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

Tue, Oct 15, 2019 at 02:40:48AM CEST, rong.a.chen@intel.com wrote:
>FYI, we noticed the following commit (built with gcc-7):
>
>commit: 4418f862d675011a242a4e687d74ea107e6a40ed ("netdevsim: implement su=
pport for devlink region and snapshots")
...
>	group: kselftests-00
>
>test-description: The kernel contains a set of "self tests" under the tool=
s/testing/selftests/ directory. These are intended to be small unit tests t=
o exercise individual code paths in the kernel.
...
orts/0/dev/take_snapshot

There's no persission to read this file. I will fix the selftest.


>#=20
># cat: /sys/kernel/debug/netdevsim/netdevsim0//ports/0/dev/take_snapshot: =
Invalid argument
...
>	make HOSTCC=3Dgcc-7 CC=3Dgcc-7 ARCH=3Dx86_64 olddefconfig prepare modules=
_prepare bzImage
>
...
>export_top_env()
>{
>	export suite=3D'kernel_selftests'
>	export testcase=3D'kernel_selftests'
>	export category=3D'functional'
>	export need_memory=3D'2G'
>	export need_cpu=3D2
>	export kernel_cmdline=3D'erst_disable'
>	export job_origin=3D'/lkp/lkp/.src-20191011-140415/allot/cyclic:vm-p1:lin=
ux-devel:devel-hourly/vm-snb/kernel_selftests.yaml'
>	export queue_cmdline_keys=3D'branch
>commit
>queue_at_least_once'
>	export queue=3D'validate'
>	export testbox=3D'vm-snb-f57ae431530c'
>	export tbox_group=3D'vm-snb'
>	export nr_vm=3D64
>	export submit_id=3D'5da4452c01cdae4816841256'
>	export job_file=3D'/lkp/jobs/scheduled/vm-snb-f57ae431530c/kernel_selftes=
ts-kselftests-00-debian-x86_64-2019-05-14.cgz-4418f862d6-20191014-18454-1rb=
bc66-3.yaml'
>	export id=3D'507f4e0f36e5d1d1910275521c9c9b32a8a2802a'
>	export queuer_version=3D'/lkp-src'
>	export arch=3D'x86_64'
>	export model=3D'qemu-system-x86_64 -enable-kvm -cpu SandyBridge'
>	export nr_cpu=3D2
>	export memory=3D'8G'
>	export hdd_partitions=3D'/dev/vda /dev/vdb /dev/vdc /dev/vdd /dev/vde /de=
v/vdf'
>	export swap_partitions=3D'/dev/vdg'
>	export need_kernel_headers=3Dtrue
>	export need_kernel_selftests=3Dtrue
>	export need_kconfig=3D'CONFIG_RUNTIME_TESTING_MENU=3Dy
...
>CONFIG_RC_DEVICES=3Dy
>CONFIG_RC_LOOPBACK
>CONFIG_IPV6_SEG6_LWTUNNEL=3Dy ~ v(4\.1[0-9]|4\.20|5\.)
>CONFIG_LWTUNNEL=3Dy
>CONFIG_WW_MUTEX_SELFTEST=3Dm ~ v(4\.1[1-9]|4\.20|5\.)
>CONFIG_DRM_DEBUG_SELFTEST=3Dm ~ v(4\.1[8-9]|4\.20|5\.)
>CONFIG_TEST_LIVEPATCH=3Dm ~ v(5\.[1-9])
>CONFIG_LIRC=3Dy
>CONFIG_RC_DECODERS=3Dy
>CONFIG_IR_SHARP_DECODER=3Dm
>CONFIG_ANDROID=3Dy ~ v(3\.[3-9]|3\.1[0-9]|4\.|5\.)
>CONFIG_STAGING=3Dy
>CONFIG_ION=3Dy ~ v(3\.1[4-9]|4\.|5\.)
>CONFIG_ION_SYSTEM_HEAP=3Dy ~ v(4\.1[2-9]|4\.20|5\.)
>CONFIG_MPLS_ROUTING=3Dm ~ v(4\.[1-9]|4\.1[0-9]|4\.20|5\.)
>CONFIG_MPLS_IPTUNNEL=3Dm ~ v(4\.[3-9]|4\.1[0-9]|4\.20|5\.)
>CONFIG_TEST_STRSCPY=3Dm ~ v(5\.2$|5\.[3-9])
>CONFIG_TEST_BLACKHOLE_DEV=3Dm ~ v(5\.[3-9])
>CONFIG_TEST_VMALLOC=3Dm ~ v(5\.[1-9])
>CONFIG_IR_IMON_DECODER=3Dm ~ v(4\.1[7-9|4\.20]|5\.)
>CONFIG_KVM_GUEST=3Dy'
>	export commit=3D'4418f862d675011a242a4e687d74ea107e6a40ed'
...
>	export enqueue_time=3D'2019-10-14 17:51:44 +0800'
>	export _id=3D'5da4452c01cdae4816841256'
>	export _rt=3D'/result/kernel_selftests/kselftests-00/vm-snb/debian-x86_64=
-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/4418f862d675011a242a4e687d74ea107e6a4=
0ed'
>	export user=3D'lkp'
>	export head_commit=3D'17fd581940448f2ea5fbf73213302c842b768f87'
>	export base_commit=3D'da0c9ea146cbe92b832f1b0f694840ea8eb33cce'
>	export branch=3D'linux-devel/devel-hourly-2019100914'
>	export result_root=3D'/result/kernel_selftests/kselftests-00/vm-snb/debia=
n-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/4418f862d675011a242a4e687d74e=
a107e6a40ed/3'
>	export scheduler_version=3D'/lkp/lkp/.src-20191014-153801'
...
>user=3Dlkp
>job=3D/lkp/jobs/scheduled/vm-snb-f57ae431530c/kernel_selftests-kselftests-=
00-debian-x86_64-2019-05-14.cgz-4418f862d6-20191014-18454-1rbbc66-3.yaml
>ARCH=3Dx86_64
>kconfig=3Dx86_64-rhel-7.6
>branch=3Dlinux-devel/devel-hourly-2019100914
>commit=3D4418f862d675011a242a4e687d74ea107e6a40ed
>BOOT_IMAGE=3D/pkg/linux/x86_64-rhel-7.6/gcc-7/4418f862d675011a242a4e687d74=
ea107e6a40ed/vmlinuz-5.3.0-rc3-00939-g4418f862d6750
>erst_disable
>max_uptime=3D3600
>RESULT_ROOT=3D/result/kernel_selftests/kselftests-00/vm-snb/debian-x86_64-=
2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/4418f862d675011a242a4e687d74ea107e6a40=
ed/3
>LKP_SERVER=3Dinn
>debug
>apic=3Ddebug
...
>vga=3Dnormal
>rw'
>	export modules_initrd=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/4418f862d675011=
a242a4e687d74ea107e6a40ed/modules.cgz'
>	export bm_initrd=3D'/osimage/deps/debian-x86_64-2018-04-03.cgz/run-ipconf=
ig_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/lkp_2019-08-05=
.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/rsync-rootfs_2018-04-03.cgz=
,/osimage/deps/debian-x86_64-2018-04-03.cgz/kernel_selftests_2019-10-13.cgz=
,/osimage/pkg/debian-x86_64-2018-04-03.cgz/kernel_selftests-x86_64-1c0cc5f1=
ae5e_2019-10-13.cgz'
>	export linux_headers_initrd=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/4418f862d=
675011a242a4e687d74ea107e6a40ed/linux-headers.cgz'
>	export linux_selftests_initrd=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/4418f86=
2d675011a242a4e687d74ea107e6a40ed/linux-selftests.cgz'
...
>	export kernel=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/4418f862d675011a242a4e6=
87d74ea107e6a40ed/vmlinuz-5.3.0-rc3-00939-g4418f862d6750'
>	export dequeue_time=3D'2019-10-14 17:51:49 +0800'
>	export job_initrd=3D'/lkp/jobs/scheduled/vm-snb-f57ae431530c/kernel_selft=
ests-kselftests-00-debian-x86_64-2019-05-14.cgz-4418f862d6-20191014-18454-1=
rbbc66-3.cgz'
>
>	[ -n "$LKP_SRC" ] ||
...
>
>	run_test group=3D'kselftests-00' $LKP_SRC/tests/wrapper kernel_selftests
>}
>
>extract_stats()
>{
