...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B9A9DB2B33
	for <lists+linux-kernel@lfdr.de>; Sat, 14 Sep 2019 14:34:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387616AbfINMcS (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sat, 14 Sep 2019 08:32:18 -0400
Received: from out02.mta.xmission.com ([166.70.13.232]:40166 "EHLO
        out02.mta.xmission.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2387462AbfINMcR (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sat, 14 Sep 2019 08:32:17 -0400
Received: from in02.mta.xmission.com ([166.70.13.52])
        by out02.mta.xmission.com with esmtps (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.87)
        (envelope-from <ebiederm@xmission.com>)
        id 1i97Ds-0003aM-6T; Sat, 14 Sep 2019 06:32:16 -0600
Received: from ip68-227-160-95.om.om.cox.net ([68.227.160.95] helo=x220.xmission.com)
        by in02.mta.xmission.com with esmtpsa (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.87)
        (envelope-from <ebiederm@xmission.com>)
        id 1i97Dp-0002oP-HB; Sat, 14 Sep 2019 06:32:16 -0600
...
Date:   Sat, 14 Sep 2019 07:31:55 -0500
In-Reply-To: <87k1apqqgk.fsf@x220.int.ebiederm.org> (Eric W. Biederman's
        message of "Tue, 03 Sep 2019 11:44:59 -0500")
Message-ID: <87blvnf490.fsf_-_@x220.int.ebiederm.org>
User-Agent: Gnus/5.13 (Gnus v5.13) Emacs/26.1 (gnu/linux)
MIME-Version: 1.0
Content-Type: text/plain
X-XM-SPF: eid=1i97Dp-0002oP-HB;;;mid=<87blvnf490.fsf_-_@x220.int.ebiederm.org>;;;hst=in02.mta.xmission.com;;;ip=68.227.160.95;;;frm=ebiederm@xmission.com;;;spf=neutral
X-XM-AID: U2FsdGVkX1/WKKW4zKjsqe/envcofroPMWToQ/iobMQ=
...
X-Spam-Timing: total 2160 ms - load_scoreonly_sql: 0.06 (0.0%),
        signal_user_changed: 16 (0.7%), b_tie_ro: 12 (0.6%), parse: 1.77
        (0.1%), extract_message_metadata: 44 (2.0%), get_uri_detail_list: 12
        (0.6%), tests_pri_-1000: 33 (1.5%), tests_pri_-950: 2.2 (0.1%),
        tests_pri_-900: 1.83 (0.1%), tests_pri_-90: 65 (3.0%), check_bayes: 62
        (2.9%), b_tokenize: 17 (0.8%), b_tok_get_all: 22 (1.0%), b_comp_prob:
        5 (0.3%), b_tok_touch_all: 10 (0.5%), b_finish: 4.3 (0.2%),
        tests_pri_0: 1962 (90.8%), check_dkim_signature: 0.94 (0.0%),
        check_dkim_adsp: 10 (0.5%), poll_dns_idle: 7 (0.3%), tests_pri_10: 3.4
        (0.2%), tests_pri_500: 28 (1.3%), rewrite_mail: 0.00 (0.0%)
