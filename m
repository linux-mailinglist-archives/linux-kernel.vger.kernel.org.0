...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0A4F826076
	for <lists+linux-kernel@lfdr.de>; Wed, 22 May 2019 11:27:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729018AbfEVJ0u (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 22 May 2019 05:26:50 -0400
Received: from smtp2200-217.mail.aliyun.com ([121.197.200.217]:53412 "EHLO
        smtp2200-217.mail.aliyun.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728766AbfEVJ0t (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 22 May 2019 05:26:49 -0400
X-Alimail-AntiSpam: AC=CONTINUE;BC=0.07436282|-1;CH=green;DM=CONTINUE|CONTINUE|true|0.187816-0.0122102-0.799974;FP=0|0|0|0|0|-1|-1|-1;HT=e02c03307;MF=han_mao@c-sky.com;NM=1;PH=DS;RN=4;RT=4;SR=0;TI=SMTPD_---.EbU0p1x_1558517207;
Received: from localhost(mailfrom:han_mao@c-sky.com fp:SMTPD_---.EbU0p1x_1558517207)
          by smtp.aliyun-inc.com(10.147.40.2);
          Wed, 22 May 2019 17:26:47 +0800
From:   Mao Han <han_mao@c-sky.com>
To:     linux-kernel@vger.kernel.org
Cc:     Mao Han <han_mao@c-sky.com>, Guo Ren <guoren@kernel.org>,
        linux-csky@vger.kernel.org
Subject: [PATCH 3/5] csky: Add pmu interrupt support
Date:   Wed, 22 May 2019 17:25:30 +0800
Message-Id: <6b44969d08c95ee7e3890caccef100ec23694f56.1558516765.git.han_mao@c-sky.com>
...
@@ -901,7 +982,9 @@ static void csky_pmu_disable(struct pmu *pmu)
...
@@ -912,16 +995,35 @@ static void csky_pmu_start(struct perf_event *event, int flags)
...
@@ -934,7 +1036,11 @@ static void csky_pmu_stop(struct perf_event *event, int flags)
...
@@ -942,12 +1048,10 @@ static void csky_pmu_del(struct perf_event *event, int flags)
...
@@ -958,8 +1062,119 @@ static int csky_pmu_add(struct perf_event *event, int flags)
 	return 0;
 }
...
@@ -1031,11 +1256,7 @@ int __init init_hw_perf_events(void)
...
@@ -1053,15 +1274,35 @@ int csky_pmu_device_probe(struct platform_device *pdev,
