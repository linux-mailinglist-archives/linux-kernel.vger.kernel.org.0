...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 411811611A7
	for <lists+linux-kernel@lfdr.de>; Mon, 17 Feb 2020 13:09:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729125AbgBQMJb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 17 Feb 2020 07:09:31 -0500
Received: from foss.arm.com ([217.140.110.172]:34714 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728897AbgBQMJb (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 17 Feb 2020 07:09:31 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id AC10230E;
        Mon, 17 Feb 2020 04:09:30 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id EFD8D3F703;
        Mon, 17 Feb 2020 04:09:27 -0800 (PST)
...
References: <20200207123847.339896630@linutronix.de>
 <20200207124403.965789141@linutronix.de>
From:   Vincenzo Frascino <vincenzo.frascino@arm.com>
X-Pep-Version: 2.0
Message-ID: <2940ba48-e53b-d6af-d893-95e5e1d026f4@arm.com>
Date:   Mon, 17 Feb 2020 12:09:26 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <20200207124403.965789141@linutronix.de>
Content-Type: multipart/mixed;
 boundary="------------7B12378F45AE4BEADCC2E35D"
...
>=20
> On powerpc, __arch_get_vdso_data() clobbers the link register, requirin=
g
> the caller to save it.
>=20
> As the parent function already has to set a stack frame and saves the l=
ink
...
> static functions which can either be called from the existing interface=
s
> with the vdso data pointer supplied via __arch_get_vdso_data() or direc=
tly
> from ASM code.
>=20
> Signed-off-by: Christophe Leroy <christophe.leroy@c-s.fr>
> Signed-off-by: Thomas Gleixner <tglx@linutronix.de>
> Link: https://lore.kernel.org/r/abf97996602ef07223fec30c005df78e5ed41b2=
e.1580399657.git.christophe.leroy@c-s.fr
>=20
