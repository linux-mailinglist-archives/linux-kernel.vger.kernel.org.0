...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 69423AD5D8
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Sep 2019 11:36:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389971AbfIIJgp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 Sep 2019 05:36:45 -0400
Received: from albert.telenet-ops.be ([195.130.137.90]:47826 "EHLO
        albert.telenet-ops.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728248AbfIIJgo (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Sep 2019 05:36:44 -0400
Received: from ramsan ([84.194.98.4])
        by albert.telenet-ops.be with bizsmtp
        id zMcc2000g05gfCL06MccyB; Mon, 09 Sep 2019 11:36:36 +0200
Received: from rox.of.borg ([192.168.97.57])
        by ramsan with esmtp (Exim 4.90_1)
        (envelope-from <geert@linux-m68k.org>)
        id 1i7G68-00060e-Fr
        for linux-kernel@vger.kernel.org; Mon, 09 Sep 2019 11:36:36 +0200
...
Subject: Build regressions/improvements in v5.3-rc8
Date:   Mon,  9 Sep 2019 11:36:36 +0200
Message-Id: <20190909093636.13059-1-geert@linux-m68k.org>
...
v5.3-rc8[1] compared to v5.2[2].

Summarized:
  - build errors: +6/-1
  - build warnings: +126/-134

JFYI, when comparing v5.3-rc8[1] to v5.3-rc7[3], the summaries are:
  - build errors: +0/-0
  - build warnings: +55/-47

Happy fixing! ;-)

Thanks to the linux-next team for providing the build service.

[1] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/f74c2bb98776e2de508f4d607cd519873065118e/ (all 242 configs)
[2] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/0ecfebd2b52404ae0c54a878c872bb93363ada36/ (all 242 configs)
[3] http://kisskb.ellerman.id.au/kisskb/branch/linus/head/089cf7f6ecb266b6a4164919a2e69bd2f938374a/ (all 242 configs)
...
126 warning regressions:
  ...
  + /kisskb/src/drivers/scsi/cxlflash/main.c: warning: this statement may fall through [-Wimplicit-fallthrough=]:  => 754:6, 975:3, 757:3, 759:3, 2347:6, 980:3, 983:3, 3018:6, 978:3
  ...
  + /kisskb/src/drivers/scsi/ncr53c8xx.c: warning: this statement may fall through [-Wimplicit-fallthrough=]:  => 3914:7, 6713:6, 3917:18, 3908:7
  ...
  + /kisskb/src/fs/nfs/read.c: warning: value computed is not used [-Wunused-value]:  => 196:5, 352:2
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U1960>]' may be used uninitialized in this function [-Wuninitialized]:  => 121:34
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U1dc0>]' may be used uninitialized in this function [-Wuninitialized]:  => 121:34
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U4000>]' may be used uninitialized in this function [-Wuninitialized]:  => 140:32
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U6140>]' may be used uninitialized in this function [-Wuninitialized]:  => 121:34, 140:32
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<U86e0>]' may be used uninitialized in this function [-Wuninitialized]:  => 140:32
  ...
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<Uc280>]' may be used uninitialized in this function [-Wuninitialized]:  => 140:32
  + /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<Ucb40>]' may be used uninitialized in this function [-Wuninitialized]:  => 140:32
...
134 warning improvements:
  ...
  - /kisskb/src/kernel/rcu/srcutree.c: warning: 'levelspread[<Ubc80>]' may be used uninitialized in this function [-Wuninitialized]: 121:34, 140:32 => 121:34
