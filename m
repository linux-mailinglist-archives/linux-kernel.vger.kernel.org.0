...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 22FC4143F65
	for <lists+linux-kernel@lfdr.de>; Tue, 21 Jan 2020 15:23:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729361AbgAUOXI (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 21 Jan 2020 09:23:08 -0500
Received: from foss.arm.com ([217.140.110.172]:43882 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727508AbgAUOXG (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 21 Jan 2020 09:23:06 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 4CBBB30E;
        Tue, 21 Jan 2020 06:23:05 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 5CB583F52E;
        Tue, 21 Jan 2020 06:23:04 -0800 (PST)
...
X-Pep-Version: 2.0
Message-ID: <8fa0e5b3-6e88-3fa2-9e16-046350cc752b@arm.com>
...
Content-Type: multipart/mixed;
 boundary="------------ADEF1A98215AA8F932CC901B"
...
--------------ADEF1A98215AA8F932CC901B
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable

Hi Greg,

I sent the fix below few days ago to the optee maintaners but I did not g=
et any
...
>=20
>   linux/drivers/tee/optee/call.c: In function =E2=80=98is_normal_memory=
=E2=80=99:
>   linux/drivers/tee/optee/call.c:533:26: error: =E2=80=98L_PTE_MT_MASK=E2=
=80=99 undeclared
>      (first use in this function); did you mean =E2=80=98PREEMPT_MASK=E2=
=80=99?
>      return (pgprot_val(p) & L_PTE_MT_MASK) =3D=3D L_PTE_MT_WRITEALLOC;=

>                              ^~~~~~~~~~~~~
>                              PREEMPT_MASK
>   linux/drivers/tee/optee/call.c:533:26: note: each undeclared identifi=
er is
>      reported only once for each function it appears in
>   linux/drivers/tee/optee/call.c:533:44: error: =E2=80=98L_PTE_MT_WRITE=
ALLOC=E2=80=99 undeclared
