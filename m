...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 51E0A22B73
	for <lists+linux-kernel@lfdr.de>; Mon, 20 May 2019 07:54:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729724AbfETFyZ (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 20 May 2019 01:54:25 -0400
Received: from mga03.intel.com ([134.134.136.65]:33046 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725829AbfETFyY (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 20 May 2019 01:54:24 -0400
X-Amp-Result: UNSCANNABLE
X-Amp-File-Uploaded: False
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga103.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 19 May 2019 22:54:17 -0700
X-ExtLoop1: 1
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by orsmga006.jf.intel.com with ESMTP; 19 May 2019 22:54:13 -0700
Date:   Mon, 20 May 2019 13:54:34 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     Trond Myklebust <trond.myklebust@hammerspace.com>
Cc:     LKML <linux-kernel@vger.kernel.org>,
        Linus Torvalds <torvalds@linux-foundation.org>, lkp@01.org
Subject: [SUNRPC]  0472e47660:  fsmark.app_overhead 16.0% regression
Message-ID: <20190520055434.GZ31424@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="pnDjx0H/VpusRTEI"
...
Content-Disposition: attachment; filename="config-5.0.0-rc7-00113-g0472e47"
...
commit'
	...
	export testbox=3D'lkp-ivb-ep01'
	export tbox_group=3D'lkp-ivb-ep01'
	export submit_id=3D'5ce07a066a702f23018a95b9'
	export job_file=3D'/lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1BR=
D_48G-4M-xfs-nfsv4-1x-64t-fsyncBeforeClose--20190519-8961-yi4g8a-3.yaml'
	export id=3D'00de3694ca424a762bbe4ca2561bd179a6388abb'
...
CONFIG_XFS_FS
CONFIG_NFS_V4'
	export commit=3D'0472e476604998c127f3c80d291113e77c5676ac'
	export kconfig=3D'x86_64-rhel-7.6'
	export compiler=3D'gcc-7'
	export rootfs=3D'debian-x86_64-2018-04-03.cgz'
	export enqueue_time=3D'2019-05-19 05:32:56 +0800'
	export _id=3D'5ce07a086a702f23018a95ba'
	export _rt=3D'/result/fsmark/performance-1BRD_48G-4M-xfs-nfsv4-1x-64t-fsyn=
cBeforeClose-40G/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/=
gcc-7/0472e476604998c127f3c80d291113e77c5676ac'
	export user=3D'lkp'
	export head_commit=3D'5d31a3395b8e0f3eeb9ad6addf570a95e542b95d'
	export base_commit=3D'e93c9c99a629c61837d5a7fc2120cd2b6c70dbdd'
	export branch=3D'linux-devel/devel-hourly-2019051813'
	export result_root=3D'/result/fsmark/performance-1BRD_48G-4M-xfs-nfsv4-1x-=
64t-fsyncBeforeClose-40G/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-r=
hel-7.6/gcc-7/0472e476604998c127f3c80d291113e77c5676ac/3'
	export scheduler_version=3D'/lkp/lkp/.src-20190518-210139'
	export LKP_SERVER=3D'inn'
	export max_uptime=3D834.16
	export initrd=3D'/osimage/debian/debian-x86_64-2018-04-03.cgz'
	export bootloader_append=3D'root=3D/dev/ram0
user=3Dlkp
job=3D/lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1BRD_48G-4M-xfs-n=
fsv4-1x-64t-fsyncBeforeClose--20190519-8961-yi4g8a-3.yaml
ARCH=3Dx86_64
kconfig=3Dx86_64-rhel-7.6
branch=3Dlinux-devel/devel-hourly-2019051813
commit=3D0472e476604998c127f3c80d291113e77c5676ac
BOOT_IMAGE=3D/pkg/linux/x86_64-rhel-7.6/gcc-7/0472e476604998c127f3c80d29111=
3e77c5676ac/vmlinuz-5.0.0-rc7-00113-g0472e47
max_uptime=3D834
RESULT_ROOT=3D/result/fsmark/performance-1BRD_48G-4M-xfs-nfsv4-1x-64t-fsync=
BeforeClose-40G/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/g=
cc-7/0472e476604998c127f3c80d291113e77c5676ac/3
LKP_SERVER=3Dinn
debug
apic=3Ddebug
...
vga=3Dnormal
rw'
	export modules_initrd=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/0472e476604998c1=
27f3c80d291113e77c5676ac/modules.cgz'
	export bm_initrd=3D'/osimage/deps/debian-x86_64-2018-04-03.cgz/run-ipconfi=
g_2018-04-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/lkp_2019-04-24.=
cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/rsync-rootfs_2018-04-03.cgz,=
/osimage/deps/debian-x86_64-2018-04-03.cgz/perf_2019-04-29.cgz,/osimage/pkg=
/debian-x86_64-2018-04-03.cgz/perf-x86_64-37624b58542f_2019-04-29.cgz,/osim=
age/deps/debian-x86_64-2018-04-03.cgz/fs_2019-05-15.cgz,/osimage/deps/debia=
n-x86_64-2018-04-03.cgz/fs2_2019-04-24.cgz,/osimage/deps/debian-x86_64-2018=
-04-03.cgz/fsmark_2018-05-17.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/=
fsmark-x86_64-_2019-04-29.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/mp=
stat_2019-04-29.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/vmstat_2019-=
05-05.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/turbostat_2019-04-29.c=
gz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/turbostat-x86_64-d5256b2_2019-=
04-29.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/mpstat-x86_64-git-1_201=
9-04-29.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/hw_2019-04-24.cgz'
	...
	export model=3D'Ivy Bridge-EP'
	export nr_node=3D2
	export nr_cpu=3D40
	export memory=3D'384G'
	export hdd_partitions=3D'/dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f9=
36347-part1 /dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-part2 /d=
ev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-part3 /dev/disk/by-id/=
scsi-36b8ca3a0e650e100228623a40f936347-part4 /dev/disk/by-id/scsi-36b8ca3a0=
e650e100228623a40f936347-part5 /dev/disk/by-id/scsi-36b8ca3a0e650e100228623=
a40f936347-part6 /dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-par=
t7 /dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-part8'
	export swap_partitions=3D
	export rootfs_partition=3D'LABEL=3DLKP-ROOTFS'
	export brand=3D'Intel(R) Xeon(R) CPU E5-2690 v2 @ 3.00GHz'
	export job_origin=3D'/lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1=
BRD_48G-4M-xfs-nfsv4-1x-64t-fsyncBeforeClose--20190519-8961-yi4g8a-3.yaml'
	export kernel=3D'/pkg/linux/x86_64-rhel-7.6/gcc-7/0472e476604998c127f3c80d=
291113e77c5676ac/vmlinuz-5.0.0-rc7-00113-g0472e47'
	export dequeue_time=3D'2019-05-19 05:40:42 +0800'
	export job_initrd=3D'/lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1=
BRD_48G-4M-xfs-nfsv4-1x-64t-fsyncBeforeClose--20190519-8961-yi4g8a-3.cgz'
...
run_job()
{
	...
	run_test filesize=3D'4M' test_size=3D'40G' sync_method=3D'fsyncBeforeClose=
' $LKP_SRC/tests/wrapper fsmark
}
...
#! /lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1BRD_48G-4M-xfs-nfsv=
4-1x-64t-fsyncBeforeClose-40-20190519-8622-aojw8a-0.yaml

#! /lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1BRD_48G-4M-xfs-nfs-=
20190516-36156-17otmln-0.yaml
...
submit_id: 5ce0758e6a702f21aefba4f7
job_file: "/lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1BRD_48G-4M-=
xfs-nfsv4-1x-64t-fsyncBeforeClose-40-20190519-8622-aojw8a-0.yaml"
id: 725d73892599be821932011bf149748c6ee8f42c
...
enqueue_time: 2019-05-19 05:13:52.072762899 +08:00
_id: 5ce0758e6a702f21aefba4f7
_rt: "/result/fsmark/performance-1BRD_48G-4M-xfs-nfsv4-1x-64t-fsyncBeforeCl=
ose-40G/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/gcc-7/047=
2e476604998c127f3c80d291113e77c5676ac"

#! schedule options
user: lkp
head_commit: 5d31a3395b8e0f3eeb9ad6addf570a95e542b95d
base_commit: e93c9c99a629c61837d5a7fc2120cd2b6c70dbdd
branch: linux-devel/devel-hourly-2019051813
result_root: "/result/fsmark/performance-1BRD_48G-4M-xfs-nfsv4-1x-64t-fsync=
BeforeClose-40G/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6/g=
cc-7/0472e476604998c127f3c80d291113e77c5676ac/0"
...
- root=3D/dev/ram0
- user=3Dlkp
- job=3D/lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1BRD_48G-4M-xfs=
-nfsv4-1x-64t-fsyncBeforeClose-40-20190519-8622-aojw8a-0.yaml
- ARCH=3Dx86_64
- kconfig=3Dx86_64-rhel-7.6
- branch=3Dlinux-devel/devel-hourly-2019051813
- commit=3D0472e476604998c127f3c80d291113e77c5676ac
- BOOT_IMAGE=3D/pkg/linux/x86_64-rhel-7.6/gcc-7/0472e476604998c127f3c80d291=
113e77c5676ac/vmlinuz-5.0.0-rc7-00113-g0472e47
- max_uptime=3D834
- RESULT_ROOT=3D/result/fsmark/performance-1BRD_48G-4M-xfs-nfsv4-1x-64t-fsy=
ncBeforeClose-40G/lkp-ivb-ep01/debian-x86_64-2018-04-03.cgz/x86_64-rhel-7.6=
/gcc-7/0472e476604998c127f3c80d291113e77c5676ac/0
- LKP_SERVER=3Dinn
- debug
- apic=3Ddebug
- sysrq_always_enabled
...
- vga=3Dnormal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/0472e476604998c127f3c80d2=
91113e77c5676ac/modules.cgz"
bm_initrd: "/osimage/deps/debian-x86_64-2018-04-03.cgz/run-ipconfig_2018-04=
-03.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/lkp_2019-04-24.cgz,/osim=
age/deps/debian-x86_64-2018-04-03.cgz/rsync-rootfs_2018-04-03.cgz,/osimage/=
deps/debian-x86_64-2018-04-03.cgz/perf_2019-04-29.cgz,/osimage/pkg/debian-x=
86_64-2018-04-03.cgz/perf-x86_64-37624b58542f_2019-04-29.cgz,/osimage/deps/=
debian-x86_64-2018-04-03.cgz/fs_2019-05-15.cgz,/osimage/deps/debian-x86_64-=
2018-04-03.cgz/fs2_2019-04-24.cgz,/osimage/deps/debian-x86_64-2018-04-03.cg=
z/fsmark_2018-05-17.cgz,/osimage/pkg/debian-x86_64-2018-04-03.cgz/fsmark-x8=
6_64-_2019-04-29.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/mpstat_2019=
-04-29.cgz,/osimage/deps/debian-x86_64-2018-04-03.cgz/vmstat_2019-05-05.cgz=
,/osimage/deps/debian-x86_64-2018-04-03.cgz/turbostat_2019-04-29.cgz,/osima=
ge/pkg/debian-x86_64-2018-04-03.cgz/turbostat-x86_64-d5256b2_2019-04-29.cgz=
,/osimage/pkg/debian-x86_64-2018-04-03.cgz/mpstat-x86_64-git-1_2019-04-29.c=
gz,/osimage/deps/debian-x86_64-2018-04-03.cgz/hw_2019-04-24.cgz"
lkp_initrd: "/lkp/lkp/lkp-x86_64.cgz"
site: inn

#! /lkp/lkp/.src-20190518-042017/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer:=20
watchdog:=20
...
nr_cpu: 40
memory: 384G
hdd_partitions: "/dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-par=
t1 /dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-part2
  /dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-part3 /dev/disk/by=
-id/scsi-36b8ca3a0e650e100228623a40f936347-part4
  /dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-part5 /dev/disk/by=
-id/scsi-36b8ca3a0e650e100228623a40f936347-part6
  /dev/disk/by-id/scsi-36b8ca3a0e650e100228623a40f936347-part7 /dev/disk/by=
-id/scsi-36b8ca3a0e650e100228623a40f936347-part8"
swap_partitions:=20
rootfs_partition: LABEL=3DLKP-ROOTFS
brand: Intel(R) Xeon(R) CPU E5-2690 v2 @ 3.00GHz

#! user overrides
job_origin: "/lkp/jobs/scheduled/lkp-ivb-ep01/fsmark-performance-1BRD_48G-4=
M-xfs-nfsv4-1x-64t-fsyncBeforeClose-40-20190519-8622-aojw8a-0.yaml"
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/0472e476604998c127f3c80d291113e77=
c5676ac/vmlinuz-5.0.0-rc7-00113-g0472e47"
dequeue_time: 2019-05-19 05:22:58.107364367 +08:00

#! /lkp/lkp/.src-20190518-210139/include/site/inn
job_state: finished
loadavg: 19.62 5.88 2.04 1/468 3594
start_time: '1558214782'
end_time: '1558214813'
