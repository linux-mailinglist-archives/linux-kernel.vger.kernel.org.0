...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 429EBFBA63
	for <lists+linux-kernel@lfdr.de>; Wed, 13 Nov 2019 22:03:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727437AbfKMVD0 (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 13 Nov 2019 16:03:26 -0500
Received: from Galois.linutronix.de ([193.142.43.55]:38873 "EHLO
        Galois.linutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726980AbfKMVCV (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 13 Nov 2019 16:02:21 -0500
Received: from localhost ([127.0.0.1] helo=nanos.tec.linutronix.de)
        by Galois.linutronix.de with esmtp (Exim 4.80)
        (envelope-from <tglx@linutronix.de>)
        id 1iUzmM-00066l-LY; Wed, 13 Nov 2019 22:02:18 +0100
Message-Id: <20191113210104.493587550@linutronix.de>
User-Agent: quilt/0.65
Date:   Wed, 13 Nov 2019 21:42:48 +0100
...
Subject: [patch V3 08/20] x86/io: Speedup schedule out of I/O bitmap user
...
V3: Moved the changes required to make the first invocation of ioperm()
    correct into a seperate patch. (Incorrectness pointed out by Andy)
...
@@ -84,6 +84,8 @@ long ksys_ioperm(unsigned long from, uns
