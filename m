...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 64B2D5671C
	for <lists+linux-kernel@lfdr.de>; Wed, 26 Jun 2019 12:46:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727127AbfFZKqg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 26 Jun 2019 06:46:36 -0400
Received: from mail-eopbgr760129.outbound.protection.outlook.com ([40.107.76.129]:35119
        "EHLO NAM02-CY1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726387AbfFZKqf (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 26 Jun 2019 06:46:35 -0400
...
x-microsoft-antispam: BCL:0;PCL:0;RULEID:(2390118)(7020095)(4652040)(8989299)(4534185)(4627221)(201703031133081)(201702281549075)(8990200)(5600148)(711020)(4605104)(1401327)(2017052603328)(7193020);SRVR:MN2PR04MB6397;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 26 Jun 2019 10:44:38.4694
 (UTC)
...
-
-static const u8 anx78xx_i2c_addresses[] =3D {
-	[I2C_IDX_TX_P0] =3D TX_P0,
-	[I2C_IDX_TX_P1] =3D TX_P1,
-	[I2C_IDX_TX_P2] =3D TX_P2,
-	[I2C_IDX_RX_P0] =3D RX_P0,
-	[I2C_IDX_RX_P1] =3D RX_P1,
-};
-
...
-	int err;
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_TX_P0], SP_DP_AUX_CH_CTRL2_REG,
-			  &value);
-	if (err < 0)
-		return false;
-
-	return (value & SP_AUX_EN) =3D=3D 0;
-}
-
...
-	err =3D regmap_read(anx78xx->map[I2C_IDX_TX_P0], SP_AUX_CH_STATUS_REG,
-			  &status);
-	if (err < 0) {
...
-	int err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_AUX_ADDR_7_0_REG,
-			   addr & 0xff);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_AUX_ADDR_15_8_REG,
-			   (addr & 0xff00) >> 8);
-	if (err)
-		return err;
-
...
-	 */
-	err =3D regmap_update_bits(anx78xx->map[I2C_IDX_TX_P0],
...
-{
-	struct anx78xx *anx78xx =3D container_of(aux, struct anx78xx, aux);
-	u8 ctrl1 =3D msg->request;
-	u8 ctrl2 =3D SP_AUX_EN;
...
-	if (msg->size < 1)
-		ctrl2 |=3D SP_ADDR_ONLY;
-	else	/* For non-zero-sized set the length field. */
-		ctrl1 |=3D (msg->size - 1) << SP_AUX_LENGTH_SHIFT;
-
-	if ((msg->request & DP_AUX_I2C_READ) =3D=3D 0) {
-		/* When WRITE | MOT write values to data buffer */
-		err =3D regmap_bulk_write(anx78xx->map[I2C_IDX_TX_P0],
...
-	err =3D anx78xx_aux_address(anx78xx, msg->address);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_DP_AUX_CH_CTRL1_REG,
-			   ctrl1);
-	if (err)
-		return err;
-
...
-		return err;
-
-	err =3D anx78xx_aux_wait(anx78xx);
-	if (err)
-		return err;
-
-	msg->reply =3D DP_AUX_I2C_REPLY_ACK;
-
-	if ((msg->size > 0) && (msg->request & DP_AUX_I2C_READ)) {
-		/* Read values from data buffer */
-		err =3D regmap_bulk_read(anx78xx->map[I2C_IDX_TX_P0],
-				       SP_DP_BUF_DATA0_REG, buffer,
-				       msg->size);
-		if (err)
-			return err;
-	}
-
-	err =3D anx78xx_clear_bits(anx78xx->map[I2C_IDX_TX_P0],
-				 SP_DP_AUX_CH_CTRL2_REG, SP_ADDR_ONLY);
-	if (err)
-		return err;
-
...
-	int err;
-
-	err =3D anx78xx_clear_bits(anx78xx->map[I2C_IDX_RX_P0],
-				 SP_TMDS_CTRL_BASE + 7, SP_PD_RT);
-	if (err)
-		return err;
-
-	err =3D anx78xx_set_bits(anx78xx->map[I2C_IDX_TX_P2], SP_VID_CTRL3_REG,
-			       SP_HPD_OUT);
-	if (err)
-		return err;
-
...
-	int err;
-
-	err =3D anx78xx_clear_bits(anx78xx->map[I2C_IDX_TX_P2], SP_VID_CTRL3_REG,
-				 SP_HPD_OUT);
-	if (err)
-		return err;
-
-	err =3D anx78xx_set_bits(anx78xx->map[I2C_IDX_RX_P0],
-			       SP_TMDS_CTRL_BASE + 7, SP_PD_RT);
-	if (err)
-		return err;
-
...
-}
-
-static const struct reg_sequence tmds_phy_initialization[] =3D {
...
-	int err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_RX_P0], SP_HDMI_MUTE_CTRL_REG,
-			   SP_AUD_MUTE | SP_VID_MUTE);
-	if (err)
-		return err;
-
-	err =3D anx78xx_set_bits(anx78xx->map[I2C_IDX_RX_P0], SP_CHIP_CTRL_REG,
...
-		return err;
-
-	err =3D anx78xx_set_bits(anx78xx->map[I2C_IDX_RX_P0], SP_AUDVID_CTRL_REG,
...
-	err =3D regmap_multi_reg_write(anx78xx->map[I2C_IDX_RX_P0],
-				     tmds_phy_initialization,
-				     ARRAY_SIZE(tmds_phy_initialization));
-	if (err)
-		return err;
-
-	err =3D anx78xx_clear_hpd(anx78xx);
-	if (err)
-		return err;
-
-	return 0;
-}
-
-static const u8 dp_tx_output_precise_tune_bits[20] =3D {
...
-	 * register.
-	 */
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P2], SP_ANALOG_CTRL0_REG,
-			   0x02);
-	if (err)
-		return err;
-
...
-	 */
-	err =3D regmap_bulk_write(anx78xx->map[I2C_IDX_TX_P1],
...
-	int err;
-
-	err =3D regmap_update_bits(anx78xx->map[I2C_IDX_TX_P2],
...
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_DP_AUX_CH_CTRL3_REG,
-			   XTAL_CLK & SP_WAIT_COUNTER_7_0_MASK);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_DP_AUX_CH_CTRL4_REG,
...
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_AUX_MISC_CTRL_REG,
-			   XTAL_CLK / 10 - 1);
-	if (err)
-		return err;
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_RX_P0],
-			  SP_HDMI_US_TIMER_CTRL_REG,
-			  &value);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_RX_P0],
-			   SP_HDMI_US_TIMER_CTRL_REG,
...
-}
-
-static const struct reg_sequence otp_key_protect[] =3D {
...
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_DP_AUX_CH_CTRL2_REG,
-			   0x30);
-	if (err)
-		return err;
-
-	/* Enable aux double diff output */
-	err =3D anx78xx_set_bits(anx78xx->map[I2C_IDX_TX_P0],
...
-		return err;
-
-	err =3D regmap_multi_reg_write(anx78xx->map[I2C_IDX_TX_P0],
-				     otp_key_protect,
...
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P2], SP_VID_CTRL8_REG,
-			   SP_VID_VRES_TH);
-	if (err)
-		return err;
-
...
-	 */
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_HDCP_AUTO_TIMER_REG,
-			   0x00);
-	if (err)
-		return err;
-
...
-		return err;
-
-	err =3D anx78xx_set_bits(anx78xx->map[I2C_IDX_TX_P2],
-			       SP_ANALOG_DEBUG2_REG, SP_POWERON_TIME_1P5MS);
-	if (err)
-		return err;
-
-	err =3D anx78xx_xtal_clk_sel(anx78xx);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_AUX_DEFER_CTRL_REG,
...
-		return err;
-
-	err =3D anx78xx_link_phy_initialization(anx78xx);
-	if (err)
-		return err;
-
...
-
-	/*
-	 * BIT0: INT pin assertion polarity: 1 =3D assert high
-	 * BIT1: INT pin output type: 0 =3D push/pull
-	 */
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P2], SP_INT_CTRL_REG, 0x01);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P2],
-			   SP_COMMON_INT_MASK4_REG, SP_HPD_LOST | SP_HPD_PLUG);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P2], SP_DP_INT_MASK1_REG,
-			   SP_TRAINING_FINISH);
-	if (err)
-		return err;
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_RX_P0], SP_INT_MASK1_REG,
...
-{
-	struct anx78xx_platform_data *pdata =3D &anx78xx->pdata;
-	int err;
-
...
-
-	if (pdata->dvdd10) {
-		err =3D regulator_enable(pdata->dvdd10);
-		if (err) {
...
-
-	if (pdata->dvdd10) {
-		err =3D regulator_disable(pdata->dvdd10);
-		if (err) {
...
-				 SP_LINK_PD);
-
-	err =3D anx78xx_enable_interrupts(anx78xx);
-	if (err) {
-		DRM_ERROR("Failed to enable interrupts: %d\n", err);
-		goto err_poweroff;
-	}
-
-	err =3D anx78xx_rx_initialization(anx78xx);
-	if (err) {
-		DRM_ERROR("Failed receiver initialization: %d\n", err);
-		goto err_poweroff;
-	}
-
-	err =3D anx78xx_tx_initialization(anx78xx);
-	if (err) {
...
-{
-	struct anx78xx_platform_data *pdata =3D &anx78xx->pdata;
-	struct device *dev =3D &anx78xx->client->dev;
-
-	/* 1.0V digital core power regulator  */
-	pdata->dvdd10 =3D devm_regulator_get(dev, "dvdd10");
...
-
-	/* GPIO for HPD */
-	pdata->gpiod_hpd =3D devm_gpiod_get(dev, "hpd", GPIOD_IN);
-	if (IS_ERR(pdata->gpiod_hpd))
-		return PTR_ERR(pdata->gpiod_hpd);
-
-	/* GPIO for chip power down */
-	pdata->gpiod_pd =3D devm_gpiod_get(dev, "pd", GPIOD_OUT_HIGH);
-	if (IS_ERR(pdata->gpiod_pd))
-		return PTR_ERR(pdata->gpiod_pd);
-
-	/* GPIO for chip reset */
-	pdata->gpiod_reset =3D devm_gpiod_get(dev, "reset", GPIOD_OUT_LOW);
-
...
-		return err;
-
-	err =3D drm_dp_dpcd_readb(&anx78xx->aux, DP_MAX_LINK_RATE, &dp_bw);
-	if (err < 0)
-		return err;
-
-	switch (dp_bw) {
...
-	}
-
-	err =3D anx78xx_set_bits(anx78xx->map[I2C_IDX_TX_P2], SP_VID_CTRL1_REG,
-			       SP_VIDEO_MUTE);
-	if (err)
-		return err;
-
...
-
-	/* Get DPCD info */
-	err =3D drm_dp_dpcd_read(&anx78xx->aux, DP_DPCD_REV,
...
-	err =3D drm_dp_link_probe(&anx78xx->aux, &anx78xx->link);
-	if (err < 0) {
...
-
-	/* Power up the sink */
-	err =3D drm_dp_link_power_up(&anx78xx->aux, &anx78xx->link);
-	if (err < 0) {
...
-			return err;
-
-		err =3D drm_dp_dpcd_writeb(&anx78xx->aux, DP_DOWNSPREAD_CTRL,
-					 DP_SPREAD_AMP_0_5);
-		if (err < 0)
-			return err;
-	} else {
-		err =3D drm_dp_dpcd_writeb(&anx78xx->aux, DP_DOWNSPREAD_CTRL, 0);
-		if (err < 0)
-			return err;
-	}
-
...
-		return err;
-
-	value =3D drm_dp_link_rate_to_bw_code(anx78xx->link.rate);
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0],
-			   SP_DP_MAIN_LINK_BW_SET_REG, value);
-	if (err)
-		return err;
-
-	err =3D drm_dp_link_configure(&anx78xx->aux, &anx78xx->link);
-	if (err < 0) {
...
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P0], SP_DP_LT_CTRL_REG,
-			   SP_LT_EN);
-	if (err)
-		return err;
-
...
-	int err;
-
-	err =3D anx78xx_clear_bits(anx78xx->map[I2C_IDX_TX_P2], SP_VID_CTRL1_REG,
-				 SP_VIDEO_MUTE);
-	if (err)
-		return err;
-
...
-		return err;
-
-	err =3D regmap_bulk_write(anx78xx->map[I2C_IDX_TX_P2],
...
-	int err;
-
-	err =3D drm_dp_dpcd_readb(&anx78xx->aux, DP_SINK_COUNT, &value);
-	if (err < 0) {
...
-{
-	struct anx78xx *anx78xx =3D connector_to_anx78xx(connector);
...
-
-	err =3D anx78xx_get_downstream_info(anx78xx);
-	if (err) {
...
-}
-
-static const struct drm_connector_helper_funcs anx78xx_connector_helper_fu=
ncs =3D {
-	.get_modes =3D anx78xx_get_modes,
-};
-
-static enum drm_connector_status anx78xx_detect(struct drm_connector *conn=
ector,
-						bool force)
-{
-	struct anx78xx *anx78xx =3D connector_to_anx78xx(connector);
...
-}
-
-static const struct drm_connector_funcs anx78xx_connector_funcs =3D {
-	.fill_modes =3D drm_helper_probe_single_connector_modes,
-	.detect =3D anx78xx_detect,
...
-{
-	struct anx78xx *anx78xx =3D bridge_to_anx78xx(bridge);
-	int err;
-
-	if (!bridge->encoder) {
...
-	anx78xx->aux.name =3D "DP-AUX";
-	anx78xx->aux.dev =3D &anx78xx->client->dev;
-	anx78xx->aux.transfer =3D anx78xx_aux_transfer;
-
-	err =3D drm_dp_aux_register(&anx78xx->aux);
-	if (err < 0) {
...
-
-	err =3D drm_connector_register(&anx78xx->connector);
-	if (err) {
-		DRM_ERROR("Failed to register connector: %d\n", err);
-		return err;
-	}
-
-	anx78xx->connector.polled =3D DRM_CONNECTOR_POLL_HPD;
-
-	err =3D drm_connector_attach_encoder(&anx78xx->connector,
-					   bridge->encoder);
-	if (err) {
...
-	}
-
-	err =3D anx78xx_send_video_infoframe(anx78xx, &frame);
-	if (err)
...
-	int err;
-
-	err =3D anx78xx_start(anx78xx);
-	if (err) {
-		DRM_ERROR("Failed to initialize: %d\n", err);
-		return;
-	}
-
-	err =3D anx78xx_set_hpd(anx78xx);
-	if (err)
-		DRM_ERROR("Failed to set HPD: %d\n", err);
-}
-
-static const struct drm_bridge_funcs anx78xx_bridge_funcs =3D {
-	.attach =3D anx78xx_bridge_attach,
-	.mode_valid =3D anx78xx_bridge_mode_valid,
-	.disable =3D anx78xx_bridge_disable,
-	.mode_set =3D anx78xx_bridge_mode_set,
-	.enable =3D anx78xx_bridge_enable,
-};
-
-static irqreturn_t anx78xx_hpd_threaded_handler(int irq, void *data)
-{
-	struct anx78xx *anx78xx =3D data;
-	int err;
-
-	if (anx78xx->powered)
-		return IRQ_HANDLED;
...
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_TX_P2], SP_DP_INT_STATUS1_REG,
-			   irq);
-	if (err)
-		return err;
-
...
-		err =3D anx78xx_config_dp_output(anx78xx);
-	}
-
-	return err;
-}
...
-
-	err =3D regmap_write(anx78xx->map[I2C_IDX_RX_P0], SP_INT_STATUS1_REG,
-			   irq);
-	if (err) {
...
-		}
-
-		err =3D anx78xx_dp_link_training(anx78xx);
-		if (err)
...
-	mutex_lock(&anx78xx->lock);
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_TX_P2], SP_DP_INT_STATUS1_REG,
-			  &irq);
-	if (err) {
...
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_TX_P2],
-			  SP_COMMON_INT_STATUS4_REG, &irq);
-	if (err) {
...
-
-	if (irq)
-		event =3D anx78xx_handle_common_int_4(anx78xx, irq);
-
-	/* Make sure we are still powered after handle HPD events */
-	if (!anx78xx->powered)
-		goto unlock;
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_RX_P0], SP_INT_STATUS1_REG,
-			  &irq);
-	if (err) {
...
-	unsigned int i;
-
-	for (i =3D 0; i < ARRAY_SIZE(anx78xx->i2c_dummy); i++)
-		i2c_unregister_device(anx78xx->i2c_dummy[i]);
-}
-
-static const struct regmap_config anx78xx_regmap_config =3D {
-	.reg_bits =3D 8,
-	.val_bits =3D 8,
-};
-
-static const u16 anx78xx_chipid_list[] =3D {
-	0x7812,
-	0x7814,
-	0x7818,
-};
...
-	int err;
-
-	anx78xx =3D devm_kzalloc(&client->dev, sizeof(*anx78xx), GFP_KERNEL);
-	if (!anx78xx)
-		return -ENOMEM;
-
...
-
-	err =3D anx78xx_init_pdata(anx78xx);
-	if (err) {
-		DRM_ERROR("Failed to initialize pdata: %d\n", err);
-		return err;
-	}
-
-	pdata->hpd_irq =3D gpiod_to_irq(pdata->gpiod_hpd);
-	if (pdata->hpd_irq < 0) {
-		DRM_ERROR("Failed to get HPD IRQ: %d\n", pdata->hpd_irq);
-		return -ENODEV;
-	}
-
-	pdata->intp_irq =3D client->irq;
-	if (!pdata->intp_irq) {
...
-		anx78xx->i2c_dummy[i] =3D i2c_new_dummy(client->adapter,
...
-		}
-
-		anx78xx->map[i] =3D devm_regmap_init_i2c(anx78xx->i2c_dummy[i],
-						       &anx78xx_regmap_config);
-		if (IS_ERR(anx78xx->map[i])) {
-			err =3D PTR_ERR(anx78xx->map[i]);
...
-	anx78xx_poweron(anx78xx);
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_TX_P2], SP_DEVICE_IDL_REG,
-			  &idl);
-	if (err)
-		goto err_poweroff;
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_TX_P2], SP_DEVICE_IDH_REG,
-			  &idh);
-	if (err)
-		goto err_poweroff;
-
-	anx78xx->chipid =3D (u8)idl | ((u8)idh << 8);
-
-	err =3D regmap_read(anx78xx->map[I2C_IDX_TX_P2], SP_DEVICE_VERSION_REG,
-			  &version);
-	if (err)
-		goto err_poweroff;
-
-	for (i =3D 0; i < ARRAY_SIZE(anx78xx_chipid_list); i++) {
-		if (anx78xx->chipid =3D=3D anx78xx_chipid_list[i]) {
...
-	}
-
-	err =3D devm_request_threaded_irq(&client->dev, pdata->hpd_irq, NULL,
...
-	}
-
-	err =3D devm_request_threaded_irq(&client->dev, pdata->intp_irq, NULL,
...
+MODULE_AUTHOR("Enric Balletbo i Serra <enric.balletbo@collabora.com>");
+MODULE_LICENSE("GPL v2");
diff --git a/drivers/gpu/drm/bridge/analogix/analogix-anx78xx.h b/drivers/g=
pu/drm/bridge/analogix/analogix-anx78xx.h
new file mode 100644
