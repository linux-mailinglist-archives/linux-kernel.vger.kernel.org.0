...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 909584B156
	for <lists+linux-kernel@lfdr.de>; Wed, 19 Jun 2019 07:27:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730966AbfFSF1s (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 19 Jun 2019 01:27:48 -0400
Received: from mail-pg1-f196.google.com ([209.85.215.196]:44219 "EHLO
        mail-pg1-f196.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730879AbfFSF1l (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 19 Jun 2019 01:27:41 -0400
Received: by mail-pg1-f196.google.com with SMTP id n2so8960881pgp.11
        for <linux-kernel@vger.kernel.org>; Tue, 18 Jun 2019 22:27:40 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xf/uPorlfVTTIgi+soiDdDdu544GX8obCg04DyshIGc=;
        b=
X-Gm-Message-State: APjAAAVxYHd2qsSW/W0UQj1EQx+p/tolMVhk1AMMKC3JJVU4XL+H7KOw
        7pxRS91qQ3HfOU5BS3KyLnc=
...
Subject: [PATCH v6 05/15] drm/bridge: tc358767: Drop custom tc_write()/tc_read() accessors
...
+		return ret;
 	...
 	switch (rate) {
@@ -855,27 +905,36 @@ static int tc_main_link_enable(struct tc_data *tc)
 		return -EINVAL;
 	}
 	value |= SYSCLK_SEL_LSCLK | LSCLK_DIV_2;
-	tc_write(SYS_PLLPARAM, value);
...
+	ret = regmap_write(tc->regmap, DP_PHY_CTRL, dp_phy_ctrl);
 	...
 	ret = tc_poll_timeout(tc, DP_PHY_CTRL, PHY_RDY, PHY_RDY, 1, 1000);
 	if (ret) {
@@ -886,7 +945,7 @@ static int tc_main_link_enable(struct tc_data *tc)
...
+		return -ENODEV;
 	...
 	/*
@@ -998,7 +1075,10 @@ static int tc_main_link_enable(struct tc_data *tc)
 	 */
...
@@ -1035,6 +1115,7 @@ static int tc_main_link_enable(struct tc_data *tc)
 		}
 	}
...
@@ -1042,7 +1123,7 @@ static int tc_main_link_enable(struct tc_data *tc)
...
+		return ret;
 	...
 	return 0;
@@ -1051,7 +1132,6 @@ static int tc_main_link_enable(struct tc_data *tc)
 	return ret;
 err_dpcd_write:
...
@@ -1061,12 +1141,11 @@ static int tc_main_link_disable(struct tc_data *tc)
...
@@ -1081,7 +1160,7 @@ static int tc_stream_enable(struct tc_data *tc)
...
@@ -1096,7 +1175,9 @@ static int tc_stream_enable(struct tc_data *tc)
...
@@ -1106,36 +1187,35 @@ static int tc_stream_enable(struct tc_data *tc)
 	 */
...
@@ -1327,7 +1407,9 @@ static enum drm_connector_status tc_connector_detect(struct drm_connector *conne
...
@@ -1335,9 +1417,6 @@ static enum drm_connector_status tc_connector_detect(struct drm_connector *conne
