...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B00E2129634
	for <lists+linux-kernel@lfdr.de>; Mon, 23 Dec 2019 14:02:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726897AbfLWNCb (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 23 Dec 2019 08:02:31 -0500
Received: from mail-eopbgr50050.outbound.protection.outlook.com ([40.107.5.50]:31717
        "EHLO EUR03-VE1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726729AbfLWNCb (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 23 Dec 2019 08:02:31 -0500
...
Received: from VI1PR08CA0181.eurprd08.prod.outlook.com (2603:10a6:800:d2::11)
 by VI1PR08MB3790.eurprd08.prod.outlook.com (2603:10a6:803:bc::16) with
...
Received: from DB5EUR03FT053.eop-EUR03.prod.protection.outlook.com
 (2a01:111:f400:7e0a::201) by VI1PR08CA0181.outlook.office365.com
...
Received: ("Tessian outbound 1da651c29646:v40"); Mon, 23 Dec 2019 13:02:22 +0000
X-CheckRecipientChecked: true
X-CR-MTA-CID: e8a53e6a0195c0d5
X-CR-MTA-TID: 64aa7808
Received: from f05765637ff9.3
        by 64aa7808-outbound-1.mta.getcheckrecipient.com id 31A55EF5-5FAC-46B2-A251-F0059CA6F874.1;
...
X-MS-Office365-Filtering-Correlation-Id: d564c9b7-8412-4c76-e4b0-08d787a859f0
X-MS-TrafficTypeDiagnostic: VI1PR08MB3760:|VI1PR08MB3760:|VI1PR08MB3790:
x-ms-exchange-transport-forked: True
X-Microsoft-Antispam-PRVS: <VI1PR08MB379051CC449786B9B28881E08F2E0@VI1PR08MB3790.eurprd08.prod.outlook.com>
...
X-Forefront-Antispam-Report: CIP:63.35.35.123;IPV:CAL;SCL:-1;CTRY:IE;EFV:NLI;SFV:NSPM;SFS:(10009020)(4636009)(7916004)(136003)(396003)(376002)(346002)(39860400002)(199004)(189003)(26005)(9686003)(6512007)(8676002)(86362001)(81166006)(81156014)(6636002)(2906002)(186003)(33716001)(6862004)(8936002)(54906003)(70206006)(70586007)(316002)(76130400001)(26826003)(6506007)(356004)(4326008)(5660300002)(478600001)(336012)(6486002)(39026012);DIR:OUT;SFP:1101;SCL:1;SRVR:VI1PR08MB3790;H:64aa7808-outbound-1.mta.getcheckrecipient.com;FPR:;SPF:Pass;LANG:en;PTR:ec2-63-35-35-123.eu-west-1.compute.amazonaws.com;A:1;MX:1;
...
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 23 Dec 2019 13:02:22.8678
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: d564c9b7-8412-4c76-e4b0-08d787a859f0
...
> @@ -27,12 +28,16 @@ static int komeda_register_show(struct seq_file *sf, =
void *x)
> =20
...
>  }
> =20
> @@ -263,15 +268,6 @@ struct komeda_dev *komeda_dev_create(struct device *=
dev)
>  	if (!mdev->iommu)
...
> @@ -307,10 +307,6 @@ struct komeda_kms_dev *komeda_kms_attach(struct kome=
da_dev *mdev)
>  	if (err)
...
> @@ -324,7 +320,6 @@ struct komeda_kms_dev *komeda_kms_attach(struct komed=
a_dev *mdev)
>  free_interrupts:
