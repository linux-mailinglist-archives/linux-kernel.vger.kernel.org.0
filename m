...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1015915003F
	for <lists+linux-kernel@lfdr.de>; Mon,  3 Feb 2020 02:27:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727156AbgBCB1E (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 2 Feb 2020 20:27:04 -0500
Received: from bombadil.infradead.org ([198.137.202.133]:41826 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726393AbgBCB1D (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 2 Feb 2020 20:27:03 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        List-Help:List-Unsubscribe:List-Subscribe:List-Post:List-Owner:List-Archive;
         bh=LGy6AsLHI+WRaVWTMjwBw9EVKhmQgS9t+lcjp0BomOs=; b=SG5MygqWJEBa/x+a4NXzq1L+d
        ;
Received: from willy by bombadil.infradead.org with local (Exim 4.92.3 #3 (Red Hat Linux))
        id 1iyQVy-0000XD-OZ
        for linux-kernel@vger.kernel.org; Mon, 03 Feb 2020 01:27:02 +0000
Date:   Sun, 2 Feb 2020 17:27:02 -0800
From:   Matthew Wilcox <willy@infradead.org>
To:     linux-kernel@vger.kernel.org
Subject: Current Linus tree protection fault in __kmalloc
Message-ID: <20200203012702.GA8731@bombadil.infradead.org>
MIME-Version: 1.0
...
[    0.830009] VFS: Disk quotas dquot_6.6.0
[    0.830987] general protection fault, probably for non-canonical address=
 0x9896808086a201: 0000 [#1] SMP PTI
[    0.831946] CPU: 0 PID: 1 Comm: swapper/0 Not tainted 5.5.0-08726-g46d6b=
7becb1d #2
[    0.831946] Hardware name: QEMU Standard PC (i440FX + PIIX, 1996), BIOS =
1.13.0-1 04/01/2014
[    0.831946] RIP: 0010:__kmalloc+0x93/0x290
[    0.831946] Code: c9 0f 84 9a 01 00 00 4d 8b 01 65 49 8b 50 08 65 4c 03 =
05 f8 b4 76 68 4d 8b 20 4d 85 e4 0f 84 b5 01 00 00 41 8b 41 20 49 8b 39 <49=
> 8b 1c 04 40 f6 c7 0f 0f 85 c2 01 00 00 48 8d 4a 01 4c 89 e0 65
[    0.831946] RSP: 0000:ffffbae280013d38 EFLAGS: 00010202
[    0.831946] RAX: 0000000000000000 RBX: 0000000000000dc0 RCX: 00000000000=
00000
[    0.831946] RDX: 000000000000012c RSI: 0000000000000dc0 RDI: 00000000000=
31120
[    0.831946] RBP: 0000000000000dc0 R08: ffff92e56a631120 R09: ffff92e507c=
02fc0
[    0.831946] R10: 0000000000000730 R11: 0000000000000000 R12: 00989680808=
6a201
[    0.831946] R13: 00000000000000fe R14: ffffffff97988098 R15: ffff92e507c=
02fc0
[    0.831946] FS:  0000000000000000(0000) GS:ffff92e56a600000(0000) knlGS:=
0000000000000000
[    0.831946] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
[    0.831946] CR2: 0000000000000000 CR3: 000000010e20a000 CR4: 00000000000=
006f0
[    0.831946] Call Trace:
[    0.831946]  __register_sysctl_table+0x388/0x510
[    0.831946]  ? kmem_cache_alloc_trace+0x1ea/0x240
[    0.831946]  ? __register_sysctl_paths+0x61/0x1f0
[    0.831946]  __register_sysctl_paths+0x1c2/0x1f0
[    0.831946]  ? iomap_init+0x20/0x20
[    0.831946]  dquot_init+0x2c/0x110
[    0.831946]  do_one_initcall+0x46/0x210
[    0.831946]  kernel_init_freeable+0x1ae/0x223
[    0.831946]  ? rest_init+0xc6/0xc6
[    0.831946]  kernel_init+0xa/0x10a
[    0.831946]  ret_from_fork+0x35/0x40
[    0.831946] Modules linked in:
[    0.860703] ---[ end trace aab9e66160eed7d5 ]---
[    0.861773] RIP: 0010:__kmalloc+0x93/0x290
[    0.862697] Code: c9 0f 84 9a 01 00 00 4d 8b 01 65 49 8b 50 08 65 4c 03 =
05 f8 b4 76 68 4d 8b 20 4d 85 e4 0f 84 b5 01 00 00 41 8b 41 20 49 8b 39 <49=
> 8b 1c 04 40 f6 c7 0f 0f 85 c2 01 00 00 48 8d 4a 01 4c 89 e0 65
[    0.866332] RSP: 0000:ffffbae280013d38 EFLAGS: 00010202
[    0.868744] RAX: 0000000000000000 RBX: 0000000000000dc0 RCX: 00000000000=
00000
[    0.870158] RDX: 000000000000012c RSI: 0000000000000dc0 RDI: 00000000000=
31120
[    0.871612] RBP: 0000000000000dc0 R08: ffff92e56a631120 R09: ffff92e507c=
02fc0
[    0.873060] R10: 0000000000000730 R11: 0000000000000000 R12: 00989680808=
6a201
[    0.874298] R13: 00000000000000fe R14: ffffffff97988098 R15: ffff92e507c=
02fc0
[    0.875531] FS:  0000000000000000(0000) GS:ffff92e56a600000(0000) knlGS:=
0000000000000000
[    0.877057] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
[    0.878030] CR2: 0000000000000000 CR3: 000000010e20a000 CR4: 00000000000=
006f0
[    0.879241] Kernel panic - not syncing: Fatal exception

[    0.000000] Linux version 5.5.0-08726-g46d6b7becb1d (willy@bobo) (gcc ve=
rsion 9.2.1 20200123 (Debian 9.2.1-25)) #2 SMP Sun Feb 2 12:10:04 EST 2020
[    0.000000] Command line: root=3D/dev/ram0 user=3Dlkp job=3D/lkp/jobs/sc=
heduled/vm-snb-ea9f97a663a6/xfstests-4HDD-xfs-generic-group00-debian-x86_64=
-2019-11-14.cgz-72273b2-20191222-10497-fw38k8-2.yaml ARCH=3Dx86_64 kconfig=
=3Dx86_64-rhel-7.6 branch=3Dlinux-devel/devel-hourly-2019122121 commit=3D72=
273b2b324c57b50842a6ece81fe27c72c330a0 BOOT_IMAGE=3D/pkg/linux/x86_64-rhel-=
7.6/gcc-7/72273b2b324c57b50842a6ece81fe27c72c330a0/vmlinuz-5.5.0-rc2-00285-=
g72273b2b324c5 max_uptime=3D3600 RESULT_ROOT=3D/result/xfstests/4HDD-xfs-ge=
neric-group00/vm-snb/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/722=
73b2b324c57b50842a6ece81fe27c72c330a0/3 LKP_LOCAL_RUN=3D1 debug apic=3Ddebu=
...
#
# Compiler: gcc (Debian 9.2.1-25) 9.2.1 20200123
#
...
CONFIG_RD_LZO=3Dy
CONFIG_RD_LZ4=3Dy
CONFIG_INITRAMFS_COMPRESSION_NONE=3Dy
