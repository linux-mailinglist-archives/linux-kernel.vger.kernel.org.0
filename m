...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9B974DFD33
	for <lists+linux-kernel@lfdr.de>; Tue, 22 Oct 2019 07:54:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387548AbfJVFyX (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 22 Oct 2019 01:54:23 -0400
Received: from mga06.intel.com ([134.134.136.31]:55600 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725788AbfJVFyW (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 22 Oct 2019 01:54:22 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 21 Oct 2019 22:54:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.67,326,1566889200"; 
   d="yaml'?scan'208";a="281181450"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.135])
  by orsmga001.jf.intel.com with ESMTP; 21 Oct 2019 22:53:58 -0700
Date:   Tue, 22 Oct 2019 14:01:43 +0800
...
Subject: [perf/core]  7fa343b7fd:  vm-scalability.median -1.5% regression
Message-ID: <20191022060143.GB5781@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.4.0-rc2-00028-g7fa343b7fdc4f"
...
export_top_env()
{
	...
	export job_origin='/lkp/lkp/.src-20191018-145736/allot/cyclic:p1:linux-devel:devel-hourly/lkp-hsw-4ex1/vm-scalability.yaml'
...
queue_at_least_once'
	...
	export submit_id='5dada2525df25b134435afb1'
	export job_file='/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-300s-512G-anon-w-rand-ucode=0x16-debia-20191021-4932-1flso7r-3.yaml'
	export id='9be3ca460f7dea9147f8f2cbe70d36135c5b893d'
	...
	export commit='7fa343b7fdc4f351de4e3f28d5c285937dd1f42f'
	export ucode='0x16'
...
CONFIG_SCSI_MPT3SAS'
	...
	export enqueue_time='2019-10-21 20:19:37 +0800'
	export _id='5dada25a5df25b134435afb2'
	export _rt='/result/vm-scalability/performance-300s-512G-anon-w-rand-ucode=0x16/lkp-hsw-4ex1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f'
	export user='lkp'
	export head_commit='ed303f8adf32e8e28d60087e67d6eacf863f86fb'
	export base_commit='4f5cafb5cb8471e54afdc9054d973535614f7675'
	export branch='linux-devel/devel-hourly-2019101913'
	export result_root='/result/vm-scalability/performance-300s-512G-anon-w-rand-ucode=0x16/lkp-hsw-4ex1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/3'
	export scheduler_version='/lkp/lkp/.src-20191021-155142'
	export LKP_SERVER='inn'
	export max_uptime=1500
	export initrd='/osimage/debian/debian-x86_64-2019-09-23.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-300s-512G-anon-w-rand-ucode=0x16-debia-20191021-4932-1flso7r-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019101913
commit=7fa343b7fdc4f351de4e3f28d5c285937dd1f42f
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/vmlinuz-5.4.0-rc2-00028-g7fa343b7fdc4f
cma=0
max_uptime=1500
RESULT_ROOT=/result/vm-scalability/performance-300s-512G-anon-w-rand-ucode=0x16/lkp-hsw-4ex1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/3
LKP_SERVER=inn
debug
apic=debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/modules.cgz'
	...
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/vmlinuz-5.4.0-rc2-00028-g7fa343b7fdc4f'
	export dequeue_time='2019-10-21 20:37:00 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-300s-512G-anon-w-rand-ucode=0x16-debia-20191021-4932-1flso7r-3.cgz'
...
run_job()
{
	...
	run_test test='anon-w-rand' $LKP_SRC/tests/wrapper vm-scalability
}
...
vm-scalability:
  test: anon-w-rand
job_origin: "/lkp/lkp/.src-20191018-145736/allot/cyclic:p1:linux-devel:devel-hourly/lkp-hsw-4ex1/vm-scalability.yaml"
...
submit_id: 5dad98c05df25b1268fb2977
job_file: "/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-300s-512G-anon-w-rand-ucode=0x16-debian--20191021-4712-grovgj-0.yaml"
id: 36bb0287596769a5e55c3e18a8b6dd8e43c442f0
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2019-10-21 19:38:56.569497418 +08:00
_id: 5dad98c05df25b1268fb2977
_rt: "/result/vm-scalability/performance-300s-512G-anon-w-rand-ucode=0x16/lkp-hsw-4ex1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f"

#! schedule options
user: lkp
head_commit: ed303f8adf32e8e28d60087e67d6eacf863f86fb
base_commit: 4f5cafb5cb8471e54afdc9054d973535614f7675
branch: linux-devel/devel-hourly-2019101913
result_root: "/result/vm-scalability/performance-300s-512G-anon-w-rand-ucode=0x16/lkp-hsw-4ex1/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/0"
scheduler_version: "/lkp/lkp/.src-20191021-155142"
LKP_SERVER: inn
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-hsw-4ex1/vm-scalability-performance-300s-512G-anon-w-rand-ucode=0x16-debian--20191021-4712-grovgj-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019101913
- commit=7fa343b7fdc4f351de4e3f28d5c285937dd1f42f
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/7fa343b7fdc4f351de4e3f28d5c285937dd1f42f/vmlinuz-5.4.0-rc2-00028-g7fa343b7fdc4f"
dequeue_time: 2019-10-21 20:00:55.128036367 +08:00

#! /lkp/lkp/.src-20191021-155142/include/site/inn
job_state: finished
loadavg: 77.03 74.86 35.78 1/1041 13107
start_time: '1571659337'
end_time: '1571659663'
version: "/lkp/lkp/.src-20191021-155209"
...
cd /lkp/benchmarks/vm-scalability
 ...
 truncate -s 473264349184 /tmp/vm-scalability-tmp/vm-scalability.img
 ...
 ./case-anon-w-rand
 ./usemem --runtime 300 -n 144 --random 1643278990
 ./case-anon-w-rand
 ./usemem --runtime 300 -n 144 --random 1643278990
 ./case-anon-w-rand
 ./usemem --runtime 300 -n 144 --random 1643278990
