...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 22F1E17DC6D
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Mar 2020 10:30:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726478AbgCIJaF (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 9 Mar 2020 05:30:05 -0400
Received: from michel.telenet-ops.be ([195.130.137.88]:40124 "EHLO
        michel.telenet-ops.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725956AbgCIJaE (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 9 Mar 2020 05:30:04 -0400
Received: from ramsan ([84.195.182.253])
        by michel.telenet-ops.be with bizsmtp
        id C9Vq2200Y5USYZQ069VqdG; Mon, 09 Mar 2020 10:29:50 +0100
Received: from rox.of.borg ([192.168.97.57])
        by ramsan with esmtp (Exim 4.90_1)
        (envelope-from <geert@linux-m68k.org>)
        id 1jBEjO-0007dx-Lm
        for linux-kernel@vger.kernel.org; Mon, 09 Mar 2020 10:29:50 +0100
...
Subject: Build regressions/improvements in v5.6-rc5
Date:   Mon,  9 Mar 2020 10:29:50 +0100
Message-Id: <20200309092950.3042-1-geert@linux-m68k.org>
...
148 warning regressions:
  + .config: warning: override: reassigning to symbol MIPS_CPS_NS16550_SHIFT:  => 11987, 11981, 11986, 11983
  ...
  + .config: warning: override: reassigning to symbol UML_NET_MCAST:  => 4176, 4200
  + .config: warning: override: reassigning to symbol UML_NET_SLIP:  => 4173, 4197
  ...
  + /kisskb/src/drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.c: warning: (near initialization for 'params.triggers') [-Wmissing-braces]:  => 8478:9
  + /kisskb/src/drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.c: warning: missing braces around initializer [-Wmissing-braces]:  => 8478:9
  ...
  + /kisskb/src/drivers/usb/gadget/udc/fsl_qe_udc.c: warning: cast to pointer from integer of different size [-Wint-to-pointer-cast]:  => 965:28, 1491:4, 837:5, 1491:27, 965:5, 837:28
  + /kisskb/src/drivers/usb/gadget/udc/fsl_qe_udc.c: warning: this statement may fall through [-Wimplicit-fallthrough=]:  => 563:8, 542:37, 596:5, 580:8, 566:8
  ...
  + /kisskb/src/fs/io_uring.c: warning: 'err' may be used uninitialized in this function [-Wuninitialized]:  => 5845:13
