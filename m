...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 155A66D90B
	for <lists+linux-kernel@lfdr.de>; Fri, 19 Jul 2019 04:25:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726653AbfGSCZH (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Thu, 18 Jul 2019 22:25:07 -0400
Received: from ozlabs.org ([203.11.71.1]:36809 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726015AbfGSCZG (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Thu, 18 Jul 2019 22:25:06 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45qZbH4vM4z9sBF;
        Fri, 19 Jul 2019 12:24:59 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1563503099;
        bh=/EFSmxLsZdpG/+El/6XSTQbWnYgcAUiPn8AEN8WNQ7Q=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 19 Jul 2019 12:24:59 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 19
Message-ID: <20190719122459.5628641b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/4OpclEf1.lENtIP91oRJjz0";
...
Changes since 20190718:

The extcon tree gained a build failure so I used the version from
next-20190718.

Non-merge commits (relative to Linus' tree): 1979
 1779 files changed, 64289 insertions(+), 26375 deletions(-)
...
Merging origin/master (0570bc8b7c9b Merge tag 'riscv/for-v5.3-rc1' of git:/=
...
Merging net/master (bb745231678c Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/bpf/bpf)
Merging bpf/master (59fd3486c3dd selftests/bpf: fix test_xdp_noinline on s3=
90)
...
Merging sound-current/for-linus (70256b42caaf ALSA: line6: Fix wrong altset=
ting for LINE6_PODHD500_1)
...
Merging mips-fixes/mips-fixes (13d282d71aa4 MIPS: Annotate fall-throughs in=
 Cavium Octeon code)
CONFLICT (content): Merge conflict in arch/mips/cavium-octeon/executive/cvm=
x-pko.c
...
Merging dma-mapping/for-next (a5008b59cd9d dma-direct: only limit the mappi=
ng size if swiotlb could be used)
...
or32)
Merging parisc-hd/for-next (0570bc8b7c9b Merge tag 'riscv/for-v5.3-rc1' of =
...
ges_range call)
Merging cifs/for-next (6aa8dc181893 cifs: flush before set-info if we have =
writeable handles)
...
Merging drm/drm-next (b3c8a40cfc4a Merge tag 'drm-misc-next-fixes-2019-07-1=
...
Merging drm-intel/for-linux-next (b5ea9c933700 drm/i915/vbt: Fix VBT parsin=
g for the PSR section)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/gt/intel_workaro=
unds.c
...
-next)
Merging sound/for-next (70256b42caaf ALSA: line6: Fix wrong altsetting for =
LINE6_PODHD500_1)
...
Merging tip/auto-latest (10aeb371cbd8 Merge branch 'core/urgent')
...
Merging extcon/extcon-next (e49d583d1df7 extcon: gpio: Request reasonable i=
nterrupts)
$ git reset --hard HEAD^
Merging next-20190718 version of extcon
...
.git hmm)
Merging akpm-current/current (4a2b79ff6bfa ipc/msg.c: consolidate all xxxct=
l_down() functions)
...
rflow
Merging akpm/master (5a6b1ebbd86d drivers/media/platform/sti/delta/delta-ip=
...

=lBsm
-----END PGP SIGNATURE-----
