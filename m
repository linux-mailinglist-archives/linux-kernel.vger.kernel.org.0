...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8001115E55
	for <lists+linux-kernel@lfdr.de>; Tue,  7 May 2019 09:38:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726810AbfEGHiO (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 7 May 2019 03:38:14 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:32849 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726175AbfEGHiN (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 7 May 2019 03:38:13 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 44ys0K3vLwz9sBV;
        Tue,  7 May 2019 17:38:09 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1557214689;
        bh=/G34S25wUCWKkgRmLTtS9D8BdYJ9rjmUn1KIeXiVN2g=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 7 May 2019 17:38:08 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 7
Message-ID: <20190507173808.20feff8a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/=CU3xWir3d0MVBu_xrp=6F2"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/=CU3xWir3d0MVBu_xrp=6F2
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20190506:

The kbuild tree lost its build failures.

The vfs tree gained a conflict against the fuse tree.

Non-merge commits (relative to Linus' tree): 11387
 10878 files changed, 492059 insertions(+), 314852 deletions(-)
...
Merging origin/master (e93c9c99a629 Linux 5.1)
...
Merging net/master (9b3040a6aafd ipv4: Define __ipv4_neigh_lookup_noref whe=
n CONFIG_INET is disabled)
...
b)
Merging sound-current/for-linus (7f641e26a6df ALSA: hda/hdmi - Consider eld=
_valid when reporting jack event)
Merging sound-asoc-fixes/for-linus (721c9537de41 Merge branch 'asoc-5.1' in=
to asoc-linus)
...
Merging amlogic/for-next (d80413fd759d Merge branch 'v5.2/drivers' into tmp=
/aml-rebuild)
...
nto for-next)
Merging clk/clk-next (10502ef5738e Merge branch 'clk-fixes' into clk-next)
...
Merging s390/features (ce968f6012f6 s390/vdso: drop unnecessary cc-ldoption)
Merging sparc-next/master (b71acb0e3721 Merge branch 'linus' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/herbert/crypto-2.6)
Merging sh/for-next (ac21fc2dcb40 sh: switch to NO_BOOTMEM)
Merging uml/linux-next (aea05eb56e47 um: Fix for a possible OOPS in ubd ini=
tialization)
Merging xtensa/xtensa-for-next (c5a771f240b1 Merge branch 'xtensa-5.2-fixes=
...
Merging cifs/for-next (31d9db43c204 cifs: update module internal version nu=
mber)
...
Merging pci/next (ec36f5fea1ef Merge branch 'pci/trivial')
...
Merging jc_docs/docs-next (894ee5ff8333 scripts/documentation-file-ref-chec=
k: detect broken :doc:`foo`)
...
Merging net-next/master (54516da1ea85 Merge branch 'r8169-replace-some-magi=
c-with-more-speaking-functions')
...
Merging bpf-next/master (d24ed99b3b27 libbpf: remove unnecessary cast-to-vo=
id)
...
Merging gfs2/for-next (e21e191994af gfs2: read journal in large chunks)
...
Merging drm-misc/for-linux-next (b208146b0c8f drm/panfrost: Show stored fea=
ture registers)
...
-next)
Merging sound/for-next (7f641e26a6df ALSA: hda/hdmi - Consider eld_valid wh=
en reporting jack event)
Merging sound-asoc/for-next (008b72158eab Merge branch 'asoc-5.2' into asoc=
-next)
...
Merging input/next (a33ff45923c8 Input: qt1050 - add Microchip AT42QT1050 s=
upport)
CONFLICT (content): Merge conflict in Documentation/devicetree/bindings/ven=
dor-prefixes.txt
Merging block/for-next (e6cb68615740 Merge branch 'for-5.2/block-post' into=
 for-next)
...
r support)
Merging iommu/next (991cc61b3e9a Merge branches 'arm/tegra', 'arm/mediatek'=
, 'arm/smmu', 'x86/vt-d', 'x86/amd' and 'core' into next)
Merging dwmw2-iommu/master (d8a5b80568a9 Linux 4.15)
Merging vfio/next (dc7b4c6a0978 vfio/mdev: Avoid inline get and put parent =
helpers)
...
Merging tip/auto-latest (a2ea1ce073d4 Merge branch 'core/core')
CONFLICT (content): Merge conflict in mm/kasan/Makefile
CONFLICT (content): Merge conflict in arch/x86/kernel/irq_64.c
CONFLICT (content): Merge conflict in arch/s390/kernel/stacktrace.c
...
u_dma_map_msi_msg())
Merging ftrace/for-next (e8025bab7bfb function_graph: Place ftrace_graph_en=
...
Merging drivers-x86/for-next (d33a7e578eae platform/x86: thinkpad_acpi: fix=
...
Merging pinctrl/for-next (b7316ebd4cc2 Merge branch 'devel' into for-next)
...
rflow
Merging akpm/master (93b01e13c0ff drivers/media/platform/sti/delta/delta-ip=
...

=bT+S
-----END PGP SIGNATURE-----
