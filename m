...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 56031F8C30
	for <lists+linux-kernel@lfdr.de>; Tue, 12 Nov 2019 10:49:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727343AbfKLJtO (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 12 Nov 2019 04:49:14 -0500
Received: from mga11.intel.com ([192.55.52.93]:45653 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725874AbfKLJtN (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 12 Nov 2019 04:49:13 -0500
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga102.fm.intel.com with ESMTP; 12 Nov 2019 01:49:10 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,295,1569308400"; 
   d="yaml'?scan'208";a="229302410"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga004.fm.intel.com with ESMTP; 12 Nov 2019 01:49:06 -0800
Date:   Tue, 12 Nov 2019 17:48:48 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     "Darrick J. Wong" <darrick.wong@oracle.com>
Cc:     LKML <linux-kernel@vger.kernel.org>,
        "Darrick J. Wong" <darrick.wong@oracle.com>, lkp@lists.01.org
Subject: [xfs] 646a9fb7fb: aim7.jobs-per-min -33.0% regression
Message-ID: <20191112094848.GC30590@shao2-debian>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.4.0-rc7-00092-g646a9fb7fb983"
...
export_top_env()
{
	...
	export job_origin='/lkp/lkp/.src-20191109-185558/allot/cyclic:p1:linux-devel:devel-hourly/lkp-skl-2sp7/aim7-fs-raid.yaml'
...
queue_at_least_once'
	...
	export submit_id='5dca70efdb9a321ccbd14455'
	export job_file='/lkp/jobs/scheduled/lkp-skl-2sp7/aim7-performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064-20191112-7371-1qc35ob-3.yaml'
	export id='74e0f2df85204799b739d41941e3e31b4aaef78f'
	...
	export commit='646a9fb7fb983a7d53da1892c7f1225929de5bd1'
	export ucode='0x2000064'
...
CONFIG_XFS_FS'
	...
	export enqueue_time='2019-11-12 16:44:41 +0800'
	export _id='5dca70fadb9a321ccbd14456'
	export _rt='/result/aim7/performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064/lkp-skl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1'
	export user='lkp'
	export head_commit='811737e8c8da0152d27acf40a44e467b0fb648a1'
	export base_commit='31f4f5b495a62c9a8b15b1c3581acd5efeb9af8c'
	export branch='linux-devel/devel-hourly-2019111114'
	export result_root='/result/aim7/performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064/lkp-skl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1/3'
	export scheduler_version='/lkp/lkp/.src-20191112-122805'
	export LKP_SERVER='inn'
	export max_uptime=748.48
	export initrd='/osimage/debian/debian-x86_64-2019-09-23.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-skl-2sp7/aim7-performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064-20191112-7371-1qc35ob-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019111114
commit=646a9fb7fb983a7d53da1892c7f1225929de5bd1
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1/vmlinuz-5.4.0-rc7-00092-g646a9fb7fb983
acpi_rsdp=0x6c030014
max_uptime=748
RESULT_ROOT=/result/aim7/performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064/lkp-skl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1/3
LKP_SERVER=inn
nokaslr
debug
apic=debug
...
aim7:
  test: disk_wrt
  load: 3000
job_origin: "/lkp/lkp/.src-20191109-185558/allot/cyclic:p1:linux-devel:devel-hourly/lkp-skl-2sp7/aim7-fs-raid.yaml"
...
submit_id: 5dca6babdb9a321bd27d287c
job_file: "/lkp/jobs/scheduled/lkp-skl-2sp7/aim7-performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064-d-20191112-7122-1s1rjnv-0.yaml"
id: 43fb132db7b8d14d9a11f6ea173f8179a990a0f5
...
enqueue_time: 2019-11-12 16:22:14.189831335 +08:00
_id: 5dca6babdb9a321bd27d287c
_rt: "/result/aim7/performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064/lkp-skl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1"

#! schedule options
user: lkp
head_commit: 811737e8c8da0152d27acf40a44e467b0fb648a1
base_commit: 31f4f5b495a62c9a8b15b1c3581acd5efeb9af8c
branch: linux-devel/devel-hourly-2019111114
result_root: "/result/aim7/performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064/lkp-skl-2sp7/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1/0"
scheduler_version: "/lkp/lkp/.src-20191112-122805"
LKP_SERVER: inn
max_uptime: 748.48
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-skl-2sp7/aim7-performance-4BRD_12G-xfs-3000-RAID0-disk_wrt-ucode=0x2000064-d-20191112-7122-1s1rjnv-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019111114
- commit=646a9fb7fb983a7d53da1892c7f1225929de5bd1
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1/modules.cgz"
...
#! /lkp/lkp/.src-20191111-182615/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/646a9fb7fb983a7d53da1892c7f1225929de5bd1/vmlinuz-5.4.0-rc7-00092-g646a9fb7fb983"
dequeue_time: 2019-11-12 16:38:15.766091991 +08:00

#! /lkp/lkp/.src-20191112-122805/include/site/inn
job_state: finished
loadavg: 1242.35 417.37 147.14 1/691 7054
start_time: '1573547954'
end_time: '1573548017'
version: "/lkp/lkp/.src-20191112-122836:491cefd6:c137a125e-dirty"
