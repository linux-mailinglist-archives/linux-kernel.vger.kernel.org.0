...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 45E691610D4
	for <lists+linux-kernel@lfdr.de>; Mon, 17 Feb 2020 12:14:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729438AbgBQLOM (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 17 Feb 2020 06:14:12 -0500
Received: from foss.arm.com ([217.140.110.172]:34108 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728297AbgBQLOK (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 17 Feb 2020 06:14:10 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 180B830E;
        Mon, 17 Feb 2020 03:14:09 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id BDC223F6CF;
        Mon, 17 Feb 2020 03:14:06 -0800 (PST)
Subject: Re: [patch V2 15/17] lib/vdso: Allow fixed clock mode
...
References: <20200207123847.339896630@linutronix.de>
 <20200207124403.748756829@linutronix.de>
From:   Vincenzo Frascino <vincenzo.frascino@arm.com>
X-Pep-Version: 2.0
Message-ID: <fe84110e-5953-15e8-74a7-a4c5cb19a8db@arm.com>
Date:   Mon, 17 Feb 2020 11:14:05 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <20200207124403.748756829@linutronix.de>
Content-Type: multipart/mixed;
 boundary="------------86736109F25F8F2EEC00D559"
...
>=20
> Some architectures have a fixed clocksource which is known at compile t=
ime
> and cannot be replaced or disabled at runtime, e.g. timebase on
> PowerPC. For such cases the clock mode check in the VDSO code is pointl=
ess.
>=20
> Move the check for a VDSO capable clocksource into an inline function a=
nd
