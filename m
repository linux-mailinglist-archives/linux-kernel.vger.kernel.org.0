...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 504D5AE448
	for <lists+linux-kernel@lfdr.de>; Tue, 10 Sep 2019 09:08:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2406549AbfIJHIw (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 10 Sep 2019 03:08:52 -0400
Received: from mga06.intel.com ([134.134.136.31]:9813 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729707AbfIJHIw (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 10 Sep 2019 03:08:52 -0400
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by orsmga104.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 10 Sep 2019 00:08:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,487,1559545200"; 
   d="scan'208";a="335831164"
Received: from yhuang-dev.sh.intel.com (HELO yhuang-dev) ([10.239.159.29])
  by orsmga004.jf.intel.com with ESMTP; 10 Sep 2019 00:08:41 -0700
...
Subject: Re: [LKP] [mm, memcg] 1e577f970f: will-it-scale.per_process_ops -7.2% regression
References: <20190909021544.GP15734@shao2-debian>
        <20190909194652.GE2063@dhcp22.suse.cz>
Date:   Tue, 10 Sep 2019 15:08:41 +0800
In-Reply-To: <20190909194652.GE2063@dhcp22.suse.cz> (Michal Hocko's message of
        "Mon, 9 Sep 2019 21:46:52 +0200")
Message-ID: <87d0g8hbly.fsf@yhuang-dev.intel.com>
...
>> commit: 1e577f970f66a53d429cbee37b36177c9712f488 ("mm, memcg:
> introduce memory.events.local")
...
>>
> +------------------+------------------------------------------------------------------------+
>> | testcase: change | vm-scalability: vm-scalability.median -13.0%
> regression |
>> | test machine | 160 threads Intel(R) Xeon(R) CPU E7-8890 v4 @
> 2.20GHz with 256G memory |
...
>> 137993  18% +54.7% 213511  30%
> sched_debug.cpu.max_idle_balance_cost.max
>> 16624  20% +60.4% 26669  39%
...
>> 0.92  13% +0.3 1.26  10%
> perf-profile.calltrace.cycles-pp.get_mem_cgroup_from_mm.mem_cgroup_try_charge.mem_cgroup_try_charge_delay.__handle_mm_fault.handle_mm_fault
>> 0.77  8% +0.6 1.39  11%
> perf-profile.calltrace.cycles-pp.mem_cgroup_commit_charge.alloc_set_pte.finish_fault.__handle_mm_fault.handle_mm_fault
>> 0.60  7% +0.6 1.22  11%
> perf-profile.calltrace.cycles-pp.mem_cgroup_charge_statistics.mem_cgroup_commit_charge.alloc_set_pte.finish_fault.__handle_mm_fault
>> 0.00 +1.0 1.00  12%
> perf-profile.calltrace.cycles-pp.__mod_memcg_state.mem_cgroup_charge_statistics.mem_cgroup_commit_charge.alloc_set_pte.finish_fault
>> 0.00 +1.1 1.08  10%
> perf-profile.calltrace.cycles-pp.__count_memcg_events.handle_mm_fault.__do_page_fault.do_page_fault.page_fault
>> 12.20  6% +3.1 15.35  7%
...
>> 0.93  13% +0.3 1.27  10%
> perf-profile.children.cycles-pp.get_mem_cgroup_from_mm
>> 0.61  7% +0.6 1.23  11%
...
>> 0.35  14% +0.1 0.46  9%
> perf-profile.self.cycles-pp.mem_cgroup_try_charge
>> 0.93  13% +0.3 1.26  10%
> perf-profile.self.cycles-pp.get_mem_cgroup_from_mm
>> 0.59  8% +0.7 1.28  9%
...
>> 173.50  6% -10.8% 154.75
> interrupts.100:PCI-MSI.1572919-edge.eth0-TxRx-55
>> 363.25  59% -57.4% 154.75
> interrupts.101:PCI-MSI.1572920-edge.eth0-TxRx-56
>> 251.75  33% -34.3% 165.50  3%
> interrupts.46:PCI-MSI.1572865-edge.eth0-TxRx-1
>> 245.50  43% -35.6% 158.00  2%
> interrupts.56:PCI-MSI.1572875-edge.eth0-TxRx-11
>>     720167            -5.0%     684354        interrupts.CAL:Function_call_interrupts
>> 251.75  33% -34.3% 165.50  3%
> interrupts.CPU1.46:PCI-MSI.1572865-edge.eth0-TxRx-1
>> 137.50  73% +11475.8% 15916 165%
> interrupts.CPU1.RES:Rescheduling_interrupts
>> 34.25  85% +4651.8% 1627 156%
...
>> 358.00  68% -81.3% 67.00  76%
> interrupts.CPU24.RES:Rescheduling_interrupts
>> 263.00  87% -90.9% 24.00  60%
...
>> 273.00 102% -90.8% 25.25  61%
> interrupts.CPU30.RES:Rescheduling_interrupts
>> 25.75  50% +292.2% 101.00  81%
> interrupts.CPU4.RES:Rescheduling_interrupts
>> 282.25  80% -89.3% 30.25  66%
> interrupts.CPU44.RES:Rescheduling_interrupts
>> 20.00  32% +623.8% 144.75  73%
...
> interrupts.CPU53.PMI:Performance_monitoring_interrupts
>> 173.50  6% -10.8% 154.75
> interrupts.CPU55.100:PCI-MSI.1572919-edge.eth0-TxRx-55
>> 363.25  59% -57.4% 154.75
> interrupts.CPU56.101:PCI-MSI.1572920-edge.eth0-TxRx-56
>> 16.25  6% +380.0% 78.00  59%
> interrupts.CPU58.RES:Rescheduling_interrupts
>> 2329  38% +45.8% 3396  18%
> interrupts.CPU60.NMI:Non-maskable_interrupts
>> 2329  38% +45.8% 3396  18%
> interrupts.CPU60.PMI:Performance_monitoring_interrupts
>> 29.00 107% +228.4% 95.25  79%
...
>> 2.29  71% -1.2 1.09  5%
> perf-profile.calltrace.cycles-pp.menu_select.do_idle.cpu_startup_entry.start_secondary.secondary_startup_64
>> 1.32  73% -0.8 0.55  6%
> perf-profile.calltrace.cycles-pp.tick_nohz_get_sleep_length.menu_select.do_idle.cpu_startup_entry.start_secondary
>> 0.44  57% +0.4 0.89
> perf-profile.calltrace.cycles-pp.__mod_memcg_state.mem_cgroup_charge_statistics.mem_cgroup_commit_charge.shmem_getpage_gfp.shmem_fault
>> 0.98  58% +0.5 1.49  3%
> perf-profile.calltrace.cycles-pp.page_add_file_rmap.alloc_set_pte.finish_fault.__handle_mm_fault.handle_mm_fault
>> 0.62  57% +0.5 1.14
> perf-profile.calltrace.cycles-pp.mem_cgroup_charge_statistics.mem_cgroup_commit_charge.shmem_getpage_gfp.shmem_fault.__do_fault
>> 0.00 +0.5 0.54  5%
> perf-profile.calltrace.cycles-pp.lock_page_memcg.page_add_file_rmap.alloc_set_pte.finish_fault.__handle_mm_fault
>> 0.79  57% +0.6 1.35
> perf-profile.calltrace.cycles-pp.mem_cgroup_commit_charge.shmem_getpage_gfp.shmem_fault.__do_fault.__handle_mm_fault
>> 0.00 +0.6 0.60  2%
> perf-profile.calltrace.cycles-pp.__mod_memcg_state.__mod_lruvec_state.__pagevec_lru_add_fn.pagevec_lru_move_fn.__lru_cache_add
>> 1.41  57% +0.6 2.04  3%
> perf-profile.calltrace.cycles-pp.alloc_set_pte.finish_fault.__handle_mm_fault.handle_mm_fault.__do_page_fault
>> 0.13 173% +0.6 0.76
> perf-profile.calltrace.cycles-pp.__mod_lruvec_state.__pagevec_lru_add_fn.pagevec_lru_move_fn.__lru_cache_add.shmem_getpage_gfp
>> 1.46  57% +0.6 2.11  3%
> perf-profile.calltrace.cycles-pp.finish_fault.__handle_mm_fault.handle_mm_fault.__do_page_fault.do_page_fault
>> 1.35  57% +0.7 2.00
> perf-profile.calltrace.cycles-pp.__pagevec_lru_add_fn.pagevec_lru_move_fn.__lru_cache_add.shmem_getpage_gfp.shmem_fault
>> 0.00 +0.8 0.77
> perf-profile.calltrace.cycles-pp.__count_memcg_events.handle_mm_fault.__do_page_fault.do_page_fault.page_fault
>> 3.19  57% +2.0 5.21
...
>> 10.40  57% +13.3 23.69  3%
> perf-profile.calltrace.cycles-pp.native_queued_spin_lock_slowpath._raw_spin_lock_irqsave.pagevec_lru_move_fn.__lru_cache_add.shmem_getpage_gfp
>> 10.44  57% +13.3 23.74  3%
...
>> 12.17  57% +14.2 26.36  3%
> perf-profile.calltrace.cycles-pp.pagevec_lru_move_fn.__lru_cache_add.shmem_getpage_gfp.shmem_fault.__do_fault
>> 12.29  57% +14.2 26.50  3%
> perf-profile.calltrace.cycles-pp.__lru_cache_add.shmem_getpage_gfp.shmem_fault.__do_fault.__handle_mm_fault
>> 35.44  57% +18.0 53.48
> perf-profile.calltrace.cycles-pp.shmem_getpage_gfp.shmem_fault.__do_fault.__handle_mm_fault.handle_mm_fault
>> 35.73  57% +18.1 53.84
> perf-profile.calltrace.cycles-pp.shmem_fault.__do_fault.__handle_mm_fault.handle_mm_fault.__do_page_fault
...
>> 0.10  11% -0.1 0.03 100%
> perf-profile.children.cycles-pp.smp_call_function_single
>> 0.11  4% -0.1 0.04  58%
> perf-profile.children.cycles-pp.perf_read
>> 0.06  58% +0.0 0.10  4%
> perf-profile.children.cycles-pp.mem_cgroup_page_lruvec
>> 0.30  58% +0.3 0.64  6%
> perf-profile.children.cycles-pp.lock_page_memcg
>> 0.46  57% +0.4 0.91
> perf-profile.children.cycles-pp.__count_memcg_events
>> 0.99  57% +0.5 1.50  4%
...
>> 0.05  58% +0.0 0.10  4%
> perf-profile.self.cycles-pp.mem_cgroup_page_lruvec
>>       0.20  57%      +0.1        0.29        perf-profile.self.cycles-pp.page_fault
>> 0.30  58% +0.3 0.63  6%
> perf-profile.self.cycles-pp.lock_page_memcg
>> 0.46  57% +0.4 0.91
> perf-profile.self.cycles-pp.__count_memcg_events
>> 1.16  54% +0.7 1.82  3%
> perf-profile.self.cycles-pp.__mod_memcg_state
...
>> 3.13  57% +2.0 5.13
> perf-profile.self.cycles-pp.prepare_exit_to_usermode
>> 12.65  57% +13.1 25.75  2%
...
>> 	export submit_id='5d7312609ab21b348295f451'
>> export
> job_file='/lkp/jobs/scheduled/lkp-csl-2sp4/will-it-scale-performance-process-50%-page_fault2-ucode=0x400001-20190907-13442-15l69or-3.yaml'
>> 	export id='7da35358ad6eb9063ab4e0c4821fe68fd3ecf33e'
...
>> 	export commit='1e577f970f66a53d429cbee37b36177c9712f488'
...
>> 	export enqueue_time='2019-09-07 10:13:59 +0800'
>> 	export _id='5d7312679ab21b348295f452'
>> export
> _rt='/result/will-it-scale/performance-process-50%-page_fault2-ucode=0x400001c/lkp-csl-2sp4/clear-ota-25590-x86_64-2018-10-18.cgz/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488'
>> 	export user='lkp'
...
>> export
> result_root='/result/will-it-scale/performance-process-50%-page_fault2-ucode=0x400001c/lkp-csl-2sp4/clear-ota-25590-x86_64-2018-10-18.cgz/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/3'
...
>> user=lkp
>>
> job=/lkp/jobs/scheduled/lkp-csl-2sp4/will-it-scale-performance-process-50%-page_fault2-ucode=0x400001-20190907-13442-15l69or-3.yaml
>> ARCH=x86_64
>> kconfig=x86_64-rhel-7.2-clear
>> branch=internal-eywa/master
>> commit=1e577f970f66a53d429cbee37b36177c9712f488
>>
> BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/vmlinuz-5.2.0-05698-g1e577f970f66a
>> max_uptime=1500
>>
> RESULT_ROOT=/result/will-it-scale/performance-process-50%-page_fault2-ucode=0x400001c/lkp-csl-2sp4/clear-ota-25590-x86_64-2018-10-18.cgz/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/3
>> LKP_SERVER=inn
...
>> rw'
>> export
> modules_initrd='/pkg/linux/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/modules.cgz'
>> export
...
>> export
> kernel='/pkg/linux/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/vmlinuz-5.2.0-05698-g1e577f970f66a'
>> 	export dequeue_time='2019-09-07 10:26:20 +0800'
>> export
> job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp4/will-it-scale-performance-process-50%-page_fault2-ucode=0x400001-20190907-13442-15l69or-3.cgz'
>> 
>> 	[ -n "$LKP_SRC" ] ||
...
>>   test: page_fault2
>> job_origin:
> "/lkp/lkp/.src-20190827-185517/allot/cyclic:clear:internal-eywa:master/lkp-csl-2sp4/will-it-scale-50.yaml"
>> 
>> #! queue options
>> queue_cmdline_keys:
>> - branch
...
>> submit_id: 5d72d8629ab21b30cc003e5d
>> job_file:
> "/lkp/jobs/scheduled/lkp-csl-2sp4/will-it-scale-performance-process-50%-page_fault2-ucode=0x400001c--20190907-12492-1lhx8xf-0.yaml"
>> id: 3596defeb4be726efa6a5fd263fd501fcd5f6eef
...
>> #! default params
>> compiler: gcc-7
>> enqueue_time: 2019-09-07 06:11:26.347801657 +08:00
>> _id: 5d72d8629ab21b30cc003e5d
>> _rt:
> "/result/will-it-scale/performance-process-50%-page_fault2-ucode=0x400001c/lkp-csl-2sp4/clear-ota-25590-x86_64-2018-10-18.cgz/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488"
>> 
>> #! schedule options
>> user: lkp
...
>> branch: internal-eywa/master
>> result_root:
> "/result/will-it-scale/performance-process-50%-page_fault2-ucode=0x400001c/lkp-csl-2sp4/clear-ota-25590-x86_64-2018-10-18.cgz/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/0"
>> scheduler_version: "/lkp/lkp/.src-20190906-164721"
>> LKP_SERVER: inn
>> max_uptime: 1500
...
>> - user=lkp
>> -
> job=/lkp/jobs/scheduled/lkp-csl-2sp4/will-it-scale-performance-process-50%-page_fault2-ucode=0x400001c--20190907-12492-1lhx8xf-0.yaml
>> - ARCH=x86_64
>> - kconfig=x86_64-rhel-7.2-clear
>> - branch=internal-eywa/master
>> - commit=1e577f970f66a53d429cbee37b36177c9712f488
...
>> - max_uptime=1500
>> -
> RESULT_ROOT=/result/will-it-scale/performance-process-50%-page_fault2-ucode=0x400001c/lkp-csl-2sp4/clear-ota-25590-x86_64-2018-10-18.cgz/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/0
>> - LKP_SERVER=inn
>> - debug
>> - apic=debug
>> - sysrq_always_enabled
...
>> - rw
>> modules_initrd:
> "/pkg/linux/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/modules.cgz"
>> bm_initrd:
> "/osimage/deps/clear-ota-25590-x86_64-2018-10-18.cgz/lkp_2019-04-25.cgz,/osimage/deps/clear-ota-25590-x86_64-2018-10-18.cgz/will-it-scale_2019-06-19.cgz,/osimage/pkg/clear-ota-25590-x86_64-2018-10-18.cgz/will-it-scale-x86_64-1eef89e_2019-08-22.cgz,/osimage/deps/clear-ota-25590-x86_64-2018-10-18.cgz/mpstat_2019-04-30.cgz,/osimage/pkg/clear-ota-25590-x86_64-2018-10-18.cgz/turbostat-x86_64-d5256b2_2019-04-30.cgz,/osimage/deps/clear-ota-25590-x86_64-2018-10-18.cgz/perf_2019-04-30.cgz,/osimage/pkg/clear-ota-25590-x86_64-2018-10-18.cgz/perf-x86_64-cb6f8739fbf9_2019-05-20.cgz,/osimage/pkg/clear-ota-25590-x86_64-2018-10-18.cgz/mpstat-x86_64-git-1_2019-05-05.cgz"
>> lkp_initrd: "/osimage/user/lkp/lkp-x86_64.cgz"
>> site: inn
>> 
>> #! /lkp/lkp/.src-20190905-235843/include/site/inn
>> LKP_CGI_PORT: 80
>> LKP_CIFS_PORT: 139
>> oom-killer: 
>> watchdog: 
...
>> kernel:
> "/pkg/linux/x86_64-rhel-7.2-clear/gcc-7/1e577f970f66a53d429cbee37b36177c9712f488/vmlinuz-5.2.0-05698-g1e577f970f66a"
>> dequeue_time: 2019-09-07 07:35:38.242855310 +08:00
>> 
>> #! /lkp/lkp/.src-20190906-164721/include/site/inn
>> job_state: finished
>> loadavg: 40.45 29.67 13.27 1/772 32146
>> start_time: '1567813193'
>> end_time: '1567813494'
>> version: "/lkp/lkp/.src-20190906-164748"
>
>> 
...
>> done
>> 
>>  "python2" "./runtest.py" "page_fault2" "295" "process" "48"
