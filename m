...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 84A464C526
	for <lists+linux-kernel@lfdr.de>; Thu, 20 Jun 2019 04:00:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731178AbfFTB6n (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Wed, 19 Jun 2019 21:58:43 -0400
Received: from szxga04-in.huawei.com ([45.249.212.190]:19043 "EHLO huawei.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726370AbfFTB6n (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Wed, 19 Jun 2019 21:58:43 -0400
Received: from DGGEMS403-HUB.china.huawei.com (unknown [172.30.72.58])
        by Forcepoint Email with ESMTP id DBFC3BA21FAF97886A08;
        Thu, 20 Jun 2019 09:58:40 +0800 (CST)
Received: from huawei.com (10.175.101.78) by DGGEMS403-HUB.china.huawei.com
 (10.3.19.203) with Microsoft SMTP Server id 14.3.439.0; Thu, 20 Jun 2019
 09:58:32 +0800
...
Subject: [PATCH v2] modules: fix BUG when load module with rodata=n
Date:   Thu, 20 Jun 2019 10:18:14 +0800
Message-ID: <1560997094-19920-1-git-send-email-yangyingliang@huawei.com>
...
index 80c7c09584cf..c3ae34c11c9f 100644
--- a/kernel/module.c
+++ b/kernel/module.c
@@ -1949,13 +1949,9 @@ void module_enable_ro(const struct module *mod, bool after_init)
...
-
 	...
 	if (after_init)
@@ -2018,6 +2014,12 @@ void set_all_modules_text_ro(void)
...
@@ -3616,6 +3618,7 @@ static int complete_formation(struct module *mod, struct load_info *info)
