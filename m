...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 51572B5989
	for <lists+linux-kernel@lfdr.de>; Wed, 18 Sep 2019 04:13:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727126AbfIRCNu (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 17 Sep 2019 22:13:50 -0400
Received: from mga01.intel.com ([192.55.52.88]:5564 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727060AbfIRCNt (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 17 Sep 2019 22:13:49 -0400
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmsmga101.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 17 Sep 2019 19:13:46 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,519,1559545200"; 
   d="yaml'?scan'208";a="387763325"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga006.fm.intel.com with ESMTP; 17 Sep 2019 19:13:43 -0700
Date:   Wed, 18 Sep 2019 10:13:34 +0800
From:   kernel test robot <rong.a.chen@intel.com>
To:     Marcelo Tosatti <mtosatti@redhat.com>
Cc:     "Rafael J. Wysocki" <rafael.j.wysocki@intel.com>,
        LKML <linux-kernel@vger.kernel.org>,
        Stephen Rothwell <sfr@canb.auug.org.au>, lkp@01.org
Subject: [cpuidle]  259231a045:  will-it-scale.per_process_ops -12.6%
 regression
Message-ID: <20190918021334.GL15734@shao2-debian>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="ZGtad4bun3m+J/4B"
...
Content-Disposition: attachment; filename="config-5.3.0-rc2-00002-g259231a045616"
...
export_top_env()
{
	...
	export nr_task=288
	export job_origin='/lkp/lkp/.src-20190912-191544/allot/cyclic:p1:linux-devel:devel-hourly/lkp-knm01/will-it-scale-100.yaml'
...
queue_at_least_once'
	...
	export submit_id='5d81281f4e2d4143e9966a41'
	export job_file='/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-debian-x86_64-2019-05--20190918-17385-1z0ehq-3.yaml'
	export id='32ee6f45191f3b1e59f44423a43407abd51b0f4f'
	...
	export commit='259231a045616c4101d023a8f4dcc8379af265a6'
	export need_kconfig_hw='CONFIG_IGB=y'
	export kconfig='x86_64-rhel-7.6'
	export compiler='gcc-7'
	export enqueue_time='2019-09-18 02:38:48 +0800'
	export _id='5d8128384e2d4143e9966a42'
	export _rt='/result/will-it-scale/performance-process-100%-mmap1/lkp-knm01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6'
	export user='lkp'
	export head_commit='c229abca5c28e736677363ab76041f8ee04dddc9'
	export base_commit='4d856f72c10ecb060868ed10ff1b1453943fc6c8'
	export branch='linux-devel/devel-hourly-2019091709'
	export result_root='/result/will-it-scale/performance-process-100%-mmap1/lkp-knm01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6/3'
	export scheduler_version='/lkp/lkp/.src-20190917-191942'
	export LKP_SERVER='inn'
	export max_uptime=1500
	export initrd='/osimage/debian/debian-x86_64-2019-05-14.cgz'
	export bootloader_append='root=/dev/ram0
user=lkp
job=/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-debian-x86_64-2019-05--20190918-17385-1z0ehq-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019091709
commit=259231a045616c4101d023a8f4dcc8379af265a6
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6/vmlinuz-5.3.0-rc2-00002-g259231a045616
max_uptime=1500
RESULT_ROOT=/result/will-it-scale/performance-process-100%-mmap1/lkp-knm01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6/3
LKP_SERVER=inn
debug
apic=debug
...
rw'
	...
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6/vmlinuz-5.3.0-rc2-00002-g259231a045616'
	export dequeue_time='2019-09-18 02:50:57 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-debian-x86_64-2019-05--20190918-17385-1z0ehq-3.cgz'
...
will-it-scale:
  mode: process
  test: mmap1
job_origin: "/lkp/lkp/.src-20190912-191544/allot/cyclic:p1:linux-devel:devel-hourly/lkp-knm01/will-it-scale-100.yaml"
...
submit_id: 5d8112a34e2d4141d659e69e
job_file: "/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-debian-x86_64-2019-05-14-20190918-16854-1kkn3wv-0.yaml"
id: 8bc62345b265688ded5467bcfa770e58a5e9438b
...
kconfig: x86_64-rhel-7.6
compiler: gcc-7
enqueue_time: 2019-09-18 01:07:15.265011002 +08:00
_id: 5d8112a34e2d4141d659e69e
_rt: "/result/will-it-scale/performance-process-100%-mmap1/lkp-knm01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6"

#! schedule options
user: lkp
head_commit: c229abca5c28e736677363ab76041f8ee04dddc9
base_commit: 4d856f72c10ecb060868ed10ff1b1453943fc6c8
branch: linux-devel/devel-hourly-2019091709
result_root: "/result/will-it-scale/performance-process-100%-mmap1/lkp-knm01/debian-x86_64-2019-05-14.cgz/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6/0"
scheduler_version: "/lkp/lkp/.src-20190917-191942"
LKP_SERVER: inn
max_uptime: 1500
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-knm01/will-it-scale-performance-process-100%-mmap1-debian-x86_64-2019-05-14-20190918-16854-1kkn3wv-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019091709
- commit=259231a045616c4101d023a8f4dcc8379af265a6
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6/modules.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/259231a045616c4101d023a8f4dcc8379af265a6/vmlinuz-5.3.0-rc2-00002-g259231a045616"
dequeue_time: 2019-09-18 01:21:52.337526976 +08:00

#! /lkp/lkp/.src-20190917-191942/include/site/inn
job_state: finished
loadavg: 59.75 139.70 77.05 1/1854 11205
start_time: '1568741022'
end_time: '1568741329'
version: "/lkp/lkp/.src-20190917-192006"
...
do
 ...
 "python2" "./runtest.py" "mmap1" "295" "process" "288"
