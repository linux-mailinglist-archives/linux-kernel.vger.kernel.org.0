...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 010825303F
	for <lists+linux-kernel@lfdr.de>; Tue, 25 Jun 2019 12:37:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731934AbfFYKhW (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 25 Jun 2019 06:37:22 -0400
Received: from ozlabs.org ([203.11.71.1]:37749 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728377AbfFYKhV (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 25 Jun 2019 06:37:21 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 45Y2fC5VFvz9s3C;
        Tue, 25 Jun 2019 20:37:07 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1561459027;
        bh=DgLeCV/x2sh1N12XazufjvJnreciqFwv7X34ye9ExaA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 25 Jun 2019 20:37:06 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 25
Message-ID: <20190625203706.6985fb04@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
 boundary="Sig_/kHCWIWFNSgEvtYrbZnmGF2D"; protocol="application/pgp-signature"
Sender: linux-kernel-owner@vger.kernel.org
Precedence: bulk
List-ID: <linux-kernel.vger.kernel.org>
X-Mailing-List: linux-kernel@vger.kernel.org

--Sig_/kHCWIWFNSgEvtYrbZnmGF2D
...
its build failure for which I reverted 2 commits.
...
The modules tree gained a build failure so I used the verison from
next-20190624.
...
wireless-drivers-next tree for which I applied a merge fix patch.

The staging tree still had its build failure for which I reverted a commit.

Non-merge commits (relative to Linus' tree): 8106
 8271 files changed, 326742 insertions(+), 261961 deletions(-)
...
Merging net/master (904d88d743b0 qmi_wwan: Fix out-of-bounds read)
Merging bpf/master (20f6239d494b samples/bpf: xdp_redirect, correctly get d=
ummy program id)
...
Merging sound-asoc-fixes/for-linus (6919d9082896 Merge branch 'asoc-5.2' in=
to asoc-linus)
Merging regmap-fixes/for-linus (2217d05161cb Merge branch 'regmap-5.2' into=
 regmap-linus)
Merging regulator-fixes/for-linus (14d1d776754e Merge branch 'regulator-5.2=
...
Merging arm64/for-next/core (3f7507064862 arm64: bpf: do not allocate execu=
table memory)
...
Merging arm-soc/for-next (e005156eb4b4 ARM: Document merges)
...
Merging bcm2835/for-next (08e3c4158538 ARM: bcm283x: Enable DMA support for=
 SPI controller)
Merging imx-mxs/for-next (d75fc68c746c Merge branch 'imx/defconfig' into fo=
r-next)
...
or-next)
Merging samsung-krzk/for-next (c8ea8c6474e1 Merge branch 'next/dt' into for=
-next)
...
tatic)
Merging ext3/for_next (a617c3043f81 Pull quota GETSTAT fix from Eric.)
...
efile
Merging net-next/master (045df37e743c Merge branch 'cxgb4-Reference-count-M=
PS-TCAM-entries-within-a-PF')
...
Merging bpf-next/master (88091ff56b71 selftests, bpf: Add test for veth nat=
ive XDP)
...
Array)
Merging netfilter-next/master (1c5ba67d2277 Merge git://git.kernel.org/pub/=
...
Merging drm/drm-next (dfd03396d7b6 Merge tag 'drm/tegra/for-5.3-rc1' of git=
://anongit.freedesktop.org/tegra/linux into drm-next)
...
Merging amdgpu/drm-next (8ac875db0fdc drm/amdgpu: disable gfxoff on navi10)
...
e_audio.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/amdgpu/amdgpu_pm.c
[master 02c16f807074] next-20190621/amdgpu
Merging drm-intel/for-linux-next (871918dffefc drm/i915/gem: Clear read/wri=
te domains for GPU clear)
...
Merging drm-msm/msm-next (f47bee2ba447 drm/msm/a3xx: remove TPL1 regs from =
snapshot)
...
-next)
Merging sound/for-next (c5dfd4b88528 ALSA: firewire-motu: unify common trac=
epoints for both direction)
CONFLICT (content): Merge conflict in sound/pci/rme9652/hdspm.c
Merging sound-asoc/for-next (f455956d2045 Merge remote-tracking branch 'aso=
...
Merging block/for-next (213c10835f60 Merge branch 'for-5.3/block' into for-=
next)
...
Merging regulator/for-next (5600da105925 Merge branch 'regulator-5.3' into =
regulator-next)
...
Merging tip/auto-latest (22d55c2f6704 Merge branch 'core/debugobjects')
...
rflow
Merging akpm/master (3098e018f7bb drivers/media/platform/sti/delta/delta-ip=
...

=WKDE
-----END PGP SIGNATURE-----
