...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 43BE417D7B1
	for <lists+linux-kernel@lfdr.de>; Mon,  9 Mar 2020 02:17:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726742AbgCIBRg (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 8 Mar 2020 21:17:36 -0400
Received: from mail-lj1-f175.google.com ([209.85.208.175]:43054 "EHLO
        mail-lj1-f175.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726346AbgCIBRf (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 8 Mar 2020 21:17:35 -0400
Received: by mail-lj1-f175.google.com with SMTP id r7so8160790ljp.10
        for <linux-kernel@vger.kernel.org>; Sun, 08 Mar 2020 18:17:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linux-foundation.org; s=google;
        h=mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=ymk44F8mQY8DHWP8Eb9JgdqVh086qtawv9+SDELaG+w=;
        b=UcoteO8lzxbIt5He0ZDgFTVY+PWY4HZ5UNAwdpIuHpW9hPEMn8Zu8O/kMIeW4ZXLfS
         3TDKGEHqtWn8lokgUs6sl2vS7ZJTpq1svMY2n/YKWjRKaXxGlewnRCNAJNbeyYGkbcdv
         1NJBXYONaYuiWI2R2BvkumgPnfX10wlP1EnUU=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=ymk44F8mQY8DHWP8Eb9JgdqVh086qtawv9+SDELaG+w=;
        b=
X-Gm-Message-State: ANhLgQ0OUdiuzbk9G/TKvqDgZej/9t/SMfmJcSMzXhSrY85nL/6jOrJt
        d4snzYGkbdX0ddQRQgIHQVA67FUM6L0=
X-Google-Smtp-Source: ADFU+vue/V5HcBedoeUh1H4xasjAx2dBkdHZ2kQ6bBNEsg7Z5VYKn8sbDdjx28ormOPTF+fc+l3PUg==
X-Received: by 2002:a2e:9182:: with SMTP id f2mr8088438ljg.110.1583716650104;
        Sun, 08 Mar 2020 18:17:30 -0700 (PDT)
Received: from mail-lf1-f45.google.com (mail-lf1-f45.google.com. [209.85.167.45])
        by smtp.gmail.com with ESMTPSA id s16sm11089020ljs.65.2020.03.08.18.17.28
        for <linux-kernel@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 08 Mar 2020 18:17:29 -0700 (PDT)
Received: by mail-lf1-f45.google.com with SMTP id v6so6233970lfo.13
        for <linux-kernel@vger.kernel.org>; Sun, 08 Mar 2020 18:17:28 -0700 (PDT)
X-Received: by 2002:ac2:5203:: with SMTP id a3mr8005611lfl.152.1583716648303;
 Sun, 08 Mar 2020 18:17:28 -0700 (PDT)
MIME-Version: 1.0
From:   Linus Torvalds <torvalds@linux-foundation.org>
Date:   Sun, 8 Mar 2020 18:17:11 -0700
X-Gmail-Original-Message-ID: <CAHk-=wjie=L9=jO-VKR5u7+5Ekis-VR5m=zUChR9djhAuAN55g@mail.gmail.com>
Message-ID: <CAHk-=wjie=L9=jO-VKR5u7+5Ekis-VR5m=zUChR9djhAuAN55g@mail.gmail.com>
...
Ard Biesheuvel (3):
      ...
      efi/x86: Remove support for EFI time and counter services in mixed mo=
de
      efi/x86: Handle by-ref arguments covering multiple pages in mixed mod=
e

Arnaldo Carvalho de Melo (4):
      perf bpf: Remove bpf/ subdir from bpf.h headers used to build bpf eve=
nts
...
Randy Dunlap (1):
      Documentation/admin-guide/acpi: fix fan_performance_states.rst warnin=
gs
...
Saravana Kannan (3):
      ...
      driver core: Skip unnecessary work when device doesn't have sync_stat=
e()
...
Ulf Hansson (5):
 ...
 PSCI
      dt-bindings: power: Convert domain-idle-states bindings to json-schem=
a
      dt-bindings: power: Extend nodename pattern for power-domain provider=
s
...
beyond 2G limits
      riscv: Change code model of module to medany to improve data accessin=
g
