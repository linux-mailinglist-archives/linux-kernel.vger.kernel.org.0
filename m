...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5AF04B5617
	for <lists+linux-kernel@lfdr.de>; Tue, 17 Sep 2019 21:26:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730150AbfIQT0P (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Tue, 17 Sep 2019 15:26:15 -0400
Received: from mail-io1-f68.google.com ([209.85.166.68]:44773 "EHLO
        mail-io1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726475AbfIQT0O (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Tue, 17 Sep 2019 15:26:14 -0400
Received: by mail-io1-f68.google.com with SMTP id j4so10300907iog.11
        for <linux-kernel@vger.kernel.org>; Tue, 17 Sep 2019 12:26:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linuxfoundation.org; s=google;
        h=to:cc:from:subject:message-id:date:user-agent:mime-version
         :content-language;
        bh=IfQjJLrOyTlrSS7kIfC1bHdxMReUZwb1f4SdnVAfmao=;
        b=Exkhmg3Dc6AkYf789tuxjcubmYUzEIUfJhGpdu2C2dqvWeVf3wMxyuZwXjB9yisSMN
         IwUgkaatsprKGt7NsN9n1kWerN9+gi8dXxUWUANSWld62gUDhVnW9WaMrwK1BFjq7UAx
         Yw39suneceGJoHnZuDO1XKjtfLVA/Q8fVVOR4=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:to:cc:from:subject:message-id:date:user-agent
         :mime-version:content-language;
        bh=IfQjJLrOyTlrSS7kIfC1bHdxMReUZwb1f4SdnVAfmao=;
        b=
X-Gm-Message-State: APjAAAW62Xk9HQxk48rlnXkxlwoOBfV5xbs2PsY58LStRTwOJpsFbFkD
        2zhzclH0cjk1pF3vXlU1iM1k1vhAX2E=
X-Google-Smtp-Source: APXvYqzHTIyF5glhLzX5zj3mGJJGhGZgqwYhS35tEnNzDg2j5VoiFsc/GGI6fvxCASOcguUFFZ6bYQ==
X-Received: by 2002:a6b:784a:: with SMTP id h10mr441320iop.39.1568748366963;
        Tue, 17 Sep 2019 12:26:06 -0700 (PDT)
Received: from [192.168.1.112] (c-24-9-64-241.hsd1.co.comcast.net. [24.9.64.241])
        by smtp.gmail.com with ESMTPSA id z16sm2403065iol.64.2019.09.17.12.26.05
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Tue, 17 Sep 2019 12:26:05 -0700 (PDT)
...
Content-Type: multipart/mixed;
 boundary="------------1E44FD834236D3D0A45FADC6"
...
Content-Type: text/x-patch;
 name="linux-kselftest-5.4-rc1.diff"
Content-Transfer-Encoding: 7bit
Content-Disposition: attachment;
 filename="linux-kselftest-5.4-rc1.diff"
...
index 43604d6ab96c..8c1fbcc0d58c 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -8807,6 +8807,17 @@ S:	Maintained
...
@@ -12964,12 +12975,14 @@ F:	Documentation/filesystems/proc.txt
 PROC SYSCTL
 M:	Luis Chamberlain <mcgrof@kernel.org>
...
index 9fa18613566f..3db2e47473e2 100644
--- a/Makefile
+++ b/Makefile
@@ -1008,6 +1008,8 @@ export MODORDER := $(if $(KBUILD_EXTMOD),$(KBUILD_EXTMOD)/)modules.order
 ifeq ($(KBUILD_EXTMOD),)
...
new file mode 100644
index 000000000000..8541ef95b65a
--- /dev/null
+++ b/kunit/Kconfig
@@ -0,0 +1,38 @@
+#
...
index 000000000000..0944dea5c321
--- /dev/null
