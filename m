...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4D2FD116360
	for <lists+linux-kernel@lfdr.de>; Sun,  8 Dec 2019 19:13:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726527AbfLHSNz (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 8 Dec 2019 13:13:55 -0500
Received: from mail.kernel.org ([198.145.29.99]:60348 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726220AbfLHSNy (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 8 Dec 2019 13:13:54 -0500
Received: from paulmck-ThinkPad-P72.home (unknown [65.158.186.218])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id EF30B205F4;
        Sun,  8 Dec 2019 18:13:42 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1575828823;
        bh=6utEFYVgZO5CN5HSxhvgeE8ZZqcTpnLcHEzr5/cWOEo=;
        h=Date:From:To:Cc:Subject:Reply-To:References:In-Reply-To:From;
        b=UucsFSkI9XO5tKF3KT/ER73vDgr6lX6bFPmqXypJYVf7wB/qcBUDhQNgiqTcAk54E
         kw2dFLjiPU8DmSmTHjGQTy0FAncDceSimilYqctBBWt7z21GC7pYzIQHSaHCfojR3Q
         0uUST0jUJjAUCGk/RmHqVCSLiIhW8mkuLyUzmwpY=
Received: by paulmck-ThinkPad-P72.home (Postfix, from userid 1000)
        id B4D4635231EA; Sun,  8 Dec 2019 10:13:42 -0800 (PST)
Date:   Sun, 8 Dec 2019 10:13:42 -0800
...
Message-ID: <20191208181342.GY2889@paulmck-ThinkPad-P72>
...
In-Reply-To: <20191208152907.GH32275@shao2-debian>
...
> 	export testtime=1
> 	export job_origin='/lkp/lkp/.src-20191201-135720/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2sp5/stress-ng.yaml'
...
> 	export submit_id='5de979ab35976f51d2416bfa'
> 	export job_file='/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c-deb-20191206-20946-kfddif-3.yaml'
> 	export id='446e68e1398a0a1c19dcbcc0faca0f710a0813f9'
...
> CONFIG_PCI=y
> CONFIG_SECURITY_APPARMOR=y'
> 	export commit='ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd'
...
> 	export enqueue_time='2019-12-06 05:42:36 +0800'
> 	export _id='5de979cc35976f51d2416bfb'
> 	export _rt='/result/stress-ng/cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c/lkp-csl-2sp5/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd'
> 	export user='lkp'
> 	export head_commit='987adfea6c3f940be81d7bc4a04adaa9f90b2fb9'
> 	export base_commit='219d54332a09e8d8741c1e1982f5eae56099de85'
> 	export branch='linux-devel/devel-hourly-2019120106'
> 	export result_root='/result/stress-ng/cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c/lkp-csl-2sp5/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd/3'
> 	export scheduler_version='/lkp/lkp/.src-20191205-143055'
> 	export LKP_SERVER='inn'
> 	export max_uptime=921.0
> 	export initrd='/osimage/debian/debian-x86_64-2019-11-14.cgz'
> 	export bootloader_append='root=/dev/ram0
> user=lkp
> job=/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c-deb-20191206-20946-kfddif-3.yaml
> ARCH=x86_64
> kconfig=x86_64-rhel-7.6
> branch=linux-devel/devel-hourly-2019120106
> commit=ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd
> BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd/vmlinuz-5.4.0-rc1-00011-ged93dfc6bc008
> max_uptime=921
> RESULT_ROOT=/result/stress-ng/cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c/lkp-csl-2sp5/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd/3
> LKP_SERVER=inn
> nokaslr
> debug
> apic=debug
...
> 	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd/vmlinuz-5.4.0-rc1-00011-ged93dfc6bc008'
> 	export dequeue_time='2019-12-06 06:14:25 +0800'
> 	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c-deb-20191206-20946-kfddif-3.cgz'
> 
> 	[ -n "$LKP_SRC" ] ||
...
> stress-ng:
>   class: cpu-cache
> job_origin: "/lkp/lkp/.src-20191201-135720/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2sp5/stress-ng.yaml"
> 
> #! queue options
> queue_cmdline_keys:
> - branch
...
> submit_id: 5de96f2735976f50cdfe5239
> job_file: "/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c-debia-20191206-20685-wnudhu-0.yaml"
> id: 6ba864645cb23ecdb69009fe3d122a817afab313
...
> kconfig: x86_64-rhel-7.6
> compiler: gcc-7
> enqueue_time: 2019-12-06 04:57:53.183922362 +08:00
> _id: 5de96f2735976f50cdfe5239
> _rt: "/result/stress-ng/cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c/lkp-csl-2sp5/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd"
> 
> #! schedule options
> user: lkp
> head_commit: 987adfea6c3f940be81d7bc4a04adaa9f90b2fb9
> base_commit: 219d54332a09e8d8741c1e1982f5eae56099de85
> branch: linux-devel/devel-hourly-2019120106
> result_root: "/result/stress-ng/cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c/lkp-csl-2sp5/debian-x86_64-2019-11-14.cgz/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd/0"
> scheduler_version: "/lkp/lkp/.src-20191205-143055"
> LKP_SERVER: inn
> max_uptime: 921.0
...
> - root=/dev/ram0
> - user=lkp
> - job=/lkp/jobs/scheduled/lkp-csl-2sp5/stress-ng-cpu-cache-performance-1HDD-100%-1s-ucode=0x500002c-debia-20191206-20685-wnudhu-0.yaml
> - ARCH=x86_64
> - kconfig=x86_64-rhel-7.6
> - branch=linux-devel/devel-hourly-2019120106
> - commit=ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd
...
> - vga=normal
> - rw
> modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd/modules.cgz"
...
> kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/ed93dfc6bc0084485ccad1ff6bd2ea81ab2c03cd/vmlinuz-5.4.0-rc1-00011-ged93dfc6bc008"
> dequeue_time: 2019-12-06 05:37:30.000008488 +08:00
> 
> #! /lkp/lkp/.src-20191205-143055/include/site/inn
> job_state: finished
> loadavg: 31.75 8.12 2.73 1/777 5676
> start_time: '1575581904'
> end_time: '1575581928'
> version: "/lkp/lkp/.src-20191205-143130:4b0399da:1b1d256a7-dirty"
...
> done
> 
>  "stress-ng" "--timeout" "1" "--times" "--verify" "--metrics-brief" "--sequential" "96" "--class" "cpu-cache" "--exclude" "spawn,exec"
