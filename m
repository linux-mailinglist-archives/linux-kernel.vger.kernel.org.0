...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E4AE51500F0
	for <lists+linux-kernel@lfdr.de>; Mon,  3 Feb 2020 05:23:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727408AbgBCEXA (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Sun, 2 Feb 2020 23:23:00 -0500
Received: from mail-qt1-f202.google.com ([209.85.160.202]:41642 "EHLO
        mail-qt1-f202.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727164AbgBCEW7 (ORCPT
        <rfc822;linux-kernel@vger.kernel.org>);
        Sun, 2 Feb 2020 23:22:59 -0500
Received: by mail-qt1-f202.google.com with SMTP id a13so9166852qtp.8
        for <linux-kernel@vger.kernel.org>; Sun, 02 Feb 2020 20:22:58 -0800 (PST)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:message-id:mime-version:subject:from:to:cc
         :content-transfer-encoding;
        bh=X6VO2mdbhKE5o6DYiR8xP596jvUpUwQpg4b1gjaIEUk=;
        b=
X-Gm-Message-State: APjAAAX7MTrmWVDWib4RxpniscXuNfW6ntFCaqUcvNf+GDpN1hS8F5UL
        y+IjU1A5UikghoYDdNgOkUSb8bui0ZtdTHagouS5e4E5e5OiFmrEZAkz98o98Fi2cISImq9VRc6
        WttC0dKC9eMAxGY6cUepaqoij3rfrVfRdY8Pot7NsRR6ywz3b0rmUoUWKyhIS9lHCoaPzvQ==
...
-}
-
-static ssize_t vsoc_read(struct file *filp, char __user *buffer, size_t le=
n,
-			 loff_t *poffset)
-{
-	__u32 area_off;
...
-
-/*
- * This should undo all of the allocations in the probe function in revers=
e
- * order.
- *
- * Notes:
...
- *
- *   This function may be called multiple times, so mark resources as free=
d
...
-
-/*
- * Returns the device relative offset and length of the area specified by =
the
- * fd scoped permission. If there is no fd scoped permission set, a defaul=
t
- * permission covering the entire region is assumed, unless the region is =
owned
- * by another one, in which case the default is a permission with zero siz=
e.
- */
