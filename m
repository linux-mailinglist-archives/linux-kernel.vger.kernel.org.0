...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D375FEDAC4
	for <lists+linux-kernel@lfdr.de>; Mon,  4 Nov 2019 09:47:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728227AbfKDIrp (ORCPT <rfc822;lists+linux-kernel@lfdr.de>);
        Mon, 4 Nov 2019 03:47:45 -0500
Received: from mga02.intel.com ([134.134.136.20]:21291 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726441AbfKDIrp (ORCPT <rfc822;linux-kernel@vger.kernel.org>);
        Mon, 4 Nov 2019 03:47:45 -0500
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga101.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 04 Nov 2019 00:47:38 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,266,1569308400"; 
   d="yaml'?scan'208";a="401538843"
Received: from shao2-debian.sh.intel.com (HELO localhost) ([10.239.13.6])
  by fmsmga005.fm.intel.com with ESMTP; 04 Nov 2019 00:47:35 -0800
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="LwbuP8dfxhLLLUfV"
...
Content-Disposition: attachment; filename="config-5.4.0-rc5-00035-g975832d6ecbe1"
...
export_top_env()
{
	...
	export nr_threads=4
	export job_origin='/lkp/lkp/.src-20191031-232715/allot/cyclic:p1:linux-devel:devel-hourly/lkp-ivb-d04/hackbench-100.yaml'
...
queue_at_least_once'
	...
	export submit_id='5dbd2112afd91e231ef1899b'
	export job_file='/lkp/jobs/scheduled/lkp-ivb-d04/hackbench-performance-pipe-process-100%-ucode=0x21-debian-x86_64-2-20191102-8990-18xbb12-3.yaml'
	export id='a9e70165711e3bad2413cc79f2a6097d31bc2860'
	...
	export commit='975832d6ecbe123dfee907af0c77cd7e0c1ad175'
...
CONFIG_SATA_AHCI'
	...
	export enqueue_time='2019-11-02 14:24:27 +0800'
	export _id='5dbd211eafd91e231ef1899c'
	export _rt='/result/hackbench/performance-pipe-process-100%-ucode=0x21/lkp-ivb-d04/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175'
	export user='lkp'
	export head_commit='67806383a7c933d7cd05260948bdfa88b2e51349'
	export base_commit='d6d5df1db6e9d7f8f76d2911707f7d5877251b02'
	export branch='linux-devel/devel-hourly-2019110119'
	export result_root='/result/hackbench/performance-pipe-process-100%-ucode=0x21/lkp-ivb-d04/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-ivb-d04/hackbench-performance-pipe-process-100%-ucode=0x21-debian-x86_64-2-20191102-8990-18xbb12-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-7.6
branch=linux-devel/devel-hourly-2019110119
commit=975832d6ecbe123dfee907af0c77cd7e0c1ad175
BOOT_IMAGE=/pkg/linux/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/vmlinuz-5.4.0-rc5-00035-g975832d6ecbe1
max_uptime=2400
RESULT_ROOT=/result/hackbench/performance-pipe-process-100%-ucode=0x21/lkp-ivb-d04/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/3
LKP_SERVER=inn
nokaslr
debug
apic=debug
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/modules.cgz'
	...
	export last_kernel='5.3.0-rc2-00075-g2871f4abd7cef'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/vmlinuz-5.4.0-rc5-00035-g975832d6ecbe1'
	export dequeue_time='2019-11-02 14:40:56 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-ivb-d04/hackbench-performance-pipe-process-100%-ucode=0x21-debian-x86_64-2-20191102-8990-18xbb12-3.cgz'
...
hackbench:
  mode: process
  ipc: pipe
job_origin: "/lkp/lkp/.src-20191031-232715/allot/cyclic:p1:linux-devel:devel-hourly/lkp-ivb-d04/hackbench-100.yaml"
...
submit_id: 5dbd0613afd91e2077c5b492
job_file: "/lkp/jobs/scheduled/lkp-ivb-d04/hackbench-performance-pipe-process-100%-ucode=0x21-debian-x86_64-201-20191102-8311-lydqbu-0.yaml"
id: 5e113fc53b65a60b7b2b9ebd6787114e349b574e
...
enqueue_time: 2019-11-02 12:29:13.421404408 +08:00
_id: 5dbd0613afd91e2077c5b492
_rt: "/result/hackbench/performance-pipe-process-100%-ucode=0x21/lkp-ivb-d04/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175"

#! schedule options
user: lkp
head_commit: 67806383a7c933d7cd05260948bdfa88b2e51349
base_commit: d6d5df1db6e9d7f8f76d2911707f7d5877251b02
branch: linux-devel/devel-hourly-2019110119
result_root: "/result/hackbench/performance-pipe-process-100%-ucode=0x21/lkp-ivb-d04/debian-x86_64-2019-09-23.cgz/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/0"
scheduler_version: "/lkp/lkp/.src-20191101-141328"
LKP_SERVER: inn
max_uptime: 2400
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-ivb-d04/hackbench-performance-pipe-process-100%-ucode=0x21-debian-x86_64-201-20191102-8311-lydqbu-0.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-7.6
- branch=linux-devel/devel-hourly-2019110119
- commit=975832d6ecbe123dfee907af0c77cd7e0c1ad175
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/modules.cgz"
...
#! /lkp/lkp/.src-20191101-141328/include/site/inn
LKP_CGI_PORT: 80
LKP_CIFS_PORT: 139
oom-killer: 
watchdog: 
...
#! runtime status
last_kernel: 5.4.0-rc5
repeat_to: 2
schedule_notify_address: 

#! user overrides
queue_at_least_once: 0
kernel: "/pkg/linux/x86_64-rhel-7.6/gcc-7/975832d6ecbe123dfee907af0c77cd7e0c1ad175/vmlinuz-5.4.0-rc5-00035-g975832d6ecbe1"
dequeue_time: 2019-11-02 12:31:22.048974585 +08:00
job_state: finished
loadavg: 68.42 64.82 36.27 1/136 12033
start_time: '1572669138'
end_time: '1572669753'
version: "/lkp/lkp/.src-20191101-141407:c74ef327-dirty:bd00a262d-dirty"
...
do
 ...
 "/usr/bin/hackbench" "-g" "4" "--process" "--pipe" "-l" "30000" "-s" "100"
 "/usr/bin/hackbench" "-g" "4" "--process" "--pipe" "-l" "30000" "-s" "100"
 "/usr/bin/hackbench" "-g" "4" "--process" "--pipe" "-l" "30000" "-s" "100"
 "/usr/bin/hackbench" "-g" "4" "--process" "--pipe" "-l" "30000" "-s" "100"
 "/usr/bin/hackbench" "-g" "4" "--process" "--pipe" "-l" "30000" "-s" "100"
